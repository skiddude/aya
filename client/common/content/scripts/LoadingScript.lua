...
function InfoProvider:LoadAssets()
    local assetsCoroutine = coroutine.create(function()
        if PLACEID <= 0 then
            repeat wait() until game.PlaceId > 0
    ...
    coroutine.resume(assetsCoroutine)
end
        ...
        for i = 0, math.ceil(frameToFill.AbsoluteSize.X/backgroundTextureSize.X) do
            for j = 0, math.ceil(frameToFill.AbsoluteSize.Y/backgroundTextureSize.Y) do
                create 'ImageLabel' {
                    ...
                    Image = 'ayaasset://textures/loading/darkLoadingTexture.png',
...
local function createTenfootCancelGui()
    local cancelLabel = create'ImageLabel'
    {
        ...
        BackgroundTransparency = 1;
        Image = 'ayaasset://textures/ui/Shell/ButtonIcons/BButton.png';
    }
...
function MainGui:GenerateMain()
    ...
    local mainBackgroundContainer = create 'Frame' {
        ...
        local closeButton =    create 'ImageButton' {
            Name = 'CloseButton',
            Image = 'ayaasset://textures/loading/cancelButton.png',
            ImageTransparency = 1,
            BackgroundTransparency = 1,
        ...
        local graphicsFrame = create 'Frame' {
            ...
            local loadingImage = create 'ImageLabel' {
                Name = 'LoadingImage',
                BackgroundTransparency = 1,
                Image = 'ayaasset://textures/loading/loadingCircle.png',
                Position = UDim2.new(0, 0, 0, 0),
                Size = UDim2.new(1, 0, 1, 0),
                ZIndex = 2,
        ...
        local infoFrame = create 'Frame' {
            ...
            if isTenFootInterface then
                ...
                local creatorIcon = create'ImageLabel' {
                    ...
                    ImageTransparency = 0,
                    Image = 'ayaasset://textures/ui/Shell/Icons/RobloxIcon32.png',
                    ZIndex = 2,
                    Visible = false,
                    Parent = infoFrame,
                }
...
local genericCoroutine = coroutine.create(function()
...
coroutine.resume(genericCoroutine)
    ...
    if guiService:GetErrorMessage() ~= '' then
        if isTenFootInterface then
            ...
            if errorImage == nil then
                ...
                errorImage.Image = "ayaasset://textures/ui/ErrorIconSmall.png"
