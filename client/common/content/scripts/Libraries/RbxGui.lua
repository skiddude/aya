...
t.CreateStyledMessageDialog = function(title, message, style, buttons)
	...
	if style == "error" or style == "Error" then
		...
		styleImage.Image = "https://assetdelivery.roblox.com/v1/asset?id=42565285"
	elseif style == "notify" or style == "Notify" then
		styleImage.Size = UDim2.new(0, 71, 0, 71)
		styleImage.Image = "https://assetdelivery.roblox.com/v1/asset?id=42604978"
	elseif style == "confirm" or style == "Confirm" then
		styleImage.Size = UDim2.new(0, 74, 0, 76)
		styleImage.Image = "https://assetdelivery.roblox.com/v1/asset?id=42557901"
	else
...
t.CreateScrollingDropDownMenu = function(onSelectedCallback, size, position, baseZ)
	...
	icon.Image = 'ayaasset://textures/ui/dropdown_arrow.png'
	...
	dropDownMenu.CreateList = function(list)
		...
		listMenu.BottomImage = 'ayaasset://textures/ui/scroll-bottom.png'
		listMenu.MidImage = 'ayaasset://textures/ui/scroll-middle.png'
		listMenu.TopImage = 'ayaasset://textures/ui/scroll-top.png'
		listMenu.ScrollBarThickness = 0
...
t.CreateDropDownMenu = function(items, onSelect, forRoblox, whiteSkin, baseZ)
	...
	if (whiteSkin) then
		dropDownIcon.Image = "ayaasset://textures/ui/dropdown_arrow.png"
		dropDownIcon.Size = UDim2.new(0,16,0,12)
		dropDownIcon.Position = UDim2.new(1,-17,0.5, -6)
	else
		dropDownIcon.Image = "https://assetdelivery.roblox.com/v1/asset?id=45732894"
	...
	if useScrollButtons then
		...
		scrollUpButton.Image = "ayaasset://textures/ui/scrollbuttonUp.png"
		...
		scrollDownButton.Image = "ayaasset://textures/ui/scrollbuttonDown.png"
		...
		scrollbar.Image = "ayaasset://textures/ui/scrollbar.png"
	...
	return frame, updateSelection, toggleVisibility
end
...
t.CreateSlider = function(steps,width,position)
	...
	slider.Image = "ayaasset://textures/ui/Slider.png"
...
t.CreateSliderNew = function(steps,width,position)
	...
	bar.Image = "ayaasset://textures/ui/Slider-BKG-Center.png"
	bar.Name = "Bar"
	...
	barLeft.Image = "ayaasset://textures/ui/Slider-BKG-Left-Cap.png"
	...
	barRight.Image = "ayaasset://textures/ui/Slider-BKG-Right-Cap.png"
	...
	fillLeft.Image = "ayaasset://textures/ui/Slider-Fill-Left-Cap.png"
	fillLeft.Parent = sliderGui	
	fillLeft.ZIndex = 4

	local fill = fillLeft:clone()
	fill.Name = "Fill"
	fill.Image = "ayaasset://textures/ui/Slider-Fill-Center.png"
	fill.Parent = bar	
	fill.ZIndex = 4
...
--	bar.Visible = false
	...
	slider.Name = "Slider"
	slider.BackgroundTransparency = 1
	slider.Image = "ayaasset://textures/ui/slider_new_tab.png"
...
t.CreateScrollingFrame = function(orderList,scrollStyle)
	...
	scrollDrag.Image = "https://assetdelivery.roblox.com/v1/asset?id=61367186"
...
local function CreateBasicTutorialPage(name, handleResize, skipTutorial, giveDoneButton)
	...
	skipButton.Image = "ayaasset://textures/ui/closeButton.png"
	skipButton.MouseButton1Click:connect(function()
		skipTutorial()
	end)
	skipButton.MouseEnter:connect(function()
		skipButton.Image = "ayaasset://textures/ui/closeButton_dn.png"
	end)
...
t.CreateSetPanel = function(userIdsForSets, objectSelected, dialogClosed, size, position, showAdminCategories, useAssetVersionId)
	...
	local function createSetGui()
		...
		setPanel.Parent = setGui
			...
			cancelButton.Parent = setPanel
				...
				cancelImage.Image = "https://assetdelivery.roblox.com/v1/asset?id=54135717"
	...
	local function createDropDownMenuButton(parent)
		...
		dropDownButton.Image = "https://assetdelivery.roblox.com/v1/asset?id=67581509"
...
t.CreateTerrainMaterialSelector = function(size,position)
	...
	for i,v in pairs(materialNames) do
		...
		if v == "Grass" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Grass.png"
		elseif v == "Sand" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Sand.png"
		elseif v == "Brick" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Brick.png"
		elseif v == "Granite" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Granite.png"
		elseif v == "Asphalt" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Asphalt.png"
		elseif v == "Iron" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Iron.png"
		elseif v == "Aluminum" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Aluminum.png"
		elseif v == "Gold" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Gold.png"
		elseif v == "Plastic (red)" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/RedPlastic.png"
		elseif v == "Plastic (blue)" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/BluePlastic.png"
		elseif v == "Plank" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Plank.png"
		elseif v == "Log" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Log.png"
		elseif v == "Gravel" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Gravel.png"
		elseif v == "Cinder Block" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/CinderBlock.png"
		elseif v == "Stone Wall" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/StoneWall.png"
		elseif v == "Concrete" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Concrete.png"
		elseif v == "Water" then materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/Water.png"
		else materialToImageMap[v].Regular = "ayaasset://textures/RbxGui/OtherMaterial.png" -- fill in the rest here!!
		end
	end
...
t.CreateLoadingFrame = function(name,size,position)
	game:GetService("ContentProvider"):Preload("https://assetdelivery.roblox.com/v1/asset?id=35238053")
	...
	loadingBar.Parent = loadingFrame
		...
		loadingGreenBar.Image = "https://assetdelivery.roblox.com/v1/asset?id=35238053"
