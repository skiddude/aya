...
------------------ CONSTANTS --------------------
local SELECTED_COLOR = Color3.fromRGB(135, 57, 255)
local NON_SELECTED_COLOR = Color3.new(78/255,84/255,96/255)

local SELECTED_LEFT_IMAGE = "ayaasset://textures/ui/Settings/Slider/SelectedBarLeft.png"
local NON_SELECTED_LEFT_IMAGE = "ayaasset://textures/ui/Settings/Slider/BarLeft.png"
local SELECTED_RIGHT_IMAGE = "ayaasset://textures/ui/Settings/Slider/SelectedBarRight.png"
local NON_SELECTED_RIGHT_IMAGE= "ayaasset://textures/ui/Settings/Slider/BarRight.png"
...
local function CreateDropDown(dropDownStringTable, startPosition, settingsHub, dropDownText)
    ...
    local inputBegan2 = UserInputService.InputBegan:connect(processInput)
    local inputEnded2 = UserInputService.InputEnded:connect(processInput)
...
local function CreateSelector(selectionStringTable, startPosition)
    ...
    local leftButtonImage = Util.Create'ImageLabel'
    {
        ...
        Image =  "ayaasset://textures/ui/Settings/Slider/Left.png",
        ZIndex = 2,
        Active = true,
        Parent = leftButton
    };
    local rightButtonImage = Util.Create'ImageLabel'
    {
        ...
        Size =  UDim2.new(0,18,0,30),
        Image =  "ayaasset://textures/ui/Settings/Slider/Right.png",
        ZIndex = 2,
        Parent = rightButton
    };
...
function moduleApiTable:CreateNewDropDown(dropDownStringTable, startPosition)
    return CreateDropDown(dropDownStringTable, startPosition, nil, nil)
end
