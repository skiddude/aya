...
-- d9mz - this was yielding -- what the hell even is LocalBackpack?
...
local backpackManager = waitForChild(guiBackpack,"CoreScripts/2013/BackpackManager")
...
local addingPlayerChild = function(child, equipped, addToSlot, inventoryGearButton)	
	...
	gearClone.MouseEnter:connect(function()
		if not child:IsA("HopperBin") and gearClone.GearReference and gearClone.GearReference.Value["ToolTip"] and gearClone.GearReference.Value.ToolTip ~= "" then
