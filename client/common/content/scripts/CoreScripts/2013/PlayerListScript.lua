...
function getMembershipTypeIcon(membershipType,playerName)
	if ADMINS[string.lower(playerName)]~=nil then
		if ADMINS[string.lower(playerName)] == 1 then
			return "ayaasset://textures/Kiseki.png"
		else
...
local function getFriendStatusIcon(friendStatus)
	...
	elseif friendStatus == Enum.FriendStatus.Friend then
		return "ayaasset://textures/2013/PlayerListScript/Friend.png"
	elseif friendStatus == Enum.FriendStatus.FriendRequestSent then
		return "ayaasset://textures/2013/PlayerListScript/FriendRequestSent.png"
	elseif friendStatus == Enum.FriendStatus.FriendRequestReceived then
		return "ayaasset://textures/2013/PlayerListScript/FriendRequestReceived.png"
	else
...
function MakePopupButton(nparent,ntext,index,last)
	...
	if index==0 then
		tobj.Image = 'ayaasset://textures/2013/PlayerListScript/popupButton0.png'
	elseif last then
		if index%2==1 then
			tobj.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='.. Images['LightPopupBottom']
		else
			tobj.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='.. Images['DarkPopupBottom']
		end
	else
		if index%2==1 then
			tobj.Image = 'ayaasset://textures/2013/PlayerListScript/popupButton1.png'
		else
			tobj.Image = 'ayaasset://textures/2013/PlayerListScript/popupButton2.png'
		end
	end
	return tobj
end
...
local HeaderFrame = Obj.Create"Frame"
{
	...
	Parent = MainFrame,
	MakeBackgroundGuiObj('ayaasset://textures/2013/PlayerListScript/background.png'),
}
...
local BottomShiftFrame = Obj.Create"Frame"
{
	...
	local BottomFrame = Obj.Create"Frame"
	{
		...
		MakeBackgroundGuiObj('https://assetdelivery.roblox.com/v1/asset/?id=94754966'),
	}
		...
		local ExtendTab = Obj.Create"ImageButton"
		{
			...
			Active = true,
			BackgroundTransparency = 1,
			Image = 'ayaasset://textures/2013/PlayerListScript/ExtendTab.png',
...
local MiddleBGTemplate = Obj.Create"Frame"
{
	...
	Position = UDim2.new(100,0,.07,0),
	Size = UDim2.new(.5, 0, .025, 0),--UDim2.new(1, 0, .03, 0),
	MakeBackgroundGuiObj('https://assetdelivery.roblox.com/v1/asset/?id=94692025'),
...
local AbuseSettingsFrame = Obj.Create"Frame"
{
	...
	Active = true,
	BackgroundTransparency = 1,
	MakeBackgroundGuiObj('https://assetdelivery.roblox.com/v1/asset/?id=96488767'), -- 96480351'),
	Obj.Create"TextLabel"
	{
		Name = "Title",
		Text = "Report Abuse",
...
local SubmitReportButton = Obj.Create"ImageButton"
{
	...
	AutoButtonColor = false,
	Image = 'https://assetdelivery.roblox.com/v1/asset/?id=96502438', -- 96501119',
	Parent = AbuseSettingsFrame,
}
...
local CancelReportButton = Obj.Create"ImageButton"
{
	...
	Image = 'https://assetdelivery.roblox.com/v1/asset/?id=96500683',
	Parent = AbuseSettingsFrame,
}
...
local CalmingAbuseBox = Obj.Create'Frame'
{
	...
	MakeBackgroundGuiObj('ayaasset://textures/2013/PlayerListScript/AbuseFeedbackBoxBkg.png3'),
	Obj.Create'TextLabel'
	{
		Name = 'Header',
	...
	Obj.Create'ImageButton'
	{
		...
		Size = UDim2.new(0,150,0,50),
		AutoButtonColor = true,
		Image = 'ayaasset://textures/2013/PlayerListScript/OkButton.png',
	}
}
...
for _,i in pairs(Images) do
	Game:GetService("ContentProvider"):Preload("https://assetdelivery.roblox.com/v1/asset/?id="..i)
end
...
function HighlightMyRank(player,BanPlayerButton,VisitorButton,MemberButton,AdminButton)
	BanPlayerButton.Image= 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LightPopupMid']
	VisitorButton.Image= 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['DarkPopupMid']
	MemberButton.Image= 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LightPopupMid']
	AdminButton.Image= 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['DarkPopupBottom']
	
	local rank=player.PersonalServerRank
	if rank <= PrivilegeLevel['Banned'] then
		BanPlayerButton.Image='https://assetdelivery.roblox.com/v1/asset/?id='..Images['LightBluePopupMid']
	elseif rank <= PrivilegeLevel['Visitor'] then
		VisitorButton.Image='https://assetdelivery.roblox.com/v1/asset/?id='..Images['DarkBluePopupMid']
	elseif rank <= PrivilegeLevel['Member'] then
		MemberButton.Image='https://assetdelivery.roblox.com/v1/asset/?id='..Images['LightBluePopupMid']
	elseif rank <= PrivilegeLevel['Admin'] then
		AdminButton.Image= 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['DarkBluePopupBottom']
	end
end
...
function CloseAbuseDialog()
	...
	SubmitReportButton.Image = 'https://assetdelivery.roblox.com/v1/asset/?id=96502438' -- 96501119',
...
function InitReportAbuse()
	...
	UpdateAbuseFunction = function(abuseText) 
		...
		if AbuseName and SelectedPlayer then
			...
			SubmitReportButton.Image = 'https://assetdelivery.roblox.com/v1/asset/?id=96501119'
		end
	end
...
function UpdateMinimize()
	...
	if IsMinimized.Value then
		...
		ExtendTab.Image = 'ayaasset://textures/2013/PlayerListScript/ExtendTab.png'
	else
		...
		ExtendTab.Image = 'ayaasset://textures/2013/PlayerListScript/ExtendTab1.png' 
	end
end
...
function UpdateMaximize()
	if IsMaximized.Value then
		...
		HeaderFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LargeHeader']
		BottomFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LargeBottom']
		for index, i in ipairs(MiddleFrameBackgrounds) do
			if (index%2) ~= 1 then
				i.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LargeDark']
			else
				i.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LargeLight']
			end
		end
		...
		HeaderFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['NormalHeader']
		BottomFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['NormalBottom']
		for index, i in ipairs(MiddleFrameBackgrounds) do
			if index%2 ~= 1 then
				i.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['midDark']
			else
				i.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['midLight']
			end
		end
		for index, i in ipairs(MiddleFrames) do
			if i:FindFirstChild('ClickListener') then
...
function AddMiddleBGFrame()
	...
	if (#MiddleFrameBackgrounds+1)%2 ~= 1 then
		if IsMaximized.Value then
			nBGFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LargeDark']
		else
			nBGFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['midDark']
		end
	else
		if IsMaximized.Value then
			nBGFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['LargeLight']
		else
			nBGFrame.Background.Image = 'https://assetdelivery.roblox.com/v1/asset/?id='..Images['midLight']
		end
	end
