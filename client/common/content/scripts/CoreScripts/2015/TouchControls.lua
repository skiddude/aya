...
local hasNewTouchControls =  true
if hasNewTouchControls then		-- NEW TOUCH CONTROLS WITH THUMBPAD
	...
	--[[ Images ]]--
	local TOUCH_CONTROL_SHEET = "ayaasset://textures/ui/TouchControlsSheet.png"
	local DPAD_SHEET = "ayaasset://textures/ui/DPadSheet.png"
	...
	local DPadSheet = "ayaasset://textures/ui/DPadSheet.png"
	...
	function createDPad()
		...
		local image = "roblox.com/asset?id=133293265"
