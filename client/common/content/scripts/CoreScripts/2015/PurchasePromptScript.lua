...
local isUsingInstance = AyaService:IsUsingInstance()
local instanceUrl = ContentProvider.InstanceUrl
local instanceCurrency = ContentProvider.InstanceCurrency
...
-- user facing images
local errorImageUrl = "ayaasset://textures/2015/PurchasePromptScript/ErrorImage.png"
local buyImageUrl = "ayaasset://textures/2015/PurchasePromptScript/BuyButton.png"
local cancelButtonImageUrl = "ayaasset://textures/2015/PurchasePromptScript/CancelButton.png"
local freeButtonImageDownUrl = "ayaasset://textures/2015/PurchasePromptScript/FreeButton.png"
local loadingImage = "ayaasset://textures/2015/PurchasePromptScript/LoadingImage.png"
...
local errorPurchasesBuyRobuxText = "your " .. instanceName .. " account does not have enough " .. instanceCurrency
local errorPurchasesUnknownText = instanceName .. " is performing maintenance"
...
function updatePurchasePromptData(insufficientFunds)
	...
	if purchasingConsumable then
		purchaseDialog.BodyFrame.ItemPreview.Image = baseUrl .. "thumbnail/asset?id=" .. tostring(currentProductInfo["IconImageAssetId"])
	else
		purchaseDialog.BodyFrame.ItemPreview.Image = baseUrl .. "thumbnail/asset?id=" .. tostring(currentAssetId)
	end
end
