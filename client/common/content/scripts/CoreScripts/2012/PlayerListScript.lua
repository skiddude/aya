...
-- @mdolli
-- 2012 playerlist originally didn't have admin icons
local ADMINS =
{
	player1 = 1,
	mdolli = 1,
...
local function rebuildBoard(owner, boardType, numStats)
	...
	if minimizedState == nil then
		...
		playerListButton.Image = "ayaasset://textures/ui/playerlist_hidden_small.png"
...
if UserSettings and LoadLibrary then
	...
	local function getFriendStatusIcon(friendStatus)
		...
		elseif friendStatus == Enum.FriendStatus.Friend then
			return "ayaasset://textures/ui/PlayerlistFriendIcon.png"
		elseif friendStatus == Enum.FriendStatus.FriendRequestSent then
			return "ayaasset://textures/ui/PlayerlistFriendRequestSentIcon.png"
		elseif friendStatus == Enum.FriendStatus.FriendRequestReceived then
			return "ayaasset://textures/ui/PlayerlistFriendRequestReceivedIcon.png"
		else
	...
	local function updatePlayerName(nameObject, membershipStatus, teamColor, playerName)
		local fontHeight = 20
	...
	local function createPlayerName(name, membershipStatus, teamColor, friendStatus)
		...
		updatePlayerName(frame, membershipStatus, teamColor, name)
			...
			player.Changed:connect(
				function(prop)
					if prop == "MembershipType" then
						updatePlayerName(playerTable[player]["NameObject" .. suffix], player.MembershipType, currentColor, player.Name)
	...
	createBoardsFunction = function (boardType, numStatColumns)
		...
		playerListButton.BackgroundTransparency = 1
		playerListButton.Image = "ayaasset://textures/ui/playerlist_small_maximize.png"
		...
		playerListButton.BackgroundTransparency = 1
		playerListButton.Image = "ayaasset://textures/ui/playerlist_small_hide.png"
		...
		playerListButton = Instance.new("ImageButton")
		playerListButton.Name = "CloseButton"
		playerListButton.Image = "ayaasset://textures/ui/playerlist_big_hide_ovr.png"
		playerListButton.BackgroundTransparency = 1
...
if contextMenu3d then
	...
	function createContextMenu(otherPlayer)
		...
		playerImage.Image = ContentProvider.BaseUrl .. "thumbnail/avatar?id=" .. tostring(otherPlayer.userId)
	...
	--[[
	-- d9mz - i think this might be important?
