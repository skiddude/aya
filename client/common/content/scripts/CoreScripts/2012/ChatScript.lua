	...
	self.SafeChatFrame = Gui.Create'Frame' 
						{
							...
							Gui.Create'ImageButton'
							{
								...
								BackgroundTransparency = 1.0;
								Image = 'ayaasset://textures/2012/ChatScript/SafeChatButton.png';
							};
						}
	...
	self.ChatTouchFrame = Gui.Create'Frame'
						{
							...
							Gui.Create'ImageLabel'
							{
								...
								Position = UDim2.new(0, 0, 0, 0);
								BackgroundTransparency = 1.0;
								Image = 'ayaasset://textures/2012/ChatScript/TouchButton.png'
							};
...
function Chat:CreateGui()
	...
	self.Frame = Gui.Create'Frame'
				{	
					...
					{
						Name = 'Background';
						Image = 'ayaasset://textures/2012/ChatScript/Background.png'; --96551212';
