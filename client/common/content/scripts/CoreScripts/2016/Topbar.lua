...
local HURT_OVERLAY_IMAGE = "ayaasset://textures/2015/HealthScript/hurtOverlayImage.png"
...
local function CreateTopBar()
	...
	local topbarShadow = Util.Create'ImageLabel'{
		...
		Image = "ayaasset://textures/ui/TopBar/dropshadow.png";
...
local function CreateSettingsIcon(topBarInstance)
	...
	game.CoreGui.RobloxGui.Modules:WaitForChild("SettingsHub")
	MenuModule = require(game.CoreGui.RobloxGui.Modules.SettingsHub)
	...
	local settingsIconImage = Util.Create'ImageLabel'
	{
		...
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/Menu/Hamburger.png";
		Parent = settingsIconButton;
	};

	local function UpdateHamburgerIcon()
		if settingsActive then
			settingsIconImage.Image = "ayaasset://textures/ui/Menu/HamburgerDown.png";
		else
			settingsIconImage.Image = "ayaasset://textures/ui/Menu/Hamburger.png";
		end
	end
...
local function CreateUnreadMessagesNotifier(ChatModule)
	...
	local chatCounter = Util.Create'ImageLabel'
	{
		...
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/Chat/MessageCounter.png";
		Visible = false;
	};
...
local function CreateChatIcon()
	...
	local chatIconImage = Util.Create'ImageLabel'
	{
		...
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/Chat/Chat.png";
	...
	local function updateIcon(down)
		if down then
			chatIconImage.Image = "ayaasset://textures/ui/Chat/ChatDown.png";
		else
			chatIconImage.Image = "ayaasset://textures/ui/Chat/Chat.png";
		end
	end
...
local function CreateMobileHideChatIcon()
	...
	local chatIconImage = Util.Create'ImageLabel'
	{
		...
		Position = UDim2.new(0.5, -14, 0.5, -13);
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/Chat/ToggleChat.png";
	...
	local function updateIcon(down)
		if down then
			chatIconImage.Image = "ayaasset://textures/ui/Chat/ToggleChatDown.png";
		else
			chatIconImage.Image = "ayaasset://textures/ui/Chat/ToggleChat.png";
		end
	end
...
local function CreateBackpackIcon()
	...
	local backpackIconImage = Util.Create'ImageLabel'
	{
		...
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/Backpack/Backpack.png";
		Parent = backpackIconButton;
	};

	local function onBackpackStateChanged(open)
		if open then
			backpackIconImage.Image = "ayaasset://textures/ui/Backpack/Backpack_Down.png";
		else
			backpackIconImage.Image = "ayaasset://textures/ui/Backpack/Backpack.png";
		end
	end
...
local function CreateStopRecordIcon()
	...
	local stopRecordIconLabel = Util.Create'ImageLabel'
	{
		...
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/RecordDown.png";
...
local function CreateShiftLockIcon()
	...
	local shiftlockIconLabel = Util.Create'ImageLabel'
	{
		...
		BackgroundTransparency = 1;
		Image = "ayaasset://textures/ui/ShiftLock/ShiftLock.png";
	...
	shiftlockIconButton.MouseButton1Click:connect(function()
		if shiftlockActive == false then
			...
			shiftlockIconLabel.Image = "ayaasset://textures/ui/ShiftLock/ShiftLockDown.png";
		else
			shiftlockActive = false
			shiftlockIconLabel.Image = "ayaasset://textures/ui/ShiftLock/ShiftLock.png";
		end
	end)
