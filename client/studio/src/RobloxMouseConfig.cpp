...
bool RobloxMouseConfig::canOpenContextMenu(Aya::InputObject::UserInputType inputType, Aya::InputObject::UserInputState inputState)
{
    ...
    if ((m_contextMenuConfig & MOUSEBUTTON_RIGHT) == MOUSEBUTTON_RIGHT && inputState == Aya::InputObject::INPUT_STATE_END &&
        inputType == Aya::InputObject::TYPE_MOUSEBUTTON2)
        buttonDown = true;

    Qt::KeyboardModifiers modifiers = QApplication::queryKeyboardModifiers();

    if (buttonDown && m_contextMenuConfig == MOUSEBUTTON_RIGHT &&
        !(inputState == Aya::InputObject::INPUT_STATE_END && inputType == Aya::InputObject::TYPE_MOUSEBUTTON1) &&
        (modifiers & Qt::ShiftModifier) == 0 && (modifiers & Qt::AltModifier) == 0 && (modifiers & Qt::ControlModifier) == 0)
        return true;
...
void RobloxMouseConfigWidget::initialize()
{
    ...
    connect(m_contextMenuOption, SIGNAL(currentIndexChanged(const QString&)), this, SLOT(contextMenuOptionSelected(const QString&)));
...
void RobloxMouseConfigWidget::updateContextMenuOption()
{
    ...
    else if (m_contextMenuOverride & RobloxMouseConfig::MOUSEBUTTON_RIGHT && m_contextMenuOverride & RobloxMouseConfig::MOUSEMODIFIER_SHIFT)
    {
        m_contextMenuOption->setCurrentIndex(2);
    }
    else if (m_contextMenuOverride & RobloxMouseConfig::MOUSEBUTTON_RIGHT && m_contextMenuOverride & RobloxMouseConfig::MOUSEMODIFIER_ALT)
    {
        m_contextMenuOption->setCurrentIndex(3);
    }
    else if (m_contextMenuOverride & RobloxMouseConfig::MOUSEBUTTON_RIGHT && m_contextMenuOverride & RobloxMouseConfig::MOUSEMODIFIER_CONTROL)
    {
...
void RobloxMouseConfigWidget::contextMenuOptionSelected(const QString& option)
{
    ...
    {
        m_contextMenuOverride = RobloxMouseConfig::MOUSEBUTTON_RIGHT | RobloxMouseConfig::MOUSEMODIFIER_SHIFT;
    }
    else if (option == "Right Click + Alt")
    {
        m_contextMenuOverride = RobloxMouseConfig::MOUSEBUTTON_RIGHT | RobloxMouseConfig::MOUSEMODIFIER_ALT;
    }
    else if (option == "Right Click + Ctrl")
    {
        m_contextMenuOverride = RobloxMouseConfig::MOUSEBUTTON_RIGHT | RobloxMouseConfig::MOUSEMODIFIER_CONTROL;
    }
