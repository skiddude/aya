...
bool BasicFindDialog::getSearchParameters(bool forward, QRegularExpression& outRegExp, QTextDocument::FindFlags& outflags)
{
    ...
    outflags = QFlags<QTextDocument::FindFlag>(0);
    ...
    outRegExp.setPatternOptions(patternOptions);

    Qt::CaseSensitivity caseSensitivity = m_pCaseCheckBox->isChecked() ? Qt::CaseSensitive : Qt::CaseInsensitive;
    outRegExp.setPatternOptions(outRegExp.patternOptions() | (caseSensitivity == Qt::CaseSensitive ? QRegularExpression::CaseInsensitiveOption : QRegularExpression::NoPatternOption));
...
bool ReplaceDialog::isSelectionValid()
{
    ...
    if (!selectedText.isEmpty())
    {
        ...
        if (!toSearch.isEmpty())
        {
            ...
            QRegularExpression reg(toSearch, patternOptions);
...
void EmbeddedFindReplaceWidget::initDialog()
{
    ...
    setMaximumHeight(0);
        ...
        m_pFindComboBox->setCompleter(nullptr);
        ...
        m_pReplaceComboBox->setCompleter(nullptr);

        m_pToggleReplaceButton = new QPushButton(QIcon(":/images/icons/16x16/expand_gray_16.png"), "");
        ...
        m_pFindNextButton = new QPushButton(QIcon(":/images/icons/16x16/arrowright_black_16.png"), "");
        ...
        m_pFindPreviousButton = new QPushButton(QIcon(":/images/icons/16x16/arrowleft_black_16.png"), "");
        ...
        m_pCloseDialogButton = new QPushButton(QIcon(":/images/icons/16x16/delete_x_16_b.png"), "");
        ...
        m_pReplaceNextButton = new QPushButton(QIcon(":/images/icons/16x16/replace.png"), "");
        ...
        m_pReplaceAllButton = new QPushButton(QIcon(":/images/icons/16x16/replace_all.png"), "");
        ...
        m_pMatchCaseButton = new QPushButton(QIcon(":/images/icons/16x16/match_case.png"), "");
        ...
        m_pMatchWholeWordButton = new QPushButton(QIcon(":/images/icons/16x16/match_whole_word.png"), "");
        ...
        m_pRegularExpressionButton = new QPushButton(QIcon(":/images/icons/16x16/regexp.png"), "");
        ...
        QRegularExpression EmbeddedFindReplaceWidget::getSearchString()
        {
            QRegularExpression::PatternOptions patternOptions = QRegularExpression::NoPatternOption;
            ...
            if (!m_pMatchCaseButton->isChecked()) {
                patternOptions |= QRegularExpression::CaseInsensitiveOption;
            }

            QRegularExpression rx(m_pFindComboBox->lineEdit()->text(), patternOptions);
        ...
        void EmbeddedFindReplaceWidget::toggleReplaceVisible()
        {
            ...
            m_pToggleReplaceButton->setIcon(QIcon(":/images/icons/16x16/" + toggleButtonIconLocation));
        ...
        {
            QTextDocument::FindFlags flags = m_pMatchWholeWordButton->isChecked() ? QTextDocument::FindWholeWords : (QTextDocument::FindFlags)0;
