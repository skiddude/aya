...
public:
    ...
    RobloxMainWindow& getMainWindow() const
    {
        return *m_pRobloxMainWindow;
    }
...
private:
    ...
    void exectueProgressFunction(boost::function<void()> userWorkFunc, QEventLoop* eventLoop, QMutex* eventLoopMutex, bool* done);
