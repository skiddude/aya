...
public:
    ...
    int getCurrentDeviceWidth()
    {
        return m_currentWidth;
    }
    int getCurrentDeviceHeight()
    {
        return m_currentHeight;
    }
    bool isEmulatingTouch()
    {
        return m_isEmulatingTouch;
    }

    void setCurrentDeviceWidth(int value)
    {
        m_currentWidth = value;
    }
    void setCurrentDeviceHeight(int value)
    {
        m_currentHeight = value;
    }
    void setIsEmulatingTouch(bool value)
    {
        m_isEmulatingTouch = value;
    }
