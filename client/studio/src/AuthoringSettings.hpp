...
class AuthoringSettings : public Aya::GlobalAdvancedSettingsItem<AuthoringSettings, sAuthoringSettings>
{
public:
    ...
    TestServerAudioBehavior getTestServerAudioBehavior() const
    {
        return testServerAudioBehavior;
    }
    ...
    Aya::ChangeHistoryService::RuntimeUndoBehavior getRuntimeUndoBehavior() const
    {
        return Aya::ChangeHistoryService::runtimeUndoBehavior;
    }
    void setRuntimeUndoBehavior(Aya::ChangeHistoryService::RuntimeUndoBehavior value);

    Aya::Security::Permissions getPermissionShown() const;
    PermissionLevelShown getPermissionLevelShown() const
    {
    ...
    bool isShown(Aya::Reflection::Metadata::Class* metadata, const DescriptorType& descriptor)
    {
        if (descriptor.security > getPermissionShown())
            return false;
        if (Aya::Reflection::Metadata::Item::isDeprecated(metadata, descriptor) && !showDeprecated)
            return false;
        if (!metadata)
            return false;
    ...
    template<class DescriptorType>
    bool isHiddenInBrowser(Aya::Reflection::Metadata::Item* metadata, const DescriptorType& descriptor)
    {
        if (descriptor.security > getPermissionShown())
            return true;
        if (Aya::Reflection::Metadata::Item::isDeprecated(metadata, descriptor) && !showDeprecated)
    ...
    QDir getCoreScriptsDir() const
    {
        return coreScriptsDir;
    }
    void setCoreScriptsDir(QDir value);

    bool getOverrideCoreScripts() const
    {
        return overrideCoreScripts;
    }
    void setOverrideCoreScripts(bool value);

    void onPluginsDirChanged(const Aya::Reflection::PropertyDescriptor&);
    ...
    HoverAnimateSpeed getHoverAnimateSpeed() const
    {
        return hoverAnimateSpeed;
    }
    void setHoverAnimateSpeed(HoverAnimateSpeed speed);

    ListDisplayMode getBasicObjectsDisplayMode() const
    {
        return basicObjectsDisplayMode;
    }
    void setBasicObjectsDisplayMode(ListDisplayMode mode);

    void setEditorFont(const QFont& font);

    OutputLayoutMode getOutputLayoutMode() const
    {
