...
public:
    ...
    bool createNewStudioInstance(const QString& script = QString(), const QString& fileLocation = QString(), bool isTestMode = false,
        bool isAvatarMode = false, NewInstanceMode mode = NewInstanceMode_Detached);
...
private:
    ...
    void composeArgList(QStringList& argsContainer, const QString& script, const QString& fileLocation, bool isTestMode, bool isAvatarMode);
