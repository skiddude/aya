...
void ScriptPickerDialog::runModal(QWidget* parent, QString suggestedName, CompletedState* state, QString* newName)
{
    ...
    *picked = Abandoned;
    ...
    UpdateUIManager::Instance().getViewWidget<RobloxGameExplorer>(eDW_GAME_EXPLORER).getListOfScripts(&usedNames);
    ...
    QObject::connect(nameEdit, SIGNAL(returnPressed()), this, SLOT(acceptLineEditValue()));
    QObject::connect(pb, SIGNAL(clicked()), this, SLOT(acceptLineEditValue()));
