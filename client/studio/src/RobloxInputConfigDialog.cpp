...
void RobloxInputConfigDialog::initialize()
{
    ...
    connect(m_dialogButtonBox, SIGNAL(clicked(QAbstractButton*)), this, SLOT(clicked(QAbstractButton*)));
    ...
    connect(m_keyboardConfigWidget, SIGNAL(dataChanged()), this, SLOT(dataChanged()));
    ...
    connect(m_mouseConfigWidget, SIGNAL(dataChanged()), this, SLOT(dataChanged()));
