...
public:
    ...
    bool doUnion(Instances::const_iterator start, Instances::const_iterator end, boost::shared_ptr<PartOperation>& partOperation);
    bool doNegate(Instances::const_iterator start, Instances::const_iterator end, Instances& toSelect);
    bool doSeparate(Instances::const_iterator start, Instances::const_iterator end, Instances& ungroupedItems);

private:
    DataModel* mDatamodel;
    MessageCallback operationFailed;

    bool setUnionMesh(boost::shared_ptr<PartOperation> finalPartOperation, Instances::const_iterator start, Instances::const_iterator end,
    ...
    bool negateSelection(Instances& toRemove, Instances& toSelect, Instances::const_iterator start, Instances::const_iterator end);
    bool separate(const shared_ptr<Instance>& wInstance, Instances& separatedItems, Instances& itemsToDelete);
    ...
    void resetInstanceCFrame(Instances::const_iterator start, Instances::const_iterator end,
