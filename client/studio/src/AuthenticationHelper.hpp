...
private:
    ...
    // WinINet auth
    QString doHttpGetRequest(const QString& url, const Aya::HttpAux::AdditionalHeaders& externalHeaders = Aya::HttpAux::AdditionalHeaders());
    ...
    QString getHttpRequest(const QString& urlString, const Aya::HttpAux::AdditionalHeaders& externalHeaders = Aya::HttpAux::AdditionalHeaders());
