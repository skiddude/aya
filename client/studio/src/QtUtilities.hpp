...
public:
    ...
    RBXMessageBox(QMessageBox::Icon icon, const QString& title, const QString& text, QMessageBox::StandardButtons buttons = NoButton,
...
public:
    RBXConfirmationMessageBox(
        QString question, QString yesButtonName = QObject::tr("Yes"), QString noButtonName = QObject::tr("No"), QWidget* parent = 0);
    bool getClickedYes()
    {
        return clickedYes;
    }
    ...
    {
        return dontAskCheckbox->isChecked();
    }
public Q_SLOTS:
    void markYes();
    void markNo();
