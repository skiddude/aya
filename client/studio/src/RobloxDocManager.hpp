...
typedef QMap<QString, Aya::BaldPtr<IRobloxDoc>> tKeyDocMap;
typedef QList<Aya::BaldPtr<RobloxScriptDoc>> tScriptDocs;
typedef QList<boost::shared_ptr<Aya::Instance>> tPlayModifiedScriptList;
...
public:
    ...
    const tScriptDocs& getOpenScriptDocs()
    {
        return m_OpenScriptDocs;
    }
    ...
    RobloxIDEDoc* getPlayDoc() const
    {
        return m_pPlayDoc;
    }
    RobloxWebDoc* getStartPageDoc() const
    {
        return m_pWebDoc;
    }
...
public Q_SLOTS:
    ...
    void openDoc(shared_ptr<Aya::Instance> script, int lineNumber);
...
private:
    ...
    Aya::BaldPtr<IRobloxDoc> m_pCurrentDoc;
    Aya::BaldPtr<RobloxIDEDoc> m_pPlayDoc;
    Aya::BaldPtr<RobloxObjectBrowserDoc> m_pObjectBrowser;
    Aya::BaldPtr<RobloxWebDoc> m_pWebDoc;
    tScriptDocs m_OpenScriptDocs;
    Aya::BaldPtr<DocTabManager> m_DocTabManager;
    Aya::BaldPtr<DocDockManager> m_DocDockManager;
