...
public:
    ...
    T& getViewWidget(EDebuggerViewID id) const
    {
        ...
        AYAASSERT(m_ViewWidgets[id]);
        QWidget* widget = m_ViewWidgets[id];
        AYAASSERT(dynamic_cast<T*>(widget));
...
private:
    ...
    void onDebuggerClientActivated(int currentBreakpoint, Aya::Scripting::ScriptDebugger::Stack currentStack);
    ...
    void onBreakpointAdded(shared_ptr<Aya::Scripting::DebuggerBreakpoint> spBreakpoint);
    void onBreakpointRemoved(shared_ptr<Aya::Scripting::DebuggerBreakpoint> spBreakpoint);

    void onWatchAdded(shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
    void onWatchRemoved(shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
...
{
public:
    StackDetailsItem(const Aya::Scripting::ScriptDebugger::FunctionInfo& funcInfo, bool isFirstItem);
    ~StackDetailsItem();
    void activate();
...
private:
    ...
    boost::shared_ptr<Aya::Instance> m_spAssociatedScript;
    bool m_bIsFirstItem;
};
...
public:
    ...
    void setCallStack(const Aya::Scripting::ScriptDebugger::Stack& stack);
...
{
public:
    BreakpointItem(boost::shared_ptr<Aya::Scripting::DebuggerBreakpoint> breakpoint);
    ~BreakpointItem();

    bool hasBreakpoint(boost::shared_ptr<Aya::Scripting::DebuggerBreakpoint> breakpoint);
...
private:
    void onBreakpointPropertyChanged(const Aya::Reflection::PropertyDescriptor* pPropertyDescriptor);
    void onScriptAncestryChanged(shared_ptr<Aya::Instance> newParent);

    boost::shared_ptr<Aya::Scripting::DebuggerBreakpoint> m_spBreakpoint;
    Aya::signals::scoped_connection m_cPropertyChangedConnection;
    Aya::signals::scoped_connection m_cAncestoryChangedConnection;
...
public:
    ...
    void addBreakpoint(boost::shared_ptr<Aya::Scripting::DebuggerBreakpoint> breakpoint);
    void removeBreakpoint(boost::shared_ptr<Aya::Scripting::DebuggerBreakpoint> breakpoint);
...
private:
    BreakpointItem* findBreakpointItem(boost::shared_ptr<Aya::Scripting::DebuggerBreakpoint> breakpoint);
...
public:
    ...
    int numBreakpoints()
    {
        return m_pBreakpointTreeWidget ? m_pBreakpointTreeWidget->topLevelItemCount() : 0;
    }
...
{
public:
    WatchItem(boost::shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
    ~WatchItem();

    void updateWatchValue();
    bool hasWatch(boost::shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
...
private:
    void onWatchPropertyChanged(const Aya::Reflection::PropertyDescriptor* pPropertyDescriptor);
    void onScriptAncestryChanged(shared_ptr<Aya::Instance> newParent);
    void removeChildren();

    boost::shared_ptr<Aya::Scripting::DebuggerWatch> m_spWatch;
    Aya::signals::scoped_connection m_cPropertyChangedConnection;
    Aya::signals::scoped_connection m_cAncestoryChangedConnection;
...
public:
    ...
    void addWatch(boost::shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
    void removeWatch(boost::shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
    void deleteSelectedWatch();

    QTreeWidgetItem* itemFromIndex(QModelIndex index) const
    {
...
private:
    ...
    WatchItem* findWatchItem(boost::shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
...
public:
    ...
    void addWatch(shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
    void removeWatch(shared_ptr<Aya::Scripting::DebuggerWatch> spWatch);
...
public:
    ...
    void showToolTip(const QPoint& pos, const QString& key, const Aya::Reflection::Variant& value);
    void hideToolTip();
...
private:
    ...
    QString m_Key;
    Aya::Reflection::Variant m_Value;
};
