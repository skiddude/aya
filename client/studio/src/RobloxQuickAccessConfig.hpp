...
#include "RobloxSavingStateDialog.hpp"
...
public:
    ...
    void setQuickAccess(Qt::CheckState state)
    {
        m_isQuickAccessCheckState = state;
    }
    bool hasQuickAccessOverride() const
    {
        return m_isQuickAccessCheckState != m_originalCheckState;
    }

    void removeQuickAccessOverride();
    void commitQuickAccessOverride()
    {
        m_originalCheckState = m_isQuickAccessCheckState;
    }
...
public:
    ...
    void setPluginHostInitialized(bool state)
    {
        m_pluginHostInitialized = state;
    }
    ...
    QuickAccessActionCollection& getQuickAccessBarActions()
    {
        return m_currentQuickAccessBarActions;
    }
