    ...
    switch (element) 
    {
        case PE_FrameWindow: 
            if (const QStyleOptionFrame* optFrame = qstyleoption_cast<const QStyleOptionFrame*>(option)) 
            {
                ...
                p->fillRect(rect, /*optFrame->palette*/m_palBackground.color(QPalette::Window));
                rect.adjust(3, titleBarHeight, -3, -3);
                p->fillRect(rect, /*optFrame->palette*/m_palBackground.color(QPalette::Text));
                rect.adjust(optFrame->lineWidth, optFrame->lineWidth, -optFrame->lineWidth, -optFrame->lineWidth); 
                rect.setBottom(rect.top() + 30);
                DrawHelpers::drawGradientFill(*p, rect, /*optFrame->palette*/m_palBackground.color(QPalette::Text).darker(111), /*optFrame->palette*/m_palBackground.color(QPalette::Text), true);
                break;
            }
        default:
#if (QT_VERSION >= QT_VERSION_CHECK(5, 0, 0))
...
void PopupDrawHelper::refreshPalette()
{
    ...
    m_palBackground.setColor(QPalette::Window, QColor(116, 116, 116));
    m_palBackground.setColor(QPalette::WindowText, QColor(255, 255, 255));
}
    ...
    switch (element) 
    {
        case PE_FrameWindow: 
            if (const QStyleOptionFrame* optFrame = qstyleoption_cast<const QStyleOptionFrame*>(option)) 
            {
                ...
                DrawHelpers::drawGradientFill(*p, rect, m_palBackground.color(QPalette::Window), m_palBackground.color(QPalette::Window), true);
