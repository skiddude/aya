    ...
    : CommonStylePrivate()
{
    ...
    m_ignoreDialogs = !DARKMODE;
    m_ignoreScrollBars = !DARKMODE;
    m_ignoreMDIWindowTitle = !DARKMODE;
    m_popupProxy = Q_NULL;
    m_refCountProxy = 0;
...
void OfficeStylePrivate::updateColors()
{
    ...
    helper.openIniFile(DARKMODE ? ":/theme_dark.ini" : ":/theme.ini");
...
void OfficeStylePrivate::makePaintManager()
{
    ...
    else if (theme == OfficeStyle::Office2016Colorful || theme == OfficeStyle::Office2016White || theme == OfficeStyle::Office2016DarkGray ||
...
Sets \a ignore dialog flag. If this flag is true that can ignore the current Ribbon or Office Style for dialogs and standard Qt style will be used for
dialog. By default this flag is false.
*/
...
/*!
Returns the value of the DPI setting in native format. If isDPIAware() is false then this function always returns 96 for WIndows and Linux and 72 for
MacOSX.
*/
...
void OfficeStyle::polish(QWidget* widget)
{
    ...
    if (qobject_cast<QCheckBox*>(widget) || qobject_cast<QRadioButton*>(widget) || qobject_cast<QToolButton*>(widget) ||
        qobject_cast<QComboBox*>(widget) || qobject_cast<QScrollBar*>(widget) || qobject_cast<QGroupBox*>(widget) || qobject_cast<QTabBar*>(widget) ||
        qobject_cast<QAbstractSpinBox*>(widget) || qobject_cast<QSlider*>(widget) || qobject_cast<QTabWidget*>(widget) ||
    ...
    {
        QPalette palette = widget->palette();
        palette.setColor(QPalette::Window, DARKMODE ? QColor(45, 45, 45) : Qt::white);
    ...
    else if (qobject_cast<QSplitterHandle*>(widget))
    {
        ...
        palette.setColor(QPalette::Window, clrBackground.isValid() ? clrBackground : d.m_clrDockBar);
        widget->setPalette(palette);
    }
    ...
    {
        QPalette palette = widget->palette();
        palette.setColor(QPalette::Window, helper().getColor("Dialog", "Background"));
        palette.setColor(QPalette::WindowText, helper().getColor("Dialog", "Foreground"));
        widget->setPalette(palette);
    }
    ...
    {
        QPalette palette = widget->palette();
        palette.setColor(QPalette::WindowText, d.m_clrStatusBarText);
        widget->setPalette(palette);
    }
    ...
    else if (qobject_cast<QSlider*>(widget))
    {
        ...
        palette.setBrush(QPalette::WindowText, d.m_tickSlider);
        widget->setPalette(palette);
    }
    else if (qobject_cast<QTabBar*>(widget))
    {
        ...
        if (clrAccessHeader.isValid())
            palette.setColor(QPalette::Window, clrAccessHeader);

        QColor clrNormalText = helper().getColor("TabManager", "NormalText");
        if (clrNormalText.isValid())
            palette.setColor(QPalette::WindowText, clrNormalText);
...
void OfficeStyle::unpolish(QWidget* widget)
{
    ...
    if (qobject_cast<QCheckBox*>(widget) || qobject_cast<QRadioButton*>(widget) || qobject_cast<QPushButton*>(widget) ||
        qobject_cast<QToolButton*>(widget) || qobject_cast<QAbstractSpinBox*>(widget) || qobject_cast<QComboBox*>(widget) ||
...
void OfficeStyle::createPopupProxy()
{
    ...
    case PopupSystemDecoration:
    {
        ...
        {
            if (theme == OfficeStyle::Office2007Blue || theme == OfficeStyle::Office2007Black || theme == OfficeStyle::Office2007Silver ||
        ...
        else if (/*qobject_cast<const QMdiSubWindow*>(widget)*/ true)
        {
            if (const QStyleOptionTitleBar* tb = qstyleoption_cast<const QStyleOptionTitleBar*>(opt))
            {
                ...
                case SC_TitleBarSysMenu:
                    if (tb->titleBarFlags & Qt::WindowSystemMenuHint)
                    {
                        ret.setRect(tb->rect.left() + controlMargin, tb->rect.top() + controlMargin, controlHeight, controlHeight);
                    }
                    break;
                default:
                    break;
...
int OfficeStyle::pixelMetric(PixelMetric pm, const QStyleOption* opt, const QWidget* w) const
{
    ...
    case PM_DockWidgetTitleMargin:
        ret = CommonStyle::pixelMetric(pm, opt, w); // lookatme
        break;
    default:
        ret = CommonStyle::pixelMetric(pm, opt, w);
        break;
...
/*! \reimp */
QStyle::SubControl OfficeStyle::hitTestComplexControl(
    ComplexControl control, const QStyleOptionComplex* opt, const QPoint& pt, const QWidget* widget) const
{
...
void OfficeStyle::drawPrimitive(PrimitiveElement element, const QStyleOption* option, QPainter* painter, const QWidget* widget) const
{
    ...
    if (getTheme() == OfficeStyle::Office2016Black)
    {
        ...
        if (!ok)
            ok = qobject_cast<const QTabWidget*>(widget);
    }
...
{
    QTN_D(const OfficeStyle)
    return CommonStyle::cached(":/images/" + img);
}

/*! \internal */
QIcon OfficeStyle::qtnStandardIcon(StandardPixmap px, const QStyleOption* opt, const QWidget* wd, bool& ret) const
{
    QTN_D(const OfficeStyle);
    return d.officePaintManager()->qtnStandardIcon(px, opt, wd, ret);
}
...
bool OfficeStyle::drawMenuBarItem(const QStyleOption* opt, QPainter* p, const QWidget* w) const
{
    if (const QStyleOptionMenuItem* mbi = qstyleoption_cast<const QStyleOptionMenuItem*>(opt))
    {
        ...
        QPalette::ColorRole textRole = !enabled ? QPalette::Text : selected ? QPalette::HighlightedText : QPalette::ButtonText;
...
bool OfficeStyle::drawMenuItem(const QStyleOption* opt, QPainter* p, const QWidget* widget) const
{
    ...
    if (const QStyleOptionMenuItem* menuitem = qstyleoption_cast<const QStyleOptionMenuItem*>(opt))
    {
        ...
        if (act)
            drawRectangle(
                p, menuitem->rect, true /*selected*/, false /*pressed*/, !dis /*enabled*/, false /*checked*/, false /*popuped*/, TypePopup, BarPopup);
        ...
        QRect vCheckRect =
            visualRect(opt->direction, menuitem->rect, QRect(menuitem->rect.x(), menuitem->rect.y(), checkcol, menuitem->rect.height()));
        ...
        if (!menuitem->icon.isNull())
        {
            ...
            if (checked)
            {
                ...
                drawRectangle(p, rcChecked.adjusted(-2, 0, 2, 0), false /*selected*/, true /*pressed*/, !dis /*enabled*/, true /*checked*/,
        ...
        else if (checked)
        {
            ...
            newMi.rect = visualRect(opt->direction, menuitem->rect,
                QRect(menuitem->rect.x() + windowsItemFrame, menuitem->rect.y() + windowsItemFrame, checkcol - 2 * windowsItemFrame,
        ...
        if (!s.isEmpty())
        {
            ...
            {
                QRect vShortcutRect =
                    visualRect(opt->direction, menuitem->rect, QRect(textRect.topRight(), QPoint(menuitem->rect.right(), textRect.bottom())));
                /*
    ...
    if (const QStyleOptionToolButton* toolbutton = qstyleoption_cast<const QStyleOptionToolButton*>(opt))
    {
        ...
        else
        {
            ...
            if (w && qobject_cast<const RibbonButton*>(w))
            {
                if (!pmSize.isEmpty())
                {
                    int maxIconHeight = (toolbutton->toolButtonStyle == Qt::ToolButtonTextUnderIcon) ? rect.height() * 2 / 3 : rect.height();
            ...
            if (toolbutton->toolButtonStyle != Qt::ToolButtonIconOnly)
            {
                ...
                if (toolbutton->toolButtonStyle == Qt::ToolButtonTextUnderIcon)
                {
                    ...
                    QRect rcFirstRowText(
                        QPoint(rcText.left(), rcText.bottom() - height * 2 + 1), QPoint(rcText.right(), rcText.bottom() - height + 1));

                    if (!strFirstRow.isEmpty())
                    {
                        proxy()->drawItemText(
                            p, rcFirstRowText, alignment, toolbutton->palette, toolbutton->state & State_Enabled, strFirstRow, QPalette::ButtonText);
                    }
                    ...
                    if (!strSecondRow.isEmpty())
                    {
                        ...
                        proxy()->drawItemText(p, rcSecondRowText, alignment, toolbutton->palette, toolbutton->state & State_Enabled, strSecondRow,
                            QPalette::ButtonText);
                    }
                }
                else
...
bool OfficeStyle::drawPanelButtonTool(const QStyleOption* opt, QPainter* p, const QWidget* w) const
{
    ...
    if (const QStyleOptionToolButton* toolbutton = qstyleoption_cast<const QStyleOptionToolButton*>(opt))
    {
        ...
        int specialOffset = 0;
        QPixmap soImageSplit = smallSize ? cached("ToolbarButtonsSplit22.png") : cached("ToolbarButtonsSplit50.png");
        QPixmap soImageSplitDropDown = smallSize ? cached("ToolbarButtonsSplitDropDown22.png") : cached("ToolbarButtonsSplitDropDown50.png");
    ...
    if (const QStyleOptionToolButton* toolbutton = qstyleoption_cast<const QStyleOptionToolButton*>(opt))
    {
        ...
        if (toolbutton->subControls & SC_ToolButtonMenu)
        {
            ...
            if (toolbutton->toolButtonStyle == Qt::ToolButtonTextUnderIcon)
            {
                ...
                splitString(toolbutton->text, strFirstRow, strSecondRow);
                rcArrow =
                    QRect(QPoint(strSecondRow.isEmpty() ? opt->rect.width() / 2 - 2 : opt->rect.right() - 7, opt->rect.bottom() - 8), QSize(5, 4));
            }
            else
            {
        ...
        else if (toolbutton->features & QStyleOptionToolButton::HasMenu)
        {
            ...
            if (toolbutton->toolButtonStyle == Qt::ToolButtonTextUnderIcon)
            {
                ...
                splitString(toolbutton->text, strFirstRow, strSecondRow);
                newBtn.rect =
                    QRect(QPoint(strSecondRow.isEmpty() ? opt->rect.width() / 2 - 2 : opt->rect.right() - 8, opt->rect.bottom() - 8), QSize(5, 5));
            }
            else
            {
                QRect ir = menuarea;
...
/*! \internal */
bool OfficeStyle::drawIndicatorCheckRadioButton(PrimitiveElement element, const QStyleOption* option, QPainter* painter, const QWidget* widget) const
{
        ...
        if ((opt->subControls & SC_SliderHandle))
        {
            ...
            if (slider->orientation == Qt::Horizontal)
            {
                ...
                else
                {
                    ...
                    rcSrc = getTheme() == Office2010Silver || getTheme() == Office2007Aqua ? sourceRectImage(hndl.rect(), stateId, 5)
                                                                                           : getSourceH(hndl.rect(), stateId, 5);
                }
            }
...
bool OfficeStyle::drawDockWidgetTitle(const QStyleOption* opt, QPainter* p, const QWidget* w) const
{
    ...
    if (const QStyleOptionDockWidget* dwOpt = qstyleoption_cast<const QStyleOptionDockWidget*>(opt))
    {
        ...
        if (!dwOpt->title.isEmpty())
        {
            ...
            palette.setColor(QPalette::Window, DARKMODE ? QColor(170, 170, 170) : d.m_clrNormalCaptionText);
            palette.setColor(QPalette::WindowText, DARKMODE ? QColor(170, 170, 170) : d.m_clrActiveCaptionText);
            palette.setColor(QPalette::BrightText, DARKMODE ? QColor(170, 170, 170) : d.m_clrActiveCaptionText);

            int buttonMargin = 4;
            int mw = proxy()->pixelMetric(QStyle::PM_DockWidgetTitleMargin, dwOpt, w); // lookatme
...
bool OfficeStyle::drawMdiControls(const QStyleOptionComplex* opt, QPainter* p, const QWidget* w) const
{
    ...
    if (opt->subControls & QStyle::SC_MdiCloseButton)
    {
        ...
        if (opt->activeSubControls & QStyle::SC_MdiCloseButton)
            drawRectangle(p, btnOpt.rect, opt->state & State_MouseOver, opt->state & State_Sunken, opt->state & State_Enabled, false, false,
                TypeMenuBar, BarTop);
...
{
    bool drawDefaultStyle =
        !(getTheme() == OfficeStyle::Office2016Black && (qobject_cast<const QListView*>(widget) || qobject_cast<const QTreeView*>(widget)));
...
/*! \internal */
void OfficeStyle::drawRectangle(
...
/*! \internal */
QColor OfficeStyle::getTextColor(
