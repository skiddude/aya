...
// d9mz - thank god for stackoverflow
// because i probably would've blowned my brains out trying to fix this myself

// vvv msvc specific thingy?? make this a preprocessor definition
#ifndef __clang__
