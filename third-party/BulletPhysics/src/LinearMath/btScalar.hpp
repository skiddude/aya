...
#if (defined (_WIN32) && (_MSC_VER) && _MSC_VER >= 1400) && (!defined (BT_USE_DOUBLE_PRECISION)) && !defined(_M_ARM64) && !defined(__aarch64__)
			#if _MSC_VER>1400
...
#ifdef BT_DEBUG
	// !defined(__clang__) this is not defined? 
...
#define printf spu_printf
    ...
    #if defined (__i386__) || defined (__x86_64__) && !defined(_M_ARM64) && !defined(__aarch64__)
		#define BT_USE_SIMD_VECTOR3
		#define BT_USE_SSE
