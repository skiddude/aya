...
AYA_SIMD_INLINE v4f::pod_t loadUnaligned(const float* s)
{
    return _mm_loadu_ps(s);
}

AYA_SIMD_INLINE v4i::pod_t loadUnaligned(const int32_t* s)
{
    return _mm_loadu_si128(reinterpret_cast<const __m128i*>(s));
}

AYA_SIMD_INLINE v4u::pod_t loadUnaligned(const uint32_t* s)
{
    return _mm_loadu_si128(reinterpret_cast<const __m128i*>(s));
}

AYA_SIMD_INLINE v4f::pod_t loadSingle(const float* s)
{
    return _mm_load_ss(s);
}

AYA_SIMD_INLINE v4i::pod_t loadSingle(const int32_t* s)
{
    return _mm_castps_si128(_mm_load_ss(reinterpret_cast<const float*>(s)));
}

AYA_SIMD_INLINE v4u::pod_t loadSingle(const uint32_t* s)
{
    return _mm_castps_si128(_mm_load_ss(reinterpret_cast<const float*>(s)));
}
...
namespace details
{
AYA_SIMD_INLINE void store(float* dst, __m128 v)
{
    _mm_store_ps(dst, v);
}

AYA_SIMD_INLINE void store(int32_t* dst, __m128i v)
{
    _mm_store_si128(reinterpret_cast<__m128i*>(dst), v);
}

AYA_SIMD_INLINE void store(uint32_t* dst, __m128i v)
{
    _mm_store_si128(reinterpret_cast<__m128i*>(dst), v);
}

AYA_SIMD_INLINE void storeUnaligned(float* dst, __m128 v)
{
    _mm_storeu_ps(dst, v);
}

AYA_SIMD_INLINE void storeUnaligned(int32_t* dst, __m128i v)
{
    _mm_storeu_si128(reinterpret_cast<__m128i*>(dst), v);
}

AYA_SIMD_INLINE void storeUnaligned(uint32_t* dst, __m128i v)
{
    _mm_storeu_si128(reinterpret_cast<__m128i*>(dst), v);
}

AYA_SIMD_INLINE void storeSingle(float* dst, __m128 v)
{
    _mm_store_ss(dst, v);
}

AYA_SIMD_INLINE void storeSingle(int32_t* dst, __m128i v)
{
    _mm_store_ss(reinterpret_cast<float*>(dst), _mm_castsi128_ps(v));
}

AYA_SIMD_INLINE void storeSingle(uint32_t* dst, __m128i v)
{
    _mm_store_ss(reinterpret_cast<float*>(dst), _mm_castsi128_ps(v));
}
} // namespace details
...
namespace details
{
AYA_SIMD_INLINE __m128 splat(float s)
{
    return _mm_set_ps1(s);
}

AYA_SIMD_INLINE __m128i splat(int32_t s)
{
    return _mm_set1_epi32(int(s));
}

AYA_SIMD_INLINE __m128i splat(uint32_t s)
{
    return _mm_set1_epi32(int(s));
}
} // namespace details
...
namespace details
{
AYA_SIMD_INLINE __m128 form(float x, float y, float z, float w)
{
    return _mm_set_ps(w, z, y, x);
}

AYA_SIMD_INLINE __m128i form(int32_t x, int32_t y, int32_t z, int32_t w)
{
    return _mm_set_epi32(w, z, y, x);
}

AYA_SIMD_INLINE __m128i form(uint32_t x, uint32_t y, uint32_t z, uint32_t w)
{
    return _mm_set_epi32(w, z, y, x);
}

AYA_SIMD_INLINE __m128 setSingle(float x)
{
    return _mm_set_ss(x);
}

AYA_SIMD_INLINE __m128i setSingle(int32_t x)
{
    return _mm_set_epi32(0, 0, 0, x);
}

AYA_SIMD_INLINE __m128i setSingle(uint32_t x)
{
    return _mm_set_epi32(0, 0, 0, x);
}
} // namespace details
...
// Splat
//
#define AYA_SIMD_SHUFFLE(a, b, c, d) _MM_SHUFFLE((d) & 0x3, (c) & 0x3, (b) & 0x3, (a) & 0x3)

namespace details
{
template<int a, int b, int c, int d>
AYA_SIMD_INLINE __m128 shuffle(__m128 u)
{
    return _mm_shuffle_ps(u, u, AYA_SIMD_SHUFFLE(a, b, c, d));
}

template<int a, int b, int c, int d>
AYA_SIMD_INLINE __m128i shuffle(__m128i u)
{
    return _mm_shuffle_epi32(u, AYA_SIMD_SHUFFLE(a, b, c, d));
}

template<int a, int b, int c, int d>
AYA_SIMD_INLINE __m128 shuffle(__m128 u, __m128 v)
{
    return _mm_shuffle_ps(u, v, AYA_SIMD_SHUFFLE(a, b, c, d));
}

template<int a, int b, int c, int d>
AYA_SIMD_INLINE __m128i shuffle(__m128i u, __m128i v)
{
...
template<>
AYA_SIMD_INLINE v4f select(const v4f& a, const v4f& b, const v4u& mask)
{
...
template<>
AYA_SIMD_INLINE v4u select(const v4u& a, const v4u& b, const v4u& mask)
{
...
template<>
AYA_SIMD_INLINE v4i select(const v4i& a, const v4i& b, const v4u& mask)
{
    __m128i aOnly = _mm_andnot_si128(mask.v, a.v);
    __m128i bOnly = _mm_and_si128(mask.v, b.v);
    v4i r;
...
namespace details
{
AYA_SIMD_INLINE __m128 unpackLow(__m128 u, __m128 v)
{
    return _mm_unpacklo_ps(u, v);
}

AYA_SIMD_INLINE __m128i unpackLow(__m128i u, __m128i v)
{
    return _mm_unpacklo_epi32(u, v);
}

AYA_SIMD_INLINE __m128 unpackHigh(__m128 u, __m128 v)
{
    return _mm_unpackhi_ps(u, v);
}

AYA_SIMD_INLINE __m128i unpackHigh(__m128i u, __m128i v)
{
...
namespace details
{
AYA_SIMD_INLINE __m128 moveHighLow(__m128 u, __m128 v)
{
    return _mm_movehl_ps(u, v);
}

AYA_SIMD_INLINE __m128i moveHighLow(__m128i u, __m128i v)
{
    return _mm_castps_si128(_mm_movehl_ps(_mm_castsi128_ps(u), _mm_castsi128_ps(v)));
    ;
}

AYA_SIMD_INLINE __m128 moveLowHigh(__m128 u, __m128 v)
{
    return _mm_movelh_ps(u, v);
}

AYA_SIMD_INLINE __m128i moveLowHigh(__m128i u, __m128i v)
{
...
namespace details
{
AYA_SIMD_INLINE __m128 replaceFirst(__m128 a, __m128 b)
{
    return _mm_move_ss(a, b);
}

AYA_SIMD_INLINE __m128i replaceFirst(__m128i a, __m128i b)
{
    return _mm_castps_si128(_mm_move_ss(_mm_castsi128_ps(a), _mm_castsi128_ps(b)));
}

template<class VectorType>
AYA_SIMD_INLINE VectorType replaceFirst(const VectorType& a, const VectorType& b)
{
    VectorType r;
...
#ifdef AYA_SSE3
template<uint32_t a, uint32_t b, uint32_t c, uint32_t d>
AYA_SIMD_INLINE v4f blend(v4fArg u, v4fArg v)
{
    v4f r;
...
template<uint32_t a, uint32_t b, uint32_t c, uint32_t d>
AYA_SIMD_INLINE v4i blend(v4iArg u, v4iArg v)
{
    v4i r;
...
AYA_SIMD_INLINE VectorType rotateLeft(const VectorType& v)
{
