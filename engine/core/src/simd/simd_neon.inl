...
namespace details
{
AYA_SIMD_INLINE v4f::pod_t load(const float* s)
{
    return vld1q_f32(s);
}

AYA_SIMD_INLINE v4i::pod_t load(const int32_t* s)
{
    return vld1q_s32(s);
}

AYA_SIMD_INLINE v4u::pod_t load(const uint32_t* s)
{
    return vld1q_u32(s);
}

template<int Lane>
AYA_SIMD_INLINE v4f::pod_t loadLane(const float* s, v4f::pod_t vec)
{
    return vld1q_lane_f32(s, vec, Lane);
}

template<int Lane>
AYA_SIMD_INLINE v4u::pod_t loadLane(const uint32_t* s, v4u::pod_t vec)
{
    return vld1q_lane_u32(s, vec, Lane);
}

template<int Lane>
AYA_SIMD_INLINE v4i::pod_t loadLane(const int32_t* s, v4i::pod_t vec)
{
    return vld1q_lane_s32(s, vec, Lane);
}

AYA_SIMD_INLINE v4f::pod_t loadSplat(const float* s)
{
    return vld1q_dup_f32(s);
}

AYA_SIMD_INLINE v4u::pod_t loadSplat(const uint32_t* s)
{
    return vld1q_dup_u32(s);
}

AYA_SIMD_INLINE v4i::pod_t loadSplat(const int32_t* s)
{
    return vld1q_dup_s32(s);
}

AYA_SIMD_INLINE float32x2_t loadD(const float* s)
{
    return vld1_f32(s);
}

AYA_SIMD_INLINE int32x2_t loadD(const int32_t* s)
{
    return vld1_s32(s);
}

AYA_SIMD_INLINE uint32x2_t loadD(const uint32_t* s)
{
    return vld1_u32(s);
}

AYA_SIMD_INLINE float32x2_t loadSplatD(const float* s)
{
    return vld1_dup_f32(s);
}

AYA_SIMD_INLINE int32x2_t loadSplatD(const int32_t* s)
{
    return vld1_dup_s32(s);
}

AYA_SIMD_INLINE uint32x2_t loadSplatD(const uint32_t* s)
{
    return vld1_dup_u32(s);
}

AYA_SIMD_INLINE float32x4_t combine(float32x2_t a, float32x2_t b)
{
    return vcombine_f32(a, b);
}

AYA_SIMD_INLINE int32x4_t combine(int32x2_t a, int32x2_t b)
{
    return vcombine_s32(a, b);
}

AYA_SIMD_INLINE uint32x4_t combine(uint32x2_t a, uint32x2_t b)
{
    return vcombine_u32(a, b);
}

template<class Type>
AYA_SIMD_INLINE typename Type::pod_t zero();

template<>
AYA_SIMD_INLINE v4f::pod_t zero<v4f>()
{
...
template<>
AYA_SIMD_INLINE v4i::pod_t zero<v4i>()
{
...
template<>
AYA_SIMD_INLINE v4u::pod_t zero<v4u>()
{
...
AYA_SIMD_INLINE v4f load3(const float* value)
{
...
namespace details
{
AYA_SIMD_INLINE void store(float* s, float32x4_t v)
{
    vst1q_f32(s, v);
}

AYA_SIMD_INLINE void store(int32_t* s, int32x4_t v)
{
    vst1q_s32(s, v);
}

AYA_SIMD_INLINE void store(uint32_t* s, uint32x4_t v)
{
    vst1q_u32(s, v);
}

template<int lane>
AYA_SIMD_INLINE void storeLane(float* s, float32x4_t v)
{
    vst1q_lane_f32(s, v, lane);
}

template<int lane>
AYA_SIMD_INLINE void storeLane(int32_t* s, int32x4_t v)
{
    vst1q_lane_s32(s, v, lane);
}

template<int lane>
AYA_SIMD_INLINE void storeLane(uint32_t* s, uint32x4_t v)
{
...
namespace details
{
AYA_SIMD_INLINE float32x4_t splat(float s)
{
    return vdupq_n_f32(s);
}

AYA_SIMD_INLINE int32x4_t splat(int32_t s)
{
    return vdupq_n_s32(s);
}

AYA_SIMD_INLINE uint32x4_t splat(uint32_t s)
{
...
namespace details
{
AYA_SIMD_INLINE float32x2_t splatD(float s)
{
    return vmov_n_f32((s));
}

AYA_SIMD_INLINE int32x2_t splatD(int32_t s)
{
    return vmov_n_s32((s));
}

AYA_SIMD_INLINE uint32x2_t splatD(uint32_t s)
{
    return vmov_n_u32((s));
}

AYA_SIMD_INLINE float32x2_t zip1(float32x2_t a, float32x2_t b)
{
    return vzip_f32(a, b).val[0];
}

AYA_SIMD_INLINE int32x2_t zip1(int32x2_t a, int32x2_t b)
{
    return vzip_s32(a, b).val[0];
}

AYA_SIMD_INLINE uint32x2_t zip1(uint32x2_t a, uint32x2_t b)
{
...
AYA_SIMD_INLINE typename VectorType::elem_t extractSlow(const VectorType& _v, uint32_t _i)
{
    union
    {
...
namespace details
{
AYA_SIMD_INLINE float32x2_t low(float32x4_t t)
{
    return vget_low_f32(t);
}

AYA_SIMD_INLINE int32x2_t low(int32x4_t t)
{
    return vget_low_s32(t);
}

AYA_SIMD_INLINE uint32x2_t low(uint32x4_t t)
{
    return vget_low_u32(t);
}

AYA_SIMD_INLINE float32x2_t high(float32x4_t t)
{
    return vget_high_f32(t);
}

AYA_SIMD_INLINE int32x2_t high(int32x4_t t)
{
    return vget_high_s32(t);
}

AYA_SIMD_INLINE uint32x2_t high(uint32x4_t t)
{
    return vget_high_u32(t);
}

template<int lane>
AYA_SIMD_INLINE float32x4_t splat(float32x2_t a)
{
    return vdupq_lane_f32(a, lane);
}

template<int lane>
AYA_SIMD_INLINE int32x4_t splat(int32x2_t a)
{
    return vdupq_lane_s32(a, lane);
}

template<int lane>
AYA_SIMD_INLINE uint32x4_t splat(uint32x2_t a)
{
    return vdupq_lane_u32(a, lane);
}

template<int lane>
AYA_SIMD_INLINE float32x2_t splatD(float32x2_t a)
{
    return vdup_lane_f32(a, lane);
}

template<int lane>
AYA_SIMD_INLINE int32x2_t splatD(int32x2_t a)
{
    return vdup_lane_s32(a, lane);
}

template<int lane>
AYA_SIMD_INLINE uint32x2_t splatD(uint32x2_t a)
{
...
{
    static AYA_SIMD_INLINE VectorType splat(const VectorType& v)
    {
    ...
    static AYA_SIMD_INLINE v2<typename VectorType::elem_t> splatD(const VectorType& v)
    {
...
namespace details
{
AYA_SIMD_INLINE float32x2_t selectD(float32x2_t u, float32x2_t v, uint32x2_t s)
{
    return vbsl_f32(s, v, u);
}

AYA_SIMD_INLINE int32x2_t selectD(int32x2_t u, int32x2_t v, uint32x2_t s)
{
    return vbsl_s32(s, v, u);
}

AYA_SIMD_INLINE uint32x2_t selectD(uint32x2_t u, uint32x2_t v, uint32x2_t s)
{
    return vbsl_u32(s, v, u);
}

AYA_SIMD_INLINE uint8x8_t castToUInt8(float32x2_t v)
{
    return vreinterpret_u8_f32(v);
}

AYA_SIMD_INLINE uint8x8_t castToUInt8(uint32x2_t v)
{
    return vreinterpret_u8_u32(v);
}

AYA_SIMD_INLINE uint8x8_t castToUInt8(int32x2_t v)
{
    return vreinterpret_u8_s32(v);
}

template<class From>
AYA_SIMD_INLINE uint8x8x2_t castToUInt8x2(From v)
{
    uint8x8x2_t r;
...
template<class From>
AYA_SIMD_INLINE uint8x8x4_t castToUInt8x4(From u, From v)
{
    uint8x8x4_t r;
...
{
    static AYA_SIMD_INLINE float32x4_t cast(uint8x8x2_t v)
    {
    ...
    static AYA_SIMD_INLINE float32x2_t cast(uint8x8_t v)
    {
...
{
    static AYA_SIMD_INLINE uint32x4_t cast(uint8x8x2_t v)
    {
    ...
    static AYA_SIMD_INLINE uint32x2_t cast(uint8x8_t v)
    {
...
{
    static AYA_SIMD_INLINE int32x4_t cast(uint8x8x2_t v)
    {
    ...
    static AYA_SIMD_INLINE int32x2_t cast(uint8x8_t v)
    {
...
AYA_SIMD_INLINE uint32x2_t selectMaskD()
{
    boost::uint64_t mask64 =
        (boost::uint64_t(boost::uint32_t(-(boost::int32_t(b) & 0x1))) << 32) | boost::uint64_t(boost::uint32_t(-(boost::int32_t)(a & 0x1)));
...
#define AYA_SIMD_NEON_TBL_MASK(a) ((4 * (a)) | ((4 * (a) + 1) << 8) | ((4 * (a) + 2) << 16) | ((4 * (a) + 3) << 24))

namespace details
{
template<uint32_t a, uint32_t b, class VectorType>
AYA_SIMD_INLINE typename details::v2<typename VectorType::elem_t>::pod_t chooseTwoElements(const VectorType& u)
{
    uint8x8x2_t u8 = details::castToUInt8x2(u.v);
    uint64_t lowMask = uint64_t(AYA_SIMD_NEON_TBL_MASK(a)) | (uint64_t(AYA_SIMD_NEON_TBL_MASK(b)) << 32);
    return details::CastFromUInt8<typename VectorType::pod_t>::cast(vtbl2_u8(u8, vcreate_u8(lowMask)));
}

template<uint32_t a, uint32_t b, class VectorType>
AYA_SIMD_INLINE typename details::v2<typename VectorType::elem_t>::pod_t chooseTwoElements(const VectorType& u, const VectorType& v)
{
...
namespace details
{
AYA_SIMD_INLINE float32x4_t zipLow(float32x4_t a, float32x4_t b)
{
    float32x2x2_t t = vzip_f32(low(a), low(b));
    return combine(t.val[0], t.val[1]);
}

AYA_SIMD_INLINE uint32x4_t zipLow(uint32x4_t a, uint32x4_t b)
{
    uint32x2x2_t t = vzip_u32(low(a), low(b));
    return combine(t.val[0], t.val[1]);
}

AYA_SIMD_INLINE int32x4_t zipLow(int32x4_t a, int32x4_t b)
{
    int32x2x2_t t = vzip_s32(low(a), low(b));
    return combine(t.val[0], t.val[1]);
}

AYA_SIMD_INLINE float32x4_t zipHigh(float32x4_t a, float32x4_t b)
{
    float32x2x2_t t = vzip_f32(high(a), high(b));
    return combine(t.val[0], t.val[1]);
}

AYA_SIMD_INLINE uint32x4_t zipHigh(uint32x4_t a, uint32x4_t b)
{
    uint32x2x2_t t = vzip_u32(high(a), high(b));
    return combine(t.val[0], t.val[1]);
}

AYA_SIMD_INLINE int32x4_t zipHigh(int32x4_t a, int32x4_t b)
{
    int32x2x2_t t = vzip_s32(high(a), high(b));
    return combine(t.val[0], t.val[1]);
}

AYA_SIMD_INLINE float32x4x2_t zip(float32x4_t a, float32x4_t b)
{
    return vzipq_f32(a, b);
}

AYA_SIMD_INLINE uint32x4x2_t zip(uint32x4_t a, uint32x4_t b)
{
    return vzipq_u32(a, b);
}

AYA_SIMD_INLINE int32x4x2_t zip(int32x4_t a, int32x4_t b)
{
...
struct SelectHelper
{
    static AYA_SIMD_INLINE T select(const T& u, const T& v)
    {
...
AYA_SIMD_INLINE T select(const T& u, const T& v)
{
    return details::SelectHelper<T, a, b, c, d>::select(u, v);
}

template<uint32_t index, class T>
AYA_SIMD_INLINE T replace(const T& a, const T& b)
{
...
//
template<uint32_t a, uint32_t b, uint32_t c, uint32_t d, class VectorType>
AYA_SIMD_INLINE VectorType permute(const VectorType& u)
{
    VectorType r;
...
AYA_SIMD_INLINE T rotateLeft(const T& v)
{
...
namespace details
{
AYA_SIMD_INLINE v4f inverseEstimateIteration(const v4f& a, const v4f& estimate)
{
...
namespace details
{
AYA_SIMD_INLINE v4f inverseSqrtIteration(const v4f& v, const v4f& estimate)
{
...
AYA_SIMD_INLINE v4f inverseSqrtEstimate1Fast(const v4f& v)
{
...
{
template<class T>
AYA_SIMD_INLINE T moveHigh(const T& a, const T& b)
{
    return details::combine(details::low(a), details::high(b));
}

template<class T>
AYA_SIMD_INLINE T moveLow(const T& a, const T& b)
{
