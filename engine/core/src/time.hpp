...
public:
    ...
    public:
        ...
        static inline Interval from_milliseconds(double milliseconds)
        {
            return Interval(0.001 * milliseconds);
        }
        static inline Interval from_seconds(double seconds)
        {
            return Interval(seconds);
        }
        static inline Interval from_minutes(double minutes)
        {
            return Interval(60.0 * minutes);
        }
        static inline Interval from_hours(double hours)
        {
            return Interval(60.0 * 60.0 * hours);
        }

        inline explicit Interval(double seconds)
            : sec(seconds)
        {
        }
        ...
        friend std::basic_ostream<charT, traits>& operator<<(std::basic_ostream<charT, traits>& out, Interval interval)
        {
            out << interval.sec;
            return out;
        }
    ...
    {
        return Time(std::numeric_limits<double>::max());
    }
    ...
    bool operator>(const Time& j) const
    {
        return sec > j.sec;
    }
    bool operator<(const Time& j) const
    ...
    template<class charT, class traits>
    friend std::basic_ostream<charT, traits>& operator<<(std::basic_ostream<charT, traits>& out, Time time)
    {
        out << time.sec;
        return out;
    }
...
public:
    Timer()
        : start(Time::now<sampleMethod>())
    {
    }
    Time::Interval delta() const
    {
        return Time::now<sampleMethod>() - start;
    }
    Time::Interval reset()
    {
...
public:
    inline RemoteTime()
        : Time(){};
    inline RemoteTime(double value)
        : Time(value){};
    RemoteTime(const Time& value)
        : Time(value){};
};
} // namespace Aya