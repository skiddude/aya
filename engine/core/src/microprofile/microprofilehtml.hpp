...
const char g_MicroProfileHtml_begin_0[] =
    ...
    "{\n"
    "	var group = {\"id\":id, \"name\":name, \"category\":category, \"numtimers\":numtimers, \"isgpu\":isgpu, \"total\": total, \"average\" : "
    "average, \"max\" : max, \"color\":color};\n"
    "	return group;\n"
    "}\n"
    "\n"
    "function MakeTimer(id, name, group, color, colordark, average, max, exclaverage, exclmax, callaverage, callcount, total, meta, metaagg, "
    "metamax)\n"
    "{\n"
    "	var timer = {\"id\":id, \"name\":name, \"namelabel\":name.startsWith(\"$\"), \"color\":color, \"colordark\":colordark,\"timercolor\":color, "
    "\"textcolor\":InvertColor(color), \"group\":group, \"average\":average, \"max\":max, \"exclaverage\":exclaverage, \"exclmax\":exclmax, "
    "\"callaverage\":callaverage, \"callcount\":callcount, \"total\":total, \"meta\":meta, \"textcolorindex\":InvertColorIndex(color), "
    "\"metaagg\":metaagg, \"metamax\":metamax};\n"
    "	return timer;\n"
    "}\n"
    "\n"
    ...
    "{\n"
    "	var frame = {\"id\":id, \"framestart\":framestart, \"frameend\":frameend, \"framestartgpu\":framestartgpu, \"frameendgpu\":frameendgpu, "
    "\"ts\":ts, \"tt\":tt, \"ti\":ti, \"tl\":tl};\n"
    "	return frame;\n"
    "}\n"
    "\n"
    ...
    "\"value\":value, \"formatted\":formatted, \"limit\":limit, \"formattedlimit\":formattedlimit, \"counterprc\":counterprc, \"boxprc\":boxprc};\n"
    "	return counter;\n"
    "}\n"
    "\n"
    "\n"
...
const char g_MicroProfileHtml_end_1[] =
    ...
    "						var PerThreadTimerTotal = ThreadGroupTimeArray[i][groupid];\n"
    "						var PerThreadTimer = PerThreadTimerTotal / AggregateInfo.Frames;\n"
    "						if((PerThreadTimer > 0.0001|| PerThreadTimerTotal>0.1) && (ThreadsActive[ThreadNames[i]] || "
    "ThreadsAllActive))\n"
    "						{\n"
    "							var YText = Y+Height-FontAscent;\n"
    "							bMouseIn = DetailedViewMouseY >= Y && DetailedViewMouseY < Y + BoxHeight;\n"
    ...
    "										WText = nWidth - XText;\n"
    "									}\n"
    "									var Name = LabelArray[globstart] ? LabelArray[globstart] : "
    "TimerInfo[index].name;\n"
    ...
    "											BatchesTxtPos[txtidx].push(XText+WText-2 - TimeTextLen * "
    "FontWidth);\n"
    "											BatchesTxtPos[txtidx].push(YPos);\n"
    "											DebugDrawTextCount++;\n"
    "										}\n"
    ...
    "	var fOffsetY = -nOffsetY + BoxHeight;\n"
    "\n"
    "	if(DetailedRedrawState.fOffsetY == fOffsetY && DetailedRedrawState.fDetailedOffset == fDetailedOffset && DetailedRedrawState.fDetailedRange "
    "== fDetailedRange && !KeyCtrlDown && !KeyShiftDown && !MouseDragButton)\n"
    "	{\n"
    "		Invalidate++;\n"
    "	}\n"
    "	else\n"
...
const char g_MicroProfileHtml_end_2[] =
    ...
    "	{\n"
    "		if(ProfileMode == 2 || ((nHoverCSCpu >= 0 || nHoverToken != -1) && !KeyCtrlDown && !KeyShiftDown && !MouseDragButton)||(Invalidate<2 "
    "&& !KeyCtrlDown && !KeyShiftDown && !MouseDragButton))\n"
    "		{\n"
    "			RedrawMode = 1;\n"
    "		}\n"
    "	}\n"
    ...
    "			var FrameDiscard = Frame_.frameend + 33;//if timestamps are more than 33ms after current frame, we assume buffer has "
    "wrapped.\n"
    "			var tt = Frame_.tt[nLog];\n"
    "			var ts = Frame_.ts[nLog];\n"
