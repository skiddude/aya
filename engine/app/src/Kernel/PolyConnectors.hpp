...
protected:
    ...
    PolyConnector(Body* b0, Body* b1, const ContactParams& contactParams, int param0, int param1)
...
public:
    ...
    {
        return ((p0->param0 == p1->param0) && (p0->param1 == p1->param1) && (p0->getConnectorType() == p1->getConnectorType()));
    }
};
...
public:
    FaceVertexConnector(
        Body* b0, Body* b1, const ContactParams& contactParams, const Plane& facePlane, const Vector3& vertexOffset, int planeId, int vertexId)
...
private:
    ...
    /*override*/ GeoPairType getConnectorType() const
    {
        return EDGE_EDGE_PLANE_CONNECTOR;
    }

public:
    FaceEdgeConnector(Body* b0, Body* b1, const ContactParams& contactParams, const Plane& facePlane, const Plane& sideFacePlane, Line faceLine,
        Line edgeLine, const int faceId, const int edgeId)
...
private:
    ...
    /*override*/ GeoPairType getConnectorType() const
    {
        return EDGE_EDGE_CONNECTOR;
    }

public:
    EdgeEdgeConnector(Body* b0, Body* b1, const ContactParams& contactParams, Line edgeLine0, Line edgeLine1, int edgeId0, int edgeId1)
...
private:
    ...
    /*override*/ GeoPairType getConnectorType() const
    {
        return BALL_VERTEX_CONNECTOR;
    }

public:
    BallVertexConnector(Body* b0, Body* b1, const ContactParams& contactParams, float radius, const Vector3& offset, int vertexId)
...
private:
    ...
    /*override*/ GeoPairType getConnectorType() const
    {
        return BALL_EDGE_CONNECTOR;
    }

public:
    BallEdgeConnector(Body* b0, Body* b1, const ContactParams& contactParams, float radius, const Vector3& offset, const Vector3& normal, int edgeId)
...
public:
    BallPlaneConnector(Body* b0, Body* b1, const ContactParams& contactParams, float radius, const Vector3& offset, const Vector3& normal, int faceId)
