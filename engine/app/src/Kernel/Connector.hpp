...
public:
    int& getHumanoidIndex()
    {
        return humanoidIndex;
    }
    int& getRealTimeIndex()
    {
        return realTimeIndex;
    }
    int& getSecondPassIndex()
    {
        return secondPassIndex;
    }
    int& getJointIndex()
    {
        return jointIndex;
    }
    int& getBuoyancyIndex()
    {
        return buoyancyIndex;
    }
    int& getContactIndex()
    {
        return contactIndex;
    ...
    bool isInKernel()
    {
        return isHumanoid() || isRealTime() || isSecondPass() || isJoint() || isBuoyancy() || isContact();
    }
    ...
    virtual bool computeImpulse(float& residualVelocity)
    {
        return false;
    }
...
class JointConnector : public Connector
{
protected:
...
public:
    RotateConnector(Body* _b0, Body* _b1, const CoordinateFrame& _j0, const CoordinateFrame& _j1, float _baseAngle, float kValue, float armLength);
...
public:
    ...
    /*override*/ virtual bool getBroken()
    {
        return broken;
    }
