...
public:
    ...
    {
        return IStage::KERNEL_STAGE;
    }

    /*override*/ Kernel* getKernel()
    {
        return this;
    }
    ...
    int numBodies() const
    {
        return numFreeFallBodies() + numRealTimeBodies() + numJointBodies() + numContactBodies();
    }
    int numBodiesMax() const
    {
        return maxBodies;
    }
    ...
    {
        return numLastIterations;
    }
    inline int numMaxIterations() const
    {
        return numOfMaxIterations;
    }
    inline float getSolverError() const
    {
        return error;
    }
    inline float getMaxSolverError() const
    {
        return maxError;
    }
    ...
    void setUsingPGSSolver(bool pgsOn)
    {
        usingPGSSolver = pgsOn;
    }
    bool getUsingPGSSolver() const
    {
        return usingPGSSolver;
    }
    void dumpLog(bool enable)
    {
        pgsSolver.dumpLog(enable);
    }
};
} // namespace Aya
