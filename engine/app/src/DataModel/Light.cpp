...
Reflection::PropDescriptor<SurfaceLight, float> SurfaceLight::prop_Range(
    "Range", category_Appearance, &SurfaceLight::getRange, &SurfaceLight::setRange);
Reflection::PropDescriptor<SurfaceLight, float> SurfaceLight::prop_Angle(
    "Angle", category_Appearance, &SurfaceLight::getAngle, &SurfaceLight::setAngle);
Reflection::EnumPropDescriptor<SurfaceLight, NormalId> SurfaceLight::prop_Face(
    "Face", category_Appearance, &SurfaceLight::getFace, &SurfaceLight::setFace);
