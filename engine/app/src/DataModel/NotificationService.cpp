...
static Reflection::BoundFuncDesc<NotificationService, void(int, int, std::string, int)> func_ScheduleNotification(
    &NotificationService::scheduleNotification, "ScheduleNotification", "userId", "alertId", "alertMsg", "minutesToFire", Security::RobloxPlace);

static Reflection::BoundFuncDesc<NotificationService, void(int, int)> func_CancelNotification(
    &NotificationService::cancelNotification, "CancelNotification", "userId", "alertId", Security::RobloxPlace);

static Reflection::BoundFuncDesc<NotificationService, void(int)> func_CancelAllNotification(
    &NotificationService::cancelAllNotification, "CancelAllNotification", "userId", Security::RobloxPlace);

static Reflection::BoundYieldFuncDesc<NotificationService, shared_ptr<const Reflection::ValueArray>(int)> func_GetScheduledNotifications(
    &NotificationService::getScheduledNotifications, "GetScheduledNotifications", "userId", Security::RobloxPlace);
REFLECTION_END();
...
void NotificationService::getScheduledNotifications(
