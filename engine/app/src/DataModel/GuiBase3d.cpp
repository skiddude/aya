...
const Reflection::PropDescriptor<GuiBase3d, Color3> prop_color(
    "Color3", category_Appearance, &GuiBase3d::getColor, &GuiBase3d::setColor, Reflection::PropertyDescriptor::STANDARD);
const Reflection::PropDescriptor<GuiBase3d, BrickColor> prop_depBrickColor("Color", category_Appearance, &GuiBase3d::getBrickColor,
    &GuiBase3d::setBrickColor, Reflection::PropertyDescriptor::Attributes::deprecated(prop_color, Reflection::PropertyDescriptor::LEGACY_SCRIPTING));

const Reflection::PropDescriptor<GuiBase3d, float> prop_transparency(
    "Transparency", category_Appearance, &GuiBase3d::getTransparency, &GuiBase3d::setTransparency);
