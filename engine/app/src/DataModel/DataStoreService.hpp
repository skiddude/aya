...
private:
    ...
    std::list<HttpRequest> throttledGets, throttledGetSorteds, throttledSets,
        throttledOrderedSets; // New requests go to back, executes from the front
...
public:
    ...
    bool isUrlEncodingDisabled() const
    {
