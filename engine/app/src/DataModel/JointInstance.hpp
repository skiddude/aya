...
public:
    ...
    /*override*/ XmlElement* writeXml(const boost::function<bool(Instance*)>& isInScope, Aya::CreatorRole creatorRole);
};


extern const char* const sSnap;
class Snap : public DescribedCreatable<Snap, JointInstance, sSnap>
{
public:
    Snap();
    Snap(Joint* joint);
...
class Weld : public DescribedCreatable<Weld, JointInstance, sWeld>
{
private:
...
class ManualSurfaceJointInstance : public DescribedNonCreatable<ManualSurfaceJointInstance, JointInstance, sManualSurfaceJointInstance>
{
private:
...
class ManualWeld : public DescribedCreatable<ManualWeld, ManualSurfaceJointInstance, sManualWeld>
{
private:
...
class ManualGlue : public DescribedCreatable<ManualGlue, ManualSurfaceJointInstance, sManualGlue>
{
private:
...
class Glue : public DescribedCreatable<Glue, JointInstance, sGlue>
{
private:
    GlueJoint* glueJoint();
...
class Rotate : public DescribedCreatable<Rotate, JointInstance, sRotate>
{
public:
    Rotate();
    Rotate(Joint* joint);
...
class RotateP : public DescribedCreatable<RotateP, DynamicRotate, sRotateP>
{
public:
    RotateP();
    RotateP(Joint* joint);
...
class RotateV : public DescribedCreatable<RotateV, DynamicRotate, sRotateV>
{
public:
    RotateV();
    RotateV(Joint* joint);
...
class Motor6D : public DescribedCreatable<Motor6D, Motor, sMotor6D> // derive from Motor, so that and script doing a ::IsA(Motor) should still work.
{
private:
