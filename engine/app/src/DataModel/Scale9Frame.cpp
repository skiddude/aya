...
static Reflection::PropDescriptor<Scale9Frame, Vector2int16> prop_scaleEdgeSize(
    "ScaleEdgeSize", category_Data, &Scale9Frame::getScaleEdgeSize, &Scale9Frame::setScaleEdgeSize);
static Reflection::PropDescriptor<Scale9Frame, std::string> prop_slicePrefix(
    "SlicePrefix", category_Data, &Scale9Frame::getSlicePrefix, &Scale9Frame::setSlicePrefix);
REFLECTION_END();
