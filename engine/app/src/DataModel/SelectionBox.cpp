...
const Reflection::PropDescriptor<SelectionBox, Color3> prop_SurfaceColor(
    "SurfaceColor3", category_Appearance, &SelectionBox::getSurfaceColor, &SelectionBox::setSurfaceColor, Reflection::PropertyDescriptor::STANDARD);
const Reflection::PropDescriptor<SelectionBox, BrickColor> prop_depSurfaceBrickColor("SurfaceColor", category_Appearance,
    &SelectionBox::getSurfaceBrickColor, &SelectionBox::setSurfaceBrickColor,
    Reflection::PropertyDescriptor::Attributes::deprecated(prop_SurfaceColor, Reflection::PropertyDescriptor::LEGACY_SCRIPTING));

const Reflection::PropDescriptor<SelectionBox, float> prop_SurfaceTransparency(
    "SurfaceTransparency", category_Appearance, &SelectionBox::getSurfaceTransparency, &SelectionBox::setSurfaceTransparency);
const Reflection::PropDescriptor<SelectionBox, float> prop_LineThickness(
    "LineThickness", category_Appearance, &SelectionBox::getLineThickness, &SelectionBox::setLineThickness);
...
static void renderPart(
    Adorn* adorn, const Part& part, Color3 color, float transparency, Color3 surfaceColor, float surfaceTransparency, float lineThickness)
{
    if (transparency < 1)
    {
