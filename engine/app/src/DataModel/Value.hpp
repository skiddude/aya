...
#if defined(AYA_SECURE_DOUBLE)
#define LUA_VALUE_CONVERT(x) (x.binary[sizeof(ValueType) / sizeof(int64_t) - 1] ^= ::LuaSecureDouble::luaXorMask[3])
#else
...
public:
    ...
    Aya::signal<void(ValueType)> valueChangedSignal;
    ...
    {
        desc_Value.setValue(this, _value);
    }
    ...
    , public IValue
{
    ...
    union Storage
    {
        size_t binary[sizeof(ValueType) / sizeof(int64_t)];
        ValueType native;
    };
...
typedef NumericValue<int64_t, sIntValue> IntValue;
...
typedef Value<Aya::RbxRay, sRayValue> RayValue;
...
typedef Value<Aya::BrickColor, sBrickColorValue> BrickColorValue;

extern const char* const sBinaryStringValue;
typedef Value<Aya::BinaryString, sBinaryStringValue> BinaryStringValue;
...
public:
    ...
    Aya::signal<void(std::string)> valueChangedSignal;
...
public:
    ...
    static Aya::Reflection::RefPropDescriptor<ObjectValue, Instance> desc_Value;
    Aya::signal<void(shared_ptr<Instance>)> valueChangedSignal;
