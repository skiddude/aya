...
// backend
static Reflection::BoundFuncDesc<MarketplaceService, void(int, int, bool)> func_signalPromptProductFinished(
    &MarketplaceService::signalPromptProductPurchaseFinished, "SignalPromptProductPurchaseFinished", "userId", "productId", "success",
    Security::RobloxScript);
static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool)> func_signalPromptPurchaseFinished(
    &MarketplaceService::signalPromptPurchaseFinished, "SignalPromptPurchaseFinished", "player", "assetId", "success", Security::RobloxScript);

static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool, MarketplaceService::CurrencyType)>
    event_promptPurchaseRequested(&MarketplaceService::promptPurchaseRequested, "PromptPurchaseRequested", "player", "assetId", "equipIfPurchased",
        "currencyType", Security::RobloxScript, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::BROADCAST);
static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool, MarketplaceService::CurrencyType)>
    event_promptProductPurchaseRequested(&MarketplaceService::promptProductPurchaseRequested, "PromptProductPurchaseRequested", "player", "productId",
        "equipIfPurchased", "currencyType", Security::RobloxScript, Reflection::RemoteEventCommon::SCRIPTING,
        Reflection::RemoteEventCommon::BROADCAST);

static Reflection::BoundFuncDesc<MarketplaceService, void(std::string, int, int)> func_signalClientPurchaseSuccess(
    &MarketplaceService::signalClientPurchaseSuccess, "SignalClientPurchaseSuccess", "ticket", "playerId", "productId", Security::RobloxScript);
static Reflection::RemoteEventDesc<MarketplaceService, void(std::string, int, int)> event_clientPurchaseSuccess(
    &MarketplaceService::clientPurchaseSuccess, "ClientPurchaseSuccess", "ticket", "playerId", "productId", Security::RobloxScript,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<const Reflection::ValueTable>)> event_serverPurchaseVerification(
    &MarketplaceService::serverPurchaseVerification, "ServerPurchaseVerification", "serverResponseTable", Security::RobloxScript,
...
static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> event_promptThirdPartyPurchaseRequested(
    &MarketplaceService::promptThirdPartyPurchaseRequested, "PromptThirdPartyPurchaseRequested", "player", "productId", Security::Roblox,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::BROADCAST);

static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> event_promptNativePurchaseRequested(
    &MarketplaceService::promptNativePurchaseRequested, "PromptNativePurchaseRequested", "player", "productId", Security::Roblox,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::BROADCAST);

// frontend

// used by core script to automatically convert app store product purchases into roblox items
static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> func_PromptNativePurchase(
    &MarketplaceService::promptNativePurchase, "PromptNativePurchase", "player", "productId", Security::RobloxScript);
static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string, bool)> event_PromptNativePurchaseFinished(
    &MarketplaceService::nativePurchaseFinished, "NativePurchaseFinished", "player", "productId", "wasPurchased", Security::RobloxScript,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);


// used by some roblox created games to do direct purchases from app stores
static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> func_PromptTPPurchase(
    &MarketplaceService::promptThirdPartyPurchase, "PromptThirdPartyPurchase", "player", "productId", Security::RobloxPlace);
static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string, std::string, bool)> event_PromptTPPurchaseFinished(
    &MarketplaceService::thirdPartyPurchaseFinished, "ThirdPartyPurchaseFinished", "player", "productId", "receipt", "wasPurchased",
    Security::RobloxPlace, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);


// Aya dev purchasing calls
static Reflection::BoundYieldFuncDesc<MarketplaceService, shared_ptr<const Reflection::ValueTable>(int, MarketplaceService::InfoType)>
    func_getProductInfo(&MarketplaceService::getProductInfo, "GetProductInfo", "assetId", "infoType", MarketplaceService::INFO_ASSET, Security::None);
static Reflection::BoundYieldFuncDesc<MarketplaceService, bool(shared_ptr<Instance>, int)> func_playerOwnsAsset(
    &MarketplaceService::playerOwnsAsset, "PlayerOwnsAsset", "player", "assetId", Security::None);
static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool, MarketplaceService::CurrencyType)> func_PromptPurchase(
    &MarketplaceService::promptPurchase, "PromptPurchase", "player", "assetId", "equipIfPurchased", true, "currencyType",
    MarketplaceService::CURRENCY_DEFAULT, Security::None);
static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool, MarketplaceService::CurrencyType)>
    func_PromptProductPurchase(&MarketplaceService::promptProductPurchase, "PromptProductPurchase", "player", "productId", "equipIfPurchased", true,
        "currencyType", MarketplaceService::CURRENCY_DEFAULT, Security::None);
static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool)> event_promptPurchaseFinished(
    &MarketplaceService::promptPurchaseFinished, "PromptPurchaseFinished", "player", "assetId", "isPurchased", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::BROADCAST);
static Reflection::RemoteEventDesc<MarketplaceService, void(int, int, bool)> event_promptProductPurchaseFinished(
    &MarketplaceService::promptProductPurchaseFinished, "PromptProductPurchaseFinished", "userId", "productId", "isPurchased", Security::None,
    Reflection::RemoteEventCommon::Attributes::deprecated(Reflection::RemoteEventCommon::SCRIPTING, NULL), Reflection::RemoteEventCommon::BROADCAST);

static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<const Reflection::Tuple>)> event_ClientLuaDialogRequested(
    &MarketplaceService::clientLuaDialogRequested, "ClientLuaDialogRequested", "arguments", Security::RobloxScript,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<MarketplaceService, void(bool, shared_ptr<Instance>)> event_luaDialogCallbackSignal(
    &MarketplaceService::luaDialogCallbackSignal, "LuaDialogCallbackSignal", "value", "player", Security::RobloxScript,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::BoundFuncDesc<MarketplaceService, void(bool)> func_signalServerLuaDialogClosed(
    &MarketplaceService::signalServerLuaDialogClosed, "SignalServerLuaDialogClosed", "value", Security::RobloxScript);

static Reflection::BoundYieldFuncDesc<MarketplaceService, shared_ptr<Instance>()> func_getDeveloperProductsAsync(
    &MarketplaceService::getDeveloperProductsAsync, "GetDeveloperProductsAsync", Security::None);

static Reflection::BoundAsyncCallbackDesc<MarketplaceService, MarketplaceService::ProductPurchaseDecision(shared_ptr<const Reflection::ValueTable>)>
    callback_ProcessReceipt(
        "ProcessReceipt", &MarketplaceService::receiptCallback, "receiptInfo", &MarketplaceService::processReceiptsCallbackChanged);
REFLECTION_END();
...
template<>
bool StringConverter<MarketplaceService::ProductPurchaseDecision>::convertToValue(
    const std::string& text, MarketplaceService::ProductPurchaseDecision& value)
{
...
bool MarketplaceService::isValidPlayer(
    const shared_ptr<Instance> player, const std::string& funcName, boost::function<void(std::string)> errorFunction)
{
    if (Network::Player* thePlayer = Instance::fastDynamicCast<Network::Player>(player.get()))
    {
        if (thePlayer->getUserID() <= 0) // warn when we use a guest player (otherwise this call will fail in all local test scenarios!)
        {
            ...
            {
                std::string longFuncName = Aya::format("MarketplaceService:%s", funcName.c_str());
                longFuncName.append(" was called on a guest, please use this call only on players with an account.");

                Aya::StandardOut::singleton()->print(Aya::MESSAGE_WARNING, longFuncName);
                return false;
            }
        }
    }
...
void MarketplaceService::promptProductPurchase(
    const shared_ptr<Instance> player, const int productId, const bool equipIfPurchased, const CurrencyType currencyType)
{
    if (!isValidPlayer(player, "PromptProductPurchase()"))
        return;

    if (Network::Players* players = ServiceProvider::find<Aya::Network::Players>(this))
        if (Network::Players::frontendProcessing(this) && (player.get() != players->getLocalPlayer()))
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_WARNING,
                "MarketplaceService:PromptProductPurchase called from a local script, but not called on a local player. Local "
                "scripts can only prompt the local player.");
            return;
        }

    if (productId <= 0)
        throw Aya::runtime_error("MarketplaceService:PromptPurchase() second argument is not a valid productId (supplied productId was less than 0)");
    ...
    if (dm)
        if (LuaWebService* lws = dm->create<LuaWebService>())
            if (!lws->isApiAccessEnabled())
                throw Aya::runtime_error("Studio API access is not enabled. Enable it by going to the Game Settings page.");
...
void MarketplaceService::promptPurchase(
    const shared_ptr<Instance> player, const int assetId, const bool equipIfPurchased, const CurrencyType currencyType)
{
    ...
    if (Network::Players* players = ServiceProvider::find<Aya::Network::Players>(this))
        if (Network::Players::frontendProcessing(this) && (player.get() != players->getLocalPlayer()))
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_WARNING, "MarketplaceService:PromptPurchase called from a local script, but not "
                                                                        "called on a local player. Local scripts can only prompt the local player.");
            return;
        }

    if (assetId <= 0)
        throw Aya::runtime_error("MarketplaceService:PromptPurchase() second argument is not a valid assetId (supplied assetId was less than 0)");
...
void MarketplaceService::processRemoteEvent(
    const Reflection::EventDescriptor& descriptor, const Reflection::EventArguments& args, const SystemAddress& source)
{
    if (DFFlag::DoubleCheckPurchase && descriptor == event_promptPurchaseFinished)
    {
        ...
        if (isPurchase)
        {
            ...
            playerOwnsAsset(player, assetId,
                boost::bind(
                    &MarketplaceService::processPurchaseFinished, weakDataModel, args, source, _1),       // the arguments should be passed by value.
...
void MarketplaceService::processPurchaseFinished(
    weak_ptr<DataModel> weakDm, Reflection::EventArguments args, SystemAddress source, const bool isOwner)
{
    bool isPurchase = args[2].cast<bool>();
...
void MarketplaceService::processPurchaseError(
    weak_ptr<DataModel> weakDm, Reflection::EventArguments args, SystemAddress source, const std::string msg)
{
...
void MarketplaceService::dispatchRequest(
    const std::string& url, boost::function<void(ResultType)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
...
void MarketplaceService::getProductInfo(const int assetId, const MarketplaceService::InfoType infoType,
    boost::function<void(shared_ptr<const Reflection::ValueTable>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        ...
        std::string infoPathFull(Aya::format(infoPath.c_str(), assetId));
        ...
        apiService->getAsync(infoPathFull, true, Aya::PRIORITY_DEFAULT,
            boost::bind(&MarketplaceService::onReceivedRawProductInfoSuccess, this, infoPathFull, _1, weak_from(Aya::DataModel::get(this)),
                resumeFunction, errorFunction),
            boost::bind(&MarketplaceService::onReceivedRawProductInfoError, this, _1, weak_from(Aya::DataModel::get(this)), errorFunction));
    }
}

void MarketplaceService::onReceivedRawProductInfoSuccess(std::string url, std::string response, boost::weak_ptr<Aya::DataModel> weakDM,
    boost::function<void(shared_ptr<const Reflection::ValueTable>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    if (shared_ptr<Aya::DataModel> sharedDM = weakDM.lock())
    {
        if (response.empty())
        {
            errorFunction(Aya::format("MarketplaceService:getProductInfo() failed because rawProductInfo was empty"));
            return;
        }
...
#ifdef AYA_PLAYER
            // manually parse response with rapidjson
            rapidjson::Document document;
            document.Parse(response.c_str());

            if (sharedDM->getPlaceID() == document["AssetId"].GetInt())
            {
                DiscordIntegration integration;
                if (!integration.hasSetDetails())
                {
                    integration.setDetails(std::string("Playing ") + document["Name"].GetString() + " by " + document["Creator"]["Name"].GetString());
                }

                int numPlayers = sharedDM->getNumPlayers();
                int maxPlayers = sharedDM->getMaxPlayers();

                integration.setPartySize(numPlayers == 0 ? 1 : numPlayers, maxPlayers == 0 ? 8 : maxPlayers);
            }
#endif
        }
        else
...
void MarketplaceService::onReceivedRawProductInfoError(
    std::string error, boost::weak_ptr<Aya::DataModel> weakDM, boost::function<void(std::string)> errorFunction)
{
    if (shared_ptr<Aya::DataModel> sharedDM = weakDM.lock())
    {
        if (!error.empty())
        {
            errorFunction(Aya::format("MarketplaceService:getProductInfo() failed because %s", error.c_str()));
        }
        else
        {
...
void MarketplaceService::processPlayerOwnsAssetResponseSuccess(
    std::string response, boost::function<void(bool)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    if (response.empty())
    {
...
void MarketplaceService::processPlayerOwnsAssetResponseError(std::string error, boost::function<void(std::string)> errorFunction)
{
    if (!error.empty())
    {
        errorFunction(Aya::format("MarketPlaceService::PlayerOwnsAsset failed because %s", error.c_str()));
        return;
    }
    else
    {
...
void MarketplaceService::playerOwnsAsset(const shared_ptr<Instance> player, const int assetId, boost::function<void(bool)> resumeFunction,
    boost::function<void(std::string)> errorFunction)
{
    ...
    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        apiService->getAsync(Aya::format(playerOwnsAssetUrl.c_str(), userId, assetId), true, Aya::PRIORITY_DEFAULT,
...
void MarketplaceService::verifyPurchaseTicket(std::string ticket, int userId, int productId)
{
    if (Network::Players::backendProcessing(this, false))
    {
        if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
        {
            apiService->postAsync(Aya::format("%s/validatepurchase?receipt=%s", urlApiPath(), ticket.c_str()),
                std::string("GameServerVerifyPurchase"), true, Aya::PRIORITY_EXTREME, HttpService::TEXT_PLAIN,
...
bool MarketplaceService::launchClientLuaDialog(std::string message, std::string accept, std::string decline, shared_ptr<Instance> player,
    boost::function<void(bool, shared_ptr<Instance>)> callback)
{
    if (Network::Player* thePlayer = Instance::fastDynamicCast<Network::Player>(player.get()))
    {
        Network::Players* players = ServiceProvider::find<Network::Players>(this);

        if (!players || thePlayer->getParent() != players || players->clientIsPresent(this) ||
            callbackFunctionMap.find(player) != callbackFunctionMap.end())
            return false;

        if (!playerRemovingConnection.connected())
            playerRemovingConnection =
                players->playerRemovingSignal.connect(boost::bind(&MarketplaceService::executeClientDialogCallback, this, false, _1));

        callbackFunctionMap[player] = callback;

        const Aya::SystemAddress& target = thePlayer->getRemoteAddressAsRbxAddress();
...
void MarketplaceService::onServiceProvider(ServiceProvider* oldSp, ServiceProvider* newSp)
{
    ...
    if (newSp && Network::Players::backendProcessing(newSp))
    {
        ...
        playerAddedReceiptConnection =
            players->getOrCreateChildAddedSignal()->connect(boost::bind(&MarketplaceService::getReceiptsForJoiningPlayer, this, _1));

        // Attach listener for player purchases
        playerPurchaseReceiptConnection = clientPurchaseSuccess.connect(boost::bind(&MarketplaceService::getReceiptsAfterPurchase, this, _1, _2, _3));
    }

    if (newSp)
    {
        verifyPurchaseConnection = clientPurchaseSuccess.connect(boost::bind(&Aya::MarketplaceService::verifyPurchaseTicket, this, _1, _2, _3));
    }
}
...
void MarketplaceService::processReceiptsCallbackChanged(const ReceiptCallback& oldValue)
{
    if (!Network::Players::backendProcessing(this))
    {
        ...
        throw Aya::runtime_error("Can only register ProcessReceipt callback on server");
    }

    receiptProcessingEnabledByUser = true;
}

static void alwaysApproveReceiptsCallback(
    Reflection::Variant, Reflection::AsyncCallbackDescriptor::ResumeFunction resumeFunc, Reflection::AsyncCallbackDescriptor::ErrorFunction)
{
...
void MarketplaceService::setupBackendOnlyReceiptHandling()
{
    ...
    AYAASSERT(!receiptProcessingEnabledByUser);
    receiptProcessingEnabledByUser = false;
...
{
    if (Network::Players::backendProcessing(this) && ServiceProvider::create<LuaWebService>(this)->isApiAccessEnabled())
    {
        ...
        if (placeId > 0 && userId > 0)
        {
            ...
            Http http(format("%sgametransactions/getpendingtransactions/?PlaceId=%d&PlayerId=%d", apiBaseUrl.c_str(), placeId, userId));
            http.additionalHeaders["Cache-Control"] = "no-cache";
            http.doNotUseCachedResponse = true;

            if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
            {
                apiService->getAsync(http, Aya::PRIORITY_EXTREME,
...
{
    shared_ptr<const Reflection::ValueTable> sourceTable = jsonReceiptAsVariant.cast<shared_ptr<const Reflection::ValueTable>>();
    ...
    {
        shared_ptr<const Reflection::ValueArray> argsArray = sourceTable->at("actionArgs").cast<shared_ptr<const Reflection::ValueArray>>();
        for (size_t j = 0; j < argsArray->size(); ++j)
        {
            if (argsArray->at(j).isType<shared_ptr<const Reflection::ValueTable>>())
            {
                shared_ptr<const Reflection::ValueTable> kvPair = argsArray->at(j).cast<shared_ptr<const Reflection::ValueTable>>();
...
void MarketplaceService::handleReceiptQueryResponseSuccess(weak_ptr<MarketplaceService> weakMk, std::string response)
{
    if (!response.empty())
    {
        if (shared_ptr<MarketplaceService> m = weakMk.lock())
        {
            ...
            {
                shared_ptr<const Reflection::ValueArray> receiptArray = jsonVariant.cast<shared_ptr<const Reflection::ValueArray>>();
                for (size_t i = 0; i < receiptArray->size(); ++i)
                {
                    if (receiptArray->at(i).isType<shared_ptr<const Reflection::ValueTable>>())
                    {
                        DataModel::get(m.get())->submitTask(
                            boost::bind(&MarketplaceService::processReceipt, weakMk, buildReceiptInfoFromJson(receiptArray->at(i))),
                            DataModelJob::Write);
                    }
                }
            }
        ...
        if (!mk->receiptCallback.empty())
        {
            try
            {
                ...
                mk->receiptCallback(receiptInfo,
                    boost::bind(&MarketplaceService::processReceiptSuccessContinuation, mk, receiptId, currencyType, currencySpent, _1),
...
void MarketplaceService::processReceiptSuccessContinuation(
    shared_ptr<MarketplaceService> mk, std::string receiptId, int currencyType, int currencySpent, shared_ptr<const Reflection::Tuple> result)
{
    ...
    {
        if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(mk.get()))
        {
            apiService->postAsync("gametransactions/settransactionstatuscomplete", format("receipt=%s", receiptId.c_str()), true,
                Aya::PRIORITY_EXTREME, HttpService::APPLICATION_URLENCODED, boost::bind(&doNothingHttpCallbackSuccess, _1),
...
void MarketplaceService::promptThirdPartyPurchase(const shared_ptr<Instance> player, std::string thirdPartyProductId)
{
    ...
    if (Network::Players* players = ServiceProvider::find<Aya::Network::Players>(this))
    {
        ...
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_WARNING,
                "MarketplaceService:PromptThirdPartyPurchase called from a local script, but not called on a local player. "
                "Local scripts can only prompt the local player.");
            return;
        }
    }

    if (thirdPartyProductId.empty())
        throw Aya::runtime_error("MarketplaceService:PromptThirdPartyPurchase() productId is empty");
...
void MarketplaceService::signalPromptThirdPartyPurchaseFinished(
    const shared_ptr<Instance> player, std::string productId, std::string receipt, const bool success)
{
...
void MarketplaceService::promptNativePurchase(const shared_ptr<Instance> player, std::string nativeProductId)
{
    ...
    if (Network::Players* players = ServiceProvider::find<Aya::Network::Players>(this))
    {
        if (Network::Players::frontendProcessing(this) && (player.get() != players->getLocalPlayer()))
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_WARNING, "MarketplaceService:PromptNativePurchase called from a local script, but not "
                                                                        "called on a local player. Local scripts can only prompt the local player.");
            return;
        }
    }
    ...
    if (nativeProductId.empty())
        throw Aya::runtime_error("MarketplaceService:PromptNativePurchase() productId is empty");
...
void MarketplaceService::getDeveloperProductsAsync(
