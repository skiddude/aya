...
protected:
    ...
    virtual InOutZ getCoordOrientation() const
    {
        return Z_OUT;
    }
...
public:
    ...
    TopBottom getTopBottom() const
    {
        return topBottom;
    }
    void setTopBottom(TopBottom value);

    LeftRight getLeftRight() const
    {
        return leftRight;
    }
    void setLeftRight(LeftRight value);

    InOut getInOut() const
    {
        return inOut;
    }
...
private:
    ...
    // Feature
    /*override*/ InOutZ getCoordOrientation() const
    {
        return Z_IN;
    }
...
private:
    ...
    Aya::signals::scoped_connection holeAncestorChanged;
