...
class BodyMover
    : public DescribedNonCreatable<BodyMover, Instance, sBodyMover>
...
protected:
    ...
    /*implement*/ virtual void computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque) = 0;
...
private:
    ...
    /*override*/ void computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque);
...
private:
    ...
    /*override */ bool duplicateBodyMoverExists(Primitive*, Primitive*)
    {
        return false;
    }
    /*override*/ void computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque);
...
public:
    ...
    Vector3 getBodyForce() const
    {
        return bodyForceValue;
    }
...
public:
    ...
    Aya::remote_signal<void()> reachedTargetSignal;

    Vector3 getLastForce()
    {
        return lastForce;
    }
    Vector3 getMaxForce() const
    {
        return maxForce;
    }
...
class BodyAngularVelocity : public DescribedCreatable<BodyAngularVelocity, BodyMover, sBodyAngularVelocity>
{
private:
    float kP;          // units: 1/sec        force = kMoveP * mass * velocity
...
private:
    ...
    PartInstance* getTargetDangerous() const
    {
        return target.get();
    } // for reflection only
