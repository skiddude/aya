...
static const Reflection::PropDescriptor<Smoke, float> prop_SizeUi(
    "Size", category_Data, &Smoke::getSizeRaw, &Smoke::setSizeUi, Reflection::PropertyDescriptor::UI);
static const Reflection::PropDescriptor<Smoke, float> prop_OpacityUi(
    "Opacity", category_Data, &Smoke::getOpacityRaw, &Smoke::setOpacityUi, Reflection::PropertyDescriptor::UI);
static const Reflection::PropDescriptor<Smoke, float> prop_RiseVelocityUi(
    "RiseVelocity", category_Data, &Smoke::getRiseVelocityRaw, &Smoke::setRiseVelocityUi, Reflection::PropertyDescriptor::UI);

static const Reflection::PropDescriptor<Smoke, float> prop_Size(
    "size_xml", category_Data, &Smoke::getSizeRaw, &Smoke::setSize, Reflection::PropertyDescriptor::STREAMING);
static const Reflection::PropDescriptor<Smoke, float> prop_Opacity(
    "opacity_xml", category_Data, &Smoke::getOpacityRaw, &Smoke::setOpacity, Reflection::PropertyDescriptor::STREAMING);
static const Reflection::PropDescriptor<Smoke, float> prop_RiseVelocity(
    "riseVelocity_xml", category_Data, &Smoke::getRiseVelocityRaw, &Smoke::setRiseVelocity, Reflection::PropertyDescriptor::STREAMING);
REFLECTION_END();
