...
public:
    ...
    const TextureId& getSkyboxUp() const
    {
        return skyUp;
    }
    const TextureId& getSkyboxLf() const
    {
        return skyLf;
    }
    const TextureId& getSkyboxRt() const
    {
        return skyRt;
    }
    const TextureId& getSkyboxBk() const
    {
        return skyBk;
    }
    const TextureId& getSkyboxDn() const
    {
        return skyDn;
    }
    const TextureId& getSkyboxFt() const
    {
        return skyFt;
    }
    const TextureId& getSunTexture() const
    {
        return sunTexture;
    }
    const TextureId& getMoonTexture() const
    {
        return moonTexture;
    }
    const float& getSunAngularSize() const
    {
        return sunAngularSize;
    }
    const float& getMoonAngularSize() const
    {
        return moonAngularSize;
    }
