...
// const PropDescriptor<PrismInstance, int> PrismInstance::prop_slices("Slices", category_Prism, &PrismInstance::GetNumSlices,
// &PrismInstance::SetNumSlices);


PrismInstance::PrismInstance()
    : DescribedNonCreatable<PrismInstance, PartInstance, sPrism>(InitialPrismPartSize)
{
    setName("Prism");
