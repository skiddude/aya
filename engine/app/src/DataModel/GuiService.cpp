...
static const Reflection::PropDescriptor<GuiService, bool> prop_IsModalDialog(
    "IsModalDialog", category_Data, &GuiService::getModalDialogStatus, NULL, Reflection::PropertyDescriptor::Attributes::deprecated());
static const Reflection::PropDescriptor<GuiService, bool> prop_IsWindows(
    "IsWindows", category_Data, &GuiService::getIsWindows, NULL, Reflection::PropertyDescriptor::Attributes::deprecated());

static Reflection::EventDesc<GuiService, void(std::string, std::string)> event_keypressed(
    &GuiService::keyPressed, "KeyPressed", "key", "modifiers", Security::RobloxScript);
static Reflection::EventDesc<GuiService, void(GuiService::SpecialKey, std::string)> event_specialKeypressed(
    &GuiService::specialKeyPressed, "SpecialKeyPressed", "key", "modifiers", Security::RobloxScript);
...
static Reflection::BoundFuncDesc<GuiService, void(GuiService::SpecialKey)> func_addSpecialKey(
    &GuiService::addSpecialKey, "AddSpecialKey", "key", Security::RobloxScript);
static Reflection::BoundFuncDesc<GuiService, void(GuiService::SpecialKey)> func_removeSpecialKey(
    &GuiService::removeSpecialKey, "RemoveSpecialKey", "key", Security::RobloxScript);
...
static Reflection::BoundFuncDesc<GuiService, void(shared_ptr<Instance>, GuiService::CenterDialogType, Lua::WeakFunctionRef, Lua::WeakFunctionRef)>
    func_showCenterDialog(
        &GuiService::addCenterDialog, "AddCenterDialog", "dialog", "centerDialogType", "showFunction", "hideFunction", Security::RobloxScript);
static Reflection::BoundFuncDesc<GuiService, void(shared_ptr<Instance>)> func_hideCenterDialog(
    &GuiService::removeCenterDialog, "RemoveCenterDialog", "dialog", Security::RobloxScript);

static Reflection::BoundFuncDesc<GuiService, shared_ptr<const Reflection::Tuple>()> func_getGlobalGuiInset(
    &GuiService::getGlobalGuiInset2, "GetGuiInset", Security::None);
static Reflection::BoundFuncDesc<GuiService, void(int, int, int, int)> func_setGlobalGuiInset(
    &GuiService::setGlobalGuiInset, "SetGlobalGuiInset", "x1", "y1", "x2", "y2", Security::RobloxScript);

static Reflection::BoundYieldFuncDesc<GuiService, Vector2(void)> func_getScreenResolution(
    &GuiService::getScreenResolutionLua, "GetScreenResolution", Security::RobloxScript);

static Reflection::BoundFuncDesc<GuiService, shared_ptr<Instance>(Vector3)> func_GetClosestDialogToPosition(
    &GuiService::getClosestDialogToPosition, "GetClosestDialogToPosition", "position", Security::RobloxScript);
...
static Reflection::BoundFuncDesc<GuiService, void(GuiService::UiMessageType, std::string)> func_setUiMessage(
    &GuiService::setUiMessage, "SetUiMessage", "msgType", "uiMessage", Security::LocalUser);
...
static Reflection::EventDesc<GuiService, void(GuiService::UiMessageType, std::string)> event_newUiMessage(
    &GuiService::newUiMessageSignal, "UiMessageChanged", "msgType", "newUiMessage", Security::RobloxScript);

static Reflection::BoundFuncDesc<GuiService, void(std::string)> func_setErrorMessage(&GuiService::setErrorMessage, "SetErrorMessage", "errorMessage",
    Security::LocalUser, Reflection::Descriptor::Attributes::deprecated(func_setUiMessage));
static Reflection::BoundFuncDesc<GuiService, std::string()> func_getErrorMessage(
    &GuiService::getErrorMessage, "GetErrorMessage", Security::RobloxScript, Reflection::Descriptor::Attributes::deprecated(func_getUiMessage));
static Reflection::EventDesc<GuiService, void(std::string)> event_newError(&GuiService::newErrorSignal, "ErrorMessageChanged", "newErrorMessage",
    Security::RobloxScript, Reflection::Descriptor::Attributes::deprecated(event_newUiMessage));

static Reflection::EventDesc<GuiService, void()> event_showLeaveConfirmation(
    &GuiService::showLeaveConfirmationSignal, "ShowLeaveConfirmation", Security::RobloxScript);
...
static Reflection::BoundFuncDesc<GuiService, bool()> func_isTenFootInterface(
    &GuiService::isTenFootInterface, "IsTenFootInterface", Security::RobloxScript);

static Reflection::BoundFuncDesc<GuiService, void(std::string, shared_ptr<Instance>)> func_addSelectionGroup(
    &GuiService::addSelectionGroup, "AddSelectionParent", "selectionName", "selectionParent", Security::None);
static Reflection::BoundFuncDesc<GuiService, void(std::string, shared_ptr<const Reflection::Tuple>)> func_addSelectionGroupTuple(
    &GuiService::addSelectionGroup, "AddSelectionTuple", "selectionName", "selections", Security::None);

static Reflection::BoundFuncDesc<GuiService, void(std::string)> func_removeSelectionGroup(
    &GuiService::removeSelectionGroup, "RemoveSelectionGroup", "selectionName", Security::None);

Reflection::RefPropDescriptor<GuiService, GuiObject> GuiService::prop_selectedGuiObject(
    "SelectedObject", category_Data, &GuiService::getSelectedGuiObjectLua, &GuiService::setSelectedGuiObjectLua);
Reflection::RefPropDescriptor<GuiService, GuiObject> GuiService::prop_selectedCoreGuiObject("SelectedCoreObject", category_Data,
    &GuiService::getSelectedCoreGuiObjectLua, &GuiService::setSelectedCoreGuiObjectLua, Reflection::PropertyDescriptor::UI, Security::RobloxScript);

static const Reflection::PropDescriptor<GuiService, bool> prop_autoGuiSelectionAllowed(
    "AutoSelectGuiEnabled", category_Data, &GuiService::getAutoGuiSelectionAllowed, &GuiService::setAutoGuiSelectionAllowed);
static const Reflection::PropDescriptor<GuiService, bool> prop_gamepadNavigationEnabled(
    "GuiNavigationEnabled", category_Data, &GuiService::getGamepadNavEnabled, &GuiService::setGamepadNavEnabled);
static const Reflection::PropDescriptor<GuiService, bool> prop_coreGamepadNavigationEnabled(
    "CoreGuiNavigationEnabled", category_Data, &GuiService::getCoreGamepadNavEnabled, &GuiService::setCoreGamepadNavEnabled);

static Reflection::BoundAsyncCallbackDesc<GuiService, void(std::string, std::string)> callback_notificationCallback(
    "SendCoreUiNotification", &GuiService::notificationCallback, "title", "text", Security::RobloxScript);
...
static const Reflection::BoundFuncDesc<GuiService, void(bool)> func_setMenuOpen(
    &GuiService::setMenuOpen, "SetMenuIsOpen", "open", Security::RobloxScript);
...
static Reflection::BoundFuncDesc<GuiService, bool(std::string)> func_ShowStatsBasedOnInputString(
    &GuiService::showStatsBasedOnInputString, "ShowStatsBasedOnInputString", "input", Security::RobloxScript);
REFLECTION_END();
...
bool GuiService::shouldPreemptCurrentDialog(DialogWrapper* newDialog) const
{
    ...
    if (newDialog->dialogType < currentDialog->dialogType)
        return false;
    AYAASSERT(newDialog->dialogType == currentDialog->dialogType);
...
void GuiService::getScreenResolutionLua(boost::function<void(Vector2)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (getScreenResolution() == Vector2::zero())
    {
        if (RunService* runService = ServiceProvider::create<RunService>(this))
            screenGuiConnection =
                runService->heartbeatSignal.connect(boost::bind(&GuiService::getScreenResolutionNoRetry, this, resumeFunction, errorFunction));
    }
    else
    {
...
void GuiService::addCenterDialog(
    shared_ptr<Instance> dialogInstance, GuiService::CenterDialogType type, Lua::WeakFunctionRef show, Lua::WeakFunctionRef hide)
{
    shared_ptr<GuiObject> dialog = Instance::fastSharedDynamicCast<GuiObject>(dialogInstance);
    if (!dialog)
        throw Aya::runtime_error("dialog must be a GuiObject instance");
    ...
    if (iter != dialogWrapperMap.end())
    {
        if (DialogWrapper* wrapper = iter->second)
        {
            ...
            {
                throw Aya::runtime_error("A dialogInstance should not change CenterDialogTypes");
            }
    ...
    AYAASSERT(dialogWrapperMap.find(weakDialog) == dialogWrapperMap.end());
...
void GuiService::removeCenterDialog(shared_ptr<Instance> dialogInstance)
{
    ...
    if (DialogWrapper* wrapper = dialogWrapperMap[weakDialog])
    {
        ...
        if (wrapper == currentDialog)
        {
            ...
            if (showWaitingDialog(CENTER_DIALOG_QUIT_DIALOG) || showWaitingDialog(CENTER_DIALOG_MODAL_DIALOG) ||
                showWaitingDialog(CENTER_DIALOG_PLAYER_INITIATED_DIALOG) || showWaitingDialog(CENTER_DIALOG_UNSOLICITED_DIALOG))
            {
                // Make it show
                DataModel::get(this)->submitTask(boost::bind(currentDialog->showFunction), DataModelJob::Write);
            }
...
bool GuiService::processKeyDown(const shared_ptr<Aya::InputObject>& event)
{
    // ensure we are dealing with a key down
    AYAASSERT(event->isKeyDownEvent());

    if (event->isTextCharacterKey() || (UserInputService::IsUsingNewKeyboardEvents() && event->getUserInputType() == Aya::InputObject::TYPE_KEYBOARD))
    {
        if (!event->isAltEvent() && !event->isCtrlEvent())
        {
            if (event->modifiedKey == '/' || (UserInputService::IsUsingNewKeyboardEvents() && event->getKeyCode() == AYA_SDLK_SLASH))
            {
        ...
        {
        case AYA_SDLK_INSERT:
            if (dispatchKey(KEY_INSERT))
                return true;
            break;
        case AYA_SDLK_HOME:
            if (dispatchKey(KEY_HOME))
                return true;
            break;
        case AYA_SDLK_END:
            if (dispatchKey(KEY_END))
                return true;
            break;
        case AYA_SDLK_PAGEUP:
            if (dispatchKey(KEY_PAGEUP))
                return true;
            break;
        case AYA_SDLK_PAGEDOWN:
            if (dispatchKey(KEY_PAGEDOWN))
                return true;
            break;
        default:
            break;
...
shared_ptr<const Reflection::Tuple> GuiService::getGlobalGuiInset2()
{
    shared_ptr<Reflection::Tuple> result(new Reflection::Tuple(2));
    result->values[0] = Vector2(guiInset.x, guiInset.y);
    result->values[1] = Vector2(guiInset.z, guiInset.w);
    return result;
}
...
{
    if (key.size() != 1)
        throw Aya::runtime_error("GuiService:AddKey requires a string with a single character");
...
{
    if (key.size() != 1)
        throw Aya::runtime_error("GuiService:RemoveKey requires a string with a single character");
    char character = tolower(key[0]);
...
void GuiService::toggleFullscreen()
{
    ...
    if (Workspace* workspace = ServiceProvider::find<Workspace>(this))
    {
        ...
        {
            Aya::Tokens::simpleToken |= HATE_VERB_SNATCH;
            verb = NULL;
        }
#endif
    }
...
void GuiService::addSelectionGroup(std::string selectionGroupName, shared_ptr<Instance> selectionParent)
{
    ...
    if (!guiObjectParent)
    {
        Aya::StandardOut::singleton()->printf(
            MESSAGE_ERROR, "GuiService:AddSelectionParent for group name %s: parent is not a GuiObject.", selectionGroupName.c_str());
        return;
    }

    if (selectionMap.find(selectionGroupName) != selectionMap.end())
    {
        Aya::StandardOut::singleton()->printf(MESSAGE_WARNING,
            "GuiService:AddSelectionParent already has selection group with name %s, overwriting selection group.", selectionGroupName.c_str());
...
void GuiService::addSelectionGroup(std::string selectionGroupName, shared_ptr<const Reflection::Tuple> selectionTuple)
{
    ...
    {
        Aya::StandardOut::singleton()->printf(MESSAGE_WARNING,
            "GuiService:AddSelectionTuple already has selection group with name %s, overwriting selection group.", selectionGroupName.c_str());
        removeSelectionGroup(selectionGroupName);
    }
