...
private:
    ...
    Aya::InsertMode insertMode;
    bool parentIsPart;
    /*override*/ const std::string getCursorName() const
    {
        return "ArrowCursorDecalDrag";
    }
...
public:
    DecalTool(Workspace* workspace, Decal* decal, Aya::InsertMode insertMode);
...
public:
    FlatTool(Workspace* workspace)
        : Named<SurfaceTool, sFlatTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<FlatTool>(workspace);
    }
};
...
public:
    GlueTool(Workspace* workspace)
        : Named<SurfaceTool, sGlueTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<GlueTool>(workspace);
    }
};
...
public:
    WeldTool(Workspace* workspace)
        : Named<SurfaceTool, sWeldTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<WeldTool>(workspace);
    }
};
...
public:
    StudsTool(Workspace* workspace)
        : Named<SurfaceTool, sStudsTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<StudsTool>(workspace);
    }
};
...
public:
    InletTool(Workspace* workspace)
        : Named<SurfaceTool, sInletTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<InletTool>(workspace);
    }
};
...
public:
    UniversalTool(Workspace* workspace)
        : Named<SurfaceTool, sUniversalTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<UniversalTool>(workspace);
    }
};
...
public:
    ...
    HingeTool(Workspace* workspace)
        : Named<SurfaceTool, sHingeTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const;
};
...
public:
    static bool isStickyVerb;
    RightMotorTool(Workspace* workspace)
        : Named<SurfaceTool, sRightMotorTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const;
};
...
public:
    LeftMotorTool(Workspace* workspace)
        : Named<SurfaceTool, sLeftMotorTool>(workspace)
    {
    }
};
...
public:
    OscillateMotorTool(Workspace* workspace)
        : Named<SurfaceTool, sOscillateMotorTool>(workspace)
    {
    }
};
...
public:
    SmoothNoOutlinesTool(Workspace* workspace)
        : Named<SurfaceTool, sSmoothNoOutlinesTool>(workspace)
    {
    }
    /*override*/ shared_ptr<MouseCommand> isSticky() const
    {
        return Creatable<MouseCommand>::create<SmoothNoOutlinesTool>(workspace);
    }
};
