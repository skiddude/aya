...
#include "World/MegaClusterPoly.hpp"
#include "World/SmoothClusterGeometry.hpp"
#include "World/TerrainPartition.hpp"
...
#include "Voxel2/MaterialTable.hpp"
#include "Voxel2/Mesher.hpp"
#include "Voxel2/Conversion.hpp"
...
static const ContentId kSmoothTerrainMaterials("ayaasset://terrain/materials.json");

namespace Reflection
{
template<>
Reflection::EnumDesc<CellMaterial>::EnumDesc()
    : Aya::Reflection::EnumDescriptor("CellMaterial")
{
...
template<>
Reflection::EnumDesc<CellBlock>::EnumDesc()
    : Aya::Reflection::EnumDescriptor("CellBlock")
{
...
template<>
Reflection::EnumDesc<CellOrientation>::EnumDesc()
    : Aya::Reflection::EnumDescriptor("CellOrientation")
{
...
template<>
Reflection::EnumDesc<WaterCellForce>::EnumDesc()
    : Aya::Reflection::EnumDescriptor("WaterForce")
{
...
template<>
Reflection::EnumDesc<WaterCellDirection>::EnumDesc()
    : Aya::Reflection::EnumDescriptor("WaterDirection")
{
...
template<>
bool Aya::StringConverter<CellMaterial>::convertToValue(const std::string& text, CellMaterial& value)
{
    return Reflection::EnumDesc<CellMaterial>::singleton().convertToValue(text.c_str(), value);
}
template<>
bool Aya::StringConverter<CellBlock>::convertToValue(const std::string& text, CellBlock& value)
{
    return Reflection::EnumDesc<CellBlock>::singleton().convertToValue(text.c_str(), value);
}
template<>
bool Aya::StringConverter<CellOrientation>::convertToValue(const std::string& text, CellOrientation& value)
{
    return Reflection::EnumDesc<CellOrientation>::singleton().convertToValue(text.c_str(), value);
}
template<>
bool Aya::StringConverter<WaterCellForce>::convertToValue(const std::string& text, WaterCellForce& value)
{
    return Reflection::EnumDesc<WaterCellForce>::singleton().convertToValue(text.c_str(), value);
}
template<>
bool Aya::StringConverter<WaterCellDirection>::convertToValue(const std::string& text, WaterCellDirection& value)
{
...
static Reflection::PropDescriptor<MegaClusterInstance, std::string> desc_ClusterGridV1(
    "ClusterGrid", category_Data, NULL, &MegaClusterInstance::setPackagedClusterGridV1, Reflection::PropertyDescriptor::LEGACY, Security::None);
static Reflection::PropDescriptor<MegaClusterInstance, std::string> desc_ClusterGridV2(
    "ClusterGridV2", category_Data, NULL, &MegaClusterInstance::setPackagedClusterGridV2, Reflection::PropertyDescriptor::LEGACY, Security::None);
static Reflection::PropDescriptor<MegaClusterInstance, BinaryString> desc_ClusterGridV3("ClusterGridV3", category_Data,
    &MegaClusterInstance::getPackagedClusteredGridV3, &MegaClusterInstance::setPackagedClusterGridV3, Reflection::PropertyDescriptor::CLUSTER,
    Security::None);

static Reflection::PropDescriptor<MegaClusterInstance, BinaryString> desc_SmoothGrid("SmoothGrid", category_Data,
    &MegaClusterInstance::getPackagedSmoothGrid, &MegaClusterInstance::setPackagedSmoothGrid, Reflection::PropertyDescriptor::CLUSTER,
    Security::None);

static Reflection::PropDescriptor<MegaClusterInstance, int> desc_SmoothReplicate("SmoothReplicate", category_Data,
    &MegaClusterInstance::getSmoothReplicate, &MegaClusterInstance::setSmoothReplicate, Reflection::PropertyDescriptor::REPLICATE_ONLY,
    Security::None);

static Reflection::PropDescriptor<MegaClusterInstance, Region3int16> prop_MaxExtents(
    "MaxExtents", category_Data, &MegaClusterInstance::getMaxExtents, NULL, PropertyDescriptor::UI);

// LUA function reflections
static Reflection::BoundFuncDesc<MegaClusterInstance, shared_ptr<const Reflection::Tuple>(int, int, int)> func_getCell(
    &MegaClusterInstance::getCellScript, "GetCell", "x", "y", "z", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(int, int, int, CellMaterial, CellBlock, CellOrientation)> func_setCell(
    &MegaClusterInstance::setCellScript, "SetCell", "x", "y", "z", "material", "block", "orientation", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(Region3int16, CellMaterial, CellBlock, CellOrientation)> func_setCells(
    &MegaClusterInstance::setCellsScript, "SetCells", "region", "material", "block", "orientation", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, shared_ptr<const Reflection::Tuple>(int, int, int)> func_getWaterCell(
    &MegaClusterInstance::getWaterCellScript, "GetWaterCell", "x", "y", "z", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(int, int, int, WaterCellForce, WaterCellDirection)> func_setWaterCell(
    &MegaClusterInstance::setWaterCellScript, "SetWaterCell", "x", "y", "z", "force", "direction", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, bool(int, int, int)> func_autoWedgeCell(
    &MegaClusterInstance::autoWedgeCellScript, "AutowedgeCell", "x", "y", "z", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(Region3int16)> func_autoWedgeCells(
    &MegaClusterInstance::autoWedgeCellsScript, "AutowedgeCells", "region", Security::None);


static Reflection::BoundFuncDesc<MegaClusterInstance, Vector3(int, int, int)> func_cellCornerToWorld(
    &MegaClusterInstance::cellCornerToWorldScript, "CellCornerToWorld", "x", "y", "z", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, Vector3(int, int, int)> func_cellCenterToWorld(
    &MegaClusterInstance::cellCenterToWorldScript, "CellCenterToWorld", "x", "y", "z", Security::None);

static Reflection::BoundFuncDesc<MegaClusterInstance, Vector3(Vector3)> func_worldToCellPreferSolid(
    &MegaClusterInstance::worldToCellPreferSolidScript, "WorldToCellPreferSolid", "position", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, Vector3(Vector3)> func_worldToCellPreferEmpty(
    &MegaClusterInstance::worldToCellPreferEmptyScript, "WorldToCellPreferEmpty", "position", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, Vector3(Vector3)> func_worldToCell(
    &MegaClusterInstance::worldToCellScript, "WorldToCell", "position", Security::None);

static Reflection::BoundFuncDesc<MegaClusterInstance, void(void)> func_clear(&MegaClusterInstance::clear, "Clear", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, int(void)> func_countCells(
    &MegaClusterInstance::countCellsScript, "CountCells", Security::None);

static Reflection::BoundFuncDesc<MegaClusterInstance, shared_ptr<Instance>(Region3int16)> func_copyRegion(
    &MegaClusterInstance::copyRegion, "CopyRegion", "region", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(shared_ptr<Instance>, Vector3int16, bool)> func_pasteRegion(
    &MegaClusterInstance::pasteRegion, "PasteRegion", "region", "corner", "pasteEmptyCells", Security::None);

static Reflection::PropDescriptor<MegaClusterInstance, bool> prop_IsSmooth(
    "IsSmooth", category_Data, &MegaClusterInstance::isSmooth, NULL, Reflection::PropertyDescriptor::UI, Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(void)> func_convertToSmooth(
    &MegaClusterInstance::convertToSmooth, "ConvertToSmooth", Security::Plugin);

static Reflection::CustomBoundFuncDesc<MegaClusterInstance, shared_ptr<const Reflection::Tuple>(Region3, float)> func_readVoxels(
    &MegaClusterInstance::readVoxels, "ReadVoxels", "region", "resolution", Security::None);
static Reflection::CustomBoundFuncDesc<MegaClusterInstance,
    void(Region3, float, shared_ptr<const Reflection::ValueArray>, shared_ptr<const Reflection::ValueArray>)>
    func_writeVoxels(&MegaClusterInstance::writeVoxels, "WriteVoxels", "region", "resolution", "materials", "occupancy", Security::None);

static Reflection::BoundFuncDesc<MegaClusterInstance, void(Region3, float, PartMaterial)> func_fillRegion(
    &MegaClusterInstance::fillRegion, "FillRegion", "region", "resolution", "material", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(CoordinateFrame, Vector3, PartMaterial)> func_fillBlock(
    &MegaClusterInstance::fillBlock, "FillBlock", "cframe", "size", "material", Security::None);
static Reflection::BoundFuncDesc<MegaClusterInstance, void(Vector3, float, PartMaterial)> func_fillBall(
    &MegaClusterInstance::fillBall, "FillBall", "center", "radius", "material", Security::None);
REFLECTION_END();

static Reflection::PropDescriptor<MegaClusterInstance, Color3> desc_WaterColor(
    "WaterColor", category_Appearance, &MegaClusterInstance::getWaterColor, &MegaClusterInstance::setWaterColor);
static Reflection::PropDescriptor<MegaClusterInstance, float> desc_WaterTransparency(
    "WaterTransparency", category_Appearance, &MegaClusterInstance::getWaterTransparency, &MegaClusterInstance::setWaterTransparency);
static Reflection::PropDescriptor<MegaClusterInstance, float> desc_WaterWaveSize(
    "WaterWaveSize", category_Appearance, &MegaClusterInstance::getWaterWaveSize, &MegaClusterInstance::setWaterWaveSize);
static Reflection::PropDescriptor<MegaClusterInstance, float> desc_WaterWaveSpeed(
    "WaterWaveSpeed", category_Appearance, &MegaClusterInstance::getWaterWaveSpeed, &MegaClusterInstance::setWaterWaveSpeed);
...
{
    throw Aya::runtime_error("GetTouchingParts is not a valid member of Terrain");
}
...
MegaClusterInstance::~MegaClusterInstance()
{
    ...
    if (parentWorkspace)
        parentWorkspace->setTerrain(NULL);
...
void MegaClusterInstance::verifySetParent(const Instance* instance) const
{
    ...
    const Workspace* workspace = instance != NULL ? instance->fastDynamicCast<Workspace>() : NULL;
    if (instance != NULL && ((workspace == NULL) || (workspace->getTerrain() != NULL)))
    {
        throw Aya::runtime_error("Unable to change Terrain's parent. Workspace already has Terrain");
    }
...
void MegaClusterInstance::setCellsScript(Region3int16 region, CellMaterial material, CellBlock block, CellOrientation orientation)
{
    ...
    if (smoothGrid)
    {
        ...
        if (minPos.x <= maxPos.x && minPos.y <= maxPos.y && minPos.z <= maxPos.z)
        {
            ...
            Voxel2::Cell cell =
                (material == CELL_MATERIAL_Water) ? Voxel2::Cell(Voxel2::Cell::Material_Water, Voxel2::Cell::Occupancy_Max)
    ...
    else
    {
        ...
        // Data is stored in (Y > Z > X) format [so Y is most significant index and X is least in pointer arithmetic], so traverse in this order for
...
bool MegaClusterInstance::autoWedgeCellScript(int scriptX, int scriptY, int scriptZ)
{
    ...
    if (currentCell.solid.getBlock() != CELL_BLOCK_Empty)
    {
        ...
        bool blockBelow =
            (voxelGrid->getCell(Vector3int16(internalCellPos.x, internalCellPos.y - 1, internalCellPos.z)).solid.getBlock() != CELL_BLOCK_Empty);
        ...
        for (int j = 0; j <= 1; ++j)
        {
            for (int k = 0; k <= 2; ++k)
            {
                ...
                {
                    surroundings[i][j][k] =
                        (voxelGrid->getCell(Vector3int16(internalCellPos.x - 1 + i, internalCellPos.y + j, internalCellPos.z - 1 + k))
                                .solid.getBlock() != CELL_BLOCK_Empty);
                }
            }
        }
        ...
        if (!surroundings[1][1][1])
        {
            ...
            // type 2: 45 degree corner [must not have a block on top, and be surrounded by 2 sides and the 1 corner between them; or 3 sides and 1
            // corner between 2 of them (facing towards that corner)]
            for (int n = 0; n < 4; ++n)
            {
                if (sides[n] && corners[(n + 1) % 4] && sides[(n + 1) % 4] &&
                    (adjacentSides == 2 || (adjacentSides == 3 && (corners[(n + 3) % 4] || (sides[(n + 2) % 4] && corners[(n + 2) % 4]) ||
                                                                      (sides[(n + 3) % 4] && corners[n])))))
                {
                    wedge = (CellBlock)2;
                    rotation = (CellOrientation)((n + 2) % 4);
                    cell.solid.setBlock(wedge);
        ...
        // type 3: 45 degree inverse corner [surrounded by three sides or 4 sides and 3 corners, with nothing above or else a block on top surrounded
        // on 2 sides and the corner between them]
        if (adjacentSides == 3 && surroundings[1][1][1])
        {
            if (adjacentCorners > 1)
            {
                for (int n = 0; n < 4; ++n)
                {
                    if ((!corners[n] || !cornersAbove[n]) && (!sides[(n - 1) % 4] || !sides[n]) &&
                        (!sidesAbove[n] && sidesAbove[(n + 1) % 4] && sidesAbove[(n + 2) % 4] && !sidesAbove[(n + 3) % 4]))
                    {
                        wedge = (CellBlock)3;
        ...
        else if (adjacentSides == 4 && adjacentCorners == 3)
        {
            for (int n = 0; n < 4; ++n)
            {
                if (!corners[n] && (!surroundings[1][1][1] || (!sidesAbove[n] && sidesAbove[(n + 1) % 4] && cornersAbove[(n + 2) % 4] &&
                                                                  sidesAbove[(n + 2) % 4] && !sidesAbove[(n + 3) % 4])))
                {
                    wedge = (CellBlock)3;
                    rotation = (CellOrientation)((n + 3) % 4);
                    cell.solid.setBlock(wedge);
        ...
        if (adjacentSides == 2 && adjacentCorners < 4)
        {
            for (int n = 0; n < 4; ++n)
            {
                if (!sides[n] && !sides[(n + 1) % 4] &&
                    (!surroundings[1][1][1] || (!sidesAbove[n] && !sidesAbove[(n + 1) % 4] && sidesAbove[(n + 2) % 4] && sidesAbove[(n + 3) % 4])))
                {
                    wedge = (CellBlock)4;
...
void writeCountValue(Stream& s, unsigned count)
{
    AYAASSERT(count <= 0xffff);
...
template<class Stream>
unsigned readCountValue(Stream& s)
{
    unsigned char count;
    s >> count;
...
template<class Stream>
void writeInt16(Stream& s, short value)
{
...
template<class Stream>
void MegaClusterInstance::decodeChunkDataFromStreamV1_Deprecated(const Vector3int16& chunkPos, Stream& encodedData)
{
    ...
    while (cellInChunkIndex.y < Voxel::kY_CHUNK_SIZE)
    {
        ...
        for (unsigned i = 0; i < count; ++i)
        {
            Vector3int16 cellPos =
                Vector3int16(chunkPos.x * Voxel::kXZ_CHUNK_SIZE, chunkPos.y * Voxel::kY_CHUNK_SIZE, chunkPos.z * Voxel::kXZ_CHUNK_SIZE);
...
template<class Stream>
void MegaClusterInstance::decodeChunkDataFromStream(Voxel::Grid& grid, const Vector3int16& chunkPos, Stream& encodedData)
{
    FASTLOG3(FLog::MegaClusterDecodeStream, "Decode chunk pos (%d,%d,%d)", chunkPos.x, chunkPos.y, chunkPos.z);
    ...
    bool chunkWasEmpty = grid.getRegion(region.getMinPos(), region.getMaxPos()).isGuaranteedAllEmpty();
...
template<class Stream>
void MegaClusterInstance::encodeChunkDataIntoStream(const Voxel::Grid::Region& chunk, Stream& s)
{
...
void MegaClusterInstance::setCellInternalV1_Deprecated(const Vector3int16& pos, const unsigned char& inputCell)
{
    Cell cell;
    CellMaterial material = getCellMaterial_Deprecated(inputCell);
    if (material == CELL_MATERIAL_Deprecated_Empty)
    {
        cell = Voxel::Constants::kUniqueEmptyCellRepresentation;
...
bool MegaClusterInstance::isCellIdealForPreference(const Vector3int16& location, const Cell cell, bool preferSolid) const
{
    Cell tmpCell = voxelGrid->getCell(location);
    return ((preferSolid && cell.solid.getBlock() != CELL_BLOCK_Empty) || (!preferSolid && tmpCell.isEmpty()));
}

bool MegaClusterInstance::isCellAcceptablePreferenceWaterAlternative(const Vector3int16& location, const Cell cell, bool preferSolid) const
{
    Cell waterCell = voxelGrid->getWaterCell(location);
    bool hasWater = !waterCell.isEmpty();
    return ((preferSolid && hasWater) || (!preferSolid && hasWater && cell.solid.getBlock() == CELL_BLOCK_Empty));
}
    ...
    else
    {
        ...
        for (int y = -1; y < 2; y += 2)
        {
            for (int z = -1; z < 2; z += 2)
            {
                for (int x = -1; x < 2; x += 2)
                {
                    Vector3int16 test = Voxel::worldToCell_floor(worldPos + Vector3(searchEpsilon * x, searchEpsilon * y, searchEpsilon * z));
        ...
        for (unsigned i = 0; i < Invalid; i++)
        {
            ...
            if (isCellIdealForPreference(npos, tmpCell, preferSolid) && distance < bestDistance)
            {
                foundTotalMatch = true;
                bestCell = npos;
                bestDistance = distance;
            }
            if (isCellAcceptablePreferenceWaterAlternative(npos, tmpCell, preferSolid) && distance < bestWaterDistance)
            {
                foundAcceptableWaterCell = true;
            ...
            for (int y = min.y; y <= max.y; ++y)
                for (int z = min.z; z <= max.z; ++z)
                    for (int x = min.x; x <= max.x; ++x)
                        voxelGrid->setCell(Vector3int16(x, y, z), Voxel::Constants::kUniqueEmptyCellRepresentation, CELL_MATERIAL_Water);
        }
    }
}
...
{
    AYAASSERT(!getParent());
    AYAASSERT(!voxelGrid && !smoothGrid);
...
int MegaClusterInstance::writeVoxels(lua_State* L)
{
    ...
    if (!isArray(L, 4, box.getSizeX()))
        throw Aya::runtime_error("Bad argument materials to 'WriteVoxels' (%dx%dx%d array expected)", box.getSizeX(), box.getSizeY(), box.getSizeZ());

    if (!isArray(L, 5, box.getSizeX()))
        throw Aya::runtime_error("Bad argument occupancy to 'WriteVoxels' (%dx%dx%d array expected)", box.getSizeX(), box.getSizeY(), box.getSizeZ());
    ...
    for (int x = 0; x < box.getSizeX(); ++x)
    {
        ...
        if (!isArray(L, -2, box.getSizeY()))
            throw Aya::runtime_error("Bad argument materials[%d] to 'WriteVoxels' (%dx%d array expected)", x + 1, box.getSizeY(), box.getSizeZ());

        if (!isArray(L, -1, box.getSizeY()))
            throw Aya::runtime_error("Bad argument occupancy[%d] to 'WriteVoxels' (%dx%d array expected)", x + 1, box.getSizeY(), box.getSizeZ());
        ...
        for (int y = 0; y < box.getSizeY(); ++y)
        {
            ...
            if (!isArray(L, -2, box.getSizeZ()))
                throw Aya::runtime_error("Bad argument materials[%d][%d] to 'WriteVoxels' (%d-element array expected)", x + 1, y + 1, box.getSizeZ());

            if (!isArray(L, -1, box.getSizeZ()))
                throw Aya::runtime_error("Bad argument occupancy[%d][%d] to 'WriteVoxels' (%d-element array expected)", x + 1, y + 1, box.getSizeZ());
            ...
            for (int z = 0; z < box.getSizeZ(); ++z)
            {
                ...
                if (!mat)
                    luaL_error(L, "Bad argument materials[%d][%d][%d] to 'WriteVoxels' (Enum.Material expected, got %s)", x + 1, y + 1, z + 1,
                        luaL_typename(L, -2));
                ...
                if (!lua_isnumber(L, -1))
                    luaL_error(L, "Bad argument occupancy[%d][%d][%d] to 'WriteVoxels' (number expected, got %s)", x + 1, y + 1, z + 1,
                        luaL_typename(L, -1));
                ...
                else
                {
                    ...
                    box.set(x, y, z,
                        Voxel2::Cell(material, std::min(std::max(static_cast<int>(occInt), 0), static_cast<int>(Voxel2::Cell::Occupancy_Max))));
                }
...
void MegaClusterInstance::fillBlock(CoordinateFrame cframe, Vector3 size, PartMaterial material)
{
    ...
    Vector3 localCorner =
        cframe.pointToObjectSpace(Vector3(rr.begin().x + 0.5f, rr.begin().y + 0.5f, rr.begin().z + 0.5f) * Voxel::kCELL_SIZE) / Voxel::kCELL_SIZE;
