...
public:
    ...
    Vector2 getImageRectOffset() const
    {
        return imageRectOffset;
    }

    Vector2 getImageRectSize() const
    {
        return imageRectSize;
    }

    float getImageTransparency() const
    {
        return imageTransparency;
    }

    Color3 getImageColor3() const
    {
        return imageColor;
    }

    Rect2D getSliceCenter() const
    {
        return sliceCenter;
    }

    GuiObject::ImageScale getImageScale() const
    {
        return imageScale;
    }
        ...
        { \
            ...
            { \
                Aya::StandardOut::singleton()->printf( \
                    MESSAGE_WARNING, "SliceCenter ((%f,%f), (%f,%f)) is outside the bounds of imageOffset ((%f,%f), (%f,%f)).", offsetSliceCenter.x0(), offsetSliceCenter.y0(), offsetSliceCenter.x1(), offsetSliceCenter.y1(), imageRect.x0(), imageRect.y0(), imageRect.x1(), imageRect.y1()); \
            } \
