...
static Reflection::BoundFuncDesc<PersonalServerService, void(std::string)> func_SetPersonalServerGetRankUrl(
    &PersonalServerService::setPersonalServerGetRankUrl, "SetPersonalServerGetRankUrl", "personalServerGetRankUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<PersonalServerService, void(std::string)> func_SetPersonalServerSetRankUrl(
    &PersonalServerService::setPersonalServerSetRankUrl, "SetPersonalServerSetRankUrl", "personalServerSetRankUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<PersonalServerService, void(std::string)> func_SetPersonalServerBuildToolsUrl(
    &PersonalServerService::setPersonalServerRoleSetsUrl, "SetPersonalServerRoleSetsUrl", "personalServerRoleSetsUrl", Security::LocalUser);

static Reflection::BoundFuncDesc<PersonalServerService, void(shared_ptr<Instance>)> func_Promote(
    &PersonalServerService::promote, "Promote", "player", Security::RobloxScript);
static Reflection::BoundFuncDesc<PersonalServerService, void(shared_ptr<Instance>)> func_Demote(
    &PersonalServerService::demote, "Demote", "player", Security::RobloxScript);

static Reflection::BoundYieldFuncDesc<PersonalServerService, std::string(int)> func_GetRoleSets(
    &PersonalServerService::getWebRoleSets, "GetRoleSets", "placeId", Security::RobloxScript);

static Reflection::PropDescriptor<PersonalServerService, std::string> prop_roleSets("RoleSets", category_Behavior,
    &PersonalServerService::getRoleSets, &PersonalServerService::setRoleSets, Reflection::PropertyDescriptor::SCRIPTING, Security::RobloxScript);
REFLECTION_END();
    ...
    , roleSets("")
{
    ...
    this->setName("PersonalServerService");
}
...
void PersonalServerService::dispatchRequest(
...
void PersonalServerService::getWebRoleSets(
    int placeId, boost::function<void(std::string)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    {
        std::string url(Aya::format(personalServerRoleSetsUrl.c_str(), placeId));
...
void PersonalServerService::getRank(
    Network::Player* player, int placeId, boost::function<void(std::string)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    if (personalServerGetRankUrl.empty())
        errorFunction("No personalServerGetRankUrl set");
    else
    {
        std::string url(Aya::format(personalServerGetRankUrl.c_str(), placeId, player->getUserID()));
        dispatchRequest(url, resumeFunction, errorFunction);
    }
}

void PersonalServerService::setRank(
    Network::Player* player, int placeId, int newRank, boost::function<void(bool)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    if (personalServerSetRankUrl.empty())
        errorFunction("No personalServerSetRankUrl set");
    else
    {
        std::string url(Aya::format(personalServerSetRankUrl.c_str(), placeId, player->getUserID(), newRank));
        dispatchRequest(url, resumeFunction, errorFunction);
    }
}
