...
const char* const Aya::sDebugSettings = "DebugSettings";
const char* const Aya::sTaskSchedulerSettings = "TaskScheduler";
...
static Reflection::PropDescriptor<DebugSettings, std::string> prop_RobloxProductName(
    "RobloxProductName", "Profile", &DebugSettings::getRobloxProductName, NULL);
...
static Reflection::PropDescriptor<DebugSettings, std::string> prop_systemProductName(
    "SystemProductName", "Profile", &DebugSettings::systemProductName, NULL);
...
static Reflection::PropDescriptor<TaskSchedulerSettings, int> prop_ThreadPoolSize(
    "ThreadPoolSize", "Diagnostics", &TaskSchedulerSettings::threadPoolSize, NULL);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_threadAffinity(
    "ThreadAffinity", "Diagnostics", &TaskSchedulerSettings::threadAffinity, NULL);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_numSleepingJobs(
    "NumSleepingJobs", "Diagnostics", &TaskSchedulerSettings::numSleepingJobs, NULL);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_numWaitingJobs(
    "NumWaitingJobs", "Diagnostics", &TaskSchedulerSettings::numWaitingJobs, NULL);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_numRunningJobs(
    "NumRunningJobs", "Diagnostics", &TaskSchedulerSettings::numRunningJobs, NULL);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_messageRate(
    "SchedulerRate", "Diagnostics", &TaskSchedulerSettings::schedulerRate, NULL);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_messageDutyCycle(
    "SchedulerDutyCycle", "Diagnostics", &TaskSchedulerSettings::schedulerDutyCyclePerThread, NULL);
static Reflection::BoundFuncDesc<TaskSchedulerSettings, void(bool, double)> func_AddDummyJob(
    &TaskSchedulerSettings::addDummyJob, "AddDummyJob", "exclusive", true, "fps", 30, Security::LocalUser);

Reflection::BoundProp<bool> prop_SoundWarnings("ReportSoundWarnings", "Errors", &DebugSettings::soundWarnings);
static Reflection::EnumPropDescriptor<DebugSettings, DebugSettings::ErrorReporting> prop_errorReporting(
    "ErrorReporting", "Errors", &DebugSettings::getErrorReporting, &DebugSettings::setErrorReporting);
...
Reflection::BoundFuncDesc<DebugSettings, void()> func_LegacyScriptMode(
    &DebugSettings::noOpt, "LegacyScriptMode", Security::LocalUser, Reflection::Descriptor::Attributes::deprecated());
Reflection::BoundFuncDesc<DebugSettings, void(bool)> func_BlockingRemove(
    &DebugSettings::setBlockingRemove, "SetBlockingRemove", "value", Security::LocalUser);

static Reflection::EnumPropDescriptor<TaskSchedulerSettings, TaskScheduler::ThreadPoolConfig> prop_ThreadPool(
    "ThreadPoolConfig", "Configuration", &TaskSchedulerSettings::getThreadPoolConfig, &TaskSchedulerSettings::setThreadPoolConfig);
static Reflection::BoundFuncDesc<TaskSchedulerSettings, void(double, int)> func_ThreadShare(
    &TaskSchedulerSettings::setThreadShare, "SetThreadShare", "timeSlice", "numShare", Security::LocalUser);
static Reflection::EnumPropDescriptor<TaskSchedulerSettings, TaskScheduler::PriorityMethod> prop_PriorityMethod(
    "PriorityMethod", "Configuration", &TaskSchedulerSettings::getPriorityMethod, &TaskSchedulerSettings::setPriorityMethod);
static Reflection::EnumPropDescriptor<TaskSchedulerSettings, TaskScheduler::Job::SleepAdjustMethod> prop_SleepAdjustMethod(
    "SleepAdjustMethod", "Configuration", &TaskSchedulerSettings::getSleepAdjustMethod, &TaskSchedulerSettings::setSleepAdjustMethod);
static Reflection::EnumPropDescriptor<TaskSchedulerSettings, DataModelArbiter::ConcurrencyModel> prop_ConcurrencyModel(
    "Concurrency", "Configuration", &TaskSchedulerSettings::getConcurrencyModel, &TaskSchedulerSettings::setConcurrencyModel);
static Reflection::PropDescriptor<TaskSchedulerSettings, bool> prop_IsArbiterThrottled(
    "AreArbitersThrottled", "Configuration", &TaskSchedulerSettings::getIsArbiterThrottled, &TaskSchedulerSettings::setIsArbiterThrottled);
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_ThrottledJobSleepTime(
    "ThrottledJobSleepTime", "Configuration", &TaskSchedulerSettings::getThrottledJobSleepTime, &TaskSchedulerSettings::setThrottledJobSleepTime);

#if HANG_DETECTION
static Reflection::PropDescriptor<TaskSchedulerSettings, double> prop_StepTimeThreshold(
    "StepTimeThreshold", "Configuration", &TaskSchedulerSettings::getStepTimeThreshold, &TaskSchedulerSettings::setStepTimeThreshold);
#endif

static Reflection::PropDescriptor<DebugSettings, bool> prop_Profiling(
    "IsProfilingEnabled", "Benchmarking", &DebugSettings::getIsProfilingEnabled, &DebugSettings::setIsProfilingEnabled);
static Reflection::PropDescriptor<DebugSettings, double> prop_ProfilingWindow(
    "ProfilingWindow", "Benchmarking", &DebugSettings::getProfilingWindow, &DebugSettings::setProfilingWindow);
static Reflection::EnumPropDescriptor<DebugSettings, Time::SampleMethod> prop_PrecisionOverride(
    "TickCountPreciseOverride", "Benchmarking", &DebugSettings::getTickCountPreciseOverride, &DebugSettings::setTickCountPreciseOverride);
...
static Reflection::PropDescriptor<DebugSettings, int> prop_LuaRamLimit(
    "LuaRamLimit", "Limits", &DebugSettings::getLuaRamLimit, &DebugSettings::setLuaRamLimit);
REFLECTION_END();
...
{
    return Aya::LuaAllocator::heapLimit;
}
void DebugSettings::setLuaRamLimit(int value)
{
    Aya::LuaAllocator::heapLimit = value;
}
...
public:
    ...
    DummyJob(bool exclusive, double fps)
        : Job(Aya::format("DummyJob%s %gfps", exclusive ? "Exclusive" : "", fps).c_str(), dummyArbiter)
        , exclusive(exclusive)
        , fps(fps)
    {
    }
