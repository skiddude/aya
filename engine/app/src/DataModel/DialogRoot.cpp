...
// static Reflection::PropDescriptor<DialogRoot, bool> prop_PublicChat("Public", category_Data, &DialogRoot::getPublicChat,
// &DialogRoot::setPublicChat);
...
static Reflection::RemoteEventDesc<DialogRoot, void(shared_ptr<Instance>, shared_ptr<Instance>)> event_DialogChoiceSelected(
    &DialogRoot::dialogChoiceSelected, "DialogChoiceSelected", "player", "dialogChoice", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::BROADCAST);
REFLECTION_END();
...
DialogRoot::~DialogRoot()
{
    ...
    {
        // Aya::removeWriteBreakpoint(reinterpret_cast<uintptr_t>(&initialPrompt));
    }
#endif
}
...
void DialogRoot::setInitialPrompt(std::string value)
{
    ...
    {
        // Aya::addWriteBreakpoint(reinterpret_cast<uintptr_t>(&initialPrompt));
    }
#endif
}
