...
private:
    ...
    std::string url;
    Aya::Timer<Aya::Time::Fast> retryTimer;
...
public:
    ...
    void TeleportToSpawnByName(int placeId, std::string spawnName, shared_ptr<Instance> characterOrPlayerInstance, Reflection::Variant teleportData,
        shared_ptr<Instance> customLoadingGUI);
    void TeleportToPrivateServer(int placeId, std::string reservedServerAccessCode, shared_ptr<const Instances> players, std::string spawnName,
        Reflection::Variant teleportData, shared_ptr<Instance> customLoadingGUI);

    void ProcessGrantAccessSuccess(shared_ptr<const Instances> players, shared_ptr<Reflection::ValueTable> teleportInfo,
        shared_ptr<Instance> customLoadingGUI, std::string response);
    ...
    void ProcessReserveServerResultsSuccess(
    ...
    void ProcessGetPlayerPlaceInstanceResultsSuccess(std::string response, boost::function<void(shared_ptr<const Reflection::Tuple>)> resumeFunction,
        boost::function<void(std::string)> errorFunction);
    void ProcessGetPlayerPlaceInstanceResultsError(std::string error, boost::function<void(std::string)> errorFunction);

    void GetPlayerPlaceInstanceAsync(
    ...
    void TeleportToPlaceInstance(int placeId, std::string instanceId, shared_ptr<Instance> characterOrPlayerInstance, std::string spawnName,
        Reflection::Variant teleportData, shared_ptr<Instance> customLoadingGUI);
    ...
    void sendPlayerArrivedFromTeleportSignal(shared_ptr<Instance> loadingGui, Reflection::Variant teleportDataTable)
    {
        playerArrivedFromTeleportSignal(loadingGui, teleportDataTable);
    }
    Aya::signal<void(shared_ptr<Instance>, Reflection::Variant)> playerArrivedFromTeleportSignal;
    static int getPreviousPlaceId()
    {
        return previousPlaceId;
    }
    static int getPreviousCreatorType()
    {
        return previousCreatorType;
    }
    static int getPreviousCreatorId()
    {
        return previousCreatorId;
    }
    static boost::shared_ptr<Instance> getCustomTeleportLoadingGui()
    {
        return customTeleportLoadingGui;
    }
    static void setCustomTeleportLoadingGui(shared_ptr<Instance> value)
    {
        customTeleportLoadingGui = value;
    }
    boost::shared_ptr<Instance> getTempCustomTeleportLoadingGui()
    {
        return tempCustomTeleportLoadingGui;
    }
    void setTempCustomTeleportLoadingGui(shared_ptr<Instance> value)
    {
        tempCustomTeleportLoadingGui = value;
    }
    static bool didTeleport()
    {
        return teleported;
    }
    static Reflection::Variant getDataTable()
    {
        return dataTable;
    }
