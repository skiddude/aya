...
protected:
    ...
    // PVInstance
    /*override*/ bool hitTestImpl(const class Aya::RbxRay& worldRay, G3D::Vector3& worldHitPoint);
...
public:
    ...
    void setModelInPrimary(const CoordinateFrame& set)
    {
        modelInPrimary = set;
    }
    ...
    bool containedByFrustum(const class Aya::Frustum& frustrum) const;
    ...
    float computeLargestMoment() const; // kg*Aya^2
    std::vector<PartInstance*> getDescendantPartInstances() const;

    static const G3D::Color4& primaryPartSelectColor()
    {
        return sPrimaryPartSelectColor;
    }
    static void setPrimaryPartSelectColor(const G3D::Color4& color)
    {
        sPrimaryPartSelectColor = color;
    }

    static const G3D::Color4& primaryPartHoverOverColor()
    {
        return sPrimaryPartHoverOverColor;
    }
    static void setPrimaryPartHoverOverColor(const G3D::Color4& color)
    {
        sPrimaryPartHoverOverColor = color;
    }

    static float primaryPartLineThickness()
    {
        return sPrimaryPartLineThickness;
    }
    static void setPrimaryPartLineThickness(float thickness)
    {
        sPrimaryPartLineThickness = thickness;
    }
