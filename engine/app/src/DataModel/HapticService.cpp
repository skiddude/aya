...
static Reflection::BoundFuncDesc<HapticService, bool(InputObject::UserInputType)> func_isVibrationSupported(
    &HapticService::isVibrationSupported, "IsVibrationSupported", "inputType", Security::None);
static Reflection::BoundFuncDesc<HapticService, bool(InputObject::UserInputType, HapticService::VibrationMotor)> func_isMotorSupported(
    &HapticService::isMotorSupported, "IsMotorSupported", "inputType", "vibrationMotor", Security::None);

static Reflection::BoundFuncDesc<HapticService,
    void(InputObject::UserInputType, HapticService::VibrationMotor, shared_ptr<const Aya::Reflection::Tuple>)>
    func_setMotor(&HapticService::setMotor, "SetMotor", "inputType", "vibrationMotor", "vibrationValues", Security::None);
static Reflection::BoundFuncDesc<HapticService, shared_ptr<const Aya::Reflection::Tuple>(InputObject::UserInputType, HapticService::VibrationMotor)>
    func_getMotor(&HapticService::getMotor, "GetMotor", "inputType", "vibrationMotor", Security::None);
REFLECTION_END();
...
shared_ptr<const Aya::Reflection::Tuple> HapticService::getMotor(InputObject::UserInputType inputType, HapticService::VibrationMotor vibrationMotor)
{
    ...
    shared_ptr<const Aya::Reflection::Tuple> tuple(Aya::make_shared<Reflection::Tuple>());
    return tuple;
}

void HapticService::setMotor(
    InputObject::UserInputType inputType, HapticService::VibrationMotor vibrationMotor, shared_ptr<const Aya::Reflection::Tuple> args)
{
    if (args && !args->values.empty())
    {
        if (inputType == InputObject::TYPE_NONE)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Error in HapticService:SetMotor inputType is not a valid type");
            return;
        }
        if (vibrationMotor == MOTOR_NONE)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Error in HapticService:SetMotor vibrationMotor is not a valid type");
            return;
        }
    ...
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Error in HapticService:SetMotor no values found for vibration.");
    }
}
