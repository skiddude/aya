...
const Reflection::PropDescriptor<SelectionSphere, Color3> prop_SurfaceColor("SurfaceColor3", category_Appearance, &SelectionSphere::getSurfaceColor,
    &SelectionSphere::setSurfaceColor, Reflection::PropertyDescriptor::STANDARD);
const Reflection::PropDescriptor<SelectionSphere, BrickColor> prop_depSurfaceBrickColor("SurfaceColor", category_Appearance,
    &SelectionSphere::getSurfaceBrickColor, &SelectionSphere::setSurfaceBrickColor,
    Reflection::PropertyDescriptor::Attributes::deprecated(prop_SurfaceColor, Reflection::PropertyDescriptor::LEGACY_SCRIPTING));

const Reflection::PropDescriptor<SelectionSphere, float> prop_SurfaceTransparency(
    "SurfaceTransparency", category_Appearance, &SelectionSphere::getSurfaceTransparency, &SelectionSphere::setSurfaceTransparency);
