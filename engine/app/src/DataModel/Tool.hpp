...
public:
    ...
    class special_equipped_signal : public Aya::signals::signal_with_args<1, void(shared_ptr<Instance>)> // Aya::signal<void(shared_ptr<Instance>)>
    {
    private:
        typedef Aya::signals::signal_with_args<1, void(shared_ptr<Instance>)> Super;
    ...
    public:
        ...
        Aya::signals::connection connect(Delegate& function)
        {
            Aya::signals::connection result = Super::connect(function);
...
private:
    ...
    Aya::signals::scoped_connection torsoChildAdded;
    Aya::signals::scoped_connection torsoChildRemoved;
    Aya::signals::scoped_connection armChildAdded;
    ...
    {
        return (backendToolState >= EQUIPPED);
    }
...
public:
    ...
    Aya::remote_signal<void()> activatedSignal;
    Aya::signal<void()> unequippedSignal;
    Aya::remote_signal<void()> deactivatedSignal;
    ...
    void setDroppable(bool newDroppable)
    {
        droppable = newDroppable;
    }
    bool getRequiresHandle() const
    {
        return requiresHandle;
    }
    ...
    const CoordinateFrame& getGrip() const
    {
        return grip;
    }
    ...
    bool getManualActivationOnly() const
    {
        return manualActivationOnly;
    }
