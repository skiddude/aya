...
public:
    Aya::signals::scoped_connection p0AncestorChangedConnection;
    Aya::signals::scoped_connection p1AncestorChangedConnection;
    ...
    void setP0(Primitive* prim)
    {
        p0 = prim;
    }
    void setP1(Primitive* prim)
    {
        p1 = prim;
    }
    void setS0(size_t surfID)
    {
        s0 = surfID;
    }
    void setS1(size_t surfID)
    {
        s1 = surfID;
    }

    const Primitive* getP0(void)
    {
        return p0;
    }
    const Primitive* getP1(void)
    {
        return p1;
    }

    const size_t& getSurf0(void)
    {
        return s0;
    }
    const size_t& getSurf1(void)
    {
        return s1;
    }

    virtual void dynamicDraw(Adorn* adorn) = 0;
    virtual void createJoint(void)
    { /* override to create joints */
    }
};
...
{
public:
    AutoJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    StudAutoJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : AutoJointSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    WeldAutoJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : AutoJointSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    GlueAutoJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : AutoJointSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    HingeAutoJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : AutoJointSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    DisallowedJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    FeatureSnapJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    ManualJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
public:
    TerrainManualJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
    ...
    void setCellIndex(Vector3int16& value)
    {
        cellIndex = value;
    }
};
...
public:
    DisallowedTerrainJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
{
public:
    SmoothTerrainManualJointSurfacePair(const Primitive& p0, size_t& face0Id, const Primitive& p1, size_t& face1Id)
        : ConstraintSurfacePair(p0, face0Id, p1, face1Id)
    {
    }
...
public:
    ...
    unsigned int getNumJointSurfacePairs(void)
    {
        return jointSurfacePairs.size();
    }
    bool autoJointsWereDetected(void)
    {
        return autoJointsDetected;
    }
    void createJoints();
    ...
    void clearSelectedPrimitives(void)
    {
    ...
    // IAdornable
    void setDisplayPotentialJoints(bool value)
    {
        displayPotentialJoints = value;
    }
    bool shouldRender3dAdorn() const
    {
        return true;
    }
