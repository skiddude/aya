...
public:
    ...
    virtual Aya::HandleType getHandleType() const
    {
        return Aya::HANDLE_RESIZE;
    }
...
protected:
    ...
    virtual int getHandlesNormalIdMask() const
    {
        return 0;
    }
    ...
    bool getAngleRadiusFromHandle(const shared_ptr<InputObject>& inputObject, NormalId faceId, const Vector3& hitPointWorld, float& angle,
