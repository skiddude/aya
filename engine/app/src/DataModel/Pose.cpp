...
static Reflection::EnumPropDescriptor<Pose, Pose::PoseEasingStyle> prop_EasingStyle(
    "EasingStyle", category_Data, &Pose::getEasingStyle, &Pose::setEasingStyle);
static Reflection::EnumPropDescriptor<Pose, Pose::PoseEasingDirection> prop_EasingDirection(
    "EasingDirection", category_Data, &Pose::getEasingDirection, &Pose::setEasingDirection);

namespace Reflection
{
template<>
EnumDesc<Aya::Pose::PoseEasingStyle>::EnumDesc()
...
template<>
EnumDesc<Aya::Pose::PoseEasingDirection>::EnumDesc()
