...
namespace
{
bool computeNetworkOwnerIsSomeoneElseImpl(const Aya::SystemAddress& address, const Aya::SystemAddress& localAddress)
{
    bool networkOwnerAssigned =
        ((address != Aya::Network::NetworkOwner::Unassigned()) && (address != Aya::Network::NetworkOwner::ServerUnassigned()));
...
bool currentSecurityIdentityIsScript()
{
    ...
    if (securityContext.identity == Aya::Security::LocalGUI_ || securityContext.identity == Aya::Security::GameScript_ ||
        securityContext.identity == Aya::Security::GameScriptInRobloxPlace_ || securityContext.identity == Aya::Security::RobloxGameScript_ ||
#if defined(AYA_STUDIO)
        securityContext.identity == Aya::Security::StudioPlugin ||
#endif
        securityContext.identity == Aya::Security::CmdLine_)
    {
        return true;
    }
    else
...
static const Aya::Name& namePart = Aya::Name::declare(sPart);
static const Aya::Name& nameCFrame = Aya::Name::declare("CFrame");
static const Aya::Name& namePosition = Aya::Name::declare("Position");
...
const PropDescriptor<PartInstance, CoordinateFrame> PartInstance::prop_CFrame(
    "CFrame", category_Data, &PartInstance::getCoordinateFrame, &PartInstance::setCoordinateFrameRoot);
static const PropDescriptor<PartInstance, Vector3> prop_PositionUi(
    "Position", category_Data, &PartInstance::getTranslationUi, &PartInstance::setTranslationUi, PropertyDescriptor::UI);
static const PropDescriptor<PartInstance, Vector3> prop_RotationUi(
    "Rotation", category_Data, &PartInstance::getRotationUi, &PartInstance::setRotationUi, PropertyDescriptor::UI);
const PropDescriptor<PartInstance, Vector3> PartInstance::prop_Velocity(
    "Velocity", category_Data, &PartInstance::getLinearVelocity, &PartInstance::setLinearVelocity);
const PropDescriptor<PartInstance, Vector3> PartInstance::prop_RotVelocity(
    "RotVelocity", category_Data, &PartInstance::getRotationalVelocity, &PartInstance::setRotationalVelocityRoot);
static const PropDescriptor<PartInstance, float> prop_Density(
    "SpecificGravity", category_Data, &PartInstance::getSpecificGravity, NULL, Reflection::PropertyDescriptor::UI);
REFLECTION_END();
...
static BoundFuncDesc<PartInstance, void()> dep_breakJoints(
    &PartInstance::destroyJoints, "breakJoints", Security::None, Reflection::Descriptor::Attributes::deprecated(desc_unjoin));
...
static BoundFuncDesc<PartInstance, shared_ptr<const Instances>(bool)> desc_getConnectedParts(
    &PartInstance::getConnectedParts, "GetConnectedParts", "recursive", false, Security::None);
...
static BoundFuncDesc<PartInstance, CoordinateFrame()> desc_getRenderingCFrame(
    &PartInstance::calcRenderingCoordinateFrame, "GetRenderCFrame", Security::None);

// Network Ownership API
static BoundFuncDesc<PartInstance, void(shared_ptr<Instance>)> desc_setNetOwner(
    &PartInstance::setNetworkOwnerScript, "SetNetworkOwner", "playerInstance", shared_ptr<Instance>(), Security::None);
...
static BoundFuncDesc<PartInstance, void()> desc_setNetOwnershipAuto(
    &PartInstance::setNetworkOwnershipAuto, "SetNetworkOwnershipAuto", Security::None);
static BoundFuncDesc<PartInstance, bool()> desc_getNetOwnershipIsAuto(
    &PartInstance::getNetworkOwnershipAuto, "GetNetworkOwnershipAuto", Security::None);
static BoundFuncDesc<PartInstance, shared_ptr<const Reflection::Tuple>()> desc_canSetNetworkOwnershipScript(
    &PartInstance::canSetNetworkOwnershipScript, "CanSetNetworkOwnership", Security::None);

// shape, size, form factor - both UI and streaming
const PropDescriptor<PartInstance, Aya::Vector3> prop_Siz(
    "siz", category_Part, NULL, &PartInstance::setPartSizeXml, PropertyDescriptor::LEGACY); // Used to prepare for TA14264
const PropDescriptor<PartInstance, Aya::Vector3> PartInstance::prop_Size(
    "size", category_Part, &PartInstance::getPartSizeXml, &PartInstance::setPartSizeXml, PropertyDescriptor::STREAMING);
static const PropDescriptor<PartInstance, Aya::Vector3> prop_SizeUi(
    "Size", category_Part, &PartInstance::getPartSizeUi, &PartInstance::setPartSizeUi, PropertyDescriptor::UI);

const PropDescriptor<PartInstance, float> PartInstance::prop_Elasticity(
    "Elasticity", category_Part, &PartInstance::getElasticity, &PartInstance::setElasticity);
const PropDescriptor<PartInstance, float> PartInstance::prop_Friction(
    "Friction", category_Part, &PartInstance::getFriction, &PartInstance::setFriction);
const PropDescriptor<PartInstance, PhysicalProperties> PartInstance::prop_CustomPhysicalProperties(
    "CustomPhysicalProperties", category_Part, &PartInstance::getPhysicalProperties, &PartInstance::setPhysicalProperties);

// color, transparency, reflectance, anchored, canCollide, canTouch, locked
const PropDescriptor<PartInstance, Color3> PartInstance::prop_Color(
    "Color", category_Appearance, &PartInstance::getColor3, &PartInstance::setColor3, PropertyDescriptor::NO_XML_WRITE);
const PropDescriptor<PartInstance, Color3uint8> PartInstance::prop_Color3uint8(
    "Color3uint8", category_Appearance, &PartInstance::getColor3, &PartInstance::setColor3, PropertyDescriptor::STREAMING);
const PropDescriptor<PartInstance, BrickColor> PartInstance::prop_BrickColor(
    "BrickColor", category_Appearance, &PartInstance::getColor, &PartInstance::setColor);
const PropDescriptor<PartInstance, BrickColor> prop_BrickColorDep("brickColor", category_Appearance, &PartInstance::getColor, &PartInstance::setColor,
    PropertyDescriptor::Attributes::deprecated(PartInstance::prop_BrickColor));
const EnumPropDescriptor<PartInstance, PartMaterial> PartInstance::prop_renderMaterial(
    "Material", category_Appearance, &PartInstance::getRenderMaterial, &PartInstance::setRenderMaterial);
const PropDescriptor<PartInstance, float> PartInstance::prop_Transparency(
    "Transparency", category_Appearance, &PartInstance::getTransparencyXml, &PartInstance::setTransparency);
// DFFlagNetworkOwnershipRuleReplicates
// Temporary Hack that allows use to Replicate Network Ownerhip
static const PropDescriptor<PartInstance, bool> prop_networkOwnershipRuleBool("NetworkOwnershipRuleBool", category_Behavior,
    &PartInstance::getNetworkOwnershipManualReplicate, &PartInstance::setNetworkOwnershipManualReplicate, PropertyDescriptor::REPLICATE_ONLY);
// DFFlagNetworkOwnershipRuleReplicates -> Commented Out for now because cannot introduce new Enum safely
// static const EnumPropDescriptor<PartInstance, NetworkOwnership> prop_networkOwnershipRule("NetworkOwnershipRule", category_Behavior,
// &PartInstance::getNetworkOwnershipRule, &PartInstance::setNetworkOwnershipRule, PropertyDescriptor::REPLICATE_ONLY); Client side only
// LocalTransparencyModifier property
const PropDescriptor<PartInstance, float> PartInstance::prop_LocalTransparencyModifier("LocalTransparencyModifier", category_Data,
    &PartInstance::getLocalTransparencyModifier, &PartInstance::setLocalTransparencyModifier, PropertyDescriptor::HIDDEN_SCRIPTING);
const PropDescriptor<PartInstance, float> PartInstance::prop_Reflectance(
    "Reflectance", category_Appearance, &PartInstance::getReflectance, &PartInstance::setReflectance);
const PropDescriptor<PartInstance, bool> PartInstance::prop_Locked(
    "Locked", category_Behavior, &PartInstance::getPartLocked, &PartInstance::setPartLocked);
const PropDescriptor<PartInstance, bool> PartInstance::prop_Anchored(
    "Anchored", category_Behavior, &PartInstance::getAnchored, &PartInstance::setAnchored);
const PropDescriptor<PartInstance, bool> PartInstance::prop_CanCollide(
    "CanCollide", "Collision", &PartInstance::getCanCollide, &PartInstance::setCanCollide);
const PropDescriptor<PartInstance, bool> PartInstance::prop_CanTouch("CanTouch", "Collision", &PartInstance::getCanTouch, &PartInstance::setCanTouch);

const PropDescriptor<PartInstance, Faces> prop_ResizeableFaces(
    "ResizeableFaces", category_Behavior, &PartInstance::getResizeHandleMask, NULL, PropertyDescriptor::UI);
const PropDescriptor<PartInstance, int> prop_ResizeIncrement(
    "ResizeIncrement", category_Behavior, &PartInstance::getResizeIncrement, NULL, PropertyDescriptor::UI);
...
const BoundFuncDesc<PartInstance, bool(NormalId, int)> desc_dep_resize(
    &PartInstance::resize, "resize", "normalId", "deltaAmount", Security::None, Descriptor::Attributes::deprecated(desc_resize));

const BoundFuncDesc<PartInstance, shared_ptr<const Instances>()> func_getTouchingParts(
    &PartInstance::getTouchingParts, "GetTouchingParts", Security::None);


// Used for network communication - streamed, not in the UI
// Nuked "v1" because the "" empty string is no longer legal
const PropDescriptor<PartInstance, Aya::SystemAddress> PartInstance::prop_NetworkOwner(
    "NetworkOwnerV3", category_Data, &PartInstance::getNetworkOwner, &PartInstance::setNetworkOwner, PropertyDescriptor::REPLICATE_ONLY);
static RemoteEventDesc<PartInstance, void(Aya::SystemAddress), Aya::remote_signal<void(Aya::SystemAddress)>,
    Aya::remote_signal<void(Aya::SystemAddress)>* (PartInstance::*)(bool)>
    event_NetworkOwnerChanged(&PartInstance::getOrCreateNetworkOwnerChangedSignal, "NetworkOwnerChanged", "systemAddress", Security::LocalUser,
        RemoteEventCommon::REPLICATE_ONLY, RemoteEventCommon::CLIENT_SERVER);
const PropDescriptor<PartInstance, bool> PartInstance::prop_NetworkIsSleeping(
    "NetworkIsSleeping", category_Data, &PartInstance::getNetworkIsSleeping, &PartInstance::setNetworkIsSleeping, PropertyDescriptor::REPLICATE_ONLY);
#ifdef AYA_TEST_BUILD
EventDesc<PartInstance, void(float, float)> event_OwnershipChange(
    &PartInstance::ownershipChangeSignal, "OwnershipChange", "binaryAddress", "port", Security::None);
#endif

// New way of reporting touches
EventDesc<PartInstance, void(shared_ptr<Instance>), Aya::signal<void(shared_ptr<Instance>)>,
    Aya::signal<void(shared_ptr<Instance>)>* (PartInstance::*)(bool)>
    event_LocalSimulationTouched(&PartInstance::getOrCreateLocalSimulationTouchedSignal, "LocalSimulationTouched", "part");

EventDesc<PartInstance, void(shared_ptr<Instance>), PartInstance::TouchedSignal, PartInstance::TouchedSignal* (PartInstance::*)(bool)> event_Touched(
    &PartInstance::getOrCreateTouchedSignal, "Touched", "otherPart");

EventDesc<PartInstance, void(shared_ptr<Instance>), PartInstance::TouchedSignal, PartInstance::TouchedSignal* (PartInstance::*)(bool)> dep_Touched(
    &PartInstance::getOrCreateTouchedSignal, "touched", "otherPart", Reflection::Descriptor::Attributes::deprecated(event_Touched));

EventDesc<PartInstance, void(shared_ptr<Instance>), PartInstance::TouchedSignal, PartInstance::TouchedSignal* (PartInstance::*)(bool)>
    event_TouchEnded(&PartInstance::getOrCreateTouchedEndedSignal, "TouchEnded", "otherPart");

EventDesc<PartInstance, void(shared_ptr<Instance>), Aya::signal<void(shared_ptr<Instance>)>,
    Aya::signal<void(shared_ptr<Instance>)>* (PartInstance::*)(bool)>
    dep_StoppedTouching(&PartInstance::getOrCreateDeprecatedStoppedTouchingSignal, "StoppedTouching", "otherPart",
        Reflection::Descriptor::Attributes::deprecated(event_TouchEnded));

EventDesc<PartInstance, void(), Aya::signal<void()>, Aya::signal<void()>* (PartInstance::*)(bool)> event_OutfitChanged(
    &PartInstance::getOrCreateOutfitChangedSignal, "OutfitChanged");

// Temporary property for handling concurrent drags
const PropDescriptor<PartInstance, bool> prop_Dragging(
    "DraggingV1", category_Behavior, &PartInstance::getDragging, &PartInstance::setDragging, PropertyDescriptor::REPLICATE_ONLY);
const PropDescriptor<PartInstance, float> PartInstance::prop_ReceiveAge(
    "ReceiveAge", category_Part, &PartInstance::getReceiveInterval, NULL, PropertyDescriptor::HIDDEN_SCRIPTING);
...
{
    AYAASSERT(!onDemandRead() || onDemandRead()->touchTransmitter == NULL);
...
{
    AYA_CRASH_ASSERT(!onDemandRead() || onDemandRead()->touchedSlotCount >= 0);
    if (++(onDemandWrite()->touchedSlotCount) == 1)
        // TODO: This isn't thread-safe, as it might appear
        addTouchTransmitter();
    AYA_CRASH_ASSERT(onDemandRead()->touchedSlotCount >= 0);
}
...
PartInstance::PartInstance(const Vector3& initialSize)
    ...
    , color3(BrickColor::defaultColor().color3uint8())
    , transparency(0.0f)
    , reflectance(0.0f)
...
PartInstance::~PartInstance()
{
    ...
    AYAASSERT(getPartPrimitive());
    AYAASSERT(getPartPrimitive()->getClump() == NULL);
    AYAASSERT(getPartPrimitive()->getWorld() == NULL);
}
...
{
    AYAASSERT(!getPartPrimitive()->getWorld()); // not in workspace!
...
bool PartInstance::aligned(bool useGlobalGridSetting) const
{
    ...
    if (isAligned)
    {
        ...
        AYAASSERT(delta < (Tolerance::maxOverlapOrGap() * 0.5));
    }
#endif
    return isAligned;
}
...
bool PartInstance::reportTouches() const
{
    ...
    return this->canTouch ? (hasTouchedSignalConnections || hasTouchTransmitter() || this->findConstFirstChildOfType<TouchTransmitter>()) : false;
}


void PartInstance::primitivesToParts(const G3D::Array<Primitive*>& primitives, std::vector<shared_ptr<PartInstance>>& parts)
{
...
bool PartInstance::nonNullInWorkspace(const shared_ptr<PartInstance>& part)
{
    ...
    AYAASSERT(!answer || part->getPartPrimitive()->inPipeline());
    return answer;
}

bool PartInstance::partIsLegacyCustomPhysProperties(const PartInstance* part)
{
    return (!part->getConstPartPrimitive()->getConstGeometry()->isTerrain() && !part->getPhysicalProperties().getCustomEnabled() &&
...
void PartInstance::convertToNewPhysicalPropRecursive(Aya::Instance* instance)
{
    if (PartInstance* part = Instance::fastDynamicCast<PartInstance>(instance))
    {
...
bool PartInstance::instanceOrChildrenContainsNewCustomPhysics(Aya::Instance* instance)
{
    if (PartInstance* part = Instance::fastDynamicCast<PartInstance>(instance))
    {
        if (!part->getPartPrimitive()->getGeometry()->isTerrain() && part->getPhysicalProperties().getCustomEnabled())
        {
            return true;
        }
    }
...
void PartInstance::onSleepingChanged(bool sleeping)
{
    ...
    AYAASSERT(sleeping == getSleeping());
    if (onDemandRead())
...
{
    return p ? aya_static_cast<PartInstance*>(p->getOwner()) : NULL;
}
...
bool PartInstance::computeSurfacesNeedAdorn() const
{
    for (int i = 0; i < 6; ++i)
    {
        ...
        if (type == ROTATE || type == ROTATE_P || type == ROTATE_V)
        {
            return true;
        }
    }
...
Part PartInstance::getPart()
{
    ...
    return Part(getPartType(), getConstPartPrimitive()->getSize(), Color4(getColor3(), alpha()), surf6, calcRenderingCoordinateFrame());
}
...
void PartInstance::updatePrimitiveState()
{
    ...
    if (world != oldWorld)
    {
        AYAASSERT(oldWorld || (getPartPrimitive()->getClump() == NULL));
        ...
        if (world)
        {
            ...
            const Aya::SystemAddress localAddress = Aya::Network::Players::findLocalSimulatorAddress(this);
            ...
            if (getNetworkOwner() == Aya::Network::NetworkOwner::Unassigned())
            {
                if (Aya::Network::Player* player = Aya::Network::Players::findLocalPlayer(this))
                {
                ...
                {
                    getPartPrimitive()->setNetworkOwner(Aya::Network::NetworkOwner::ServerUnassigned());
                }
            }
...
bool PartInstance::shouldRender3dAdorn() const
{
    return ((getTransparencyUi() < 1.0f) &&
            (computeSurfacesNeedAdorn() || PartInstance::showContactPoints || PartInstance::showJointCoordinates ||
                PartInstance::highlightSleepParts || PartInstance::highlightAwakeParts || PartInstance::showBodyTypes ||
                PartInstance::showPartCoordinateFrames || PartInstance::showAnchoredParts || PartInstance::showUnalignedParts ||
                PartInstance::showSpanningTree || Workspace::showEPhysicsOwners || Workspace::showEPhysicsRegions || PartInstance::showMechanisms ||
                PartInstance::showAssemblies || PartInstance::showReceiveAge || PartInstance::showInterpolationPath));
}
...
void PartInstance::render3dAdorn(Adorn* adorn)
{
    ...
    {
        Draw::partAdorn(getPart(), adorn, Color3::gray());
    }
    ...
    if (PartInstance::highlightSleepParts && getPartPrimitive()->getAssembly())
    {
        ...
        if ((sleepStatus != Sim::ANCHORED) && (sleepStatus != Sim::AWAKE))
        {
            ...
            case Sim::RECURSIVE_WAKE_PENDING:
                sleepColor = Color3::purple();
                break;
            case Sim::WAKE_PENDING:
                sleepColor = Color3::purple();
                break;
            case Sim::SLEEPING_CHECKING:
                sleepColor = Color3::orange();
                break;
            case Sim::SLEEPING_DEEPLY:
                sleepColor = Color3::yellow();
                break;
            default:
                AYAASSERT(0);
                break;
    ...
    if (PartInstance::highlightAwakeParts && getPartPrimitive()->getAssembly())
    {
        ...
        if ((sleepStatus != Sim::ANCHORED) && (sleepStatus != Sim::SLEEPING_DEEPLY))
        {
            ...
            {
            case Sim::AWAKE:
                wakeColor = Color3::red();
                break;
            case Sim::SLEEPING_CHECKING:
                wakeColor = Color3::orange();
                break;
            case Sim::RECURSIVE_WAKE_PENDING:
                wakeColor = Color3::purple();
                break;
            case Sim::WAKE_PENDING:
                wakeColor = Color3::purple();
                break;
    ...
    if (PartInstance::showBodyTypes)
    {
        ...
        if (body && world)
        {
            ...
            if (simBody->isInKernel())
            {
                ...
                {
                    AYAASSERT(simBody->isContactBody());
    ...
    if (PartInstance::showAnchoredParts && getAnchored())
    {
        DrawAdorn::partSurface(
            getPart(), Math::getClosestObjectNormalId(Vector3(0, -1, 0), getCoordinateFrame().rotation), adorn, G3D::Color4(Color3::gray(), alpha()));
    }
    ...
    if (PartInstance::showSpanningTree)
    {
        if (getPartPrimitive()->getMechanism())
        {
            if (Mechanism::isMechanismRootPrimitive(getPartPrimitive()))
            {
                ...
                adorn->box(AABox(-boxSize, boxSize), (primitiveAnchoredInEngine ? Color3::red() : Color3::orange()));
            }
            else if (Mechanism::getRootMovingPrimitive(getPartPrimitive()) == getPartPrimitive())
            {
                adorn->setObjectToWorldMatrix(getCoordinateFrame().translation);
                Vector3 boxSize(Vector3::one() * 0.40);
                adorn->box(AABox(-boxSize, boxSize), (Color3::blue()));
            }
    ...
    if (Workspace::showEPhysicsOwners)
    {
        if (this->getPartPrimitive()->getAssembly())
        {
            ...
            {
                const Aya::SystemAddress& systemAddress = PartInstance::fromPrimitive(movingRoot)->getNetworkOwner();
                Color3 color = Aya::Network::NetworkOwner::colorFromAddress(systemAddress);
                ...
                Draw::selectionBox(getPart(), adorn, color);
            }
        }
    }
    ...
    if (PartInstance::showAssemblies)
    {
        ...
        {
            Draw::selectionBox(getPart(), adorn, Aya::Color::colorFromPointer(a));
        }
    }
    if (PartInstance::showMechanisms)
    {
        ...
        {
            Draw::selectionBox(getPart(), adorn, Aya::Color::colorFromPointer(m));
        }
    }
}
...
{
    Draw::selectionBox(getPart(), adorn, selectState, 0.02f);
}
...
bool PartInstance::hitTestImpl(const Aya::RbxRay& worldRay, Vector3& worldHitPoint)
{
    Aya::RbxRay rayInPartCoords = getCoordinateFrame().toObjectSpace(worldRay);
...
{
    AYAASSERT(getPartPrimitive());
    AYAASSERT_IF_VALIDATING(!getPartPrimitive()->hasAutoJoints());
...
void PartInstance::addInterpolationSample(
    const CoordinateFrame& value, const Velocity& velocity, const RemoteTime& timeStamp, Time now, float localTimeOffest, int numNodesAhead)
{
...
void PartInstance::setPhysics(const CoordinateFrame& value)
{
    ...
    {
        AYAASSERT_IF_VALIDATING(Math::isOrthonormal(value.rotation));
...
{
    AYAASSERT(this->getConstPartPrimitive()->getConstMechanism() == mechanismRootPart->getConstPartPrimitive()->getConstMechanism());
    AYAASSERT(
        mechanismRootPart->getConstPartPrimitive()->getConstMechanism()->getConstMechanismPrimitive() == mechanismRootPart->getConstPartPrimitive());
...
CoordinateFrame PartInstance::calcRenderingCoordinateFrame(const Time& t)
{
    ...
    if (DFFlag::HumanoidFloorPVUpdateSignal && !PartInstance::disableInterpolation && m && (!networkOwnerIsSomeoneElse))
    {
        ...
        Humanoid* humanoid = Aya::Humanoid::modelIsCharacter(mechRootPart->getParent());
        if (humanoid && humanoid->getLastFloor())
        {
            ...
            if (floorPart)
            {
                ...
                return CoordinateFrame(getCoordinateFrame().rotation) +
                       floorPart->calcRenderingCoordinateFrameImpl(t).pointToWorldSpace(localDeltaToChar);
            }
        }
    }
...
const Vector3 PartInstance::getRotationUi() const
{
    ...
    Vector3 v(Math::radiansToDegrees(x), Math::radiansToDegrees(y), Math::radiansToDegrees(z));
    return v;
}
...
Aya::Vector3 PartInstance::getPrincipalMoment() const
{
...
void PartInstance::setPartSizeXml(const Vector3& rbxSize)
{
    if (DFFlag::FixShapeChangeBug)
    {
        ...
        {
            AYAASSERT_VERY_FAST(!getPartPrimitive()->hasAutoJoints());
    ...
    else
    {
        if (rbxSize != getPartSizeXml())
        {
            ...
            // TODO: ASSERT
            // AYAASSERT(newRbxSize.max(Vector3(1.0, plateHeight(), 1.0)) == newRbxSize);
...
void PartInstance::onNetworkIsSleepingChanged(Time now)
{
    ...
    {
        AYAASSERT(!now.isZero()); // setNetworkIsSleeping passes 0 for speed when waking up.
        if (DFFlag::CleanUpInterpolationTimestamps)
        {
            if (renderingCoordinateFrame && renderingCoordinateFrame->getLocalToRemoteTimeOffset() > 0.0)
                addInterpolationSample(
                    getCoordinateFrame(), getVelocity(), now - Time::Interval(renderingCoordinateFrame->getLocalToRemoteTimeOffset()), now, 0.0f);
        }
        else
        {
            createRenderingCoordinateFrame();
...
const Aya::SystemAddress PartInstance::getNetworkOwner() const
{
    AYAASSERT(getConstPartPrimitive());
    return getConstPartPrimitive()->getNetworkOwner();
}

void PartInstance::setNetworkOwnerNotifyIfServer(const Aya::SystemAddress value, bool ownershipBecomingManual)
{
    ...
    if (Aya::Network::Players::serverIsPresent(this, false))
    {
...
void PartInstance::setNetworkOwner(const Aya::SystemAddress value)
{
    const Aya::SystemAddress currentOwner = getConstPartPrimitive()->getNetworkOwner();
    if (value != currentOwner)
    {
        AYAASSERT(value != Network::NetworkOwner::Unassigned());
...
void PartInstance::setNetworkOwnerAndNotify(const Aya::SystemAddress value)
{
    const Aya::SystemAddress oldOwner = getConstPartPrimitive()->getNetworkOwner();
    setNetworkOwner(value);

    notifyNetworkOwnerChanged(oldOwner);
}

void PartInstance::notifyNetworkOwnerChanged(const Aya::SystemAddress oldOwner)
{
    const Aya::SystemAddress currentOwner = getConstPartPrimitive()->getNetworkOwner();
    if (oldOwner != currentOwner)
    {
        ...
        */
        ...
        else
        {
            ...
            AYAASSERT(currentOwner == Network::NetworkOwner::Server());
...
Aya::remote_signal<void(Aya::SystemAddress)>* PartInstance::getOrCreateNetworkOwnerChangedSignal(bool create)
{
    return NULL;
}
...
void PartInstance::setCanTouch(bool value)
{
    ...
    {
        canTouch = value;
        raisePropertyChanged(prop_CanTouch);
    }
}
...
void PartInstance::getConnectedPartsRecursiveImpl(shared_ptr<Instances>& objs, boost::unordered_set<PartInstance*>& seen) const
{
    ...
    for (int i = 0; i < primitive->getNumJoints(); ++i)
    {
        ...
        if (otherNeighbor != NULL && (Joint::isKinematicJoint(primitive->getJoint(i))))
        {
...
{
    Aya::SystemAddress consistentAddress;
    bool hasConsistentOwner;
    bool hasConsistentManualOwnershipRule;
    PartInstance::checkConsistentOwnerAndRuleResetRoots(
        consistentAddress, hasConsistentOwner, hasConsistentManualOwnershipRule, previousOwnershipRoots);
...
void PartInstance::updateOwnershipSettingsPostAnchor(std::vector<Primitive*>& futureMechRoots, RootPrimitiveOwnershipData& ownershipData)
{
    ...
    for (size_t i = 0; i < futureMechRoots.size(); i++)
    {
        if (DFFlag::SetNetworkOwnerFixAnchoring2)
        {
            ...
            if (futureMechRootPart)
            {
                ...
                else
                {
                    ...
                    if ((Aya::Network::Players::serverIsPresent(this) || DFFlag::NetworkOwnershipRuleReplicates) && ownershipData.ownershipManual)
                    {
        ...
        {
            AYAASSERT(Mechanism::isMovingAssemblyRoot(futureMechRoots[i]->getAssembly()));
...
void PartInstance::updateResetOwnershipSettingsOnUnAnchor()
{
    ...
    if (Assembly* currentAssembly = getPartPrimitive()->getAssembly())
    {
        if (!currentAssembly->computeIsGrounded())
        {
            ...
            Aya::SystemAddress addressToPass;
            ...
            if (hasConsistentAddress)
            {
                ...
                if (rootMovingPrim && !PartInstance::isPlayerCharacterPart(rootMovingPrimPart))
                {
                    ...
                    else
                    {
                        ...
                        if ((Aya::Network::Players::serverIsPresent(this) || DFFlag::NetworkOwnershipRuleReplicates) && hasConsistentOwnership)
                        {
    ...
    if (!recursive)
    {
        ...
        for (int i = 0; i < primitive->getNumJoints(); ++i)
        {
            ...
            if (otherNeighbor != NULL && PartInstance::fromPrimitive(otherNeighbor) != NULL &&
                PartInstance::fromPrimitive(otherNeighbor) != terrain && (Joint::isKinematicJoint(primitive->getJoint(i))))
            {
...
void PartInstance::setNetworkOwnershipRule(NetworkOwnership value)
{
    if (getNetworkOwnershipRule() != value)
    {
        ...
        if (DFFlag::NetworkOwnershipRuleReplicates && Aya::Network::Players::serverIsPresent(this, false))
        {
...
void PartInstance::setNetworkOwnerScript(shared_ptr<Instance> playerInstance)
{
    ...
    if (canSetNetworkOwnership(rootPrim, statusMessage))
    {
        ...
        Aya::SystemAddress ownerAddress;
        if (player)
        {
        ...
        {
            ownerAddress = Aya::Network::NetworkOwner::Server();
        }
...
shared_ptr<Instance> PartInstance::getNetworkOwnerScript()
{
    ...
    if (canSetNetworkOwnership(rootPrim, statusMessage))
    {
        ...
        {
            Aya::SystemAddress networkOwner = rootPrim->getNetworkOwner();
...
void PartInstance::checkConsistentOwnerAndRuleResetRoots(
    Aya::SystemAddress& consistentAddress, bool& hasConsistentOwner, bool& hasConsistentManualOwnershipRule, std::vector<Primitive*>& primRoots)
{
...
{
    if (value != (G3D::Color3)color3)
    {
        color = BrickColor::closest(value);
        color3 = value;
        raisePropertyChanged(prop_BrickColor);
        raisePropertyChanged(prop_Color3uint8);
        raisePropertyChanged(prop_Color);
...
bool PartInstance::resizeImpl(NormalId localNormalId, int amount)
{
    ...
    else
    {
        ...
        else
        {
            if (!DFFlag::FormFactorDeprecated)
            {
                AYAASSERT(getFormFactor() == PartInstance::SYMETRIC);
            }
        ...
        if (ContactManager* contactManager = Workspace::getContactManagerIfInWorkspace(this))
        {
            if (Dragger::intersectingWorldOrOthers(*this, *contactManager, Tolerance::maxOverlapAllowedForResize(), Dragger::maxDragDepth()))
            {
...
Surface PartInstance::getSurface(const Aya::RbxRay& gridRay, int& surfaceId)
{
    const CoordinateFrame& currentCoord = getCoordinateFrame();

    Aya::RbxRay localRay = currentCoord.toObjectSpace(gridRay);

    Extents extents = getPartPrimitive()->getExtentsLocal();
    Vector3 hitPoint;

    G3D::CollisionDetection::collisionLocationForMovingPointFixedAABox(
        localRay.origin(), localRay.direction(), G3D::AABox(extents.min(), extents.max()), hitPoint);
...
bool PartInstance::containedByFrustum(const Aya::Frustum& frustum) const
{
    return frustum.containsAABB(getConstPartPrimitive()->getExtentsLocal(), getCoordinateFrame());
}

bool PartInstance::intersectFrustum(const Aya::Frustum& frustum) const
{
...
bool PartInstance::isStandardPart() const
{
    ...
    return ((getSurfaceType(NORM_Y_NEG) == INLET) && (getSurfaceType(NORM_Z_NEG) == NO_SURFACE) && (getSurfaceType(NORM_Z) == NO_SURFACE) &&
            (getSurfaceType(NORM_X_NEG) == NO_SURFACE) && (getSurfaceType(NORM_X) == NO_SURFACE));
}
...
{
template<>
void Aya::TypedPropertyDescriptor<CoordinateFrame>::readValue(DescribedBase* instance, const XmlElement* element, IReferenceBinder& binder) const
{
    if (!element->isXsiNil())
    {
        CoordinateFrame c;
...
template<>
void Aya::TypedPropertyDescriptor<CoordinateFrame>::writeValue(const DescribedBase* instance, XmlElement* element) const
{
...
template<>
bool Aya::TypedPropertyDescriptor<CoordinateFrame>::hasStringValue() const
{
    return false;
}

template<>
std::string Aya::TypedPropertyDescriptor<CoordinateFrame>::getStringValue(const DescribedBase* instance) const
{
    return Super::getStringValue(instance);
}

template<>
bool Aya::TypedPropertyDescriptor<CoordinateFrame>::setStringValue(DescribedBase* instance, const std::string& text) const
{
