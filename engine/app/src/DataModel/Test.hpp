...
public:
    ...
    void setIsAClient(bool tF)
    {
        clientTestService = tF;
    }

    Aya::remote_signal<void(std::string, shared_ptr<Instance>, int)> serverCollectResultSignal;
    Aya::remote_signal<void(bool, std::string, shared_ptr<Instance>, int)> serverCollectConditionalResultSignal;
...
private:
    ...
    Aya::signals::scoped_connection resultCollectConnection;
    Aya::signals::scoped_connection conditionalResultCollectConnection;
};
