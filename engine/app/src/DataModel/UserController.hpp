...
public:
    ...
    void setHardwareDevice(UserInputBase* value)
    {
...
class Controller
    : public Reflection::Described<Controller, sController, Instance>
    , public IStepped
{
private:
...
public:
    ...
    {
        JUMP = AYA_SDLK_SPACE,
        DISMOUNT = AYA_SDLK_BACKSPACE // AYA_SDLK_ESCAPE
    };
...
public:
    ...
    bool getDismount() const
    {
        return getButton(DISMOUNT);
    } // do we need this on the controller? probably shoudn't be here.


    Aya::signal<void(Button)> buttonChangedSignal;
};
...
public:
    ...
    void setPanSensitivity(float newPan)
    {
        panSensitivity = newPan;
    }
};
