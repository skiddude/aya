...
template<>
bool Aya::StringConverter<FunctionalTest::Result>::convertToValue(const std::string& text, FunctionalTest::Result& value)
{
...
Reflection::BoundProp<bool> descPhysicsEnvironmentalThrottle(
    "PhysicsEnvironmentalThrottle", "Physics", &FunctionalTest::isPhysicsThrottled, Reflection::PropertyDescriptor::LEGACY);
...
Reflection::BoundProp<bool> descIs30FpsThrottleEnabled(
    "Is30FpsThrottleEnabled", "Physics", &FunctionalTest::is30FpsThrottleEnabled, Reflection::PropertyDescriptor::LEGACY);
Reflection::BoundProp<bool> prop_HasMigratedSettingsToTestService(
    "HasMigratedSettingsToTestService", "Settings", &FunctionalTest::hasMigratedSettingsToTestService, Reflection::PropertyDescriptor::STREAMING);
...
static Reflection::BoundFuncDesc<FunctionalTest, void(std::string)> descPassedDeprecated(
    &FunctionalTest::pass, "Passed", "message", "", Security::None);
static Reflection::BoundFuncDesc<FunctionalTest, void(std::string)> descFailedDeprecated(
    &FunctionalTest::error, "Failed", "message", "", Security::None);
...
static Reflection::BoundFuncDesc<TestService, void(std::string, shared_ptr<Instance>, int)> func_Message(
    &TestService::message, "Message", "text", "source", shared_ptr<Instance>(), "line", 0, Security::None);
static Reflection::BoundFuncDesc<TestService, void(std::string, shared_ptr<Instance>, int)> func_Checkpoint(
    &TestService::checkpoint, "Checkpoint", "text", "source", shared_ptr<Instance>(), "line", 0, Security::None);
static Reflection::BoundFuncDesc<TestService, void(bool, std::string, shared_ptr<Instance>, int)> func_Warn(
    &TestService::warn, "Warn", "condition", "description", "source", shared_ptr<Instance>(), "line", 0, Security::None);
static Reflection::BoundFuncDesc<TestService, void(bool, std::string, shared_ptr<Instance>, int)> func_Check(
    &TestService::check, "Check", "condition", "description", "source", shared_ptr<Instance>(), "line", 0, Security::None);
static Reflection::BoundFuncDesc<TestService, void(bool, std::string, shared_ptr<Instance>, int)> func_Require(
    &TestService::require2, "Require", "condition", "description", "source", shared_ptr<Instance>(), "line", 0, Security::None);
static Reflection::BoundFuncDesc<TestService, void(std::string, shared_ptr<Instance>, int)> func_Error(
    &TestService::error, "Error", "description", "source", shared_ptr<Instance>(), "line", 0, Security::None);
static Reflection::BoundFuncDesc<TestService, void(std::string, shared_ptr<Instance>, int)> func_Fails(
    &TestService::fail, "Fail", "description", "source", shared_ptr<Instance>(), "line", 0, Security::None);
...
#ifdef AYA_TEST_BUILD
static Reflection::BoundFuncDesc<TestService, shared_ptr<const Reflection::ValueArray>()> func_GetCommandNames(
    &TestService::getCommandNames, "GetCommandNames", Security::LocalUser);
...
static Reflection::BoundFuncDesc<TestService, bool(std::string)> func_IsCommandEnabled(
    &TestService::isCommandEnabled, "IsCommandEnabled", "name", Security::LocalUser);
static Reflection::BoundFuncDesc<TestService, bool(std::string)> func_IsCommandChecked(
    &TestService::isCommandChecked, "IsCommandChecked", "name", Security::LocalUser);
#endif

static Reflection::RemoteEventDesc<TestService, void(std::string, shared_ptr<Instance>, int)> desc_serverCollectResult(
    &TestService::serverCollectResultSignal, "ServerCollectResult", "text", "script", "line", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<TestService, void(bool, std::string, shared_ptr<Instance>, int)> desc_serverCollectConditionalResult(
    &TestService::serverCollectConditionalResultSignal, "ServerCollectConditionalResult", "condition", "text", "script", "line", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
REFLECTION_END();
    ...
    , scriptCount(0)
{
    ...
    Aya::NetworkSettings& ns = Aya::NetworkSettings::singleton();
...
void TestService::message(std::string text, shared_ptr<Instance> source, int line)
{
    ...
    if (onMessage)
        ...
        output(Aya::MESSAGE_INFO, source, line, text);
}
...
void TestService::checkpoint(std::string text, shared_ptr<Instance> source, int line)
{
    if (onCheckpoint)
        ...
        output(Aya::MESSAGE_INFO, source, line, "checkpoint " + text);
}
...
void TestService::warn(bool condition, std::string description, shared_ptr<Instance> source, int line)
{
    ...
    if (onWarn)
        ...
        output(Aya::MESSAGE_WARNING, source, line, description);
}
...
void TestService::check(bool condition, std::string description, shared_ptr<Instance> source, int line)
{
    ...
    if (onCheck)
        ...
        output(Aya::MESSAGE_ERROR, source, line, description);
}
...
void TestService::require2(bool condition, std::string description, shared_ptr<Instance> source, int line)
{
    ...
    if (onCheck)
        ...
        output(Aya::MESSAGE_ERROR, source, line, "fatal " + description);
...
void TestService::done()
{
    ...
    if (onDone)
        ...
        Aya::StandardOut::singleton()->print(Aya::MESSAGE_INFO, "TestService: Doesn't include any assertions");
    else
        Aya::StandardOut::singleton()->printf(
            Aya::MESSAGE_INFO, "TestService: Run completed, tests: %u, warns: %u, errors: %u", testCount, warnCount, errorCount);
...
void TestService::stillWaiting(int runCount, double timeout)
{
    ...
    if (onStillWaiting)
        ...
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "TestService: Waiting a total of %g seconds for the test to end", timeout);
}
...
void TestService::onTimeout(int runCount, double timeout)
{
    ...
    if (onCheck)
        onCheck(false, Aya::format("Tests failed to complete in %g seconds", timeout), shared_ptr<Instance>(), 0);
    else
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "TestService: Tests failed to complete in %g seconds", timeout);
...
void TestService::startScript(shared_ptr<Instance> instance)
{
    ...
    {
        Aya::ScriptContext* scriptContext = Aya::ServiceProvider::create<Aya::ScriptContext>(this);
        if (!scriptContext)
        ...
        options.identity = Aya::Security::Context::current().identity;
...
{
    Aya::PhysicsSettings& ps = Aya::PhysicsSettings::singleton();
...
private:
    ...
    {
        if (doAYA_Test_Equality(lineNumber, line, "AYA_CHECK_EQUAL", "Check", "==", "!="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_CHECK_NE", "Check", "~=", "=="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_CHECK_GE", "Check", ">=", "<"))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_CHECK_LE", "Check", "<=", ">"))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_CHECK_GT", "Check", ">", "<="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_CHECK_LT", "Check", "<", ">="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_WARN_EQUAL", "Warn", "==", "!="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_WARN_NE", "Warn", "!=", "=="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_WARN_GE", "Warn", ">=", "<"))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_WARN_LE", "Warn", "<=", ">"))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_WARN_GT", "Warn", ">", "<="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_WARN_LT", "Warn", "<", ">="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_REQUIRE_EQUAL", "Require", "==", "!="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_REQUIRE_NE", "Require", "!=", "=="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_REQUIRE_GE", "Require", ">=", "<"))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_REQUIRE_LE", "Require", "<=", ">"))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_REQUIRE_GT", "Require", ">", "<="))
            return;
        if (doAYA_Test_Equality(lineNumber, line, "AYA_REQUIRE_LT", "Require", "<", ">="))
            return;

        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_WARN_MESSAGE", "Warn"))
            return;
        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_CHECK_MESSAGE", "Check"))
            return;
        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_REQUIRE_MESSAGE", "Require"))
            return;

        if (doAYA_Test_Throw(lineNumber, line, "AYA_WARN_THROW", "Warn"))
            return;
        if (doAYA_Test_Throw(lineNumber, line, "AYA_CHECK_THROW", "Check"))
            return;
        if (doAYA_Test_Throw(lineNumber, line, "AYA_REQUIRE_THROW", "Require"))
            return;

        if (doAYA_Test_NoThrow(lineNumber, line, "AYA_WARN_NO_THROW", "Warn"))
            return;
        if (doAYA_Test_NoThrow(lineNumber, line, "AYA_CHECK_NO_THROW", "Check"))
            return;
        if (doAYA_Test_NoThrow(lineNumber, line, "AYA_REQUIRE_NO_THROW", "Require"))
            return;

        if (doAYA_Test(lineNumber, line, "AYA_WARN", "Warn"))
            return;
        if (doAYA_Test(lineNumber, line, "AYA_CHECK", "Check"))
            return;
        if (doAYA_Test(lineNumber, line, "AYA_REQUIRE", "Require"))
            return;

        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_ERROR", "Error"))
            return;
        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_FAIL", "Fail"))
            return;
        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_MESSAGE", "Message"))
            return;
        if (doAYA_SimpleSubstitution(lineNumber, line, "AYA_CHECKPOINT", "Checkpoint"))
            return;
    ...
    bool doAYA_Test_Equality(int lineNumber, const std::string& line, const char* macro, const char* f, const char* equality, const char* notEquality)
    {
        int i = line.find(macro);
        if (i < 0)
            return false;

        // AYA_CHECK_EQUAL(a, b) ===> if a == b then Game:GetService('TestService'):Check(true, [==[a == b]==]) else
        // Game:GetService('TestService'):Check(false,[==[test a == b failed [1 != 2]]==]) end
        ...
        if (args.size() != 2)
            throw Aya::runtime_error("Expected 2 arguments but got %d", (int)args.size());
        ...
        // First write everything before AYA_CHECK
        ...
        result << "Game:GetService('TestService'):" << f << "(true, [==[" << args[0] << " " << equality << " " << args[1] << "]==], script, "
               << lineNumber << ") ";
        result << "else ";
        result << "Game:GetService('TestService'):" << f << "(false, [==[test " << args[0] << " " << equality << " " << args[1]
               << " failed []==] .. tostring(aZZZZ) .. ' " << notEquality << " ' .. tostring(bZZZZ) .. ']', script, " << lineNumber << ") ";
        result << "end ";
        result << "end";
    ...
    bool doAYA_Test(int lineNumber, const std::string& line, const char* macro, const char* f)
    {
        int i = line.find(macro);
        if (i < 0)
            return false;

        // AYA_CHECK(a) ===> Game:GetService('TestService'):Check(a,[==[test failed: a]==])
    ...
    bool doAYA_Test_Throw(int lineNumber, const std::string& line, const char* macro, const char* f)
    {
        int i = line.find(macro);
        if (i < 0)
            return false;

        // AYA_CHECK_THROW(a) ===> Game:GetService('TestService'):Check(ypcall(function() a end) == false, 'Exception expected in ' .. [==[a]==])
        ...
        // First write everything before AYA_CHECK_THROW
        result << line.substr(0, i);
    ...
    bool doAYA_Test_NoThrow(int lineNumber, const std::string& line, const char* macro, const char* f)
    {
        int i = line.find(macro);
        if (i < 0)
            return false;

        // AYA_CHECK_NO_THROW(a) ===> Game:GetService('TestService'):Check(ypcall(function() a end) == true, 'Exception thrown by ' .. [==[a]==])
    ...
    bool doAYA_SimpleSubstitution(int lineNumber, const std::string& line, const char* macro, const char* f)
    {
        int i = line.find(macro);
        if (i < 0)
            return false;

        // AYA_CHECK(a) ===> Game:GetService('TestService'):Check(a,[==[a]==])
...
{
    if (source)
        Aya::StandardOut::singleton()->printf(type, "TestService.%s(%d): %s", source->getName().c_str(), line, message.c_str());
    else
        Aya::StandardOut::singleton()->printf(type, "TestService: %s", message.c_str());
}
...
Verb* TestService::getVerb(std::string name)
{
    ...
    if (!verb)
        throw Aya::runtime_error("Verb %s does not exist", name.c_str());
    return verb;
}
#endif
...
void TestService::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider)
{
    ...
    if (newProvider)
    {
        ...
        conditionalResultCollectConnection =
            serverCollectConditionalResultSignal.connect(boost::bind(&TestService::onRemoteConditionalResult, this, _1, _2, _3, _4));
    }
    else if (oldProvider)
    {
