...
const char* const Aya::sBodyMover = "BodyMover";
const char* const Aya::sBodyPosition = "BodyPosition";
const char* const Aya::sBodyVelocity = "BodyVelocity";
const char* const Aya::sBodyGyro = "BodyGyro";
const char* const Aya::sBodyAngularVelocity = "BodyAngularVelocity";
const char* const Aya::sBodyForce = "BodyForce";
const char* const Aya::sBodyThrust = "BodyThrust";
const char* const Aya::sRocket = "RocketPropulsion";

AYA_REGISTER_CLASS(Aya::BodyGyro);
AYA_REGISTER_CLASS(Aya::BodyForce);
AYA_REGISTER_CLASS(Aya::BodyThrust);
AYA_REGISTER_CLASS(Aya::BodyPosition);
AYA_REGISTER_CLASS(Aya::BodyVelocity);
AYA_REGISTER_CLASS(Aya::BodyAngularVelocity);
AYA_REGISTER_CLASS(Aya::Rocket);


static const float PGSSolverSpringConstantScale = 1.0f / 19.0f;

void Aya::registerBodyMovers()
{
    BodyGyro::className();
...
void BodyMover::computeForce(bool throttling)
{
    AYAASSERT(world);
    AYAASSERT(part.lock());
    AYAASSERT(part.lock()->getPartPrimitive()->getBody());
    //	AYAASSERT(part.lock()->getPrimitive()->getAssembly()->inKernel());
...
void BodyMover::computeForce(bool throttling, Body*& root, Vector3& force, Vector3& torque)
{
    ...
    AYAASSERT(force == Vector3::zero());
    if (!pi || !(pi->getPartPrimitive()) || !(pi->getPartPrimitive()->getBody()))
        return;
...
{
    AYAASSERT(Math::fuzzyEq(Vector3(1, 1, 1), Vector3(1.04, 1, 1), 0.05f));
    AYAASSERT(!Math::fuzzyEq(Vector3(1, 1, 1), Vector3(1.2, 1, 1), 0.05f));
...
bool BodyMover::duplicateBodyMoverExists(Primitive* p0, Primitive* p1)
{
    ...
    do
    {
        ...
        {
            // AYAASSERT(0);	// show to DB, then delete
            return true;
        }
        pairId++;
    } while (joint);
...
void BodyMover::onAncestorChanged(const AncestorChanged& event)
{
    ...
    if (event.child == this)
    {
        ...
        { // getEngineBody() need part during removeJoint()
    ...
    if (world != NULL && newWorld == NULL)
    {
        ...
        {
            if (world)
            { // TODO - remove this test after a while - asserting now for safety
                world->removeJoint(this);
            }
        }
...
static Reflection::BoundFuncDesc<Rocket, void()> func_fire(
    &Rocket::fire, "fire", Security::None, Reflection::Descriptor::Attributes::deprecated(Rocket::func_Fire));
Reflection::BoundFuncDesc<Rocket, void()> Rocket::func_Abort(&Rocket::abort, "Abort", Security::None);

static Reflection::RemoteEventDesc<Rocket, void()> event_ReachedTarget(&Rocket::reachedTargetSignal, "ReachedTarget", Security::None,
...
void Rocket::computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque)
{
    AYAASSERT(world);
...
Reflection::PropDescriptor<BodyGyro, G3D::Vector3> BodyGyro::prop_maxTorqueDeprecated("maxTorque", "Goals", &BodyGyro::getMaxTorque,
    &BodyGyro::setMaxTorque, Reflection::PropertyDescriptor::Attributes::deprecated(BodyGyro::prop_maxTorque));
...
Reflection::PropDescriptor<BodyGyro, CoordinateFrame> BodyGyro::prop_cframeDeprecated(
    "cframe", "Goals", &BodyGyro::getCFrame, &BodyGyro::setCFrame, Reflection::PropertyDescriptor::Attributes::deprecated(BodyGyro::prop_cframe));
...
void BodyGyro::putInKernel(Kernel* _kernel)
{
    ...
    if (FFlag::PGSUsesConstraintBasedBodyMovers && getKernel()->getUsingPGSSolver())
    {
        ...
        if (angularVelocityConstraint != NULL &&
            (angularVelocityConstraint->getBodyA()->getUID() != b0->getUID() || angularVelocityConstraint->getBodyB()->getUID() != b1->getUID()))
        {
            delete angularVelocityConstraint;
...
void BodyGyro::computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque)
{
    AYAASSERT(world);
    AYAASSERT(part.lock());
...
Reflection::PropDescriptor<BodyPosition, G3D::Vector3> BodyPosition::prop_maxForce(
    "MaxForce", "Goals", &BodyPosition::getMaxForce, &BodyPosition::setMaxForce);
Reflection::PropDescriptor<BodyPosition, G3D::Vector3> BodyPosition::prop_maxForceDeprecated("maxForce", "Goals", &BodyPosition::getMaxForce,
    &BodyPosition::setMaxForce, Reflection::PropertyDescriptor::Attributes::deprecated(BodyPosition::prop_maxForce));
Reflection::PropDescriptor<BodyPosition, G3D::Vector3> BodyPosition::prop_position(
    "Position", "Goals", &BodyPosition::getPosition, &BodyPosition::setPosition);
Reflection::PropDescriptor<BodyPosition, G3D::Vector3> BodyPosition::prop_positionDeprecated("position", "Goals", &BodyPosition::getPosition,
    &BodyPosition::setPosition, Reflection::PropertyDescriptor::Attributes::deprecated(BodyPosition::prop_position));

// Query for debugging:
// TODO: Can we fix Reflection to allow const member functions???
Aya::Reflection::BoundFuncDesc<BodyPosition, G3D::Vector3()> func_getLastForce(&BodyPosition::getLastForce, "GetLastForce", Security::None);
Aya::Reflection::BoundFuncDesc<BodyPosition, G3D::Vector3()> func_getLastForceOld(
    &BodyPosition::getLastForce, "lastForce", Security::None, Reflection::PropertyDescriptor::Attributes::deprecated(func_getLastForce));
...
// This is called frequently during simulation, so try to keep it fast!!!!
void BodyPosition::computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque)
{
    AYAASSERT(world);
    AYAASSERT(part.lock());
    ...
    if (FFlag::PGSUsesConstraintBasedBodyMovers && world && world->getUsingPGSSolver())
    {
        ...
        spring->setPD(p, d);
        spring->setPivotA(
            spring->getBodyA()->getCoordinateFrame().pointToObjectSpace(spring->getBodyA()->getRootSimBody()->getPV().position.translation));
        spring->setPivotB(spring->getBodyB()->getCoordinateFrame().pointToObjectSpace(
            position + spring->getBodyA()->getRootSimBody()->getPV().position.translation - spring->getBodyA()->getCoordinateFrame().translation));
    }
    else
    {
        float newKP = kP;
...
Reflection::PropDescriptor<BodyVelocity, G3D::Vector3> BodyVelocity::prop_maxForce(
    "MaxForce", "Goals", &BodyVelocity::getMaxForce, &BodyVelocity::setMaxForce);
Reflection::PropDescriptor<BodyVelocity, G3D::Vector3> BodyVelocity::prop_maxForceDeprecated("maxForce", "Goals", &BodyVelocity::getMaxForce,
    &BodyVelocity::setMaxForce, Reflection::PropertyDescriptor::Attributes::deprecated(BodyVelocity::prop_maxForce));
Reflection::PropDescriptor<BodyVelocity, G3D::Vector3> BodyVelocity::prop_velocity(
    "Velocity", "Goals", &BodyVelocity::getVelocity, &BodyVelocity::setVelocity);
Reflection::PropDescriptor<BodyVelocity, G3D::Vector3> BodyVelocity::prop_velocityDeprecated("velocity", "Goals", &BodyVelocity::getVelocity,
    &BodyVelocity::setVelocity, Reflection::PropertyDescriptor::Attributes::deprecated(BodyVelocity::prop_velocity));

// Query for debugging:
// TODO: Can we fix Reflection to allow const member functions???
Aya::Reflection::BoundFuncDesc<BodyVelocity, G3D::Vector3()> func_getLastForceVOld(&BodyVelocity::getLastForce, "lastForce", Security::None);
Aya::Reflection::BoundFuncDesc<BodyVelocity, G3D::Vector3()> func_getLastForceV(&BodyVelocity::getLastForce, "GetLastForce", Security::None);
...
void BodyVelocity::computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque)
{
    float newKP = kP;
    if (world && world->getUsingPGSSolver())
    {
...
Reflection::PropDescriptor<BodyAngularVelocity, Vector3> BodyAngularVelocity::prop_maxTorque(
    "MaxTorque", "Goals", &BodyAngularVelocity::getMaxTorque, &BodyAngularVelocity::setMaxTorque);
Reflection::PropDescriptor<BodyAngularVelocity, Vector3> BodyAngularVelocity::prop_maxTorqueDeprecated("maxTorque", "Goals",
    &BodyAngularVelocity::getMaxTorque, &BodyAngularVelocity::setMaxTorque,
    Reflection::PropertyDescriptor::Attributes::deprecated(BodyAngularVelocity::prop_maxTorque));
Reflection::PropDescriptor<BodyAngularVelocity, G3D::Vector3> BodyAngularVelocity::prop_angularvelocity(
    "AngularVelocity", "Goals", &BodyAngularVelocity::getAngularVelocity, &BodyAngularVelocity::setAngularVelocity);
Reflection::PropDescriptor<BodyAngularVelocity, G3D::Vector3> BodyAngularVelocity::prop_angularvelocityDeprecated("angularvelocity", "Goals",
    &BodyAngularVelocity::getAngularVelocity, &BodyAngularVelocity::setAngularVelocity,
    Reflection::PropertyDescriptor::Attributes::deprecated(BodyAngularVelocity::prop_angularvelocity));
...
void BodyAngularVelocity::computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque)
{
    AYAASSERT(world);
...
Reflection::PropDescriptor<BodyForce, Vector3> BodyForce::prop_ForceDeprecated("force", "Goals", &BodyForce::getBodyForce, &BodyForce::setBodyForce,
    Reflection::PropertyDescriptor::Attributes::deprecated(BodyForce::prop_Force));
...
void BodyForce::computeForceImpl(bool throttling, Body* body, Body* root, Vector3& force, Vector3& torque)
{
...
Reflection::PropDescriptor<BodyThrust, Vector3> BodyThrust::prop_forceDeprecated(
    "force", "Goals", &BodyThrust::getForce, &BodyThrust::setForce, Reflection::PropertyDescriptor::Attributes::deprecated(BodyThrust::prop_force));
Reflection::PropDescriptor<BodyThrust, G3D::Vector3> BodyThrust::prop_location(
    "Location", "Goals", &BodyThrust::getLocation, &BodyThrust::setLocation);
Reflection::PropDescriptor<BodyThrust, G3D::Vector3> BodyThrust::prop_locationDeprecated("location", "Goals", &BodyThrust::getLocation,
    &BodyThrust::setLocation, Reflection::PropertyDescriptor::Attributes::deprecated(BodyThrust::prop_location));
