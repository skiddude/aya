...
static const Reflection::EnumPropDescriptor<Handles, Handles::VisualStyle> prop_Style(
    "Style", category_Appearance, &Handles::getVisualStyle, &Handles::setVisualStyle);
static const Reflection::PropDescriptor<Handles, Faces> prop_Faces("Faces", category_Data, &Handles::getFaces, &Handles::setFaces);

static Reflection::RemoteEventDesc<Handles, void(NormalId)> event_MouseEnter(&Handles::mouseEnterSignal, "MouseEnter", "face", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<Handles, void(NormalId)> event_MouseLeave(&Handles::mouseLeaveSignal, "MouseLeave", "face", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<Handles, void(NormalId, float)> event_MouseDrag(&Handles::mouseDragSignal, "MouseDrag", "face", "distance",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<Handles, void(NormalId)> event_MouseButton1Down(&Handles::mouseButton1DownSignal, "MouseButton1Down", "face",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<Handles, void(NormalId)> event_MouseButton1Up(&Handles::mouseButton1UpSignal, "MouseButton1Up", "face",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
...
Aya::HandleType Handles::getHandleType() const
{
    switch (visualStyle)
    {
    case RESIZE_HANDLES:
        return HANDLE_RESIZE;
    case MOVEMENT_HANDLES:
        return HANDLE_MOVE;
    case ARC_HANDLES:
        return HANDLE_ROTATE;
    case VELOCITY_HANDLES:
        return HANDLE_VELOCITY;
    default:
        return HANDLE_RESIZE;
    }
}
