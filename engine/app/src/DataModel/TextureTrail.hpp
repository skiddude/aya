...
public:
    ...
    // For floor wire
    static void renderInternal(const Workspace* workspace, const Camera* camera, const Vector3& fromPosition, const Vector3& toPosition,
...
protected:
    ...
    static bool getPosition(const weak_ptr<PartInstance>& dataSource, Vector3* out);
