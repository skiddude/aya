...
const EnumPropDescriptor<PyramidInstance, PyramidInstance::NumSidesEnum> PyramidInstance::prop_sidesXML(
    "sides", category_Pyramid, &PyramidInstance::GetNumSides, &PyramidInstance::SetNumSides, PropertyDescriptor::STREAMING);
static const EnumPropDescriptor<PyramidInstance, PyramidInstance::NumSidesEnum> prop_sidesUI(
    "Sides", category_Pyramid, &PyramidInstance::GetNumSides, &PyramidInstance::SetNumSides, PropertyDescriptor::UI);
static const Vector3 InitialPyramidPartSize = Vector3(4.0, 4.0, 4.0);

// Disable slice control for now.
// const PropDescriptor<PyramidInstance, int> PyramidInstance::prop_slices("Slices", category_Pyramid, &PyramidInstance::GetNumSlices,
// &PyramidInstance::SetNumSlices);


PyramidInstance::PyramidInstance()
    : DescribedNonCreatable<PyramidInstance, PartInstance, sPyramid>(InitialPyramidPartSize)
{
    setName("Pyramid");
