...
protected:
    ...
    ///////////////////////////////
    // overrides
    virtual void verifyAddDescendant(const Instance* newParent, const Instance* instanceGettingNewParent) const override;
...
public:
    ...
    bool useSubmitTaskForLuaListeners() const override
    {
        return true;
    }
};
...
class GlobalAdvancedSettings : public DescribedNonCreatable<GlobalAdvancedSettings, Settings, sGlobalAdvancedSettings>
{
...
public:
    ...
    shared_ptr<const Aya::Reflection::ValueTable> getFVariables();
...
class GlobalAdvancedSettingsItem
    : public Aya::DescribedCreatable<Class, Aya::GlobalAdvancedSettings::Item, sClassName>
    , public Service
{
    typedef Aya::DescribedCreatable<Class, Aya::GlobalAdvancedSettings::Item, sClassName> Super;
...
protected:
    GlobalAdvancedSettingsItem()
    {
        ...
        if (sing)
            throw Aya::runtime_error("singleton %s already exists", sClassName);
        sing = this;
    }
    ~GlobalAdvancedSettingsItem()
    {
...
public:
    static Class& singleton()
    {
        ...
        Aya::GlobalAdvancedSettings* gs = Aya::GlobalAdvancedSettings::singleton().get();
...
class GlobalBasicSettingsItem
    : public Aya::DescribedCreatable<Class, Aya::GlobalBasicSettings::Item, sClassName>
    , public Service
{
    typedef Aya::DescribedCreatable<Class, Aya::GlobalBasicSettings::Item, sClassName> Super;
...
public:
    static Class& singleton()
    {
        ...
        Aya::GlobalBasicSettings* gs = Aya::GlobalBasicSettings::singleton().get();
        boost::mutex::scoped_lock lock(gs->mutex);
        if (!sing)
        {
            // "s" won't get collected when we leave scope because the parent will hold a ref to it
