...
#include "DataModel/RootInstance.hpp"
...
static Reflection::RemoteEventDesc<InsertService, void(std::string, ContentId)> event_insertRequest(&InsertService::insertRequestSignal,
    "InsertRequest", "key", "contentId", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<InsertService, void(std::string, int, int)> event_insertRequestAsset(&InsertService::insertRequestAssetSignal,
    "InsertRequestAsset", "key", "assetId", "userId", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<InsertService, void(std::string, int, int)> event_insertRequestAssetVersion(
    &InsertService::insertRequestAssetVersionSignal, "InsertRequestAssetVersion", "key", "assetVersionId", "userId", Security::None,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::RemoteEventDesc<InsertService, void(std::string, shared_ptr<Instance>)> event_insertReady(&InsertService::insertReadySignal,
    "InsertReady", "key", "instance", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<InsertService, void(std::string, std::string)> event_insertError(&InsertService::insertErrorSignal, "InsertError",
    "key", "message", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<InsertService, void(shared_ptr<Instance>)> event_internalDelete(&InsertService::internalDeleteSignal,
    "InternalDelete", "instance", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

// Public functions exposed to Lua

/*Deprecated -- Nuke this when the Game service is updated */ static Reflection::BoundFuncDesc<InsertService, void(std::string)>
    func_SetBaseCategoryUrl(&InsertService::setBaseSetsUrl, "SetBaseCategoryUrl", "baseSetsUrl", Security::LocalUser);
/*Deprecated -- Nuke this when the Game service is updated */ static Reflection::BoundFuncDesc<InsertService, void(std::string)>
    func_SetUserCategoryUrl(&InsertService::setUserSetsUrl, "SetUserCategoryUrl", "userSetsUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(float)> func_SetTrustLevel(
    &InsertService::setTrustLevel, "SetTrustLevel", "trustLevel", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetBaseSetUrl(
    &InsertService::setBaseSetsUrl, "SetBaseSetsUrl", "baseSetsUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetUserSetUrl(
    &InsertService::setUserSetsUrl, "SetUserSetsUrl", "userSetsUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetFreeModelSetUrl(
    &InsertService::setFreeModelUrl, "SetFreeModelUrl", "freeModelUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetFreeDecalSetUrl(
    &InsertService::setFreeDecalUrl, "SetFreeDecalUrl", "freeDecalUrl", Security::LocalUser);

static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetCollectionUrl(
    &InsertService::setCollectionUrl, "SetCollectionUrl", "collectionUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetAssetUrl(
    &InsertService::setAssetUrl, "SetAssetUrl", "assetUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(std::string)> func_SetAssetVersionUrl(
    &InsertService::setAssetVersionUrl, "SetAssetVersionUrl", "assetVersionUrl", Security::LocalUser);
static Reflection::BoundFuncDesc<InsertService, void(int)> func_ApproveAssetId(
    &InsertService::backendApproveAssetId, "ApproveAssetId", "assetId", Security::None);
static Reflection::BoundFuncDesc<InsertService, void(int)> func_ApproveAssetVersionId(
    &InsertService::backendApproveAssetVersionId, "ApproveAssetVersionId", "assetVersionId", Security::None);

static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(std::string, int)> func_GetFreeModels(
    &InsertService::getFreeModels, "GetFreeModels", "searchText", "pageNum", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(std::string, int)> func_GetFreeDecals(
    &InsertService::getFreeDecals, "GetFreeDecals", "searchText", "pageNum", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(void)> func_GetDefaultSets(
    &InsertService::getBaseSets, "GetBaseSets", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(int)> func_GetUserSets(
    &InsertService::getUserSets, "GetUserSets", "userId", Security::None);

/*Deprecated*/ static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(void)> func_GetDefaultCategories(
    &InsertService::getBaseSets, "GetBaseCategories", Security::None, Reflection::Descriptor::Attributes::deprecated(func_GetDefaultSets));
/*Deprecated*/ static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(int)> func_GetUserCategories(
    &InsertService::getUserSets, "GetUserCategories", "userId", Security::None, Reflection::Descriptor::Attributes::deprecated(func_GetUserSets));
/*Deprecated Nuke this when the Game service is updated: */ static Reflection::BoundFuncDesc<InsertService, void(bool, bool)> func_SetAdvancedResults(
    &InsertService::setAdvancedResults, "SetAdvancedResults", "enable", "user", false, Security::LocalUser);

static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<const Reflection::ValueArray>(int)> func_GetCollectionObjects(
    &InsertService::getCollection, "GetCollection", "categoryId", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<Instance>(int)> func_LoadAsset(
    &InsertService::loadAsset, "LoadAsset", "assetId", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<Instance>(int)> func_LoadAssetDep(
    &InsertService::loadAsset, "loadAsset", "assetId", Security::None, Reflection::Descriptor::Attributes::deprecated(func_LoadAsset));
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<Instance>(int)> func_LoadAssetVersion(
    &InsertService::loadAssetVersion, "LoadAssetVersion", "assetVersionId", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, shared_ptr<Instance>(std::string)> func_LoadPrivateAsset(
    &InsertService::loadPrivateAsset, "LoadPrivateAsset", "contentId", Security::None);
static Reflection::BoundYieldFuncDesc<InsertService, int(int)> func_GetLastestAssetVersion(
    &InsertService::getLatestAssetVersion, "GetLatestAssetVersionAsync", "assetId", Security::None);
static Reflection::BoundFuncDesc<InsertService, void(shared_ptr<Instance>)> func_Insert(
    &InsertService::insert, "Insert", "instance", Security::None, Reflection::Descriptor::Attributes::deprecated());

static Reflection::PropDescriptor<InsertService, bool> prop_AllowInsertFreeModels("AllowInsertFreeModels", category_Behavior,
    &InsertService::getAllowInsertFreeModels, &InsertService::setAllowInsertFreeModels, Reflection::PropertyDescriptor::STANDARD_NO_REPLICATE);
...
void InsertService::dispatchRequest(const std::string& url, boost::function<void(shared_ptr<const Reflection::ValueArray>)> resumeFunction,
...
void InsertService::getFreeModels(std::string searchText, int pageNum, boost::function<void(shared_ptr<const Reflection::ValueArray>)> resumeFunction,
    boost::function<void(std::string)> errorFunction)
{
    dispatchRequest(addBaseUrlAndQuery(DFString::FreeModelUrlPiece, searchText, pageNum), resumeFunction, errorFunction);
}
void InsertService::getFreeDecals(std::string searchText, int pageNum, boost::function<void(shared_ptr<const Reflection::ValueArray>)> resumeFunction,
    boost::function<void(std::string)> errorFunction)
{
    dispatchRequest(addBaseUrlAndQuery(DFString::FreeDecalUrlPiece, searchText, pageNum), resumeFunction, errorFunction);
}
void InsertService::getBaseSets(
...
void InsertService::getUserSets(
...
void InsertService::getCollection(int collectionId, boost::function<void(shared_ptr<const Reflection::ValueArray>)> resumeFunction,
    boost::function<void(std::string)> errorFunction)
{
...
void InsertService::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider)
{
    ...
    if (newProvider)
    {
        if (Network::Players::backendProcessing(newProvider))
        {
            ...
            backendInsertAssetConnection =
                insertRequestAssetSignal.connect(boost::bind(&InsertService::backendInsertAssetRequested, this, _1, true, _2, _3));
            backendInsertAssetVersionConnection =
                insertRequestAssetVersionSignal.connect(boost::bind(&InsertService::backendInsertAssetVersionRequested, this, _1, true, _2, _3));
...
void InsertService::loadAssetVersion(
    int id, boost::function<void(shared_ptr<Instance>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    privateLoadAsset(id, true, resumeFunction, errorFunction);
}

void InsertService::loadPrivateAsset(
    std::string contentId, boost::function<void(shared_ptr<Instance>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (Network::Players::frontendProcessing(this) && !Network::Players::backendProcessing(this))
    {
        ...
        ContentId asset = ContentId(contentId);
        event_insertRequest.replicateEvent(this, keyRequest, asset);
    }
    else
    {
        // We're the server or in single-player mode
        ContentId asset = ContentId(contentId);
        backendInsertRequested(keyRequest, false, asset);
    }
}
...
void InsertService::getLatestAssetVersionSuccess(
...
{
    errorFunction(Aya::format("InsertService getLatestAssetVersion : Request Failed because %s", error.c_str()));
}
...
void InsertService::getLatestAssetVersion(int id, boost::function<void(int)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        ...
        {
            apiService->getAsync(Aya::format(DFString::AssetVersionsUrl.c_str(), id, dm->getPlaceID()), true, Aya::PRIORITY_DEFAULT,
...
void InsertService::privateLoadAsset(
...
void InsertService::insert(shared_ptr<Instance> instance)
{
    if (DataModel* dataModel = (DataModel*)getParent())
    {
        ...
        if (instance->getRobloxLocked())
            Aya::Security::Context::current().requirePermission(Aya::Security::Plugin, "Roblox locked in InsertService:Insert()");
...
{
    AYAASSERT(instance);
    AYAASSERT(instance->isDescendantOf(this));
...
void InsertService::backendInsertReady(
...
void InsertService::BackendInsertReadyHelper(weak_ptr<InsertService> insertService, std::string key, shared_ptr<Instance> pseudoRoot,
...
void InsertService::RemoteInsertItemsLoadedHelper(weak_ptr<InsertService> insertService, weak_ptr<ContentProvider> cp,
...
void InsertService::remoteInsertItemsLoaded(weak_ptr<ContentProvider> weakCp, AsyncHttpQueue::RequestResult requestResult,
    shared_ptr<Instances> instances, shared_ptr<std::exception> requestError,
    boost::function<void(shared_ptr<Instance>, AsyncHttpQueue::RequestResult requestResult, shared_ptr<std::exception>)> resultFunction)
{
    ...
    {
        LuaSourceContainer::loadLinkedScripts(
            cp, pseudoRoot.get(), AsyncHttpQueue::AsyncWrite, boost::bind(resultFunction, pseudoRoot, requestResult, requestError));
    }
}
...
void InsertService::populateExtraInsertUrlParams(std::stringstream& url, bool clientInsert)
{
    ...
    {
        Aya::DataModel* dataModel = DataModel::get(this);
        url << "&serverplaceid=";
...
void InsertService::safeInsert(ContentId asset, bool clientInsert,
    boost::function<void(shared_ptr<Instance>, AsyncHttpQueue::RequestResult, shared_ptr<std::exception>)> callback)
{
    ...
    cp->loadContent(substitute, ContentProvider::PRIORITY_INSERT,
        boost::bind(&InsertService::RemoteInsertItemsLoadedHelper, weak_from(this), weak_from(cp),
...
void InsertService::safeInsert(InsertRequestType requestType, int id, bool clientInsert,
    boost::function<void(shared_ptr<Instance>, AsyncHttpQueue::RequestResult, shared_ptr<std::exception>)> callback)
{
    // Adding placeid to insert service requests
    // This is delayed until right before sending a request through
