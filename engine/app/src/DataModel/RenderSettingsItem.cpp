...
AYA_REGISTER_CLASS(CRenderSettingsItem);

AYA_REGISTER_ENUM(CRenderSettings::AASamples);
AYA_REGISTER_ENUM(CRenderSettings::GraphicsMode);
AYA_REGISTER_ENUM(CRenderSettings::FrameRateManagerMode);
AYA_REGISTER_ENUM(CRenderSettings::AntialiasingMode);
AYA_REGISTER_ENUM(CRenderSettings::QualityLevel);
AYA_REGISTER_ENUM(CRenderSettings::ResolutionPreset);
...
{
template<>
Reflection::EnumDesc<CRenderSettings::AASamples>::EnumDesc()
    : Aya::Reflection::EnumDescriptor("AASamples")
{
...
template<>
Reflection::EnumDesc<CRenderSettings::AntialiasingMode>::EnumDesc()
...
template<>
Reflection::EnumDesc<CRenderSettings::ResolutionPreset>::EnumDesc()
...
static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::GraphicsMode> prop_graphicsMode(
    "GraphicsMode", "General", &CRenderSettingsItem::getGraphicsMode, &CRenderSettingsItem::setGraphicsMode);
static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_exporterMergeByMaterial(
    "ExportMergeByMaterial", "General", &CRenderSettingsItem::getObjExportMergeByMaterial, &CRenderSettingsItem::setObjExportMergeByMaterial);

static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::FrameRateManagerMode> prop_frameRateManagerMode(
    "FrameRateManager", "General", &CRenderSettingsItem::getFrameRateManagerMode, &CRenderSettingsItem::setFrameRateManagerMode);
static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::QualityLevel> prop_frmQuality(
    "QualityLevel", "Performance", &CRenderSettingsItem::getQualityLevel, &CRenderSettingsItem::setQualityLevel);
static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::QualityLevel> prop_frmEditQuality(
    "EditQualityLevel", "Performance", &CRenderSettingsItem::getEditQualityLevel, &CRenderSettingsItem::setEditQualityLevel);

static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_ShowAggregation(
    "IsAggregationShown", "Debug", &CRenderSettingsItem::getShowAggregation, &CRenderSettingsItem::setShowAggregation);

static Reflection::BoundProp<bool> prop_IsSynchronizedWithPhysics(
    "IsSynchronizedWithPhysics", "Performance", &CRenderSettingsItem::isSynchronizedWithPhysics);
static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::AASamples> prop_AASamples(
    "AASamples", "Quality", &CRenderSettingsItem::getAASamples, &CRenderSettingsItem::setAASamples);
Reflection::BoundProp<std::string> CRenderSettingsItem::prop_profileName(
    "profileName", "Quality", &CRenderSettingsItem::profileName, Reflection::PropertyDescriptor::STREAMING);
static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::AntialiasingMode> prop_antialiasingMode(
    "Antialiasing", "Quality", &CRenderSettingsItem::getAntialiasingMode, &CRenderSettingsItem::setAntialiasingMode);
static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_debugShowBoundingBoxes(
    "ShowBoundingBoxes", "Debug", &CRenderSettingsItem::getDebugShowBoundingBoxes, &CRenderSettingsItem::setDebugShowBoundingBoxes);
static Reflection::PropDescriptor<CRenderSettingsItem, int> prop_autoQualityLevel(
    "AutoFRMLevel", "Debug", &CRenderSettingsItem::getAutoQualityLevel, &CRenderSettingsItem::setAutoQualityLevel);

static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_enableFRM(
    "EnableFRM", "Debug", &CRenderSettingsItem::getEnableFRM, &CRenderSettingsItem::setEnableFRM, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_debugDisableInterpolation(
    "DebugDisableInterpolation", "Debug", &CRenderSettingsItem::getDebugDisableInterpolation, &CRenderSettingsItem::setDebugDisableInterpolation);
static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_showInterpolationPath(
    "ShowInterpolationpath", "Debug", &CRenderSettingsItem::getShowInterpolationPath, &CRenderSettingsItem::setShowInterpolationPath);

static Reflection::PropDescriptor<CRenderSettingsItem, bool> prop_debugReloadAssets(
    "ReloadAssets", "Debug", &CRenderSettingsItem::getDebugReloadAssets, &CRenderSettingsItem::setDebugReloadAssets);

Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::ResolutionPreset> CRenderSettingsItem::prop_resolution(
    "Resolution", "Screen", &CRenderSettingsItem::getResolutionPreference, &CRenderSettingsItem::setResolutionPreference);

static Reflection::BoundFuncDesc<CRenderSettingsItem, int()> func_getMaxQualityLevel(
    &CRenderSettingsItem::getMaxQualityLevel, "GetMaxQualityLevel", Security::None);

static Reflection::PropDescriptor<CRenderSettingsItem, int> prop_textureCacheSize(
    "TextureCacheSize", "Cache", &CRenderSettingsItem::getTextureCacheSize, &CRenderSettingsItem::setTextureCacheSize);
static Reflection::PropDescriptor<CRenderSettingsItem, int> prop_meshCacheSize(
    "MeshCacheSize", "Cache", &CRenderSettingsItem::getMeshCacheSize, &CRenderSettingsItem::setMeshCacheSize);
REFLECTION_END();
...
#define SET_VAR(T, boolName, boolVar, Category) \
    static Reflection::PropDescriptor<CRenderSettingsItem, T> prop_##boolVar( \
        #boolName, Category, &CRenderSettingsItem::get##boolName, &CRenderSettingsItem::set##boolName); \
