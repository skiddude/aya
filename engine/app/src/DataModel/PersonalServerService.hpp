...
public:
    ...
    void setRank(Network::Player* player, int PlaceId, int newRank, boost::function<void(bool)> resumeFunction,
    ...
    std::string getRoleSets() const
    {
        return roleSets;
    }
    void setRoleSets(std::string value)
    {
        roleSets = value;
    }
