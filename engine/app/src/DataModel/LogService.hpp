...
public:
    ...
    Aya::signal<void(std::string, MessageType)> outputMessageSignal;
    Aya::remote_signal<void(shared_ptr<Instance>)> requestServerOutputSignal;
    Aya::remote_signal<void(std::string, MessageType, int)> serverOutputMessageSignal;
    Aya::remote_signal<void(shared_ptr<Instance>, std::string)> requestScriptExecutionSignal;
...
private:
    ...
    static void handleCanManageResponse(
    ...
    Aya::signals::scoped_connection listenForServerLogRequestConnection;
