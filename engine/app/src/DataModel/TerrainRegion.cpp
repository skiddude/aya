...
static Reflection::PropDescriptor<TerrainRegion, Vector3> prop_Extents(
    "SizeInCells", category_Data, &TerrainRegion::getSizeInCells, NULL, Reflection::PropertyDescriptor::UI);

static Reflection::PropDescriptor<TerrainRegion, Vector3int16> prop_ExtentsMin(
    "ExtentsMin", category_Data, &TerrainRegion::getExtentsMin, &TerrainRegion::setExtentsMin, Reflection::PropertyDescriptor::STREAMING);
static Reflection::PropDescriptor<TerrainRegion, Vector3int16> prop_ExtentsMax(
    "ExtentsMax", category_Data, &TerrainRegion::getExtentsMax, &TerrainRegion::setExtentsMax, Reflection::PropertyDescriptor::STREAMING);

static Reflection::PropDescriptor<TerrainRegion, BinaryString> prop_GridV3("GridV3", category_Data, &TerrainRegion::getPackagedGridV3,
    &TerrainRegion::setPackagedGridV3, Reflection::PropertyDescriptor::CLUSTER, Security::None);

static Reflection::PropDescriptor<TerrainRegion, BinaryString> desc_SmoothGrid("SmoothGrid", category_Data, &TerrainRegion::getPackagedSmoothGrid,
    &TerrainRegion::setPackagedSmoothGrid, Reflection::PropertyDescriptor::CLUSTER, Security::None);

static Reflection::PropDescriptor<TerrainRegion, bool> prop_IsSmooth(
    "IsSmooth", category_Data, &TerrainRegion::isSmooth, NULL, Reflection::PropertyDescriptor::UI, Security::None);

static Reflection::BoundFuncDesc<TerrainRegion, void(void)> func_convertToSmooth(
    &TerrainRegion::convertToSmooth, "ConvertToSmooth", Security::Plugin);
REFLECTION_END();
...
static void copyEmptyVoxels(
    Voxel::Grid& target, const Region3int16& sourceExtents, const Vector3int32& offset, const std::vector<SpatialRegion::Id>& sourceRegions)
{
    boost::unordered_set<SpatialRegion::Id, SpatialRegion::Id::boost_compatible_hash_value> sourceRegionsSet(
        sourceRegions.begin(), sourceRegions.end());

    Region3int16 targetExtents(
        (Vector3int32(sourceExtents.getMinPos()) + offset).toVector3int16(), (Vector3int32(sourceExtents.getMaxPos()) + offset).toVector3int16());
...
static void copyVoxels(
    Voxel::Grid& target, const Voxel::Grid& source, const Region3int16& sourceExtents, const Vector3int32& offset, bool copyEmptyCells)
{
...
static void copyVoxels(
    Voxel2::Grid& target, const Voxel2::Grid& source, const Region3int16& sourceExtents, const Vector3int32& offset, bool copyEmptyCells)
{
