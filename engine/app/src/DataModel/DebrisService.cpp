...
const char* const Aya::sDebrisService = "Debris";

using namespace Aya;


static Reflection::PropDescriptor<DebrisService, int> prop_MaxItems(
    "MaxItems", category_Data, &DebrisService::getMaxItems, &DebrisService::setMaxItems);
static Reflection::BoundFuncDesc<DebrisService, void(shared_ptr<Instance>, double)> func_AddItem(
    &DebrisService::addItem, "AddItem", "item", "lifetime", 10, Security::None);
static Reflection::BoundFuncDesc<DebrisService, void(shared_ptr<Instance>, double)> func_AddItem_deprecated(
    &DebrisService::addItem, "addItem", "item", "lifetime", 10, Security::None);

static Reflection::BoundFuncDesc<DebrisService, void(bool)> func_LegacyMaxItems(
    &DebrisService::setLegacyMaxItems, "SetLegacyMaxItems", "enabled", Security::LocalUser);
REFLECTION_END();
...
void DebrisService::setMaxItems(int value)
{
    if (!legacyMaxItems)
    {
        Aya::Security::Context::current().requirePermission(Aya::Security::LocalUser, "DebrisService MaxItems is restricted");
    }
