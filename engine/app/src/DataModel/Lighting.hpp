...
public:
    ...
    Aya::signal<void(bool)> lightingChangedSignal; // (arg=skyboxChanged)

    bool isSkySuppressed() const
    {
        return !hasSky;
    }
    void suppressSky(const bool value)
    {
        hasSky = !value;
    }

    shared_ptr<Sky> sky;
    shared_ptr<BlurEffect> blurEffect;
    shared_ptr<ColorCorrectionEffect> colorCorrectionEffect;
    shared_ptr<BloomEffect> bloomEffect;
    ...
    const G3D::Color3& getClearColor() const
    {
        return clearColor;
    }
    ...
    const G3D::Color3& getShadowColor() const
    {
        return shadowColor;
    }
    void setShadowColor(const G3D::Color3& value);

    const G3D::Color3& getFogColor() const
    {
        return fogColor;
    }
    ...
    float getMoonPhase()
    {
        return (float)skyParameters.moonPhase;
    }
    ...
    G3D::Color3 getTopColorShift() const
    {
        return topColorShift;
    }
    G3D::Color3 getBottomColorShift() const
    {
        return bottomColorShift;
    }
    float getGlobalBrightness() const
    {
        return globalBrightness;
    }
    G3D::Color3 getGlobalAmbient() const
    {
        return globalAmbient;
    }
    G3D::Color3 getGlobalOutdoorAmbient() const
    {
        return globalOutdoorAmbient;
    }

    G3D::Color3 getSkyAmbient() const
    {
        return (globalOutdoorAmbient - globalAmbient).max(Color3::zero());
    }
