...
static const Reflection::PropDescriptor<Fire, Color3> prop_SecondaryColor(
    "SecondaryColor", category_Data, &Fire::getSecondaryColor, &Fire::setSecondaryColor);

static const Reflection::PropDescriptor<Fire, float> prop_SizeUi(
    "Size", category_Data, &Fire::getSizeRaw, &Fire::setSizeUi, Reflection::PropertyDescriptor::UI);
static const Reflection::PropDescriptor<Fire, float> dep_SizeUi(
    "size", category_Data, &Fire::getSizeRaw, &Fire::setSizeUi, Reflection::PropertyDescriptor::Attributes::deprecated(prop_SizeUi));
static const Reflection::PropDescriptor<Fire, float> prop_HeatUi(
    "Heat", category_Data, &Fire::getHeatRaw, &Fire::setHeatUi, Reflection::PropertyDescriptor::UI);

static const Reflection::PropDescriptor<Fire, float> prop_Size(
    "size_xml", category_Data, &Fire::getSizeRaw, &Fire::setSize, Reflection::PropertyDescriptor::STREAMING);
static const Reflection::PropDescriptor<Fire, float> prop_Heat(
    "heat_xml", category_Data, &Fire::getHeatRaw, &Fire::setHeat, Reflection::PropertyDescriptor::STREAMING);
REFLECTION_END();
