...
private:
    ...
    shared_ptr<KeyframeSequence> privateGetKeyframeSequence(
        ContentId assetId, bool blocking, bool useCache, const std::string& contextString = "", const Instance* contextInstance = NULL);

    void JSONHttpHelper(const std::string* response, const std::exception* exception,
...
public:
    ...
    void getAnimations(int userId, int page, boost::function<void(shared_ptr<const Reflection::ValueTable>)> resumeFunction,
