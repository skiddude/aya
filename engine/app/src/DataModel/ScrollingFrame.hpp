...
public:
    ...
    Rect2D getVerticalBarRect() const
    {
        return verticalBarSize;
    }
    Rect2D getHorizontalBarRect() const
    {
    ...
    UDim2 getCanvasSize() const
    {
        return canvasSize;
    }
    void setCanvasSize(UDim2 value);

    Vector2 getCanvasPosition() const
    {
    ...
    TextureId getTopImage() const
    {
        return topImage;
    }
    void setTopImage(TextureId value);

    TextureId getMidImage() const
    {
        return midImage;
    }
    void setMidImage(TextureId value);

    TextureId getBottomImage() const
    {
        return bottomImage;
    }
...
private:
    ...
    Aya::Timer<Aya::Time::Fast> selectionTimer;
    ...
    Aya::Timer<Aya::Time::Fast> wheelUpTimer;
    Aya::Timer<Aya::Time::Fast> wheelDownTimer;
    Aya::Timer<Aya::Time::Fast> touchDeltaTimer;

    Aya::signals::scoped_connection inputEndedConnection;
    Aya::signals::scoped_connection guiServicePropertyChangedConnection;
    Aya::signals::scoped_connection selectionGainedConnection;
    Aya::signals::scoped_connection selectionLostConnection;
    ...
    void renderScrollbarSection(Adorn* adorn, GuiDrawImage& drawImage, const TextureId& image, const char* context, const Rect2D& imageRect,
    ...
    void selectedGuiObjectChanged(const Aya::Reflection::PropertyDescriptor* desc);
