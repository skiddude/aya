...
void GuiBase2d::RecursiveRenderChildren(shared_ptr<Aya::Instance> instance, Adorn* adorn)
{
    if (Aya::GuiBase2d* guiBase = Instance::fastDynamicCast<Aya::GuiBase2d>(instance.get()))
    {
...
static void ResizeChildren(shared_ptr<Aya::Instance> instance, const Rect2D& viewport, bool force)
{
    if (Aya::GuiBase2d* guiBase = Instance::fastDynamicCast<Aya::GuiBase2d>(instance.get()))
    {
        guiBase->handleResize(viewport, force);
    }
    else if (Aya::Folder* f = Instance::fastDynamicCast<Aya::Folder>(instance.get()))
    {
