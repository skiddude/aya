...
public:
    ...
    virtual Rect2D getChildRect2D() const
    {
        return getRect2DFloat();
    }
    virtual Rect2D getCanvasRect() const
    {
        return getChildRect2D();
    }
    ...
    //
    // GuiBase
    /*implement*/ virtual bool canProcessMeAndDescendants() const
    {
        return true;
    }
    /*implement*/ virtual int getZIndex() const
    {
        return zIndex;
    }
    /*implement*/ virtual GuiQueue getGuiQueue() const
    {
        return guiQueue;
    }
    ...
    {
        return false;
    } // explicit render traversal by ScreenGui or other.

    /*override*/ bool isVisible(const Rect2D& rect) const
    {
        return rect.intersects(getRect2D());
    }
...
protected:
    ...
    void setGuiQueue(GuiQueue queue)
    {
        guiQueue = queue;
    }
...
private:
    ...
    static void RecursiveRenderChildren(shared_ptr<Aya::Instance> instance, Adorn* adorn);
};
} // namespace Aya
