...
Surface::Surface(const Surface& lhs)
    : partInstance(lhs.partInstance)
    , surfId(lhs.surfId)
{
}
...
void Surface::setSurfaceInput(Aya::LegacyController::InputType value)
{
...
template<Aya::NormalId face, typename V, typename Get, typename Set>
...
template<Aya::NormalId face, typename V>
class SurfacePropDescriptor : public Reflection::TypedPropertyDescriptor<V>
{
public:
    template<typename Get, typename Set>
    SurfacePropDescriptor(const char* name, const char* category, Get get, Set set,
        Aya::Reflection::PropertyDescriptor::Functionality flags = Aya::Reflection::PropertyDescriptor::STANDARD,
        Security::Permissions security = Security::None)
        : Reflection::TypedPropertyDescriptor<V>(PartInstance::classDescriptor(), name, category,
              std::auto_ptr<typename Reflection::TypedPropertyDescriptor<V>::GetSet>(new SurfaceGetSet<face, V, Get, Set>(get, set)), flags, security)
    {
    }
};
...
public:
    ...
    virtual bool setStringValue(Reflection::DescribedBase* instance, const Aya::Name& name) const
    {
        V value;
    ...
    virtual void readValue(Reflection::DescribedBase* instance, const XmlElement* element, Aya::IReferenceBinder& binder) const
    {
        if (!element->isXsiNil())
        {
...
static SurfaceEnumPropDescriptor<NORM_Y, SurfaceType> desc_TopType(
    "TopSurface", "Surface", &PartInstance::getSurfaceType, &PartInstance::setSurfaceType);
static SurfaceEnumPropDescriptor<NORM_Y, LegacyController::InputType> desc_TopSurfaceInput(
    "TopSurfaceInput", "Surface Inputs", &PartInstance::getInput, &PartInstance::setSurfaceInput);
...
static SurfaceEnumPropDescriptor<NORM_Y_NEG, SurfaceType> desc_BottomType(
    "BottomSurface", "Surface", &PartInstance::getSurfaceType, &PartInstance::setSurfaceType);
static SurfaceEnumPropDescriptor<NORM_Y_NEG, LegacyController::InputType> desc_BottomSurfaceInput(
    "BottomSurfaceInput", "Surface Inputs", &PartInstance::getInput, &PartInstance::setSurfaceInput);
static SurfacePropDescriptor<NORM_Y_NEG, float> desc_BottomParamA(
    "BottomParamA", "Surface Inputs", &PartInstance::getParamA, &PartInstance::setParamA);
static SurfacePropDescriptor<NORM_Y_NEG, float> desc_BottomParamB(
    "BottomParamB", "Surface Inputs", &PartInstance::getParamB, &PartInstance::setParamB);

static SurfaceEnumPropDescriptor<NORM_X_NEG, SurfaceType> desc_LeftType(
    "LeftSurface", "Surface", &PartInstance::getSurfaceType, &PartInstance::setSurfaceType);
static SurfaceEnumPropDescriptor<NORM_X_NEG, LegacyController::InputType> desc_LeftSurfaceInput(
    "LeftSurfaceInput", "Surface Inputs", &PartInstance::getInput, &PartInstance::setSurfaceInput);
...
static SurfaceEnumPropDescriptor<NORM_X, SurfaceType> desc_RightType(
    "RightSurface", "Surface", &PartInstance::getSurfaceType, &PartInstance::setSurfaceType);
static SurfaceEnumPropDescriptor<NORM_X, LegacyController::InputType> desc_RightSurfaceInput(
    "RightSurfaceInput", "Surface Inputs", &PartInstance::getInput, &PartInstance::setSurfaceInput);
...
static SurfaceEnumPropDescriptor<NORM_Z_NEG, SurfaceType> desc_FrontType(
    "FrontSurface", "Surface", &PartInstance::getSurfaceType, &PartInstance::setSurfaceType);
static SurfaceEnumPropDescriptor<NORM_Z_NEG, LegacyController::InputType> desc_FrontSurfaceInput(
    "FrontSurfaceInput", "Surface Inputs", &PartInstance::getInput, &PartInstance::setSurfaceInput);
...
static SurfaceEnumPropDescriptor<NORM_Z, SurfaceType> desc_BackType(
    "BackSurface", "Surface", &PartInstance::getSurfaceType, &PartInstance::setSurfaceType);
static SurfaceEnumPropDescriptor<NORM_Z, LegacyController::InputType> desc_BackSurfaceInput(
    "BackSurfaceInput", "Surface Inputs", &PartInstance::getInput, &PartInstance::setSurfaceInput);
...
// AYA_REGISTER_TYPE(Aya::SurfaceType);
