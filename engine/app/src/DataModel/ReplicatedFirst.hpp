...
public:
    ...
    Aya::signal<void()> finishedReplicatingSignal;
    Aya::signal<void()> removeDefaultLoadingGuiSignal;

    void doRemoveDefaultLoadingGui();
    bool getIsDefaultLoadingGuiRemoved()
    {
        return isDefaultLoadingGuiRemoved;
    }

    bool getIsFinishedReplicating()
    {
        return allInstancesHaveReplicated;
    }

    void setAllInstancesHaveReplicated();
    bool getAllInstancesHaveReplicated()
    {
        return allInstancesHaveReplicated;
    }
