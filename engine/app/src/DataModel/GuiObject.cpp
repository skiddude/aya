...
//////////////////////////////////////////////////////////
static const Reflection::BoundFuncDesc<GuiObject,
    bool(UDim2, UDim2, TweenInfo::TweenEasingDirection, TweenInfo::TweenEasingStyle, float, bool, Lua::WeakFunctionRef)>
    func_tweenSizeAndPosition(&GuiObject::tweenSizeAndPosition, "TweenSizeAndPosition", "endSize", "endPosition", "easingDirection",
        TweenInfo::EASING_DIRECTION_OUT, "easingStyle", TweenInfo::EASING_STYLE_QUAD, "time", 1, "override", false, "callback",
        Lua::WeakFunctionRef(), Security::None);
static const Reflection::BoundFuncDesc<GuiObject,
    bool(UDim2, TweenInfo::TweenEasingDirection, TweenInfo::TweenEasingStyle, float, bool, Lua::WeakFunctionRef)>
    func_tweenPosition(&GuiObject::tweenPosition, "TweenPosition", "endPosition", "easingDirection", TweenInfo::EASING_DIRECTION_OUT, "easingStyle",
        TweenInfo::EASING_STYLE_QUAD, "time", 1, "override", false, "callback", Lua::WeakFunctionRef(), Security::None);
static const Reflection::BoundFuncDesc<GuiObject,
    bool(UDim2, TweenInfo::TweenEasingDirection, TweenInfo::TweenEasingStyle, float, bool, Lua::WeakFunctionRef)>
    func_tweenSize(&GuiObject::tweenSize, "TweenSize", "endSize", "easingDirection", TweenInfo::EASING_DIRECTION_OUT, "easingStyle",
        TweenInfo::EASING_STYLE_QUAD, "time", 1, "override", false, "callback", Lua::WeakFunctionRef(), Security::None);
...
static const Reflection::PropDescriptor<GuiObject, int> prop_BorderSizePixel(
    "BorderSizePixel", category_Data, &GuiObject::getBorderSizePixel, &GuiObject::setBorderSizePixel);
...
static const Reflection::EnumPropDescriptor<GuiObject, GuiObject::SizeConstraint> prop_SizeConstraint(
    "SizeConstraint", category_Data, &GuiObject::getSizeConstraint, &GuiObject::setSizeConstraint);

static const Reflection::PropDescriptor<GuiObject, BrickColor> prop_BorderColor(
    "BorderColor", category_Data, &GuiObject::getBorderColor, &GuiObject::setBorderColor, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
static const Reflection::PropDescriptor<GuiObject, Color3> prop_BorderColor3(
    "BorderColor3", category_Data, &GuiObject::getBorderColor3, &GuiObject::setBorderColor3);

static const Reflection::PropDescriptor<GuiObject, BrickColor> prop_BackgroundColor("BackgroundColor", category_Data, &GuiObject::getBackgroundColor,
    &GuiObject::setBackgroundColor, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
static const Reflection::PropDescriptor<GuiObject, Color3> prop_BackgroundColor3(
    "BackgroundColor3", category_Data, &GuiObject::getBackgroundColor3, &GuiObject::setBackgroundColor3);

static const Reflection::PropDescriptor<GuiObject, float> prop_BackgroundTransparency(
    "BackgroundTransparency", category_Data, &GuiObject::getBackgroundTransparency, &GuiObject::setBackgroundTransparency);

static const Reflection::PropDescriptor<GuiObject, bool> prop_Draggable(
    "Draggable", category_Behavior, &GuiObject::getDraggable, &GuiObject::setDraggable);
static const Reflection::PropDescriptor<GuiObject, bool> prop_Clipping(
    "ClipsDescendants", category_Behavior, &GuiObject::getClipping, &GuiObject::setClipping);
...
static const Reflection::PropDescriptor<GuiObject, bool> prop_Selectable(
    "Selectable", category_Data, &GuiObject::getSelectable, &GuiObject::setSelectable, Reflection::PropertyDescriptor::STANDARD, Security::None);

static const Reflection::PropDescriptor<GuiObject, float> prop_Transparency("Transparency", category_Data, &GuiObject::getTransparencyLegacy,
    &GuiObject::setTransparencyLegacy, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);

static Reflection::RemoteEventDesc<GuiObject, void(int, int)> event_MouseEnter(&GuiObject::mouseEnterSignal, "MouseEnter", "x", "y", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiObject, void(int, int)> event_MouseLeave(&GuiObject::mouseLeaveSignal, "MouseLeave", "x", "y", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiObject, void(int, int)> event_MouseMoved(&GuiObject::mouseMovedSignal, "MouseMoved", "x", "y", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiObject, void(int, int)> event_MouseWheelForward(&GuiObject::mouseWheelForwardSignal, "MouseWheelForward", "x",
    "y", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiObject, void(int, int)> event_MouseWheelBackward(&GuiObject::mouseWheelBackwardSignal, "MouseWheelBackward",
    "x", "y", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::RemoteEventDesc<GuiObject, void(int, int)> event_DragStopped(&GuiObject::dragStoppedSignal, "DragStopped", "x", "y",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiObject, void(UDim2)> event_DragBegin(&GuiObject::dragBeginSignal, "DragBegin", "initialPosition",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);

// High Level touch events
static Reflection::EventDesc<GuiObject, void(shared_ptr<const Aya::Reflection::ValueArray>)> event_TapGesture(
    &GuiObject::tapGestureEvent, "TouchTap", "touchPositions", Security::None);
static Reflection::EventDesc<GuiObject, void(shared_ptr<const Aya::Reflection::ValueArray>, float, float, InputObject::UserInputState)>
    event_PinchGesture(&GuiObject::pinchGestureEvent, "TouchPinch", "touchPositions", "scale", "velocity", "state", Security::None);
static Reflection::EventDesc<GuiObject, void(UserInputService::SwipeDirection, int)> event_SwipeGesture(
    &GuiObject::swipeGestureEvent, "TouchSwipe", "swipeDirection", "numberOfTouches", Security::None);
static Reflection::EventDesc<GuiObject, void(shared_ptr<const Aya::Reflection::ValueArray>, InputObject::UserInputState)> event_LongPressGesture(
    &GuiObject::longPressGestureEvent, "TouchLongPress", "touchPositions", "state", Security::None);
static Reflection::EventDesc<GuiObject, void(shared_ptr<const Aya::Reflection::ValueArray>, float, float, InputObject::UserInputState)>
    event_RotateGesture(&GuiObject::rotateGestureEvent, "TouchRotate", "touchPositions", "rotation", "velocity", "state", Security::None);
static Reflection::EventDesc<GuiObject, void(shared_ptr<const Aya::Reflection::ValueArray>, Vector2, Vector2, InputObject::UserInputState)>
    event_PanGesture(&GuiObject::panGestureEvent, "TouchPan", "touchPositions", "totalTranslation", "velocity", "state", Security::None);

// Low Level Generic input events
static Reflection::EventDesc<GuiObject, void(shared_ptr<Instance>)> event_InputBegin(
    &GuiObject::inputBeganEvent, "InputBegan", "input", Security::None);
static Reflection::EventDesc<GuiObject, void(shared_ptr<Instance>)> event_InputUpdate(
    &GuiObject::inputChangedEvent, "InputChanged", "input", Security::None);
static Reflection::EventDesc<GuiObject, void(shared_ptr<Instance>)> event_InputEnd(
    &GuiObject::inputEndedEvent, "InputEnded", "input", Security::None);

// Gamepad selection overrides
static Reflection::RefPropDescriptor<GuiObject, GuiObject> prop_nextSelectionUp("NextSelectionUp", category_Behavior, &GuiObject::getNextSelectionUp,
    &GuiObject::setNextSelectionUp, Reflection::PropertyDescriptor::STANDARD, Security::None);
static Reflection::RefPropDescriptor<GuiObject, GuiObject> prop_nextSelectionDown("NextSelectionDown", category_Behavior,
    &GuiObject::getNextSelectionDown, &GuiObject::setNextSelectionDown, Reflection::PropertyDescriptor::STANDARD, Security::None);
static Reflection::RefPropDescriptor<GuiObject, GuiObject> prop_nextSelectionLeft("NextSelectionLeft", category_Behavior,
    &GuiObject::getNextSelectionLeft, &GuiObject::setNextSelectionLeft, Reflection::PropertyDescriptor::STANDARD, Security::None);
static Reflection::RefPropDescriptor<GuiObject, GuiObject> prop_nextSelectionRight("NextSelectionRight", category_Behavior,
    &GuiObject::getNextSelectionRight, &GuiObject::setNextSelectionRight, Reflection::PropertyDescriptor::STANDARD, Security::None);

static Reflection::RefPropDescriptor<GuiObject, GuiObject> prop_SelectionImageObject("SelectionImageObject", category_Appearance,
    &GuiObject::getSelectionImageObject, &GuiObject::setSelectionImageObject, Reflection::PropertyDescriptor::STANDARD, Security::None);
...
void GuiObject::UpdateTween(Tween& tween, GuiObject* obj, boost::function<void(GuiObject*, UDim2)> updateFunc, float timeStep)
{
    ...
    if (tween.elapsedTime >= tween.totalTime)
    {
        ...
        if (tween.callback)
        {
            ...
            {
                if (TweenService* tweenService = Aya::ServiceProvider::create<TweenService>(obj))
                {
    ...
    {
        updateFunc(obj, TweenInterpolate(tween.style, tween.variance, tween.elapsedTime, tween.totalTime, tween.start, tween.end));
    }
}
...
bool GuiObject::tweenPosition(UDim2 endPosition, TweenInfo::TweenEasingDirection style, TweenInfo::TweenEasingStyle variance, float time,
    bool overwrite, Lua::WeakFunctionRef callback)
{
    return tweenPositionDelay(
        getPosition(), endPosition, time, style, variance, 0.0f, overwrite, boost::bind(&InvokeTweenStatusCallback, weak_from(this), callback, _1));
}

bool GuiObject::tweenPosition(
    UDim2 endPosition, TweenInfo::TweenEasingDirection style, TweenInfo::TweenEasingStyle variance, float time, bool overwrite, bool removeOnCallback)
{
    TweenService* tweenService = ServiceProvider::create<TweenService>(this);
    if (removeOnCallback)
        return tweenPositionDelay(getPosition(), endPosition, time, style, variance, 0.0f, overwrite,
            boost::bind(&InvokeRemoveOnTweenEnd, weak_from(this), Lua::WeakFunctionRef()), tweenService);
    else
        return tweenPositionDelay(getPosition(), endPosition, time, style, variance, 0.0f, overwrite,
            boost::bind(&InvokeTweenStatusCallback, weak_from(this), Lua::WeakFunctionRef(), _1), tweenService);
}

bool GuiObject::tweenPosition(UDim2 endPosition, TweenInfo::TweenEasingDirection style, TweenInfo::TweenEasingStyle variance, float time,
    bool overwrite, bool removeOnCallback, TweenService* tweenService)
{
    if (removeOnCallback)
        return tweenPositionDelay(getPosition(), endPosition, time, style, variance, 0.0f, overwrite,
            boost::bind(&InvokeRemoveOnTweenEnd, weak_from(this), Lua::WeakFunctionRef()), tweenService);
...
bool GuiObject::tweenSize(UDim2 endSize, TweenInfo::TweenEasingDirection style, TweenInfo::TweenEasingStyle variance, float time, bool overwrite,
    Lua::WeakFunctionRef callback)
{
    return tweenSizeDelay(
        getSize(), endSize, time, style, variance, 0.0f, overwrite, boost::bind(&InvokeTweenStatusCallback, weak_from(this), callback, _1));
}

bool GuiObject::tweenSizeAndPosition(UDim2 endSize, UDim2 endPosition, TweenInfo::TweenEasingDirection style, TweenInfo::TweenEasingStyle variance,
...
bool GuiObject::tweenPositionDelay(UDim2 startPosition, UDim2 endPosition, float time, TweenInfo::TweenEasingDirection style,
    TweenInfo::TweenEasingStyle variance, float delayTime, bool overwrite, boost::function<void(TweenInfo::TweenStatus)> callback)
{
    TweenService* tweenService = ServiceProvider::create<TweenService>(this);
    ...
    TweenService* tweenService)
{
    ...
    AYAASSERT(!tweens->positionTween);
...
bool GuiObject::tweenSizeDelay(UDim2 startSize, UDim2 endSize, float time, TweenInfo::TweenEasingDirection style,
    TweenInfo::TweenEasingStyle variance, float delayTime, bool overwrite, boost::function<void(TweenInfo::TweenStatus)> callback)
{
    TweenService* tweenService = ServiceProvider::create<TweenService>(this);
    if (!tweenService)
...
UDim2 GuiObject::TweenInterpolate(TweenInfo::TweenEasingDirection style, TweenInfo::TweenEasingStyle variance, float elapsedTime, float totalTime,
    ...
    case TweenInfo::EASING_STYLE_BOUNCE:
    {
        ...
        case TweenInfo::EASING_DIRECTION_IN:
            return (endValue - startValue) -
                   TweenInterpolate(TweenInfo::EASING_DIRECTION_OUT, TweenInfo::EASING_STYLE_BOUNCE, totalTime - elapsedTime, totalTime, UDim2(),
                       endValue - startValue) +
                   startValue;
        case TweenInfo::EASING_DIRECTION_OUT:
        {
        ...
        case TweenInfo::EASING_DIRECTION_IN_OUT:
            if (elapsedTime < totalTime * 0.5)
                return TweenInterpolate(TweenInfo::EASING_DIRECTION_IN, TweenInfo::EASING_STYLE_BOUNCE, elapsedTime * 2, totalTime, UDim2(),
                           endValue - startValue) *
                           0.5 +
                       startValue;
            else
                return TweenInterpolate(TweenInfo::EASING_DIRECTION_OUT, TweenInfo::EASING_STYLE_BOUNCE, elapsedTime * 2 - totalTime, totalTime,
                           UDim2(), endValue - startValue) *
                           0.5 +
                       (endValue - startValue) * .5 + startValue;
        default:
            AYAASSERT(0);
            return UDim2();
        }
...
static Vector2 getConstrainedSize(const Vector2& parentSize, GuiObject::SizeConstraint sizeConstraint)
{
    ...
    {
    case GuiObject::RELATIVE_XX:
        return Vector2(parentSize.x, parentSize.x);
    case GuiObject::RELATIVE_YY:
        return Vector2(parentSize.y, parentSize.y);
...
void GuiObject::handleDrag(Aya::Vector2 mousePosition)
{
    if (mousePosition != lastMousePosition)
    {
        Vector2 mouseDelta = mousePosition - lastMousePosition;
        setPosition(Aya::UDim2(position.x.scale, position.x.offset + mouseDelta.x, position.y.scale, position.y.offset + mouseDelta.y));
...
bool GuiObject::recalculateAbsolutePlacement(const Rect2D& parentViewport)
{
    ...
    Vector2 transformedPosition =
        parentRotation.rotate(parentViewport.x0y0() + (position * parentViewport.wh()) + absoluteSizeFloat * 0.5f) - absoluteSizeFloat * 0.5f;
...
{
    AYAASSERT(isFinite(value.x.scale) || isFinite(value.y.scale));
...
void GuiObject::setBorderSizePixel(int value)
{
    ...
    if (value > MAX_BORDER_SIZE_PIXEL)
        value = MAX_BORDER_SIZE_PIXEL;
...
{
    if (Aya::Security::Context::current().hasPermission(Aya::Security::RobloxScript))
    {
    ...
    if (value > GuiBase::maxZIndex2d())
        value = GuiBase::maxZIndex2d();
...
void GuiObject::render2dImpl(Adorn* adorn, const Color4& _backgroundColor, Rect2D& rect)
{
    ...
    if (alpha > 0)
    {
        ...
        else
        {
            ...
            if (_borderSize > 0)
                adorn->outlineRect2d(rect, (float)_borderSize, _borderColor, clippingObject->getClippedRect());
        }
    }
}
...
void GuiObject::renderSelectionFrame(Adorn* adorn, GuiObject* baseSelectionObject)
{
    ...
    if (baseSelectionObject && baseSelectionObject->getVisible())
    {
        ...
        Vector2 absolutePosition = getAbsolutePosition() + (getAbsoluteSize() * Vector2(selectedGuiObjPos.x.scale, selectedGuiObjPos.y.scale)) +
                                   Vector2(selectedGuiObjPos.x.offset, selectedGuiObjPos.y.offset);
        if (GuiService* guiService = Aya::ServiceProvider::find<Aya::GuiService>(this))
        {
            absolutePosition += guiService->getGlobalGuiInset().xy();
        }

        const UDim2 selectedGuiObjSize = baseSelectionObject->getSize();
        Vector2 absoluteSize = (getAbsoluteSize() * Vector2(selectedGuiObjSize.x.scale, selectedGuiObjSize.y.scale)) +
                               Vector2(selectedGuiObjSize.x.offset, selectedGuiObjSize.y.offset);
        ...
        baseSelectionObject->setAbsoluteRotation(
            Rotation2D(getAbsoluteRotation().getAngle().combine(selectionObjectRotation), baseSelectionObject->getRect2D().center()));
...
void GuiObject::renderStudioSelectionBox(Adorn* adorn)
{
    if (selectionBox)
    {
        ...
        adorn->outlineRect2d(outlineRect, 3.0f, Aya::Color4(Aya::Color3(0.1f, 0.6f, 1.0f)), absoluteRotation);
    }
}
// Used by children without text
void GuiObject::render2dImpl(Adorn* adorn, const Color4& _backgroundColor)
{
    Rect2D rect;
...
void GuiObject::render2dScale9Impl(Adorn* adorn, const TextureId& texId, const Vector2int16& scaleEdgeSize, const Vector2& minSize,
...
static void computeScale9Sizes2(
    Rect output[9], Rect uvs[9], const Rect2D& renderRect, Rect2D& sliceRect, const Rect2D& textureBounds, const Vector2& textureSize)
{
...
void GuiObject::render2dScale9Impl2(Adorn* adorn, const TextureId& texId, GuiDrawImage& guiImageDraw, Rect2D& scaleRect, GuiObject* clippingObject,
    Color4& color, Rect2D* overrideRect, Rect2D* imageOffsetRect)
{
            ...
            if (sizes[i].size().x > 0 && sizes[i].size().y > 0 && imageWidth > 0 && imageHeight > 0)
            {
                if (clippingObject == NULL || !absoluteRotation.empty())
                    ...
                    guiImageDraw.render2d(
                        adorn, true, sizes[i], uvs[i].low, uvs[i].high, color, clippingObject->getClippedRect(), Gui::NOTHING, false);
            }
        }
    }
}

Vector2 GuiObject::render2dTextImpl(Adorn* adorn, const Color4& _backgroundColor, const std::string& _textName, TextService::Font _font,
    TextService::FontSize _fontSizeEnum, const Color4& _textColor, const Color4& _textStrokeColor, bool _textWrap, bool _textScale,
    TextService::XAlignment _xalignment, TextService::YAlignment _yalignment)
{
    // Background color
    Rect2D rect;
    render2dImpl(adorn, _backgroundColor, rect);

    return render2dTextImpl(
        adorn, rect, _textName, _font, _fontSizeEnum, _textColor, _textStrokeColor, _textWrap, _textScale, _xalignment, _yalignment);
}

Vector2 GuiObject::render2dTextImpl(Adorn* adorn, const Color4& _backgroundColor, const std::string& _textName, TextService::Font _font,
    float _textSize, const Color4& _textColor, const Color4& _textStrokeColor, bool _textWrap, bool _textScale, TextService::XAlignment _xalignment,
    TextService::YAlignment _yalignment)
{
    ...
    return render2dTextImpl(adorn, rect, _textName, _font, _textSize, _textColor, _textStrokeColor, _textWrap, _textScale, _xalignment, _yalignment);
}
...
float GuiObject::getScaledFontSize(const Rect2D& rect, const std::string& _textName, TextService::Font _font, bool _textWrap, float _fontSize)
{
    if (TextService* textService = ServiceProvider::create<TextService>(this))
    {
        if (Typesetter* typesetter = textService->getTypesetter(_font))
        {
            ...
            while (biggestLegal <= max)
            {
                ...
                typesetter->measure(_textName, mid, _textWrap ? rect.wh() : Vector2::zero(), &textFits);
...
Vector2 GuiObject::render2dTextImpl(Adorn* adorn, const Rect2D& rectIn, const std::string& _textName, TextService::Font _font,
    TextService::FontSize _fontSizeEnum, const Color4& _textColor, const Color4& _textStrokeColor, bool _textWrap, bool _textScale,
    TextService::XAlignment _xalignment, TextService::YAlignment _yalignment)
{
    Rect2D rect;
    ...
    if (adorn->useFontSmoothScalling())
        ...
        _fontSize = _textScale ? getScaledFontSize(rect, _textName, _font, _textWrap, _fontSize)
                               : getFontSizeScale(_textScale, _textWrap, _fontSizeEnum, rect);
    ...
    if (clippingObject == NULL || !absoluteRotation.empty())
    {
        return adorn->drawFont2D(_textName, pos, _fontSize, autoScale, _textColor, _textStrokeColor, TextService::ToTextFont(_font),
            TextService::ToTextXAlign(_xalignment), TextService::ToTextYAlign(_yalignment), wh,
            getClipping() ? rect : Aya::Rect2D::xyxy(-1, -1, -1, -1), absoluteRotation);
    }
    else
    {
        Aya::Rect2D clippedRect = clippingObject->getClippedRect();
        if (getClipping())
            clippedRect = clippedRect.intersect(rect);

        return adorn->drawFont2D(_textName, pos, _fontSize, autoScale, _textColor, _textStrokeColor, TextService::ToTextFont(_font),
            TextService::ToTextXAlign(_xalignment), TextService::ToTextYAlign(_yalignment), wh, clippedRect);
    }
}

Vector2 GuiObject::render2dTextImpl(Adorn* adorn, const Rect2D& rectIn, const std::string& _textName, TextService::Font _font, float _textSize,
...
void GuiObject::fireGenericInputEvent(const shared_ptr<InputObject>& event)
{
    ...
    AYAASSERT(event->getUserInputState() != InputObject::INPUT_STATE_NONE && event->getUserInputType() != InputObject::TYPE_NONE);
...
void GuiObject::fireGestureEvent(const UserInputService::Gesture& gesture, const shared_ptr<const Aya::Reflection::ValueArray>& touchPositions,
    const shared_ptr<const Reflection::Tuple>& args)
{
    ...
    case UserInputService::GESTURE_ROTATE:
        ...
        rotateGestureEvent(
            touchPositions, args->values[0].cast<float>(), args->values[1].cast<float>(), args->values[2].cast<InputObject::UserInputState>());
        break;
    ...
    case UserInputService::GESTURE_PAN:
        ...
        panGestureEvent(touchPositions, args->values[0].cast<Aya::Vector2>(), args->values[1].cast<Aya::Vector2>(),
            args->values[2].cast<InputObject::UserInputState>());
        break;
...
GuiResponse GuiObject::processGesture(const UserInputService::Gesture& gesture, const shared_ptr<const Aya::Reflection::ValueArray>& touchPositions,
    const shared_ptr<const Reflection::Tuple>& args)
{
    if (!visible)
        return GuiResponse::notSunk();
    ...
    {
        if (!mouseIsOver(iter->get<Aya::Vector2>()))
        {
            gestureIsOver = false;
            break;
        }
...
bool GuiObject::mouseIsOver(const Vector2& mousePosition)
{
    ...
    {
        Aya::Rect2D clippedRect = getRect2D().intersect(clippingObject->getClippedRect());
...
GuiResponse GuiObject::processMouseEventInternal(const shared_ptr<InputObject>& event, bool fireEvents)
{
    ...
    if (fireEvents)
    {
        if (mouseOver && (wasNothing || wasDownAway))
        {
            mouseEnterSignal(mousePosition.x, mousePosition.y);
        }
        if (mouseOver && eventMoved)
        {
            mouseMovedSignal(mousePosition.x, mousePosition.y);
        }
        if (mouseOver && eventMouseWheelForward)
        {
            mouseWheelForwardSignal(mousePosition.x, mousePosition.y);
        }
        if (mouseOver && eventMouseWheelBackward)
        {
            mouseWheelBackwardSignal(mousePosition.x, mousePosition.y);
        }
        if (!mouseOver && (wasHover || wasDownOver))
        {
            mouseLeaveSignal(mousePosition.x, mousePosition.y);
        }
    }
...
bool GuiObject::isCurrentlyVisible()
{
    ...
    if (Aya::ScreenGui* screenGui = Instance::fastDynamicCast<Aya::ScreenGui>(getParent()))
...
static Reflection::RemoteEventDesc<GuiButton, void()> event_MouseButton1Click(&GuiButton::mouseButton1ClickSignal, "MouseButton1Click",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiButton, void()> event_MouseButton2Click(&GuiButton::mouseButton2ClickSignal, "MouseButton2Click",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiButton, void(int, int)> event_MouseButton1Down(&GuiButton::mouseButton1DownSignal, "MouseButton1Down", "x", "y",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiButton, void(int, int)> event_MouseButton1Up(&GuiButton::mouseButton1UpSignal, "MouseButton1Up", "x", "y",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiButton, void(int, int)> event_MouseButton2Down(&GuiButton::mouseButton2DownSignal, "MouseButton2Down", "x", "y",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<GuiButton, void(int, int)> event_MouseButton2Up(&GuiButton::mouseButton2UpSignal, "MouseButton2Up", "x", "y",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
...
static const Reflection::PropDescriptor<GuiButton, bool> prop_AutoButtonColor(
    "AutoButtonColor", category_Data, &GuiButton::getAutoButtonColor, &GuiButton::setAutoButtonColor);
...
static const Reflection::EnumPropDescriptor<GuiButton, GuiButton::Style> prop_Style(
    "Style", category_Data, &GuiButton::getStyle, &GuiButton::setStyle);
REFLECTION_END();
...
void GuiButton::setVerb(std::string verbString)
{
    ...
    if (Workspace* workspace = ServiceProvider::find<Workspace>(this))
    {
        ...
        {
            Aya::Security::setHackFlagVmp<LINE_RAND4>(Aya::Security::hackFlag10, HATE_VERB_SNATCH);
            verb = NULL;
        }
#endif
        verbToSet = "";
...
{
    static const TextureId sGreyTransp = TextureId("ayaasset://textures/ui/btn_greyTransp.png");
    static const TextureId sGrey = TextureId("ayaasset://textures/ui/btn_grey.png");
    static const TextureId sWhite = TextureId("ayaasset://textures/ui/btn_white.png");
    static const TextureId sRed = TextureId("ayaasset://textures/ui/btn_red.png");
    static const TextureId sRedGlow = TextureId("ayaasset://textures/ui/btn_redGlow.png");
    static const TextureId sNewGrey = TextureId("ayaasset://textures/ui/btn_newGrey.png");
    static const TextureId sNewGreyGlow = TextureId("ayaasset://textures/ui/btn_newGreyGlow.png");
    static const TextureId sNewBlue = TextureId("ayaasset://textures/ui/btn_newBlue.png");
    static const TextureId sNewBlueGlow = TextureId("ayaasset://textures/ui/btn_newBlueGlow.png");
    static const TextureId sNewWhite = TextureId("ayaasset://textures/ui/btn_newWhite.png");
    static const TextureId sNewWhiteGlow = TextureId("ayaasset://textures/ui/btn_newWhiteGlow.png");
    ...
    case CUSTOM_STYLE:
    {
        ...
        if (getAutoButtonColor())
        {
            ...
            {
            case Gui::HOVER:
                renderColor = Color4(myBackColor.lerp(Color3::black(), 0.3f), renderColor.a);
                break;
            case Gui::DOWN_OVER:
                renderColor = Color4(myBackColor.lerp(Color3::white(), 0.3f), renderColor.a);
                break;
            case Gui::DOWN_AWAY:
                renderColor = Color4(myBackColor.lerp(Color3::black(), 0.3f), renderColor.a);
                break;
...
GuiResponse GuiButton::processTouchEvent(const shared_ptr<InputObject>& event)
{
    ...
    {
        if (Aya::ScrollingFrame* scrollFrame = findFirstAncestorOfType<Aya::ScrollingFrame>())
        {
                ...
                if (event->getUserInputState() == InputObject::INPUT_STATE_END)
                {
                    ...
                    if (event == lastSharedObj)
                    {
                        ...
                        if (verb != NULL)
                        {
                            ...
                            if (verb->isEnabled())
                            {
                                Verb::doItWithChecks(verb, Aya::DataModel::get(this));
                            }
                        }
...
GuiResponse GuiButton::processKeyEvent(const shared_ptr<InputObject>& event)
{
    ...
    if (event->getKeyCode() == AYA_SDLK_RETURN)
    {
...
GuiResponse GuiButton::processGamepadEvent(const shared_ptr<InputObject>& event)
{
    ...
    if (event->getKeyCode() == AYA_SDLK_GAMEPAD_BUTTONA)
    {
        GuiResponse response = checkForSelectedObjectClick(event);
        if (response.wasSunk())
        {
...
GuiResponse GuiButton::processMouseEvent(const shared_ptr<InputObject>& event)
{
    ...
    if (eventRightButtonUp && wasDownOver && shouldFireClickedEvent)
    {
        sinkEvent = true;
        mouseButton2ClickSignal();
    }
    if (mouseOver && eventLeftButtonDown)
    {
        sinkEvent = true;
        mouseButton1DownSignal(mousePosition.x, mousePosition.y);
    }
    if (mouseOver && eventRightButtonDown)
    {
        sinkEvent = true;
        mouseButton2DownSignal(mousePosition.x, mousePosition.y);
    }
    if (mouseOver && eventLeftButtonUp)
    {
        sinkEvent = true;
        mouseButton1UpSignal(mousePosition.x, mousePosition.y);
    }
    if (mouseOver && eventRightButtonUp)
    {
        sinkEvent = true;
        mouseButton2UpSignal(mousePosition.x, mousePosition.y);
    }
