...
static Reflection::BoundYieldFuncDesc<RemoteFunction, shared_ptr<const Reflection::Tuple>(shared_ptr<const Reflection::Tuple>)> func_InvokeServer(
    &RemoteFunction::invokeServer, "InvokeServer", "arguments", Security::None);
static Reflection::BoundYieldFuncDesc<RemoteFunction, shared_ptr<const Reflection::Tuple>(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)>
    func_InvokeClient(&RemoteFunction::invokeClient, "InvokeClient", "player", "arguments", Security::None);

static Reflection::BoundAsyncCallbackDesc<RemoteFunction,
    shared_ptr<const Reflection::Tuple>(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)>
    callback_OnServerInvoke("OnServerInvoke", &RemoteFunction::onServerInvoke, "player", "arguments", &RemoteFunction::onServerInvokeChanged);
static Reflection::BoundAsyncCallbackDesc<RemoteFunction, shared_ptr<const Reflection::Tuple>(shared_ptr<const Reflection::Tuple>)>
    callback_OnClientInvoke("OnClientInvoke", &RemoteFunction::onClientInvoke, "arguments", &RemoteFunction::onClientInvokeChanged);

static Reflection::RemoteEventDesc<RemoteFunction, void(int, shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)> event_RemoteOnInvokeServer(
    &RemoteFunction::remoteOnInvokeServer, "RemoteOnInvokeServer", "id", "player", "arguments", Security::None,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<RemoteFunction, void(int, shared_ptr<const Reflection::Tuple>)> event_RemoteOnInvokeClient(
    &RemoteFunction::remoteOnInvokeClient, "RemoteOnInvokeClient", "id", "arguments", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<RemoteFunction, void(int, shared_ptr<const Reflection::Tuple>)> event_RemoteOnInvokeSuccess(
    &RemoteFunction::remoteOnInvokeSuccess, "RemoteOnInvokeSuccess", "id", "arguments", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<RemoteFunction, void(int, std::string)> event_RemoteOnInvokeError(&RemoteFunction::remoteOnInvokeError,
    "RemoteOnInvokeError", "id", "arguments", Security::None, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::CLIENT_SERVER);

const char* const sRemoteEvent = "RemoteEvent";
static Reflection::BoundFuncDesc<RemoteEvent, void(shared_ptr<const Reflection::Tuple>)> func_FireServer(
    &RemoteEvent::fireServer, "FireServer", "arguments", Security::None);
static Reflection::BoundFuncDesc<RemoteEvent, void(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)> func_FireClient(
    &RemoteEvent::fireClient, "FireClient", "player", "arguments", Security::None);
static Reflection::BoundFuncDesc<RemoteEvent, void(shared_ptr<const Reflection::Tuple>)> func_FireAllClients(
    &RemoteEvent::fireAllClients, "FireAllClients", "arguments", Security::None);

static Reflection::RemoteEventDesc<RemoteEvent, void(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>),
    LatchedSignal<Aya::remote_signal, void(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)>,
    LatchedSignal<Aya::remote_signal, void(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)>* (RemoteEvent::*)(bool)>
    event_OnServerEvent(&RemoteEvent::getOrCreateOnServerEvent, "OnServerEvent", "player", "arguments", Security::None,
        Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::RemoteEventDesc<RemoteEvent, void(shared_ptr<const Reflection::Tuple>),
    LatchedSignal<Aya::remote_signal, void(shared_ptr<const Reflection::Tuple>)>,
    LatchedSignal<Aya::remote_signal, void(shared_ptr<const Reflection::Tuple>)>* (RemoteEvent::*)(bool)>
    event_OnClientEvent(&RemoteEvent::getOrCreateOnClientEvent, "OnClientEvent", "arguments", Security::None,
        Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
REFLECTION_END();
...
void DelayedInvocationQueue::process()
{
    ...
    for (size_t i = 0; i < temp.size(); ++i)
    {
        ...
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_OUTPUT, "DelayedInvocationQueue::process encountered an error %s", e.what());
            AYACRASH();
        }
    }
}
...
void RemoteFunction::invokeServer(shared_ptr<const Reflection::Tuple> arguments,
...
void RemoteFunction::invokeClient(shared_ptr<Instance> player, shared_ptr<const Reflection::Tuple> arguments,
    boost::function<void(shared_ptr<const Reflection::Tuple>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    else if (Network::Players::serverIsPresent(this))
    {
        ...
        const Aya::SystemAddress& target = p->getRemoteAddressAsRbxAddress();
...
int RemoteFunction::createRemoteInvocation(const weak_ptr<Instance>& player,
    const boost::function<void(shared_ptr<const Reflection::Tuple>)>& resumeFunction, const boost::function<void(std::string)>& errorFunction)
{
    ...
    AYAASSERT(remoteInvocations.count(id) == 0);
...
void RemoteFunction::processRemoteEvent(
    const Reflection::EventDescriptor& descriptor, const Reflection::EventArguments& args, const SystemAddress& source)
{
    if (&descriptor == &event_RemoteOnInvokeServer)
    {
        ...
        {
            localInvokeServer(player, arguments, boost::bind(&RemoteFunction::remoteSuccess, this, source, id, _1),
                boost::bind(&RemoteFunction::remoteError, this, source, id, _1));
        }
        else
        {
            Aya::StandardOut::singleton()->printf(
                Aya::MESSAGE_SENSITIVE, "RemoteFunction::processRemoteEvent: ignore a remote call from %x:%d", source.getAddress(), source.getPort());
        }
    }
    else if (&descriptor == &event_RemoteOnInvokeClient)
    {
        AYAASSERT(args.size() == 2);

        int id = args[0].cast<int>();
        shared_ptr<const Reflection::Tuple> arguments = args[1].cast<shared_ptr<const Reflection::Tuple>>();

        localInvokeClient(arguments, boost::bind(&RemoteFunction::remoteSuccess, this, source, id, _1),
            boost::bind(&RemoteFunction::remoteError, this, source, id, _1));
    }
    else
    {
...
void RemoteFunction::localInvokeServer(shared_ptr<Instance> player, shared_ptr<const Reflection::Tuple> arguments,
    boost::function<void(shared_ptr<const Reflection::Tuple>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
...
void RemoteFunction::localInvokeClient(shared_ptr<const Reflection::Tuple> arguments,
    boost::function<void(shared_ptr<const Reflection::Tuple>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
...
LatchedSignal<Aya::remote_signal, void(shared_ptr<Instance>, shared_ptr<const Reflection::Tuple>)>* RemoteEvent::getOrCreateOnServerEvent(bool create)
{
...
LatchedSignal<Aya::remote_signal, void(shared_ptr<const Reflection::Tuple>)>* RemoteEvent::getOrCreateOnClientEvent(bool create)
{
...
void RemoteEvent::processRemoteEvent(
    const Reflection::EventDescriptor& descriptor, const Reflection::EventArguments& args, const SystemAddress& source)
{
    if (&descriptor == &event_OnServerEvent)
    {
        ...
        {
            Aya::StandardOut::singleton()->printf(
                Aya::MESSAGE_SENSITIVE, "RemoteEvent::processRemoteEvent: ignore a remote call from %x:%d", source.getAddress(), source.getPort());
        }
    }
    else
    {
