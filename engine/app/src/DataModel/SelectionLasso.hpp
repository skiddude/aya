...
public:
    ...
    const Humanoid* getHumanoid() const
    {
        return humanoid.lock().get();
    }
    Humanoid* getHunanoid()
    {
        return humanoid.lock().get();
    }
    void setHumanoid(Humanoid* value);
    Humanoid* getHumanoidDangerous() const
    {
        return humanoid.lock().get();
    }
...
public:
    ...
    const PartInstance* getPart() const
    {
        return part.lock().get();
    }
    ...
    PartInstance* getPartDangerous() const
    {
        return part.lock().get();
    }
