...
private:
    ...
    Aya::signal<void(shared_ptr<Instance>)> dialogChoice;

public:
    DialogRoot();
    ~DialogRoot();

    DialogPurpose getDialogPurpose() const
    {
        return dialogPurpose;
    }
    void setDialogPurpose(DialogPurpose value);

    DialogTone getDialogTone() const
    {
        return dialogTone;
    }
    void setDialogTone(DialogTone value);

    bool getPublicChat() const
    {
        return publicChat;
    }
    ...
    float getConversationDistance() const
    {
    ...
    Aya::remote_signal<void(shared_ptr<Instance>, shared_ptr<Instance>)> dialogChoiceSelected;
