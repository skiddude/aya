...
private:
    ...
    Aya::signals::connection selectedConnectionShim;

public:
    HopperBin();

    Aya::remote_signal<void()> replicatedSelectedSignal;
    Aya::remote_signal<void(shared_ptr<Instance>)> selectedSignal;
    Aya::signal<void()> deselectedSignal;
