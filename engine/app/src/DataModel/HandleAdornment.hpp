...
public:
    ...
    Aya::remote_signal<void()> mouseEnterSignal;
    Aya::remote_signal<void()> mouseLeaveSignal;
    Aya::remote_signal<void()> mouseButton1DownSignal;
    Aya::remote_signal<void()> mouseButton1UpSignal;
...
class BoxHandleAdornment : public DescribedCreatable<BoxHandleAdornment, HandleAdornment, sBoxHandleAdornment>
{
public:
    BoxHandleAdornment();
...
class ConeHandleAdornment : public DescribedCreatable<ConeHandleAdornment, HandleAdornment, sConeHandleAdornment>
{
public:
    ConeHandleAdornment();
...
class CylinderHandleAdornment : public DescribedCreatable<CylinderHandleAdornment, HandleAdornment, sCylinderHandleAdornment>
{
public:
...
class SphereHandleAdornment : public DescribedCreatable<SphereHandleAdornment, HandleAdornment, sSphereHandleAdornment>
{
public:
...
class LineHandleAdornment : public DescribedCreatable<LineHandleAdornment, HandleAdornment, sLineHandleAdornment>
{
public:
    LineHandleAdornment();
...
class ImageHandleAdornment : public DescribedCreatable<ImageHandleAdornment, HandleAdornment, sImageHandleAdornment>
{
public:
