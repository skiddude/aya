...
Reflection::PropDescriptor<HandleAdornment, Vector3> HandleAdornment::prop_sizeRelativeOffset(
    "SizeRelativeOffset", category_Data, &HandleAdornment::getOffset, &HandleAdornment::setOffset);
Reflection::PropDescriptor<HandleAdornment, CoordinateFrame> HandleAdornment::prop_adornCFrame(
    "CFrame", category_Data, &HandleAdornment::getCFrame, &HandleAdornment::setCFrame);
Reflection::PropDescriptor<HandleAdornment, int> HandleAdornment::prop_adornZIndex(
    "ZIndex", category_Data, &HandleAdornment::getZIndex, &HandleAdornment::setZIndex);
Reflection::PropDescriptor<HandleAdornment, bool> HandleAdornment::prop_alwaysOnTop(
    "AlwaysOnTop", category_Data, &HandleAdornment::getAlwaysOnTop, &HandleAdornment::setAlwaysOnTop);

static Reflection::RemoteEventDesc<HandleAdornment, void()> event_MouseEnter(&HandleAdornment::mouseEnterSignal, "MouseEnter", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<HandleAdornment, void()> event_MouseLeave(&HandleAdornment::mouseLeaveSignal, "MouseLeave", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<HandleAdornment, void()> event_MouseDown(&HandleAdornment::mouseButton1DownSignal, "MouseButton1Down",
    Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<HandleAdornment, void()> event_MouseUp(&HandleAdornment::mouseButton1UpSignal, "MouseButton1Up", Security::None,
    Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
REFLECTION_END();
...
CoordinateFrame HandleAdornment::getWorldCoordinateFrame() const
{
    ...
    {
        if (shared_ptr<PartInstance> partInstance = Aya::Instance::fastSharedDynamicCast<PartInstance>(pvInstance))
        {
        ...
        else if (shared_ptr<ModelInstance> modelInstance = Aya::Instance::fastSharedDynamicCast<ModelInstance>(pvInstance))
        {
            Aya::Part pvPart = modelInstance->computePart();
...
static Reflection::PropDescriptor<BoxHandleAdornment, Vector3> prop_boxSize(
    "Size", category_Data, &BoxHandleAdornment::getSize, &BoxHandleAdornment::setSize);
...
bool BoxHandleAdornment::isCollidingWithHandle(const shared_ptr<InputObject>& inputObject)
{
    if (Workspace* workspace = Workspace::findWorkspace(this))
    {
        ...
        float collision_time = G3D::CollisionDetection::collisionTimeForMovingPointFixedBox(
            localRay.origin(), localRay.direction().unit(), Box(boxSize * -0.5, boxSize * 0.5), tempHitPoint);
...
static Reflection::PropDescriptor<ConeHandleAdornment, float> prop_coneRadius(
    "Radius", category_Data, &ConeHandleAdornment::getRadius, &ConeHandleAdornment::setRadius);
static Reflection::PropDescriptor<ConeHandleAdornment, float> prop_coneHeight(
    "Height", category_Data, &ConeHandleAdornment::getHeight, &ConeHandleAdornment::setHeight);
...
bool ConeHandleAdornment::isCollidingWithHandle(const shared_ptr<InputObject>& inputObject)
{
    if (Workspace* workspace = Workspace::findWorkspace(this))
    {
        ...
        float tri_collision_time =
            G3D::CollisionDetection::collisionTimeForMovingPointFixedTriangle(gridRay.origin(), gridRay.direction().unit(), Triangle(v1, v2, v3));
        ...
        G3D::CollisionDetection::collisionTimeForMovingPointFixedPlane(
            gridRay.origin(), gridRay.direction().unit(), Plane(basePlaneNormal, worldFrame.translation), hitLocation);
...
static Reflection::PropDescriptor<CylinderHandleAdornment, float> prop_cylinderRadius(
    "Radius", category_Data, &CylinderHandleAdornment::getRadius, &CylinderHandleAdornment::setRadius);
static Reflection::PropDescriptor<CylinderHandleAdornment, float> prop_cylinderHeight(
    "Height", category_Data, &CylinderHandleAdornment::getHeight, &CylinderHandleAdornment::setHeight);
...
bool CylinderHandleAdornment::isCollidingWithHandle(const shared_ptr<InputObject>& inputObject)
{
    if (Workspace* workspace = Workspace::findWorkspace(this))
    {
        ...
        Vector3 hitLocation;
        float collision_time_rect = G3D::CollisionDetection::collisionTimeForMovingPointFixedRectangle(gridRay.origin(), gridRay.direction().unit(),
            endpoint1 + tangent, endpoint2 + tangent, endpoint2 - tangent, endpoint1 - tangent, hitLocation);
        ...
        float plane_collision_time1 = G3D::CollisionDetection::collisionTimeForMovingPointFixedPlane(
            gridRay.origin(), gridRay.direction().unit(), Plane(planeNormal, endpoint1), hitLocation1);

        Vector3 hitLocation2;
        float plane_collision_time2 = G3D::CollisionDetection::collisionTimeForMovingPointFixedPlane(
            gridRay.origin(), gridRay.direction().unit(), Plane(planeNormal, endpoint2), hitLocation2);

        return collision_time_rect != G3D::inf() || (plane_collision_time1 != G3D::inf() && (hitLocation1 - endpoint1).magnitude() <= radius) ||
...
static Reflection::PropDescriptor<SphereHandleAdornment, float> prop_sphereRadius(
    "Radius", category_Data, &SphereHandleAdornment::getRadius, &SphereHandleAdornment::setRadius);
...
bool SphereHandleAdornment::isCollidingWithHandle(const shared_ptr<InputObject>& inputObject)
{
    if (Workspace* workspace = Workspace::findWorkspace(this))
    {
        ...
        float collision_time = G3D::CollisionDetection::collisionTimeForMovingPointFixedSphere(
            gridRay.origin(), gridRay.direction().unit(), Sphere(worldFrame.translation, radius), hitLocation);
...
static Reflection::PropDescriptor<LineHandleAdornment, float> prop_lineLength(
    "Length", category_Data, &LineHandleAdornment::getLength, &LineHandleAdornment::setLength);
static Reflection::PropDescriptor<LineHandleAdornment, float> prop_lineThickness(
    "Thickness", category_Data, &LineHandleAdornment::getThickness, &LineHandleAdornment::setThickness);
...
bool LineHandleAdornment::isCollidingWithHandle(const shared_ptr<InputObject>& inputObject)
{
    if (Workspace* workspace = Workspace::findWorkspace(this))
    {
        ...
        Aya::Camera* camera = workspace->getCamera();
        ...
        float collision_time1 = G3D::CollisionDetection::collisionTimeForMovingPointFixedRectangle(
            mouseLocation, Vector3(0, 0, -1), v0, pointA.y < pointB.y ? v2 : v1, v3, pointA.y < pointB.y ? v1 : v2, hitLocation);
...
void LineHandleAdornment::render3dAdorn(Adorn* adorn)
{
    ...
    if (shared_ptr<PVInstance> pvInstance = adornee.lock())
    {
        ...
        adorn->line3dAA(cFrame.translation, cFrame.translation + cFrame.lookVector() * length, Color4(color, 1.0f - transparency), thickness, zIndex,
            alwaysOnTop);
    }
}
...
static Reflection::PropDescriptor<ImageHandleAdornment, Vector2> prop_imageSize(
    "Size", category_Data, &ImageHandleAdornment::getSize, &ImageHandleAdornment::setSize);
static Reflection::PropDescriptor<ImageHandleAdornment, TextureId> prop_imageLocation(
    "Image", category_Data, &ImageHandleAdornment::getImage, &ImageHandleAdornment::setImage);
...
ImageHandleAdornment::ImageHandleAdornment()
    ...
    , image("ayaasset://textures/SurfacesDefault.png")
{
...
bool ImageHandleAdornment::isCollidingWithHandle(const shared_ptr<InputObject>& inputObject)
{
    if (Workspace* workspace = Workspace::findWorkspace(this))
    {
        ...
        float collision_time = G3D::CollisionDetection::collisionTimeForMovingPointFixedRectangle(
            gridRay.origin(), gridRay.direction().unit(), v1, v0, v2, v3, hitLocation);
