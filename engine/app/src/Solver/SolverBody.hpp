...
{
public:
    AYA_SIMD_INLINE Vector3 operator*(const Vector3& v) const
    {
        Vector3 r;
    ...
    AYA_SIMD_INLINE SymmetricMatrix operator*(float s) const
    {
        SymmetricMatrix r;
...
{
public:
    AYA_SIMD_INLINE SymmetricMatrixSIMD(const float* _m)
    {
        diagonals = simd::load3(_m);
        offDiagonals = simd::load3(_m + 3);
    }

    AYA_SIMD_INLINE SymmetricMatrixSIMD(const simd::v4f& _diagonal, const simd::v4f& _offDiagonal)
        : diagonals(_diagonal)
        , offDiagonals(_offDiagonal)
    {
    }

    AYA_SIMD_INLINE SymmetricMatrixSIMD(const SymmetricMatrixPOD& _m)
        : diagonals(_m.diagonals)
        , offDiagonals(_m.offDiagonals)
    {
    }
    ...
    AYA_SIMD_INLINE simd::v4f operator*(const simd::v4f& v) const
    {
...
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<0, 0>() const
{
    return simd::splat<0>(diagonals);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<1, 1>() const
{
    return simd::splat<1>(diagonals);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<2, 2>() const
{
    return simd::splat<2>(diagonals);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<0, 1>() const
{
    return simd::splat<0>(offDiagonals);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<0, 2>() const
{
    return simd::splat<1>(offDiagonals);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<1, 2>() const
{
    return simd::splat<2>(offDiagonals);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<1, 0>() const
{
    return get<0, 1>();
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<2, 0>() const
{
    return get<0, 2>();
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<2, 1>() const
{
    return get<1, 2>();
}

static AYA_SIMD_INLINE SymmetricMatrixSIMD operator*(const simd::v4f& s, const SymmetricMatrixSIMD& m)
{
...
{
public:
    AYA_SIMD_INLINE SymmetricMatrix2SIMD() {}

    AYA_SIMD_INLINE SymmetricMatrix2SIMD(const simd::v4f& d00, const simd::v4f& d11, const simd::v4f& d01)
    {
        m = simd::gatherX(d00, d01, d01, d11);
    }

    AYA_SIMD_INLINE void load(const float* _m)
    {
        m = simd::form(_m[0], _m[2], _m[2], _m[1]);
    }

    AYA_SIMD_INLINE void form(const simd::v4f& d00, const simd::v4f& d11, const simd::v4f& d01)
    {
        m = simd::gatherX(d00, d01, d01, d11);
    }
...
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<0, 0>() const
{
    return simd::splat<0>(m);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<1, 0>() const
{
    return simd::splat<1>(m);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<0, 1>() const
{
    return simd::splat<1>(m);
}
template<>
AYA_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<1, 1>() const
{
    return simd::splat<3>(m);
}
...
public:
    ...
    AYA_SIMD_INLINE SymmetricMatrixSIMD getInvInertiaVelStage() const
    {
        return inertiaSIMD;
    }

    AYA_SIMD_INLINE SymmetricMatrixSIMD getInvInertiaPosStage(float scale) const
    {
    ...
    AYA_SIMD_INLINE simd::v4f getInvMassVelStage() const
    {
        return simd::splat(massInvVelStage);
    }

    AYA_SIMD_INLINE simd::v4f getInvMassPosStage() const
    {
    ...
    AYA_SIMD_INLINE simd::v4f getInvMass() const;

    template<class StageSelect>
    AYA_SIMD_INLINE SymmetricMatrixSIMD getInvInertia(float scale) const;
...
template<>
AYA_SIMD_INLINE simd::v4f SolverBodyMassAndInertia::getInvMass<SolverBodyMassAndInertia::VelStage>() const
{
    return getInvMassVelStage();
}

template<>
AYA_SIMD_INLINE simd::v4f SolverBodyMassAndInertia::getInvMass<SolverBodyMassAndInertia::PosStage>() const
{
    return getInvMassPosStage();
}

template<>
AYA_SIMD_INLINE SymmetricMatrixSIMD SolverBodyMassAndInertia::getInvInertia<SolverBodyMassAndInertia::VelStage>(float scale) const
{
    return getInvInertiaVelStage();
}

template<>
AYA_SIMD_INLINE SymmetricMatrixSIMD SolverBodyMassAndInertia::getInvInertia<SolverBodyMassAndInertia::PosStage>(float scale) const
{
