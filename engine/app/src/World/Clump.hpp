...
public:
    ...
    Clump* getRootClump()
    {
        return getRoot<Clump>();
    }
    const Clump* getRootClump() const
    {
        return getRoot<Clump>();
    }

    Primitive* getClumpPrimitive()
    {
        return aya_static_cast<Primitive*>(getLower());
    }
    const Primitive* getConstClumpPrimitive() const
    {
        return aya_static_cast<const Primitive*>(getConstLower());
    }
