...
private:
    ...
    /*override*/ virtual bool isBroken() const
    {
        return false;
    }
...
protected:
    static void faceIdToCoords(Primitive* p0, Primitive* p1, NormalId nId0, NormalId nId1, CoordinateFrame& c0, CoordinateFrame& c1);

public:
    RigidJoint() {}

    RigidJoint(Primitive* prim0, Primitive* prim1, const CoordinateFrame& c0, const CoordinateFrame& c1)
