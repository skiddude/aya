...
bool SnapJoint::compatibleSurfaces(Primitive* p0, Primitive* p1, NormalId nId0, NormalId nId1)
{
    ...
    return (((t0 == STUDS) && (t1 == INLET)) || ((t0 == INLET) && (t1 == STUDS)) || ((t0 == UNIVERSAL) && (t1 == UNIVERSAL)) ||
...
{
    if (SnapJoint::compatibleSurfaces(p0, p1, nId0, nId1) && Joint::canBuildJointTight(p0, p1, nId0, nId1))
    {
