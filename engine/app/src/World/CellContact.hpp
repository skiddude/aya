...
public:
    ...
    const Vector3int32& getGridFeature() const
    {
        return gridFeature;
    }
...
public:
    ...
    POLY::Mesh* getCellMesh(void)
    {
        return cellMesh;
    }

    bool cellFaceIsInterior(const Vector3int16& mainCellLoc, Aya::Voxel::FaceDirection faceDir);
};
} // namespace Aya
