...
public:
    ...
    RotateJoint(Primitive* axlePrim, Primitive* holePrim, const CoordinateFrame& c0, const CoordinateFrame& c1);
    ...
    {
        return getPrimitive(AXLE_ID);
    }
    Primitive* getHolePrim()
    {
        return getPrimitive(HOLE_ID);
    }

    NormalId getAxleId()
    {
        return getNormalId(AXLE_ID);
    }
    NormalId getHoleId()
    {
        return getNormalId(HOLE_ID);
    }
...
private:
    ...
    /*override*/ bool canStepWorld() const
    {
        return true;
    }
    /*override*/ bool canStepUi() const
    {
        return true;
    }
...
public:
    ...
    DynamicRotateJoint(Primitive* axlePrim, Primitive* holePrim, const CoordinateFrame& c0, const CoordinateFrame& c1, float baseAngle);
...
public:
    ...
    RotatePJoint(Primitive* axlePrim, Primitive* holePrim, const CoordinateFrame& c0, const CoordinateFrame& c1, float baseAngle)
...
public:
    ...
    RotateVJoint(Primitive* axlePrim, Primitive* holePrim, const CoordinateFrame& c0, const CoordinateFrame& c1, float baseAngle);
