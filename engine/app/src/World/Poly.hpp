...
protected:
    ...
    float getCenterToCornerDistance() const
    {
        return centerToCornerDistance;
    }

    Vector3 getCenterToCornerWorst() const
    {
...
public:
    ...
    /*override*/ float getRadius() const
    {
        return centerToCornerDistance;
    }

    /*override*/ Vector3 getCenterToCorner(const Matrix3& rotation) const
    {
        return getCenterToCornerWorst();
    }
