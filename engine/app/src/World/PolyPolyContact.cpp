...
void PolyPolyContact::findBestPair()
{
    ...
    { // only doing face face - Tim - if you set this to 3 we will get EdgeEdgePairs.
...
float FaceFacePair::closestVertex(
...
bool FaceFacePair::loadVertices(FixedArray<VertexStatus, CONTACT_ARRAY_SIZE>* vertexStatus, CoordinateFrame* vertexInFace,
...
bool FaceFacePair::testVerticesInside(
...
FaceFacePair::VertexStatus FaceFacePair::vertexInPoly(
...
void FaceFacePair::validateOneSideIntersection(
...
void FaceFacePair::checkOneSideIntersection(
...
void FaceFacePair::vertexInside(
