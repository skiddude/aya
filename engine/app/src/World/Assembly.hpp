...
#include "Utility/IndexedMesh.hpp"
...
public:
    ...
    // From SpatialFilter
    FilterPhase getFilterPhase() const
    {
        return filterPhase;
    }
    void setFilterPhase(FilterPhase value)
    {
        filterPhase = value;
    }
    ...
    const SimJob* getConstSimJob() const
    {
        return simJob;
    }
    ...
    void setAssemblyState(Sim::AssemblyState value)
    {
        state = value;
    }

    void setRecursivePassId(int value)
    {
        recursivePassId = value;
    }
    int getRecursivePassId() const
    {
        return recursivePassId;
    }

    void setRecursiveDepth(int value)
    {
    ...
    float getLastComputedRadius() const
    {
        return maxRadius.getLastComputedValue();
    }
    float isComputedRadiusDirty() const
    {
        return maxRadius.getDirty();
    }

    // Replicated attributes (essentially used as Humanoid State)
    unsigned char getNetworkHumanoidState() const
    {
        return networkHumanoidState;
    }
    void setNetworkHumanoidState(unsigned char value)
    {
        networkHumanoidState = value;
    }
    ...
    bool isAnimationControlled() const
    {
        return animationControlled;
    }
    void setAnimationControlled(bool val)
    {
        animationControlled = val;
    }
