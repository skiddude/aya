...
{
    return PhysicalProperties(getDefaultMaterialDensity(material), getDefaultMaterialFriction(material), getDefaultMaterialElasticity(material),
        getDefaultMaterialFrictionWeight(material), getDefaultMaterialElasticityWeight(material));
}
...
void MaterialProperties::updateContactParamsPrims(ContactParams& params, Primitive* prim0, Primitive* prim1)
{
    ...
    params.kFriction = calculateUsingWeightedAverage(prop0.getFrictionWeight(), prop0.getFriction(), prop1.getFrictionWeight(), prop1.getFriction());
    params.kElasticity =
        calculateUsingWeightedAverage(prop0.getElasticityWeight(), prop0.getElasticity(), prop1.getElasticityWeight(), prop1.getElasticity());
...
void MaterialProperties::updateContactParamsPrimMaterial(ContactParams& params, Primitive* prim, Primitive* otherPrim, PartMaterial otherMaterial)
{
    ...
    params.kFriction = calculateUsingWeightedAverage(
        propPrim.getFrictionWeight(), propPrim.getFriction(), propMaterial.getFrictionWeight(), propMaterial.getFriction());
    params.kElasticity = calculateUsingWeightedAverage(
        propPrim.getElasticityWeight(), propPrim.getElasticity(), propMaterial.getElasticityWeight(), propMaterial.getElasticity());
...
float MaterialProperties::getDefaultMaterialFriction(PartMaterial material)
{
    if (FFlag::ModifyDefaultMaterialProperties)
    {
        ...
        case PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_PLASTIC_MATERIAL); // NYLON
        case SMOOTH_PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_SMOOTH_PLASTIC_MATERIAL); // TEFLON
        case NEON_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_NEON_MATERIAL);
        case WOOD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_WOOD_MATERIAL); // WOOD
        case WOODPLANKS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_WOODPLANKS_MATERIAL); // WOOD
        case MARBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_MARBLE_MATERIAL);
        case SLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_SLATE_MATERIAL);
        case CONCRETE_MATERIAL:
            return getPropertyValueFromFlag(
                FInt::PhysicalPropFriction_CONCRETE_MATERIAL); // CONCRETE SEE 11.7.4.3 of
                                                               // https://law.resource.org/pub/us/cfr/ibr/001/aci.318.1995.pdf
        case GRANITE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_GRANITE_MATERIAL);
        case BRICK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_BRICK_MATERIAL);
        case PEBBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_PEBBLE_MATERIAL);
        case COBBLESTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_COBBLESTONE_MATERIAL);
        case RUST_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_RUST_MATERIAL); // IRON
        case DIAMONDPLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_DIAMONDPLATE_MATERIAL); // GUESS: based on Aluminum and Steel experimental
                                                                                               // data.
        case ALUMINUM_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_ALUMINUM_MATERIAL); // GUESS: Manually tested small bricks of Aluminum
        case METAL_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_METAL_MATERIAL); // STEEL
        case GRASS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_GRASS_MATERIAL);
        case SAND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_SAND_MATERIAL);
        case FABRIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_FABRIC_MATERIAL);
        case ICE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_ICE_MATERIAL); // ICE
        case AIR_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_AIR_MATERIAL);
        case WATER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_WATER_MATERIAL);
        case ROCK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_ROCK_MATERIAL);
        case GLACIER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_GLACIER_MATERIAL);
        case SNOW_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_SNOW_MATERIAL);
        case SANDSTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_SANDSTONE_MATERIAL);
        case MUD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_MUD_MATERIAL);
        case BASALT_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_BASALT_MATERIAL);
        case GROUND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_GROUND_MATERIAL);
        case CRACKED_LAVA_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFriction_CRACKED_LAVA_MATERIAL);
        default:;
        }
    }
    else
    {
        ...
        case SLATE_MATERIAL:
            return 0.40;
        case CONCRETE_MATERIAL:
            return 0.70; // CONCRETE SEE 11.7.4.3 of https://law.resource.org/pub/us/cfr/ibr/001/aci.318.1995.pdf
        case GRANITE_MATERIAL:
            return 0.40;
        case BRICK_MATERIAL:
            return 0.80;
        ...
        case RUST_MATERIAL:
            return 0.70; // IRON
        case DIAMONDPLATE_MATERIAL:
            return 0.35; // GUESS: based on Aluminum and Steel experimental data.
        case ALUMINUM_MATERIAL:
            return 0.40; // GUESS: Manually tested small bricks of Aluminum
        case METAL_MATERIAL:
            return 0.40; // STEEL
        case GRASS_MATERIAL:
            return 0.40;
...
float MaterialProperties::getDefaultMaterialFrictionWeight(PartMaterial material)
{
    if (FFlag::ModifyDefaultMaterialProperties)
    {
        ...
        case LEGACY_MATERIAL:
        case PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_PLASTIC_MATERIAL); // NYLON
        case SMOOTH_PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_SMOOTH_PLASTIC_MATERIAL); // TEFLON
        case NEON_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_NEON_MATERIAL);
        case WOOD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_WOOD_MATERIAL); // WOOD
        case WOODPLANKS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_WOODPLANKS_MATERIAL); // WOOD
        case MARBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_MARBLE_MATERIAL);
        case SLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_SLATE_MATERIAL);
        case CONCRETE_MATERIAL:
            return getPropertyValueFromFlag(
                FInt::PhysicalPropFWeight_CONCRETE_MATERIAL); // CONCRETE SEE 11.7.4.3 of https://law.resource.org/pub/us/cfr/ibr/001/aci.318.1995.pdf
        case GRANITE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_GRANITE_MATERIAL);
        case BRICK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_BRICK_MATERIAL);
        case PEBBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_PEBBLE_MATERIAL);
        case COBBLESTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_COBBLESTONE_MATERIAL);
        case RUST_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_RUST_MATERIAL); // IRON
        case DIAMONDPLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_DIAMONDPLATE_MATERIAL); // GUESS: based on Aluminum and Steel experimental data.
        case ALUMINUM_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_ALUMINUM_MATERIAL); // GUESS: Manually tested small bricks of Aluminum
        case METAL_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_METAL_MATERIAL); // STEEL
        case GRASS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_GRASS_MATERIAL);
        case SAND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_SAND_MATERIAL);
        case FABRIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_FABRIC_MATERIAL);
        case ICE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_ICE_MATERIAL); // ICE
        case AIR_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_AIR_MATERIAL);
        case WATER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_WATER_MATERIAL);
        case ROCK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_ROCK_MATERIAL);
        case GLACIER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_GLACIER_MATERIAL);
        case SNOW_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_SNOW_MATERIAL);
        case SANDSTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_SANDSTONE_MATERIAL);
        case MUD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_MUD_MATERIAL);
        case BASALT_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_BASALT_MATERIAL);
        case GROUND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_GROUND_MATERIAL);
        case CRACKED_LAVA_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropFWeight_CRACKED_LAVA_MATERIAL);
        default:;
        }
    }
    else
...
float MaterialProperties::getDefaultMaterialElasticity(PartMaterial material)
{
    if (FFlag::ModifyDefaultMaterialProperties)
    {
        ...
        case LEGACY_MATERIAL:
        case PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_PLASTIC_MATERIAL); // NYLON
        case SMOOTH_PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_SMOOTH_PLASTIC_MATERIAL); // TEFLON
        case NEON_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_NEON_MATERIAL);
        case WOOD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_WOOD_MATERIAL); // WOOD
        case WOODPLANKS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_WOODPLANKS_MATERIAL); // WOOD
        case MARBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_MARBLE_MATERIAL);
        case SLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_SLATE_MATERIAL);
        case CONCRETE_MATERIAL:
            return getPropertyValueFromFlag(
                FInt::PhysicalPropElasticity_CONCRETE_MATERIAL); // CONCRETE SEE 11.7.4.3 of
                                                                 // https://law.resource.org/pub/us/cfr/ibr/001/aci.318.1995.pdf
        case GRANITE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_GRANITE_MATERIAL);
        case BRICK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_BRICK_MATERIAL);
        case PEBBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_PEBBLE_MATERIAL);
        case COBBLESTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_COBBLESTONE_MATERIAL);
        case RUST_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_RUST_MATERIAL); // IRON
        case DIAMONDPLATE_MATERIAL:
            return getPropertyValueFromFlag(
                FInt::PhysicalPropElasticity_DIAMONDPLATE_MATERIAL); // GUESS: based on Aluminum and Steel experimental data.
        case ALUMINUM_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_ALUMINUM_MATERIAL); // GUESS: Manually tested small bricks of Aluminum
        case METAL_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_METAL_MATERIAL); // STEEL
        case GRASS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_GRASS_MATERIAL);
        case SAND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_SAND_MATERIAL);
        case FABRIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_FABRIC_MATERIAL);
        case ICE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_ICE_MATERIAL); // ICE
        case AIR_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_AIR_MATERIAL);
        case WATER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_WATER_MATERIAL);
        case ROCK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_ROCK_MATERIAL);
        case GLACIER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_GLACIER_MATERIAL);
        case SNOW_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_SNOW_MATERIAL);
        case SANDSTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_SANDSTONE_MATERIAL);
        case MUD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_MUD_MATERIAL);
        case BASALT_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_BASALT_MATERIAL);
        case GROUND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_GROUND_MATERIAL);
        case CRACKED_LAVA_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropElasticity_CRACKED_LAVA_MATERIAL);
        default:;
        }
    }
    else
...
float MaterialProperties::getDefaultMaterialElasticityWeight(PartMaterial material)
{
    if (FFlag::ModifyDefaultMaterialProperties)
    {
        ...
        case LEGACY_MATERIAL:
        case PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_PLASTIC_MATERIAL); // NYLON
        case SMOOTH_PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_SMOOTH_PLASTIC_MATERIAL); // TEFLON
        case NEON_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_NEON_MATERIAL);
        case WOOD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_WOOD_MATERIAL); // WOOD
        case WOODPLANKS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_WOODPLANKS_MATERIAL); // WOOD
        case MARBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_MARBLE_MATERIAL);
        case SLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_SLATE_MATERIAL);
        case CONCRETE_MATERIAL:
            return getPropertyValueFromFlag(
                FInt::PhysicalPropEWeight_CONCRETE_MATERIAL); // CONCRETE SEE 11.7.4.3 of https://law.resource.org/pub/us/cfr/ibr/001/aci.318.1995.pdf
        case GRANITE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_GRANITE_MATERIAL);
        case BRICK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_BRICK_MATERIAL);
        case PEBBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_PEBBLE_MATERIAL);
        case COBBLESTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_COBBLESTONE_MATERIAL);
        case RUST_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_RUST_MATERIAL); // IRON
        case DIAMONDPLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_DIAMONDPLATE_MATERIAL); // GUESS: based on Aluminum and Steel experimental data.
        case ALUMINUM_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_ALUMINUM_MATERIAL); // GUESS: Manually tested small bricks of Aluminum
        case METAL_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_METAL_MATERIAL); // STEEL
        case GRASS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_GRASS_MATERIAL);
        case SAND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_SAND_MATERIAL);
        case FABRIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_FABRIC_MATERIAL);
        case ICE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_ICE_MATERIAL); // ICE
        case AIR_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_AIR_MATERIAL);
        case WATER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_WATER_MATERIAL);
        case ROCK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_ROCK_MATERIAL);
        case GLACIER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_GLACIER_MATERIAL);
        case SNOW_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_SNOW_MATERIAL);
        case SANDSTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_SANDSTONE_MATERIAL);
        case MUD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_MUD_MATERIAL);
        case BASALT_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_BASALT_MATERIAL);
        case GROUND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_GROUND_MATERIAL);
        case CRACKED_LAVA_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropEWeight_CRACKED_LAVA_MATERIAL);
        default:;
        }
    }
    else
...
float MaterialProperties::getDefaultMaterialDensity(PartMaterial material)
{
    if (FFlag::ModifyDefaultMaterialProperties)
    {
        ...
        case LEGACY_MATERIAL:
        case PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_PLASTIC_MATERIAL); // NYLON
        case SMOOTH_PLASTIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_SMOOTH_PLASTIC_MATERIAL); // TEFLON
        case NEON_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_NEON_MATERIAL);
        case WOOD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_WOOD_MATERIAL); // WOOD
        case WOODPLANKS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_WOODPLANKS_MATERIAL); // WOOD
        case MARBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_MARBLE_MATERIAL);
        case SLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_SLATE_MATERIAL);
        case CONCRETE_MATERIAL:
            return getPropertyValueFromFlag(
                FInt::PhysicalPropDensity_CONCRETE_MATERIAL); // CONCRETE SEE 11.7.4.3 of https://law.resource.org/pub/us/cfr/ibr/001/aci.318.1995.pdf
        case GRANITE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_GRANITE_MATERIAL);
        case BRICK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_BRICK_MATERIAL);
        case PEBBLE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_PEBBLE_MATERIAL);
        case COBBLESTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_COBBLESTONE_MATERIAL);
        case RUST_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_RUST_MATERIAL); // IRON
        case DIAMONDPLATE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_DIAMONDPLATE_MATERIAL); // GUESS: based on Aluminum and Steel experimental data.
        case ALUMINUM_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_ALUMINUM_MATERIAL); // GUESS: Manually tested small bricks of Aluminum
        case METAL_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_METAL_MATERIAL); // STEEL
        case GRASS_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_GRASS_MATERIAL);
        case SAND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_SAND_MATERIAL);
        case FABRIC_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_FABRIC_MATERIAL);
        case ICE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_ICE_MATERIAL); // ICE
        case AIR_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_AIR_MATERIAL);
        case WATER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_WATER_MATERIAL);
        case ROCK_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_ROCK_MATERIAL);
        case GLACIER_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_GLACIER_MATERIAL);
        case SNOW_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_SNOW_MATERIAL);
        case SANDSTONE_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_SANDSTONE_MATERIAL);
        case MUD_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_MUD_MATERIAL);
        case BASALT_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_BASALT_MATERIAL);
        case GROUND_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_GROUND_MATERIAL);
        case CRACKED_LAVA_MATERIAL:
            return getPropertyValueFromFlag(FInt::PhysicalPropDensity_CRACKED_LAVA_MATERIAL);
        default:;
        }
    }
    else
