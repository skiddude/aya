...
bool Poly::findTouchingSurfacesConvex(
...
bool Poly::FaceVerticesOverlapped(
    const CoordinateFrame& myCf, size_t& myFaceId, const Geometry& otherGeom, const CoordinateFrame& otherCf, size_t& otherFaceId, float tol) const
{
    // The input "adjustPartTolerance" is used to more liberally or conservatively detect overlap.
    // It has the effect of slightly shrinking or expanding a part to more/less readily get overlap.
