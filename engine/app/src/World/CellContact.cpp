...
bool CellMeshContact::cellFaceIsInterior(const Vector3int16& mainCellLoc, Aya::Voxel::FaceDirection faceDir)
{
    using namespace Voxel;

    Grid* vs = aya_static_cast<MegaClusterInstance*>(getPrimitive(0)->getOwner())->getVoxelGrid();
