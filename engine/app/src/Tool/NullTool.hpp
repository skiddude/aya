...
private:
    ...
    void getIndicatedPart(const shared_ptr<InputObject>& inputObject, const bool& clickEvent, PartInstance** instance, bool* clickable,
        Vector3* waypoint, TextureId* texture, bool isRightClick = false);
    /////////////////////////////////////////////////////////
    // MouseCommand
    //
