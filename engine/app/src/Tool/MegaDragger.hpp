...
public:
    ...
    MegaDragger(PartInstance* mousePartPtr, const PartArray& partArray, RootInstance* rootInstance, DRAG::JoinType joinType = DRAG::UNJOIN_JOIN);
