...
protected:
    ...
    /*override*/ float getYAxisRotationalVelocity() const
    {
        return desiredVelocity.rotational.y;
    }
...
public:
    ...
    static const float kTurnPForRotatePGS()
    {
        return 450.0f;
    }
    static const float kTurnPForFreeFallPGS()
    {
        return 375.0f;
    }
};
