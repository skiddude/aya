...
class MovingNoPhysicsBase : public Named<HumanoidState, sMovingNoPhysicsBase>
{
private:
    ...
    Aya::signals::scoped_connection torsoAncestryChanged;
...
protected:
    ...
    /*override*/ bool headTorsoShouldCollide() const
    {
        return false;
    }
