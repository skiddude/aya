...
#include "DataModel/Decal.hpp" // TODOFACE
...
#include "Utility/PathInterpolatedCFrame.hpp"
...
// UI
static const Reflection::RefPropDescriptor<Humanoid, PartInstance> propTorso(
    "Torso", category_Data, &Humanoid::getTorsoDangerous, &Humanoid::setTorso, Reflection::PropertyDescriptor::UI);
static const Reflection::RefPropDescriptor<Humanoid, PartInstance> propLeftLeg(
    "LeftLeg", category_Data, &Humanoid::getLeftLegDangerous, &Humanoid::setLeftLeg, Reflection::PropertyDescriptor::UI);
static const Reflection::RefPropDescriptor<Humanoid, PartInstance> propRightLeg(
    "RightLeg", category_Data, &Humanoid::getRightLegDangerous, &Humanoid::setRightLeg, Reflection::PropertyDescriptor::UI);


static const Reflection::PropDescriptor<Humanoid, float> propHealthUi(
    "Health", "Game", &Humanoid::getHealth, &Humanoid::setHealthUi, Reflection::PropertyDescriptor::UI);
static const Reflection::PropDescriptor<Humanoid, float> propHealth(
    "Health_XML", "Game", &Humanoid::getHealth, &Humanoid::setHealth, Reflection::PropertyDescriptor::STREAMING);
...
static const Reflection::PropDescriptor<Humanoid, float> propMaxHealthDep(
    "maxHealth", "Game", &Humanoid::getMaxHealth, &Humanoid::setMaxHealth, Reflection::PropertyDescriptor::Attributes::deprecated(propMaxHealth));
...
static const Reflection::EnumPropDescriptor<Humanoid, PartMaterial> propFloorMaterial(
    "FloorMaterial", "Game", &Humanoid::getFloorMaterial, NULL, Reflection::PropertyDescriptor::SCRIPTING);
...
static const Reflection::PropDescriptor<Humanoid, float> propMaxSlopeAngle(
    "MaxSlopeAngle", "Game", &Humanoid::getMaxSlopeAngle, &Humanoid::setMaxSlopeAngle);
...
static const Reflection::PropDescriptor<Humanoid, bool> propBreakJointsOnDeath(
    "BreakJointsOnDeath", category_Behavior, &Humanoid::getBreakJointsOnDeath, &Humanoid::setBreakJointsOnDeath);

// SCRIPTING
static Reflection::BoundFuncDesc<Humanoid, void(Vector3, bool)> moveFunction(
    &Humanoid::move, "Move", "moveDirection", "relativeToCamera", false, Security::None);

static const Reflection::RefPropDescriptor<Humanoid, PartInstance> propSeatPart(
    "SeatPart", "Control", &Humanoid::getSeatPart, NULL, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, Vector3> propLuaMoveDirection(
    "MoveDirection", "Control", &Humanoid::getLuaMoveDirection, NULL, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::RefPropDescriptor<Humanoid, PartInstance> propWalkToPart(
    "WalkToPart", "Control", &Humanoid::getWalkToPart, &Humanoid::setWalkToPart, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, Vector3> propWalkToPoint(
    "WalkToPoint", "Control", &Humanoid::getWalkToPoint, &Humanoid::setWalkToPoint, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, Vector3> propTargetPoint(
    "TargetPoint", "Control", &Humanoid::getTargetPoint, &Humanoid::setTargetPointLocal, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, bool> propJump(
    "Jump", "Control", &Humanoid::getJump, &Humanoid::setJump, Reflection::PropertyDescriptor::UI);
static const Reflection::PropDescriptor<Humanoid, bool> propJumpRep(
    "JumpReplicate", "Control", &Humanoid::getJump, &Humanoid::setJump, Reflection::PropertyDescriptor::REPLICATE_ONLY);
static const Reflection::PropDescriptor<Humanoid, bool> propSit(
    "Sit", "Control", &Humanoid::getSit, &Humanoid::setSit, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, bool> propPlatformStanding(
    "PlatformStand", "Control", &Humanoid::getPlatformStanding, &Humanoid::setPlatformStanding, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, bool> propAutoRotate(
    "AutoRotate", "Control", &Humanoid::getAutoRotate, &Humanoid::setAutoRotate, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, bool> propAutoJumpEnabled(
    "AutoJumpEnabled", "Control", &Humanoid::getAutoJumpEnabled, &Humanoid::setAutoJumpEnabled, Reflection::PropertyDescriptor::SCRIPTING);

// STANDARD
static const Reflection::PropDescriptor<Humanoid, std::string> prop_displayName(
    "DisplayName", category_Data, &Humanoid::getDisplayName, &Humanoid::setDisplayName, Reflection::PropertyDescriptor::STANDARD);

// REPLICATE_ONLY

static const Reflection::PropDescriptor<Humanoid, Vector3> propWalkDirection(
    "WalkDirection", "Control", &Humanoid::getWalkDirection, &Humanoid::setWalkDirection, Reflection::PropertyDescriptor::REPLICATE_ONLY);
static const Reflection::PropDescriptor<Humanoid, Vector3> propLuaMoveDirectionInternal("MoveDirectionInternal", "Control",
    &Humanoid::getLuaMoveDirection, &Humanoid::setLuaMoveDirection, Reflection::PropertyDescriptor::REPLICATE_ONLY);
static const Reflection::PropDescriptor<Humanoid, float> propWalkAngleError(
    "WalkAngleError", "Control", &Humanoid::getWalkAngleError, &Humanoid::setWalkAngleError, Reflection::PropertyDescriptor::REPLICATE_ONLY);
static const Reflection::PropDescriptor<Humanoid, bool> propStrafe(
    "Strafe", "Control", &Humanoid::getStrafe, &Humanoid::setStrafe, Reflection::PropertyDescriptor::REPLICATE_ONLY);

static Reflection::EnumPropDescriptor<Humanoid, Humanoid::HumanoidRigType> propRigType(
    "RigType", category_Data, &Humanoid::getRigType, &Humanoid::setRigType, Reflection::PropertyDescriptor::SCRIPTING);
static const Reflection::PropDescriptor<Humanoid, float> propCameraMinDistance(
    "CameraMinDistance", category_Data, &Humanoid::getMinDistance, &Humanoid::setMinDistance, Reflection::PropertyDescriptor::REPLICATE_ONLY);
static const Reflection::PropDescriptor<Humanoid, float> propCameraMaxDistance(
    "CameraMaxDistance", category_Data, &Humanoid::getMaxDistance, &Humanoid::setMaxDistance, Reflection::PropertyDescriptor::REPLICATE_ONLY);
static const Reflection::PropDescriptor<Humanoid, Vector3> propCameraOffset(
    "CameraOffset", category_Data, &Humanoid::getCamearaOffset, &Humanoid::setCameraOffset, Reflection::PropertyDescriptor::SCRIPTING);
static Reflection::EnumPropDescriptor<Humanoid, Aya::Camera::CameraMode> prop_CameraMode(
    "CameraMode", category_Data, &Humanoid::getCameraMode, &Humanoid::setCameraMode, Reflection::PropertyDescriptor::REPLICATE_ONLY);

static Reflection::BoundFuncDesc<Humanoid, void(float)> func_TakeDamage(&Humanoid::takeDamage, "TakeDamage", "amount", Security::None);
static Reflection::BoundFuncDesc<Humanoid, void(float)> dep_TakeDamage(
    &Humanoid::takeDamage, "takeDamage", "amount", Security::None, Reflection::Descriptor::Attributes::deprecated(func_TakeDamage));
static Reflection::BoundFuncDesc<Humanoid, void(bool)> func_SetClickToWalkEnabled(
    &Humanoid::setClickToWalkEnabled, "SetClickToWalkEnabled", "enabled", Security::LocalUser);
static Reflection::BoundFuncDesc<Humanoid, void(Vector3, shared_ptr<Instance>)> func_MoveTo(
    &Humanoid::moveTo2, "MoveTo", "location", "part", shared_ptr<Instance>(), Security::None);
...
static Reflection::EventDesc<Humanoid, void(HUMAN::StateType, HUMAN::StateType)> event_StateChanged(
    &Humanoid::stateChangedSignal, "StateChanged", "old", "new");
...
static Reflection::BoundFuncDesc<Humanoid, void(HUMAN::StateType)> func_ChangeState(
    &Humanoid::changeState, "ChangeState", "state", Aya::HUMAN::xx, Security::None);

static Reflection::EventDesc<Humanoid, void(float)> event_HealthChanged(&Humanoid::healthChangedSignal, "HealthChanged", "health");

static Reflection::BoundFuncDesc<Humanoid, bool(Humanoid::Status)> func_AddStatus(
    &Humanoid::addStatus, "AddStatus", "status", Humanoid::POISON_STATUS, Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<Humanoid, bool(Humanoid::Status)> func_RemoveStatus(
    &Humanoid::removeStatus, "RemoveStatus", "status", Humanoid::POISON_STATUS, Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<Humanoid, bool(Humanoid::Status)> func_HasStatus(
    &Humanoid::hasStatus, "HasStatus", "status", Humanoid::POISON_STATUS, Security::None, Reflection::Descriptor::Attributes::deprecated());

static Reflection::BoundFuncDesc<Humanoid, bool(std::string)> func_AddCustomStatus(
    &Humanoid::addCustomStatus, "AddCustomStatus", "status", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<Humanoid, bool(std::string)> func_RemoveCustomStatus(
    &Humanoid::removeCustomStatus, "RemoveCustomStatus", "status", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<Humanoid, bool(std::string)> func_HasCustomStatus(
    &Humanoid::hasCustomStatus, "HasCustomStatus", "status", Security::None, Reflection::Descriptor::Attributes::deprecated());

static Reflection::BoundFuncDesc<Humanoid, void(shared_ptr<Instance>)> func_equipTool(
    &Humanoid::equipToolInstance, "EquipTool", "tool", Security::None);
static Reflection::BoundFuncDesc<Humanoid, void()> func_unequipTools(&Humanoid::unequipTools, "UnequipTools", Security::None);

static Reflection::BoundFuncDesc<Humanoid, shared_ptr<const Reflection::ValueArray>()> func_getStatuses(
    &Humanoid::getStatuses, "GetStatuses", Security::None, Reflection::Descriptor::Attributes::deprecated());

static Reflection::EventDesc<Humanoid, void(Humanoid::Status)> event_StatusAdded(
    &Humanoid::statusAddedSignal, "StatusAdded", "status", Reflection::Descriptor::Attributes::deprecated());
static Reflection::EventDesc<Humanoid, void(Humanoid::Status)> event_StatusRemoved(
    &Humanoid::statusRemovedSignal, "StatusRemoved", "status", Reflection::Descriptor::Attributes::deprecated());

static Reflection::EventDesc<Humanoid, void(std::string)> event_CustomStatusAdded(
    &Humanoid::customStatusAddedSignal, "CustomStatusAdded", "status", Reflection::Descriptor::Attributes::deprecated());
static Reflection::EventDesc<Humanoid, void(std::string)> event_CustomStatusRemoved(
    &Humanoid::customStatusRemovedSignal, "CustomStatusRemoved", "status", Reflection::Descriptor::Attributes::deprecated());

static Reflection::RemoteEventDesc<Humanoid, void(shared_ptr<Instance>)> desc_serverEquipTool(&Humanoid::serverEquipToolSignal, "ServerEquipTool",
    "tool", Security::Roblox, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::EnumPropDescriptor<Humanoid, Humanoid::NameOcclusion> prop_NameOcclusion(
    "NameOcclusion", category_Data, &Humanoid::getNameOcclusion, &Humanoid::setNameOcclusion);
static Reflection::EnumPropDescriptor<Humanoid, Humanoid::HumanoidDisplayDistanceType> prop_DisplayDistanceType(
    "DisplayDistanceType", category_Data, &Humanoid::getDisplayDistanceType, &Humanoid::setDisplayDistanceType);
static const Reflection::PropDescriptor<Humanoid, float> propNameDisplayDistance(
    "NameDisplayDistance", category_Data, &Humanoid::getNameDisplayDistance, &Humanoid::setNameDisplayDistance);
static const Reflection::PropDescriptor<Humanoid, float> propHealthDisplayDistance(
    "HealthDisplayDistance", category_Data, &Humanoid::getHealthDisplayDistance, &Humanoid::setHealthDisplayDistance);

static Reflection::BoundFuncDesc<Humanoid, bool(HUMAN::StateType)> desc_getStateTransitionEnabled(
    &Humanoid::getStateTransitionEnabled, "GetStateEnabled", "state", Security::None);
static Reflection::BoundFuncDesc<Humanoid, void(HUMAN::StateType, bool)> desc_setStateTransitionEnabled(
    &Humanoid::setStateTransitionEnabled, "SetStateEnabled", "state", "enabled", Security::None);
static Reflection::EventDesc<Humanoid, void(HUMAN::StateType, bool)> event_StateEnabledChanged(
    &Humanoid::stateEnabledChangedSignal, "StateEnabledChanged", "state", "isEnabled");

// keep these in sync with the Animator object.
//  this is proxy interface to the Animator that is contained in Humanoid.
static Reflection::BoundFuncDesc<Humanoid, shared_ptr<Instance>(shared_ptr<Instance>)> desc_LoadAnimation(
    &Humanoid::loadAnimation, "LoadAnimation", "animation", Security::None);
static Reflection::BoundFuncDesc<Humanoid, shared_ptr<Instance>(shared_ptr<Instance>)> dep_loadAnimation(
    &Humanoid::loadAnimation, "loadAnimation", "animation", Security::None, Reflection::Descriptor::Attributes::deprecated(desc_LoadAnimation));
static Reflection::BoundFuncDesc<Humanoid, shared_ptr<const Reflection::ValueArray>()> desc_GetPlayingAnimationTracks(
    &Humanoid::getPlayingAnimationTracks, "GetPlayingAnimationTracks", Security::None);

static Reflection::EventDesc<Humanoid, void(shared_ptr<Instance>)> event_AnimationPlayed(
    &Humanoid::animationPlayedSignal, "AnimationPlayed", "animationTrack");
REFLECTION_END();
...
{
    addPair(Aya::HUMAN::FALLING_DWN, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::FALLING_DWN));
    addPair(Aya::HUMAN::RUNNING, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::RUNNING));
    addPair(Aya::HUMAN::RUNNING_NO_PHYS, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::RUNNING_NO_PHYS));
    addPair(Aya::HUMAN::CLIMBING, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::CLIMBING));
    addPair(Aya::HUMAN::STRAFING_NO_PHYS, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::STRAFING_NO_PHYS));
    addPair(Aya::HUMAN::RAGDOLL, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::RAGDOLL));
    addPair(Aya::HUMAN::GETTING_UP, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::GETTING_UP));
    addPair(Aya::HUMAN::JUMPING, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::JUMPING));
    addPair(Aya::HUMAN::LANDED, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::LANDED));
    addPair(Aya::HUMAN::FLYING, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::FLYING));
    addPair(Aya::HUMAN::FREE_FALL, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::FREE_FALL));
    addPair(Aya::HUMAN::SEATED, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::SEATED));
    addPair(Aya::HUMAN::PLATFORM_STANDING, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::PLATFORM_STANDING));
    addPair(Aya::HUMAN::DEAD, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::DEAD));
    addPair(Aya::HUMAN::SWIMMING, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::SWIMMING));
    addPair(Aya::HUMAN::PHYSICS, Aya::HUMAN::HumanoidState::getStateNameByType(Aya::HUMAN::PHYSICS));
    addPair(Aya::HUMAN::xx, "None");
}
template<>
...
{
    if (text == Aya::HUMAN::HumanoidState::getStateNameByType(compare))
    {
        value = compare;
        return true;
    }
...
template<>
bool Aya::StringConverter<HUMAN::StateType>::convertToValue(const std::string& text, HUMAN::StateType& value)
{
    if (Humanoid::isStateInString(text, Aya::HUMAN::FALLING_DWN, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::RUNNING, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::RUNNING_NO_PHYS, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::CLIMBING, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::STRAFING_NO_PHYS, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::RAGDOLL, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::GETTING_UP, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::JUMPING, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::LANDED, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::FLYING, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::FREE_FALL, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::SEATED, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::PLATFORM_STANDING, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::DEAD, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::SWIMMING, value))
        return true;
    if (Humanoid::isStateInString(text, Aya::HUMAN::PHYSICS, value))
        return true;
    if (text.find("None"))
    {
        value = Aya::HUMAN::xx;
...
static const std::string kAppendageNames[] = {"HumanoidRootPart", "Head", "Right Arm", "Left Arm", "Right Leg", "Left Leg", "Torso"};

static const std::string kAppendageNamesR15[] = {"HumanoidRootPart", "Head", "RightArm", "LeftArm", "RightLeg", "LeftLeg", "UpperTorso"};
...
static const std::string& getAppendageString(size_t appendage, bool R15)
{
    ...
    {
        AYAASSERT(!"Unknown appendage type");
...
Humanoid::~Humanoid()
{
    AYAASSERT(!currentState.get());
    AYAASSERT(world == NULL);
    FASTLOG1(FLog::ISteppedLifetime, "Humanoid destroyed - %p", this);
}

void collectStatus(shared_ptr<Aya::Instance> instance, Reflection::ValueArray* result)
{
...
{
    shared_ptr<Reflection::ValueArray> result(Aya::make_shared<Reflection::ValueArray>());
...
void Humanoid::setDisplayName(std::string value)
{
    if (value != displayName)
    {
        displayName = value;
        raisePropertyChanged(prop_displayName);
    }
}
...
void Humanoid::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider)
{
    if (newProvider)
    {
        ...
        if (DFFlag::UseR15Character && Aya::Network::Players::backendProcessing(this))
        {
            DataModel* dataModel = Instance::fastDynamicCast<DataModel>(newProvider);
            if (dataModel)
            {
                Aya::Security::Impersonator impersonate(Aya::Security::Replicator_);
...
bool Humanoid::getDead() const
{
    ...
    {
        AYAASSERT(currentState.get());
        return (currentState->getStateType() == Aya::HUMAN::DEAD);
    }
    else
    {
        return true;
...
{
    Aya::PartInstance* tempTorso = getTorsoSlow();
    if (tempTorso)
    {
...
{
    return (character) ? Instance::fastDynamicCast<PartInstance>(character->findConstFirstChildByName("Head")) : NULL;
}
...
void Humanoid::setRigType(HumanoidRigType type)
{
    /*try
    {
        Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setRigType");
    }
    catch (Aya::base_exception& e)
    {
        raisePropertyChanged(propRigType);
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficient permissions to setRigType");
        throw e;
    }*/
    ...
    if (type != rigType)
    {
        ...
        if (getParent())
        {
            ...
            {
                appendageCache[i] =
                    Instance::fastSharedDynamicCast<PartInstance>(shared_from(getParent()->findFirstChildByName(getAppendageString(i, getUseR15()))));
...
void Humanoid::buildJointsFromAttachments(PartInstance* part, std::vector<PartInstance*>& characterParts)
{
    ...
    if (shared_ptr<const Instances> children = part->getChildren2())
    {
        ...
        {
            if (Aya::Attachment* attachment = Instance::fastDynamicCast<Aya::Attachment>((*iter).get()))
            {
...
// Server side
void Humanoid::buildJoints(Aya::DataModel* dm)
{
    if (!status)
    {
        status = Creatable<Instance>::create<Aya::StatusInstance>();
    ...
    if (character)
    {
        ...
        else
        {
            ...
            AYAASSERT(head && torso && rightArm && leftArm && rightLeg && leftLeg);
...
bool Humanoid::hasWalkToPoint(Vector3& worldPosition) const
{
    Network::Player* player =
        Network::Players::getPlayerFromCharacter(getCharacterFromHumanoid(const_cast<Humanoid*>(this))); // this should always be safe, right?
    // only do click-to-walk in certain modes
    if (player && (Aya::GameBasicSettings::singleton().inHybridMode() || Aya::GameBasicSettings::singleton().inMousepanMode()))
        return false;
...
void Humanoid::setPreviousStateType(Aya::HUMAN::StateType newState)
{
...
void Humanoid::equipTool(Aya::Tool* tool)
{
    if (tool)
    {
        if (ModelInstance* character = getCharacterFromHumanoid(this))
        {
            ...
            if (Aya::Network::Players::backendProcessing(this))
            {
                ...
                if (ModelInstance* character = getCharacterFromHumanoid(this))
                {
                    ...
                    if (player && !fromWorkspace)
                    {
                        ...
                        const Aya::SystemAddress addr = player->getRemoteAddressAsRbxAddress();
...
void Humanoid::unequipTools()
{
    if (ModelInstance* character = getCharacterFromHumanoid(this))
    {
        if (character->getChildren())
        {
            ...
            {
                if (Aya::Backpack* backpack = player->findFirstChildOfType<Backpack>())
                {
                    ...
                    {
                        if (Aya::Tool* tool = Instance::fastDynamicCast<Aya::Tool>((*iter).get()))
                ...
                StandardOut::singleton()->printf(
                    MESSAGE_WARNING, "UnequipTools can only be called on a Humanoid with a corresponding Player object.");
        }
    }
}
...
Velocity Humanoid::calcDesiredWalkVelocity() const
{
    ...
    if (autorotate)
    {
        if (player && Aya::GameBasicSettings::singleton().getRotationType() == Aya::GameBasicSettings::ROTATION_TYPE_CAMERA_RELATIVE)
        {
            answer.rotational.y =
                getWalkAngleError() * Humanoid::autoTurnSpeed() * 0.5f; // hacky - multiplying angle error times auto turn speed here go get velocity
        }
        else
        {
...
{
    return (currentState.get()) ? currentState->getYAxisRotationalVelocity() : 0.0f;
}
...
{
    {
        ...
        AYAASSERT(value.x <= 1.0f && value.z <= 1.0f);
    ...
    if (walkDirection != Aya::Vector3::zero())
    {
...
{
    return ((currentState.get()) ? currentState->getStateType() == Aya::HUMAN::SWIMMING : false);
}
...
{
    if (DataModel* dataModel = Aya::DataModel::get(this))
    {
        if (walkVector == Vector3::zero())
        {
            setLuaMoveDirection(Aya::Vector3(0, 0, 0));
            rawMovementVector = Aya::Vector3(0, 0, 0);
            return;
        }
        ...
        if (relativeToCamera)
        {
            ...
            const Aya::Vector3 northDirection(0, 0, -1);
...
PartInstance* Humanoid::getAppendageFast(AppendageType appendage, shared_ptr<PartInstance>& appendagePart)
{
    ...
    AYAASSERT_FISHING(!answer || (answer == Instance::fastDynamicCast<PartInstance>(
                                                getParent()->findFirstChildByName(getAppendageString(appendage, getUseR15())))));
...
PartInstance* Humanoid::getTorsoDangerous() const
{
    return const_cast<PartInstance*>(getTorsoSlow());
} // reflection only
PartInstance* Humanoid::getLeftLegDangerous() const
{
    return const_cast<PartInstance*>(getLeftLegSlow());
} // reflection only
PartInstance* Humanoid::getRightLegDangerous() const
{
    return const_cast<PartInstance*>(getRightLegSlow());
} // reflection only
...
PartInstance* Humanoid::getVisibleTorsoSlow()
{
    return getAppendageSlow(VISIBLE_TORSO);
}
PartInstance* Humanoid::getHeadSlow()
{
    return getAppendageSlow(HEAD);
}
PartInstance* Humanoid::getRightArmSlow()
{
    return getAppendageSlow(RIGHT_ARM);
}
PartInstance* Humanoid::getLeftArmSlow()
{
    return getAppendageSlow(LEFT_ARM);
}
PartInstance* Humanoid::getRightLegSlow()
{
    return getAppendageSlow(RIGHT_LEG);
}
PartInstance* Humanoid::getLeftLegSlow()
{
    return getAppendageSlow(LEFT_LEG);
}
...
const PartInstance* Humanoid::getVisibleTorsoSlow() const
{
    return getConstAppendageSlow(VISIBLE_TORSO);
}
const PartInstance* Humanoid::getHeadSlow() const
{
    return getConstAppendageSlow(HEAD);
}
const PartInstance* Humanoid::getRightArmSlow() const
{
    return getConstAppendageSlow(RIGHT_ARM);
}
const PartInstance* Humanoid::getLeftArmSlow() const
{
    return getConstAppendageSlow(LEFT_ARM);
}
const PartInstance* Humanoid::getRightLegSlow() const
{
    return getConstAppendageSlow(RIGHT_LEG);
}
const PartInstance* Humanoid::getLeftLegSlow() const
{
    return getConstAppendageSlow(LEFT_LEG);
}

PartInstance* Humanoid::getTorsoFast()
{
    return getAppendageFast(TORSO, appendageCache[TORSO]);
}
PartInstance* Humanoid::getVisibleTorsoFast()
{
    return getAppendageFast(VISIBLE_TORSO, appendageCache[VISIBLE_TORSO]);
}
PartInstance* Humanoid::getHeadFast()
{
    return getAppendageFast(HEAD, appendageCache[HEAD]);
}
PartInstance* Humanoid::getRightArmFast()
{
    return getAppendageFast(RIGHT_ARM, appendageCache[RIGHT_ARM]);
}
PartInstance* Humanoid::getLeftArmFast()
{
    return getAppendageFast(LEFT_ARM, appendageCache[LEFT_ARM]);
}
PartInstance* Humanoid::getRightLegFast()
{
    return getAppendageFast(RIGHT_LEG, appendageCache[RIGHT_LEG]);
}
PartInstance* Humanoid::getLeftLegFast()
{
    return getAppendageFast(LEFT_LEG, appendageCache[LEFT_LEG]);
}
...
Primitive* Humanoid::getTorsoPrimitiveSlow()
{
    return PartInstance::getPrimitive(getTorsoSlow());
}
Primitive* Humanoid::getHeadPrimitiveSlow()
{
    return PartInstance::getPrimitive(getHeadSlow());
}
...
JointInstance* Humanoid::getRightShoulder()
{
    ...
    return temp ? aya_static_cast<JointInstance*>(temp->findFirstChildByName("Right Shoulder")) : NULL;
}
...
void Humanoid::computeForce(bool throttling)
{
    ...
    {
        AYAASSERT(getEngineBody() && getEngineBody()->getRootSimBody());
    ...
    if (world && currentState.get()) // put this here for safety
    {
        ...
        G3D::Vector3 temp;
        // The following AYAASSERT is just a way to get around the system to build this line on DEBUG build
...
void Humanoid::onEvent_SiblingPropertyChanged(const Aya::Reflection::PropertyDescriptor* desc)
{
    if (desc == &Instance::desc_Name)
    {
        ...
        if (pParent != NULL)
        {
            ...
            for (int i = TORSO; i < APPENDAGE_COUNT; i++)
            {
                ...
                appendageCache[i] =
                    Instance::fastSharedDynamicCast<PartInstance>(shared_from(pParent->findFirstChildByName(getAppendageString(i, getUseR15()))));
                updateSiblingPropertyListener(appendageCache[i]);
            }
            updateBaseInstance();
        }
...
void Humanoid::onAncestorChanged(const AncestorChanged& event)
{
    ...
    {
        if (world != NULL)
        { // HACK - currentState destructor looks at world
            AYAASSERT(newWorld == NULL);
...
void Humanoid::onLocalHumanoidEnteringWorkspace()
{
    ...
    if (this == me)
    {
        ...
        if (type == Camera::CUSTOM_CAMERA || type == Camera::FOLLOW_CAMERA || type == Camera::ATTACH_CAMERA || type == Camera::TRACK_CAMERA)
        {
            if (workspace->getCamera()->getCameraSubject() != this)
...
void Humanoid::onStepped(const Stepped& event)
{
    ...
    AYAPROFILER_SCOPE("Physics", "Humanoid::onStepped");
    ...
    if (localSimulating || ownedByLocalPlayer)
    {
        ...
        if (Instance::fastDynamicCast<ModelInstance>(getParent()))
        {
            ...
            // The return value of getTorsoFast()->getCoordinateFrame().translation is not bool & is Vector3.
            AYAASSERT(getTorsoFast() ? ((temp = getTorsoFast()->getCoordinateFrame().translation) == temp) : true);

            if (!ownedByLocalPlayer && !Aya::TaskScheduler::singleton().isCyclicExecutive())
            {
                if (event.longStep)
                {
            ...
            AYAASSERT(getTorsoFast() ? ((temp - getTorsoFast()->getCoordinateFrame().translation).length() < 10.0f) : true);
        }
...
{
    // @mdolli: green circle. implementation based on 2013 symbols
    if (Aya::GameBasicSettings::singleton().getVirtualVersion() > Aya::GameBasicSettings::VERSION_2013 &&
        Aya::GameBasicSettings::singleton().inClassicMode() && !Aya::GameBasicSettings::singleton().inMouseLockMode())
    {
        bool isInMenu = false;
        ...
        const PartInstance* constAppendage;
        Network::Player* player = Network::Players::getPlayerFromCharacter(getParent());
        UserInputService* userInputService = ServiceProvider::find<UserInputService>(this);

        if (!isInMenu && player && canClickToWalk())
        {
            if (Humanoid* localHumanoid = Humanoid::getLocalHumanoidFromContext(this))
            {
                if (Workspace* workspace = Workspace::findWorkspace(this))
                    ;
                {
                    Vector3 worldPosition;
                    if (localHumanoid->hasWalkToPoint(worldPosition))
                    {
                        if (!player->getMouse())
                            return;

                        constAppendage = localHumanoid->getConstAppendageSlow(TORSO);
                        Vector3 mouseLocation = player->getMouse()->getHit().translation;
                        if (constAppendage && localHumanoid->getLuaMoveDirection().isZero() &&
                            (constAppendage->getCoordinateFrame().translation - mouseLocation).magnitude() < 50.0f)
                        {
                            renderWaypoint(adorn, mouseLocation);
                            userInputService->pushMouseIcon(*new TextureId(userInputService->getDefaultMouseCursor(true)));
                        }
                        else
                            userInputService->popMouseIcon(*new TextureId(userInputService->getDefaultMouseCursor(true)));
                    }
                    if (!localHumanoid->getWalkToPoint().isZero() && isWalking)
                        renderWaypoint(adorn, localHumanoid->getWalkToPoint());
                }
            }
        }
    }
...
void Humanoid::renderMultiplayer(Adorn* adorn, const Aya::Camera& camera)
{
    ...
    if (PartInstance* foundHead = getHeadSlow())
    {
        ...
        if (distance > 100.0f ||
            foundHead->getTransparencyXml() > .99f) // if the head is 100% transparent, assume user wants this char to be invisible
            return;
        ...
        if (this->getParent() && (displayText != this->getParent()->getName() || displayText != displayName))
        {
        ...
        if (Workspace::showActiveAnimationAsset)
        {
            ...
            if (child)
            {
                if (Animator* animator = child->fastDynamicCast<Animator>())
                {
                    ...
                    adorn->drawFont2D(activeAnim, screenLoc.xy(), fontSize, false, Color4(nameTagColor, nameAlpha),
                        Color4(Color3::black(), nameAlpha), Text::FONT_ARIALBOLD, Text::XALIGN_CENTER, Text::YALIGN_BOTTOM);
                }
            }
        }
        else if (filterState == ContentFilter::Succeeded && (localNameDisplayDistance >= localHumanoidDistance))
        {
            ...
            pos.y -= 2.0f;
            adorn->drawFont2D(displayText, pos, fontSize, false, Color4(nameTagColor, nameAlpha), strokeColor, Text::FONT_SOURCESANS,
                Text::XALIGN_CENTER, Text::YALIGN_BOTTOM);
        }
        // Health
        if (maxHealth != 0 && localHealthDisplayDistance >= localHumanoidDistance)
        {
            ...
            Rect backRect[3] = {Rect(topLeft + Vector2(0, -strokeWidth), topLeft + Vector2(width, healthHeight + strokeWidth)),
            ...
            Rect strokeRect[4] = {Rect(topLeft + Vector2(0, -(strokeWidth * 1.5f)), topLeft + Vector2(width, -strokeWidth)),
                ...
                Rect(topLeft + Vector2(width, -(strokeWidth * 1.0f)),
                    topLeft + Vector2(width + strokeWidth * 1.5f, healthHeight + (strokeWidth * 1.0f)))};

            // Calc bar color
            Color4 barColor;

            static Color3 healthColors[] = {Color3(255.0f / 255.0f, 28.0f / 255.0f, 0.0f / 255.0f),
                Color3(250.0f / 255.0f, 235.0f / 255.0f, 0.0f / 255.0f), Color3(27.0f / 255.0f, 252.0f / 255.0f, 107.0f / 255.0f)};
...
void Humanoid::renderBillboard(Adorn* adorn, const Aya::Camera& camera)
{
    if (displayDistanceType == Humanoid::HUMANOID_DISPLAY_DISTANCE_TYPE_NONE)
        return;
    ...
    // Update display text
    if (displayText != getParent()->getName() || displayText != displayName)
    {
...
// this function is actually used to render in-game name tags
void Humanoid::renderBillboardImpl(
    Adorn* adorn, const Vector2& screenLoc, float fontSize, const Color3& nameTagColor, float nameAlpha, float healthAlpha)
{
    ...
    if (Aya::GameBasicSettings::singleton().getVirtualVersion() >= Aya::GameBasicSettings::VERSION_2014)
    {
        if (nameAlpha > 0)
        {
            ...
            strokeColor = Color4(0.0f / 255.0f, 0.0f / 255.0f, 0.0f / 255.0f, 1);

            // Name
            // offset text down 4 pixels, looks like that on 2014
            Vector2 pos = Vector2(screenLoc.x, screenLoc.y + 4);
            pos.y -= 2.0f;
            adorn->drawFont2D(displayText, pos, fontSize, false, Color4(nameTagColor, nameAlpha), strokeColor, Text::FONT_ARIALBOLD,
                Text::XALIGN_CENTER, Text::YALIGN_BOTTOM);
        }
        ...
        if (maxHealth != 0 && healthAlpha > 0)
        {
            ...
            float healthHeight = 6;
            float strokeWidth = 2;
            Vector2 topLeft(screenLoc.x - 0.5f * width, screenLoc.y + 2);
            float fullWidth = topLeft.x + width; // Full width for the red background

            Rect fullHealthRect(topLeft, Vector2(fullWidth, topLeft.y + healthHeight));
            Color4 fullBarColor(1.0f, 0.0f, 0.0f, healthAlpha); // Red with alpha

            float greenBarWidth = topLeft.x + (width * relativeHealth);
            Rect greenHealthRect(topLeft, Vector2(greenBarWidth, topLeft.y + healthHeight));
            Color4 greenBarColor(129.0f / 255.0f, 197.0f / 255.0f, 22.0f / 255.0f, healthAlpha); // Green with alpha

            adorn->setIgnoreTexture(true);

            adorn->rect2d(fullHealthRect.toRect2D(), Vector2::one(), Vector2::one(), fullBarColor, fullHealthRect.toRect2D());

            if (relativeHealth > 0)
            {
                adorn->rect2d(greenHealthRect.toRect2D(), Vector2::one(), Vector2::one(), greenBarColor, greenHealthRect.toRect2D());
            }
    ...
    else
    {
        if (nameAlpha > 0)
        {
            static float alpha = (GameBasicSettings::singleton().getVirtualVersion() == GameBasicSettings::VERSION_2015 ? 0.0f : 0.5f);
            Color4 strokeColor;
        ...
        if (maxHealth != 0 && healthAlpha > 0)
        {
            ...
            // Calc bar color
            static const Color3 healthColors[] = {Color3(255.0f / 255.0f, 28.0f / 255.0f, 0.0f / 255.0f),
                Color3(250.0f / 255.0f, 235.0f / 255.0f, 0.0f / 255.0f), Color3(27.0f / 255.0f, 252.0f / 255.0f, 107.0f / 255.0f)};
            ...
            Color4 backGrey(130.0f / 255.0f, 130.0f / 255.0f, 130.0f / 255.0f, 1.0f);
            Color4 backGreyOpaque(100.0f / 255.0f, 100.0f / 255.0f, 100.0f / 255.0f, healthAlpha);

            if (!Aya::GameBasicSettings::singleton().getVirtualVersion() == GameBasicSettings::VERSION_2015)
            {
                Color4 backGrey(101.0f / 255.0f, 100.0f / 255.0f, 100.0f / 255.0f, healthAlpha * 0.5);
                for (int i = 0; i < 4; i++)
                {
                ...
                for (int i = 0; i < 3; i++)
                {
                    adorn->rect2d(backRect[i].toRect2D(), Vector2::one(), Vector2::one(), backGrey, backRect[i].toRect2D());
                }
            }

            for (int i = 0; i < 3; i++)
            {
                Color4 color = Aya::GameBasicSettings::singleton().getVirtualVersion() == GameBasicSettings::VERSION_2015
                                   ? backGrey
                                   : (color = (i == 0) ? backGrey : backGreyOpaque);
...
static void collectAllDescendantCharacterPrims(shared_ptr<Aya::Instance> descendant, std::vector<Primitive*>& primitives)
{
...
static void collectAllDescendantCharacterParts(shared_ptr<Aya::Instance> descendant, std::vector<PartInstance*>& parts)
{
...
static void setLocalTransparencyModifierDecendants(shared_ptr<Aya::Instance> descendant, float transparencyModifier)
{
    PartInstance* part = Instance::fastDynamicCast<PartInstance>(descendant.get());
    if (part)
    {
...
void Humanoid::setFirstPersonRotationalVelocity(const Vector3& desiredLook, bool firstPersonOn)
{
    ...
    else
    {
        if (PartInstance* foundTorso = this->getTorsoSlow())
        {
            ...
            if (currentState.get() && currentState->getStateType() != HUMAN::SWIMMING)
            {
            ...
            if (fabs(dl) < .1f)
                dl = 0.0f; // 3 degrees of slosh, so we don't spam small updates over the network.
...
{
template<>
EnumDesc<Aya::Humanoid::NameOcclusion>::EnumDesc()
    : EnumDescriptor("NameOcclusion")
{
    addPair(Aya::Humanoid::NAME_OCCLUSION_ALL, "OccludeAll");
    addPair(Aya::Humanoid::NAME_OCCLUSION_ENEMY, "EnemyOcclusion");
    addPair(Aya::Humanoid::NAME_OCCLUSION_NONE, "NoOcclusion");
}

template<>
EnumDesc<Aya::Humanoid::HumanoidDisplayDistanceType>::EnumDesc()
    : EnumDescriptor("HumanoidDisplayDistanceType")
{
    addPair(Aya::Humanoid::HUMANOID_DISPLAY_DISTANCE_TYPE_VIEWER, "Viewer");
    addPair(Aya::Humanoid::HUMANOID_DISPLAY_DISTANCE_TYPE_SUBJECT, "Subject");
    addPair(Aya::Humanoid::HUMANOID_DISPLAY_DISTANCE_TYPE_NONE, "None");
}

template<>
EnumDesc<Aya::Humanoid::HumanoidRigType>::EnumDesc()
    : EnumDescriptor("HumanoidRigType")
{
    addPair(Aya::Humanoid::HUMANOID_RIG_TYPE_R6, "R6");
    addPair(Aya::Humanoid::HUMANOID_RIG_TYPE_R15, "R15");
}


template<>
Aya::Humanoid::NameOcclusion& Variant::convert<Aya::Humanoid::NameOcclusion>(void)
{
    return genericConvert<Aya::Humanoid::NameOcclusion>();
}

template<>
EnumDesc<Aya::Humanoid::Status>::EnumDesc()
    : EnumDescriptor("Status")
{
    addPair(Aya::Humanoid::POISON_STATUS, "Poison");
    addPair(Aya::Humanoid::CONFUSION_STATUS, "Confusion");
}

template<>
Aya::Humanoid::Status& Variant::convert<Aya::Humanoid::Status>(void)
{
    return genericConvert<Aya::Humanoid::Status>();
}
} // namespace Reflection

template<>
bool Aya::StringConverter<Aya::Humanoid::NameOcclusion>::convertToValue(const std::string& text, Aya::Humanoid::NameOcclusion& value)
{
    if (text.find("OccludeAll"))
    {
        value = Aya::Humanoid::NAME_OCCLUSION_ALL;
        return true;
    }
    if (text.find("EnemyOcclusion"))
    {
        value = Aya::Humanoid::NAME_OCCLUSION_ENEMY;
        return true;
    }
    if (text.find("NoOcclusion"))
    {
        value = Aya::Humanoid::NAME_OCCLUSION_NONE;
        return true;
    }
    return false;
}
...
template<>
bool Aya::StringConverter<Aya::Humanoid::Status>::convertToValue(const std::string& text, Aya::Humanoid::Status& value)
{
    if (text.find("Poison"))
    {
        value = Aya::Humanoid::POISON_STATUS;
        return true;
    }
    if (text.find("Confusion"))
    {
        value = Aya::Humanoid::CONFUSION_STATUS;
        return true;
    }
    return false;
}
...
bool Humanoid::getStateTransitionEnabled(HUMAN::StateType state)
{
    ...
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Invalid state passed to GetStateEnabled.");
    }
    else
    {
...
void Humanoid::setStateTransitionEnabled(HUMAN::StateType state, bool enabled)
{
    if (state < HUMAN::FALLING_DWN || state >= HUMAN::NUM_STATE_TYPES)
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Invalid state passed to SetStateEnabled.");
    }
    else
    {
...
bool Humanoid::CheckTorso()
{
    ...
    onCFrameChangedConnection = PartInstance::fromPrimitive(torso)->onDemandWrite()->cframeChangedFromReflectionSignal.connect(
        boost::bind(&Humanoid::onCFrameChangedFromReflection, this));
    torsoArrived = true;
    return true;
}
...
bool foundShortestDistanceFromCornerToObject(PartInstance* floorPart, Humanoid* charHumanoid, const Vector3& deltaDisplacementGoal,
    const Vector3& torsoSpaceClosestCorner, Vector3& allowedDisplacementOut)
{
    ...
    Aya::ContactManager* contactManager = characterWorld->getContactManager();
    ...
    for (size_t i = 0; i < 3; i++)
    {
        ...
        // Raycast
        Primitive* hitPrim = contactManager->getHit(newRay, &dummy, &combinedFilter, hitLocationOut);
    ...
    if (torsoPrim)
    {
        ...
        if (deltaDisplacement.squaredMagnitude() > 0.0f)
        {
            ...
            if (foundShortestDistanceFromCornerToObject(floorPart, this, deltaDisplacement, closestCorner, maxDisplacementAllowed))
            {
                ...
                FASTLOG3F(FLog::HumanoidFloorProcess, "Obstacle Found, Moving to: %4.4f, %4.4f, %4.4f", newCharPosition.x, newCharPosition.y,
                    newCharPosition.z);
            }
        }
    }
...
Vector3 Humanoid::getSimulatedFrictionVelocityOffset(PartInstance* floorPart, Vector3& newCharPosition, const Vector3& previousCharPosition,
    const Vector3& charPosInFloorSpace, const Aya::Velocity& previousFloorVelocity, float& netDt)
{
    ...
    if (floorPrim && (getCurrentFloorFilterPhase() >= Assembly::NoSim_SendIfSim) && floorPrim->getWorld())
    {
        ...
        if (getWorld()->getUsingPGSSolver())
            multiplyer = Aya::HUMAN::HumanoidState::runningKMovePForPGS() * netDt * (1000.0f / (DFInt::HumanoidFloorManualFrictionVelocityMultValue));
        else
            multiplyer = Aya::HUMAN::HumanoidState::runningKMoveP() * netDt * (1000.0f / (DFInt::HumanoidFloorManualFrictionVelocityMultValue));

        Vector3 approxXZForce(deltaVelocity.x * multiplyer, 0, deltaVelocity.z * multiplyer);
        float forceMagnitudeOverMax = (approxXZForce.magnitude() / (Aya::HUMAN::HumanoidState::maxLinearGroundMoveForce()));
        ...
        if (forceMagnitudeOverMax > 1.0f && deltaDisplacement.squaredMagnitude() > 0.0f)
        {
            ...
            {
                velocityOffset =
                    -(newCharPosition - previousCharPosition).unit() * (deltaVelocity - deltaVelocity * (1 / forceMagnitudeOverMax)).magnitude();
            }
            else
            {
                velocityOffset =
            ...
            FASTLOG3F(FLog::HumanoidFloorProcess, "Accelerating too fast, Applying Velocity: %4.4f, %4.4f, %4.4f", velocityOffset.x, velocityOffset.y,
                velocityOffset.z);
...
void Humanoid::updateNetworkFloorPosition(
    PartInstance* floorPart, CoordinateFrame& previousFloorPosition, Aya::Velocity& lastFloorVelocity, float& netDt)
{
    ...
    if (floorPart && getWorld() && rootHumanBody && validateNetworkUpdateDistance(floorPart, previousFloorPosition, netDt))
    {
            ...
            (floorPrimitive->getBody()->getVelocity() - lastFloorVelocity).linear.squaredMagnitude() < epsilonDisplacementSqr)
        {
            ...
            if ((floorPrimitive->getBody()->getVelocity() - lastFloorVelocity).rotational.squaredMagnitude() < epsilonDisplacementSqr &&
                eulerDeltaRot.squaredMagnitude() < epsilonDisplacementSqr)
            {
                FASTLOG1F(FLog::HumanoidFloorProcess, "Floor movement too small: %4.4f",
                    (floorPrimitive->getCoordinateFrame().translation - previousFloorPosition.translation).squaredMagnitude());
                return;
            }
        }
        ...
        FASTLOG3F(FLog::HumanoidFloorProcess, "Pre Friction Displacement: %4.4f, %4.4f, %4.4f", deltaDisplacement.x, deltaDisplacement.y,
            deltaDisplacement.z);
        Vector3 addedVelocity = getSimulatedFrictionVelocityOffset(
            floorPart, charPosInWorldSpaceGoal, rootHumanBody->getCoordinateFrame().translation, charPosInObjectSpace, lastFloorVelocity, netDt);
        ...
        FASTLOG3F(
            FLog::HumanoidFloorProcess, "Platform displaced: %4.4f, %4.4f, %4.4f", deltaDisplacement.x, deltaDisplacement.y, deltaDisplacement.z);
        FASTLOG3F(FLog::HumanoidFloorProcess, "character Position in Object Space: %4.4f, %4.4f, %4.4f", charPosInObjectSpace.x,
            charPosInObjectSpace.y, charPosInObjectSpace.z);
        FASTLOG3F(FLog::HumanoidFloorProcess, "New characterPosition in Object Space: %4.4f, %4.4f, %4.4f", newCharPosInObjectSpace.x,
            newCharPosInObjectSpace.y, newCharPosInObjectSpace.z);
    }
}
...
bool Humanoid::validateNetworkUpdateDistance(PartInstance* floorPart, CoordinateFrame& previousFloorPosition, float& netDt)
{
    ...
    {
        FASTLOG3F(FLog::HumanoidFloorProcess, "Detected Teleport with floorPositionDelta: %4.4f, %4.4f, %4.4f", floorPositionDelta.x,
            floorPositionDelta.y, floorPositionDelta.z);
...
void Humanoid::updateFloorSimPhaseCharVelocity(Primitive* floorPrim)
{
    if (floorPrim && primitiveIsLastFloor(floorPrim))
    {
        ...
        if (floorAssembly)
        {
            ...
            // If we suddenly when from not simulating to BufferZone (which happens often) we have to quickly speed the character up by the floor's
            // velocity.
...
const Velocity Humanoid::getHumanoidRelativeVelocityToPart(Primitive* floorPrim)
{
    ...
    if (floorPrim)
    {
        AYAASSERT(floorPrim->getWorld());
        if (floorPrim->getWorld())
        {

            World* world = getWorld();
            Velocity throttledV =
                floorPrim->getPV().velocityAtPoint(getRootBodyFast()->getCoordinateFrame().translation); // this velocity could be inaccurate
