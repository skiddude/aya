...
public:
    ...
    Region();
    Region(const InternalStorageType* internalStorage, const Vector3int16& minCoords, const Vector3int16& maxCoords);
...
private:
    ...
    inline bool hasWaterAtSkipAllEmptyCheck(const Cell& cell, const Vector3int16& globalCoord) const;
};
