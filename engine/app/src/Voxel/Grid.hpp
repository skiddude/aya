...
class Grid
{
    ...
    const Cell& getVoxelLikelyThisChunk(const SpatialRegion::Id& id, const Chunk& chunk, const Vector3int16& coord) const;

    void fillLocalAreaInfo(const Vector3int16& globalCoord, const Water::RelevantNeighbors& neighbors, Water::LocalAreaInfo* out) const;

public:
    typedef Aya::Voxel::Region<Chunk> Region;
    ...
    void setCell(const Vector3int16& location, Cell newCell, CellMaterial newMaterial);
