...
private:
    ...
    static const int kZOffsetMultiplier = SpatialRegion::Constants::kRegionXDimensionInVoxels;
    static const int kYOffsetMultiplier = SpatialRegion::Constants::kRegionXDimensionInVoxels * SpatialRegion::Constants::kRegionZDimensionInVoxels;
...
public:
    ...
    {
        return voxelCoordOffsetToIndexOffset(SpatialRegion::voxelCoordinateRelativeToEnclosingRegion(coord));
    }
    ...
    void updateCountOfNonEmptyCells(int delta)
    {
        ...
        AYAASSERT((int)(countOfNonEmptyCells) >= 0);
    }
    ...
    // for water
    void fillLocalAreaInfo(const Vector3int16& centerCoord, const Water::RelevantNeighbors& relevantNeighbors, Water::LocalAreaInfo* out) const
    {
