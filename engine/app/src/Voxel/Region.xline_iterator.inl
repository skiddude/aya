...
Region<InternalStorageType>::xline_iterator::xline_iterator(const Region<InternalStorageType>& owningRegion)
    ...
    , maxY(owningRegion.maxCoords.y)
{
    ...
    if (!owningRegion.isGuaranteedAllEmpty())
    {
        ...
        pointerSkipAtEndOfXLine = InternalStorageType::voxelCoordOffsetToIndexOffset(Vector3int16(0, 0, 1));
        pointerSkipAtEndOfZLine =
            InternalStorageType::voxelCoordOffsetToIndexOffset(Vector3int16(0, 1, owningRegion.minCoords.z - owningRegion.maxCoords.z));
...
template<class InternalStorageType>
bool Region<InternalStorageType>::xline_iterator::operator==(const xline_iterator& other) const
{
...
template<class InternalStorageType>
typename Region<InternalStorageType>::xline_iterator& Region<InternalStorageType>::xline_iterator::operator++()
{
