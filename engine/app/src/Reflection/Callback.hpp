...
class AyaBaseClass CallbackDescriptor : public MemberDescriptor
{
public:
...
protected:
    ...
    CallbackDescriptor(
        ClassDescriptor& classDescriptor, const char* name, Descriptor::Attributes attributes, Security::Permissions security, bool async);

public:
    inline const SignatureDescriptor& getSignature() const
    {
        return signature;
    }
    bool isAsync() const
...
public:
    ...
    typedef boost::function<void(shared_ptr<const Reflection::Tuple> args, ResumeFunction resumeFunction, ErrorFunction errorFunction)>
        GenericFunction;
...
protected:
    ...
    static typename boost::enable_if<boost::is_void<Result>, void>::type callGeneric(
        shared_ptr<SyncCallbackDescriptor::GenericFunction> function, shared_ptr<Tuple> args)
    {
        (*function)(args);
    }

    template<typename Result>
    static typename boost::disable_if<boost::is_same<shared_ptr<const Tuple>, Result>, Result>::type convertResult(
    ...
    template<typename Result>
    static typename boost::enable_if<boost::is_same<shared_ptr<const Tuple>, Result>, Result>::type convertResult(
        shared_ptr<Reflection::Tuple> result)
    {
        return result;
    }
    ...
    template<typename Result>
    static typename boost::disable_if<boost::is_void<Result>, Result>::type callGeneric(
        shared_ptr<SyncCallbackDescriptor::GenericFunction> function, shared_ptr<Tuple> args)
    {
...
protected:
    SyncCallbackDescImpl(
        ClassDescriptor& classDescriptor, const char* name, const char* arg1name, Descriptor::Attributes attributes, Security::Permissions security)
        : SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
    {
        BOOST_STATIC_ASSERT((boost::function_traits<Signature>::arity == 1));
        this->signature.resultType = &Type::singleton<result_type>();
        this->signature.addArgument(Aya::Name::declare(arg1name), Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
    }
...
protected:
    SyncCallbackDescImpl(ClassDescriptor& classDescriptor, const char* name, const char* arg1name, const char* arg2name,
        Descriptor::Attributes attributes, Security::Permissions security)
        : SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
    {
        BOOST_STATIC_ASSERT((boost::function_traits<Signature>::arity == 2));
        this->signature.resultType = &Type::singleton<result_type>();
        this->signature.addArgument(Aya::Name::declare(arg1name), Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
        this->signature.addArgument(Aya::Name::declare(arg2name), Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
    }
...
protected:
    SyncCallbackDescImpl(ClassDescriptor& classDescriptor, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        Descriptor::Attributes attributes, Security::Permissions security)
        : SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
    {
        ...
        this->signature.addArgument(Aya::Name::declare(arg1name), Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
        this->signature.addArgument(Aya::Name::declare(arg2name), Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
        this->signature.addArgument(Aya::Name::declare(arg3name), Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
    }
...
protected:
    SyncCallbackDescImpl(ClassDescriptor& classDescriptor, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, Descriptor::Attributes attributes, Security::Permissions security)
        : SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
    {
        ...
        this->signature.addArgument(Aya::Name::declare(arg2name), Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
        this->signature.addArgument(Aya::Name::declare(arg3name), Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
        this->signature.addArgument(Aya::Name::declare(arg4name), Type::singleton<typename boost::function_traits<Signature>::arg4_type>());
    }
...
class BoundCallbackDesc : public SyncCallbackDescImpl<Signature, boost::function_traits<Signature>::arity>
{
    ...
    public:
        Setter(Function Class::* member, OnChanged onChanged = NULL)
            : member(member)
            , onChanged(onChanged)
        {
        }
...
public:
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, Security::Permissions security = Security::None,
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, void (Class::*onChanged)(), Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : SyncCallbackDescImpl<Signature, 0>(Class::classDescriptor(), name, attributes, security)
    {
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, void (Class::*onChanged)(),
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name,
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name, void (Class::*onChanged)(),
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : SyncCallbackDescImpl<Signature, 2>(Class::classDescriptor(), name, arg1name, arg2name, attributes, security)
    {
        this->setter.reset(new Setter<Class>(member, onChanged));
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name, const char* arg3name,
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name, const char* arg3name,
        void (Class::*onChanged)(), Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : SyncCallbackDescImpl<Signature, 3>(Class::classDescriptor(), name, arg1name, arg2name, arg3name, attributes, security)
    {
        this->setter.reset(new Setter<Class>(member, onChanged));
    }
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
    ...
    template<class Class>
    BoundCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, void (Class::*onChanged)(), Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : SyncCallbackDescImpl<Signature, 4>(Class::classDescriptor(), name, arg1name, arg2name, arg3name, arg4name, attributes, security)
    {
        this->setter.reset(new Setter<Class>(member, onChanged));
...
{
    typedef boost::function<void(AsyncCallbackDescriptor::ResumeFunction resumeFunction, AsyncCallbackDescriptor::ErrorFunction errorFunction)>
        Function;

    static void callGeneric(shared_ptr<AsyncCallbackDescriptor::GenericFunction> function, AsyncCallbackDescriptor::ResumeFunction resumeFunction,
        AsyncCallbackDescriptor::ErrorFunction errorFunction)
    {
        shared_ptr<Reflection::Tuple> args(new Tuple());
...
public:
    BoundAsyncCallbackDesc(const char* name, Function Class::* member, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
    ...
    BoundAsyncCallbackDesc(const char* name, Function Class::* member, void (Class::*onChanged)(const Function&),
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : AsyncCallbackDescriptor(Class::classDescriptor(), name, attributes, security)
        , member(member)
        , onChanged(onChanged)
...
class BoundAsyncCallbackDesc<Class, Signature, 1> : public AsyncCallbackDescriptor
{
    ...
    typedef boost::function<void(Arg1, AsyncCallbackDescriptor::ResumeFunction resumeFunction, AsyncCallbackDescriptor::ErrorFunction errorFunction)>
        Function;

    static void callGeneric(shared_ptr<AsyncCallbackDescriptor::GenericFunction> function, Arg1 arg1,
        AsyncCallbackDescriptor::ResumeFunction resumeFunction, AsyncCallbackDescriptor::ErrorFunction errorFunction)
    {
        shared_ptr<Reflection::Tuple> args(new Tuple());
        args->values.push_back(arg1);
...
public:
    BoundAsyncCallbackDesc(const char* name, Function Class::* member, const char* arg1name, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : AsyncCallbackDescriptor(Class::classDescriptor(), name, attributes, security)
        , member(member)
        , onChanged(NULL)
    ...
    BoundAsyncCallbackDesc(const char* name, Function Class::* member, const char* arg1name, void (Class::*onChanged)(const Function&),
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : AsyncCallbackDescriptor(Class::classDescriptor(), name, attributes, security)
        , member(member)
        , onChanged(onChanged)
...
class BoundAsyncCallbackDesc<Class, Signature, 2> : public AsyncCallbackDescriptor
{
    ...
    typedef boost::function<void(
        Arg1, Arg2, AsyncCallbackDescriptor::ResumeFunction resumeFunction, AsyncCallbackDescriptor::ErrorFunction errorFunction)>
        Function;

    static void callGeneric(shared_ptr<AsyncCallbackDescriptor::GenericFunction> function, Arg1 arg1, Arg2 arg2,
        AsyncCallbackDescriptor::ResumeFunction resumeFunction, AsyncCallbackDescriptor::ErrorFunction errorFunction)
    {
        shared_ptr<Reflection::Tuple> args(new Tuple());
        args->values.push_back(arg1);
...
public:
    BoundAsyncCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name,
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : AsyncCallbackDescriptor(Class::classDescriptor(), name, attributes, security)
        , member(member)
        , onChanged(NULL)
    ...
    BoundAsyncCallbackDesc(const char* name, Function Class::* member, const char* arg1name, const char* arg2name,
        void (Class::*onChanged)(const Function&), Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : AsyncCallbackDescriptor(Class::classDescriptor(), name, attributes, security)
        , member(member)
        , onChanged(onChanged)
