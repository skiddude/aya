...
class AyaBaseClass FunctionDescriptor : public MemberDescriptor
{
public:
    enum Kind
    {
...
public:
    ...
    virtual int executeCustom(DescribedBase* instance, lua_State*) const
    {
        return 0;
    }
