...
class AyaInterface GenericSlotWrapper
    : boost::noncopyable
    , public Aya::Diagnostics::Countable<GenericSlotWrapper>
{
...
class TGenericSlotWrapper
    ...
    , public Aya::Diagnostics::Countable<TGenericSlotWrapper<GenericSlot>>
{
...
public:
    ...
    virtual void execute(const EventArguments& arguments)
    {
        ...
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Exception caught in TGenericSlotWrapper. %s", e.what());
        }
    }
};
...
public:
    ...
    virtual bool useSubmitTaskForLuaListeners() const
    {
        return false;
    }
};
...
*/
class Event;
class AyaBaseClass EventDescriptor : public MemberDescriptor
{
public:
...
public:
    virtual Aya::signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const = 0;
    ...
    {
        AYAASSERT(false); // Should only be called on RemoteEventDesc
    }
...
class AyaBaseClass EventDescBase;

template<class EventClass, typename Signature, typename SignalType>
class AyaBaseClass EventDescBase<EventClass, Signature, SignalType, SignalType EventClass::*> : public EventDescriptor
{
private:
...
public:
    inline Aya::signals::connection connect(EventSource* source, const boost::function<Signature>& slot) const
    {
        if (source)
        {
            ...
            return Aya::signals::connection(); // return an empty connection
    }
...
template<class EventClass, typename Signature, typename SignalType>
class AyaBaseClass EventDescBase<EventClass, Signature, SignalType, SignalType* (EventClass::*)(bool)> : public EventDescriptor
{
private:
...
public:
    Aya::signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const
    {
        EventArguments foo2;
    ...
    {
        AYA_SIGNALS_ASSERT(args.size() == 0);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
...
public:
    Aya::signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const
    {
        return this->connect(source, boost::bind(&GenericSlotWrapper::execute1<typename boost::function_traits<Signature>::arg1_type>, wrapper, _1));
    }
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 1);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>());
    }
...
public:
    Aya::signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const
    {
        return this->connect(source, boost::bind(&GenericSlotWrapper::execute2<typename boost::function_traits<Signature>::arg1_type,
                                                     typename boost::function_traits<Signature>::arg2_type>,
                                         wrapper, _1, _2));
    }
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 2);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
            args[1].cast<typename boost::function_traits<Signature>::arg2_type>());
    }
    void fireEvent(EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1,
        typename boost::function_traits<Signature>::arg2_type arg2) const
    {
...
public:
    ...
    {
        return this->connect(
            source, boost::bind(&GenericSlotWrapper::execute3<typename boost::function_traits<Signature>::arg1_type,
                                    typename boost::function_traits<Signature>::arg2_type, typename boost::function_traits<Signature>::arg3_type>,
                        wrapper, _1, _2, _3));
    }
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 3);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
            args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
    ...
    void fireEvent(EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1,
        typename boost::function_traits<Signature>::arg2_type arg2, typename boost::function_traits<Signature>::arg3_type arg3) const
    {
...
public:
    ...
    {
        return this->connect(
            source, boost::bind(&GenericSlotWrapper::execute4<typename boost::function_traits<Signature>::arg1_type,
                                    typename boost::function_traits<Signature>::arg2_type, typename boost::function_traits<Signature>::arg3_type,
    ...
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 4);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
            args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
            args[2].cast<typename boost::function_traits<Signature>::arg3_type>(),
    ...
    void fireEvent(EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1,
        ...
        typename boost::function_traits<Signature>::arg4_type arg4) const
    {
...
public:
    ...
    {
        return this->connect(
            source, boost::bind(&GenericSlotWrapper::execute5<typename boost::function_traits<Signature>::arg1_type,
                                    typename boost::function_traits<Signature>::arg2_type, typename boost::function_traits<Signature>::arg3_type,
                                    typename boost::function_traits<Signature>::arg4_type, typename boost::function_traits<Signature>::arg5_type>,
                        wrapper, _1, _2, _3, _4, _5));
    }
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 5);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
            args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
            args[2].cast<typename boost::function_traits<Signature>::arg3_type>(),
    ...
    void fireEvent(EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1,
        typename boost::function_traits<Signature>::arg2_type arg2, typename boost::function_traits<Signature>::arg3_type arg3,
        typename boost::function_traits<Signature>::arg4_type arg4, typename boost::function_traits<Signature>::arg5_type arg5) const
    {
...
public:
    ...
    {
        return this->connect(
            source, boost::bind(&GenericSlotWrapper::execute6<typename boost::function_traits<Signature>::arg1_type,
                                    typename boost::function_traits<Signature>::arg2_type, typename boost::function_traits<Signature>::arg3_type,
                                    typename boost::function_traits<Signature>::arg4_type, typename boost::function_traits<Signature>::arg5_type,
    ...
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 6);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
            args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
            args[2].cast<typename boost::function_traits<Signature>::arg3_type>(),
    ...
    void fireEvent(EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1,
        ...
        typename boost::function_traits<Signature>::arg6_type arg6) const
    {
...
public:
    ...
    {
        return this->connect(
            source, boost::bind(&GenericSlotWrapper::execute7<typename boost::function_traits<Signature>::arg1_type,
                                    typename boost::function_traits<Signature>::arg2_type, typename boost::function_traits<Signature>::arg3_type,
                                    typename boost::function_traits<Signature>::arg4_type, typename boost::function_traits<Signature>::arg5_type,
                                    typename boost::function_traits<Signature>::arg6_type, typename boost::function_traits<Signature>::arg7_type>,
                        wrapper, _1, _2, _3, _4, _5, _6, _7));
    }
    inline void fireEvent(EventSource* source, const EventArguments& args) const
    {
        AYA_SIGNALS_ASSERT(args.size() == 7);
        EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
        this->getSignal(e)(args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
            args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
            args[2].cast<typename boost::function_traits<Signature>::arg3_type>(),
    ...
    void fireEvent(EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1,
        typename boost::function_traits<Signature>::arg2_type arg2, typename boost::function_traits<Signature>::arg3_type arg3,
        typename boost::function_traits<Signature>::arg4_type arg4, typename boost::function_traits<Signature>::arg5_type arg5,
        typename boost::function_traits<Signature>::arg6_type arg6, typename boost::function_traits<Signature>::arg7_type arg7) const
    {
...
template<class EventClass,                           // The class type that fires the event
    typename Signature,                              // The signature of the event
    typename SignalType = Aya::signal<Signature>,    // Optional specialization of the signal type
...
{
public:
    EventDesc(SignalGetter sig, const char* name, Security::Permissions security = Security::None,
    ...
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<1, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg1(&Aya::Name::declare(arg1name), &Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
    ...
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<2, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg1(&Aya::Name::declare(arg1name), &Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
        this->signature.arguments.push_back(arg1);
        SignatureDescriptor::Item arg2(&Aya::Name::declare(arg2name), &Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
        this->signature.arguments.push_back(arg2);
    }
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<3, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg2(&Aya::Name::declare(arg2name), &Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
        this->signature.arguments.push_back(arg2);
        SignatureDescriptor::Item arg3(&Aya::Name::declare(arg3name), &Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
        this->signature.arguments.push_back(arg3);
    }
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<4, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg3(&Aya::Name::declare(arg3name), &Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
        this->signature.arguments.push_back(arg3);
        SignatureDescriptor::Item arg4(&Aya::Name::declare(arg4name), &Type::singleton<typename boost::function_traits<Signature>::arg4_type>());
        this->signature.arguments.push_back(arg4);
    }
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        const char* arg5name, Security::Permissions security = Security::None, Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<5, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg4(&Aya::Name::declare(arg4name), &Type::singleton<typename boost::function_traits<Signature>::arg4_type>());
        this->signature.arguments.push_back(arg4);
        SignatureDescriptor::Item arg5(&Aya::Name::declare(arg5name), &Type::singleton<typename boost::function_traits<Signature>::arg5_type>());
        this->signature.arguments.push_back(arg5);
    }
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        const char* arg5name, const char* arg6name, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<6, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg5(&Aya::Name::declare(arg5name), &Type::singleton<typename boost::function_traits<Signature>::arg5_type>());
        this->signature.arguments.push_back(arg5);
        SignatureDescriptor::Item arg6(&Aya::Name::declare(arg6name), &Type::singleton<typename boost::function_traits<Signature>::arg6_type>());
        this->signature.arguments.push_back(arg6);
    }
    EventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        const char* arg5name, const char* arg6name, const char* arg7name, Security::Permissions security = Security::None,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : EventDescImpl<7, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
    {
        ...
        SignatureDescriptor::Item arg6(&Aya::Name::declare(arg6name), &Type::singleton<typename boost::function_traits<Signature>::arg6_type>());
        this->signature.arguments.push_back(arg6);
        SignatureDescriptor::Item arg7(&Aya::Name::declare(arg7name), &Type::singleton<typename boost::function_traits<Signature>::arg7_type>());
...
public:
    ...
    inline const Aya::Name& getName() const
    {
...
{
protected:
    RemoteEventDescImpl(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, Security::Permissions security,
...
public:
    void fireAndReplicateEvent(
        EventClass* instance, typename boost::function_traits<Signature>::arg1_type arg1, typename boost::function_traits<Signature>::arg2_type arg2)
    {
    ...
    void replicateEvent(
        EventSource* instance, typename boost::function_traits<Signature>::arg1_type arg1, typename boost::function_traits<Signature>::arg2_type arg2)
    {
        BOOST_STATIC_ASSERT(boost::function_traits<Signature>::arity == 2);
        EventArguments args(2);
        args[0] = arg1;
...
{
protected:
    RemoteEventDescImpl(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        Security::Permissions security, Descriptor::Attributes attributes)
...
{
protected:
    RemoteEventDescImpl(SignalType EventClass::* sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, Security::Permissions security, Descriptor::Attributes attributes)
...
protected:
    RemoteEventDescImpl(SignalType EventClass::* sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, const char* arg5name, Security::Permissions security, Descriptor::Attributes attributes)
        : EventDesc<EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, arg5name, security, attributes)
    {
    }
...
protected:
    RemoteEventDescImpl(SignalType EventClass::* sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, const char* arg5name, const char* arg6name, Security::Permissions security, Descriptor::Attributes attributes)
        : EventDesc<EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, arg5name, arg6name, security, attributes)
    {
    }
...
protected:
    RemoteEventDescImpl(SignalType EventClass::* sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        const char* arg4name, const char* arg5name, const char* arg6name, const char* arg7name, Security::Permissions security,
        Descriptor::Attributes attributes)
        : EventDesc<EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, arg5name, arg6name, arg7name, security, attributes)
    {
    }
...
public:
    ...
    struct Attributes : public Descriptor::Attributes
    {
        ...
        Attributes(Functionality flags)
            : flags(flags)
        {
        }
...
template<class EventClass,                               // The class type that fires the event
    typename Signature,                                  // The signature of the event
    typename SignalType = Aya::remote_signal<Signature>, // Optional specialization of the signal type
    typename SignalGetter = SignalType EventClass::*     // Optional signal getter, raw member pointer by default
    >
class RemoteEventDesc
    : public RemoteEventDescImpl<boost::function_traits<Signature>::arity, EventClass, Signature, SignalType, SignalGetter>
...
public:
    RemoteEventDesc(SignalGetter sig, const char* name, Security::Permissions security, RemoteEventCommon::Attributes attributes,
        RemoteEventCommon::Behavior behavior)
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, Security::Permissions security,
        RemoteEventCommon::Attributes attributes, RemoteEventCommon::Behavior behavior)
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, Security::Permissions security,
        RemoteEventCommon::Attributes attributes, RemoteEventCommon::Behavior behavior)
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name,
        Security::Permissions security, RemoteEventCommon::Attributes attributes, RemoteEventCommon::Behavior behavior)
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        Security::Permissions security, RemoteEventCommon::Attributes attributes, RemoteEventCommon::Behavior behavior)
        : RemoteEventDescImpl<4, EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, security, attributes)
        , flags(attributes.flags)
        , behavior(behavior)
    {
        BOOST_STATIC_ASSERT(boost::function_traits<Signature>::arity == 4);
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        const char* arg5name, Security::Permissions security, RemoteEventCommon::Attributes attributes, RemoteEventCommon::Behavior behavior)
        : RemoteEventDescImpl<5, EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, arg5name, security, attributes)
        , flags(attributes.flags)
        , behavior(behavior)
    {
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        const char* arg5name, const char* arg6name, Security::Permissions security, RemoteEventCommon::Attributes attributes,
        RemoteEventCommon::Behavior behavior)
        : RemoteEventDescImpl<6, EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, arg5name, arg6name, security, attributes)
        , flags(attributes.flags)
        , behavior(behavior)
    {
    ...
    RemoteEventDesc(SignalGetter sig, const char* name, const char* arg1name, const char* arg2name, const char* arg3name, const char* arg4name,
        const char* arg5name, const char* arg6name, const char* arg7name, Security::Permissions security, RemoteEventCommon::Attributes attributes,
        RemoteEventCommon::Behavior behavior)
        : RemoteEventDescImpl<7, EventClass, Signature, SignalType, SignalGetter>(
              sig, name, arg1name, arg2name, arg3name, arg4name, arg5name, arg6name, arg7name, security, attributes)
        , flags(attributes.flags)
        , behavior(behavior)
    {
