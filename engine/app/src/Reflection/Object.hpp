...
public:
    ...
    inline ReplicationLevel getReplicationLevel() const
    {
        return (ReplicationLevel)bReplicateType;
    }
    inline bool isScriptCreatable() const
    {
...
class AyaBaseClass DescribedBase
    : public EventSource
...
public:
    ...
    inline const ClassDescriptor& getDescriptor() const
    {
        return *descriptor;
    };
    ...
    virtual const Aya::Name& getClassName() const = 0;
};
} // namespace Reflection
} // namespace Aya
