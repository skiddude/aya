...
class AyaBaseClass YieldFunctionDescriptor : public MemberDescriptor
{
public:
...
public:
    ...
    virtual void execute(DescribedBase* instance, FunctionDescriptor::Arguments& arguments, boost::function<void(Variant)> resumeFunction,
        boost::function<void(std::string)> errorFunction) const = 0;
};
...
public:
    ...
    void execute(FunctionDescriptor::Arguments& arguments, boost::function<void(Variant)> resumeFunction,
        boost::function<void(std::string)> errorFunction) const
    {
