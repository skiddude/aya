...
#else
#define NULL_FUNCTION_PTR const long int
#endif
...
// d9mz - error: 'sBindableEvent' causes a section type conflict with 'func_Invoke'
#else
#define REFLECTION_BEGIN()
#define REFLECTION_END()
#endif
...
template<class Class, const char* const& sClassName, class BaseClass = DescribedBase,
    ClassDescriptor::Functionality functionality = Reflection::ClassDescriptor::PERSISTENT, Security::Permissions security = Security::None>
class AyaBaseClass Described : public BaseClass
{
...
public:
    ...
    inline Described(Arg0 arg0, Arg1 arg1)
        : BaseClass(arg0, arg1)
    {
        this->descriptor = &classDescriptor();
        forceRegistration();
    ...
    inline Described(Arg0 arg0, Arg1 arg1, Arg2 arg2)
        : BaseClass(arg0, arg1, arg2)
    {
        this->descriptor = &classDescriptor();
        forceRegistration();
    }
    template<class Arg0, class Arg1, class Arg2, class Arg3>
    inline Described(Arg0 arg0, Arg1 arg1, Arg2 arg2, Arg3 arg3)
        : BaseClass(arg0, arg1, arg2, arg3)
    {
        this->descriptor = &classDescriptor();
        forceRegistration();
    }
...
#define AYA_REGISTER_CLASS(Class) \
    template<> \
    Aya::Reflection::ClassRegistrar<Class> Aya::Reflection::ClassRegistrar<Class>::registrar(0)
...
class PropDescriptor : public TypedPropertyDescriptor<V>
{
    ...
    public:
        ...
        /*implement*/ bool isReadOnly() const
        {
            return false;
        }
        /*implement*/ bool isWriteOnly() const
        {
            return false;
        }
...
public:
    template<typename Get, typename Set>
    PropDescriptor(const char* name, const char* category, Get get, Set set, PropertyDescriptor::Attributes flags = PropertyDescriptor::Attributes(),
...
public:
    ...
    EnumPropDescriptor(const char* name, const char* category, Get get, Set set,
        PropertyDescriptor::Attributes flags = PropertyDescriptor::Attributes(), Security::Permissions security = Security::None)
    ...
    bool setInt64Value(DescribedBase* instance, int64_t int64Value) const
    {
        V v;
        if (!enumDesc.mapIntValue(int64Value, v))
            return false;
        setValue(instance, v);
        return true;
    }
    ...
    virtual bool setStringValue(DescribedBase* instance, const Aya::Name& name) const
    {
        V value;
    ...
    virtual void readValue(DescribedBase* instance, const XmlElement* element, Aya::IReferenceBinder& binder) const
    {
        if (!element->isXsiNil())
        {
            ...
            {
                if (element->isValueType<int>())
                {
                    if (setIntValue(instance, value))
                        return;
                }
                else if (element->isValueType<int64_t>())
                {
                    if (setInt64Value(instance, value))
                        return;
                }
            }
    ...
    virtual void writeValue(const DescribedBase* instance, XmlElement* element) const
    {
        ...
        {
            element->setValue(static_cast<int64_t>(getValue(instance)));
        }
    }
};
...
public:
    ...
    RefPropDescriptor(const char* name, const char* category, Get get, Set set,
        PropertyDescriptor::Attributes attributes = PropertyDescriptor::Attributes(), Security::Permissions security = Security::None)
...
class ArgHelper
{
...
#ifndef __clang__
    template<int index, class T>
    static bool try_integral(FunctionDescriptor::Arguments& arguments, int64_t& arg)
    {
        int64_t a;
        if (!arguments.getLong(index, (int64_t)a))
            return false;
        arg = a;
        return true;
    }
    ...
    template<int index, class T>
    static inline bool try_integral(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_integral<T>>::type* dummy = 0)
    {
        return false;
    }

    template<int index, class T>
    static bool try_floating_point(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::enable_if<boost::is_floating_point<T>>::type* dummy = 0)
    {
        double a;
    ...
    template<int index, class T>
    static inline bool try_floating_point(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_floating_point<T>>::type* dummy = 0)
    {
        return false;
    }
    ...
    static bool try_string(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::enable_if<boost::is_same<T, std::string>>::type* dummy = 0)
    {
        return arguments.getString(index, arg);
    }

    template<int index, class T>
    static inline bool try_string(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_same<T, std::string>>::type* dummy = 0)
    {
        return false;
    }

    template<int index, class T>
    static bool try_Vector3int16(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::enable_if<boost::is_same<T, Vector3int16>>::type* dummy = 0)
    {
        return arguments.getVector3int16(index, arg);
    }

    template<int index, class T>
    static inline bool try_Vector3int16(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_same<T, Vector3int16>>::type* dummy = 0)
    {
        return false;
    }

    template<int index, class T>
    static bool try_Region3Int16(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::enable_if<boost::is_same<T, Region3int16>>::type* dummy = 0)
    {
        return arguments.getRegion3int16(index, arg);
    }

    template<int index, class T>
    static inline bool try_Region3Int16(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_same<T, Region3int16>>::type* dummy = 0)
    {
        return false;
    }
    ...
    template<int index, class T>
    static inline bool try_Vector3(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_same<T, Vector3>>::type* dummy = 0)
    {
        return false;
    }
    ...
    template<int index, class T>
    static inline bool try_Region3(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_same<T, Region3>>::type* dummy = 0)
    {
        return false;
    }
    ...
    template<int index, class T>
    static inline bool try_Rect(
        FunctionDescriptor::Arguments& arguments, T& arg, typename boost::disable_if<boost::is_same<T, Rect2D>>::type* dummy = 0)
    {
        return false;
    }

    template<int index, class T>
    static bool try_object(
        FunctionDescriptor::Arguments& arguments, shared_ptr<T>& arg, typename boost::enable_if<boost::is_base_of<DescribedBase, T>>::type* dummy = 0)
    {
    ...
    template<int index, class T>
    static inline bool try_object(FunctionDescriptor::Arguments& arguments, T& arg,
        typename boost::disable_if<boost::is_convertible<T, shared_ptr<DescribedBase>>>::type* dummy = 0)
    {
        return false;
    }
...
public:
    ...
    static T getArg(FunctionDescriptor::Arguments& arguments, const scoped_ptr<T>& defaultArg,
        typename boost::disable_if<boost::is_same<T, shared_ptr<const Tuple>>>::type* dummy = 0)
    {
        ...
        if (defaultArg)
            ...
            throw Aya::runtime_error("Argument %d missing or nil", index);
    }

    // Specialization for Tuple, which takes all arguments >= index
    template<typename T, int index>
    static T getArg(FunctionDescriptor::Arguments& arguments, const scoped_ptr<T>& defaultArg,
        typename boost::enable_if<boost::is_same<T, shared_ptr<const Tuple>>>::type* dummy = 0)
    {
        if (arguments.size() < index)
        ...
        shared_ptr<Tuple> tuple = Aya::make_shared<Tuple>(arguments.size() - index + 1);
...
public:
    BoundFuncDesc(
        FunctionPtr function, const char* name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
...
class BoundFuncDesc<Class, Signature, 1> : public FuncDesc<Class>
{
    ...
    {
        this->signature.resultType = &Type::singleton<result_type>();
        this->signature.addArgument(Aya::Name::declare(arg1Name), Type::singleton<Arg1>(), arg1Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default1()
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments) const
    {
        Call1Helper<Class, FunctionPtr, Arg1, result_type>::call(
            boost::polymorphic_downcast<Class*>(instance), function, arguments.returnValue, ArgHelper::getArg<Arg1, 1>(arguments, default1));
    }
};
...
class BoundFuncDesc<Class, Signature, 2> : public FuncDesc<Class>
{
    ...
    void declareSignature(const char* arg1Name, Variant arg1Default, const char* arg2Name, Variant arg2Default)
    {
        ...
        this->signature.resultType = &Type::singleton<result_type>();
        this->signature.addArgument(Aya::Name::declare(arg1Name), Type::singleton<Arg1>(), arg1Default);
        this->signature.addArgument(Aya::Name::declare(arg2Name), Type::singleton<Arg2>(), arg2Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default2(new Arg2(default2))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default2()
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments) const
    {
        Call2Helper<Class, FunctionPtr, Arg1, Arg2, result_type>::call(boost::polymorphic_downcast<Class*>(instance), function, arguments.returnValue,
            ArgHelper::getArg<Arg1, 1>(arguments, default1), ArgHelper::getArg<Arg2, 2>(arguments, default2));
    }
};
...
class BoundFuncDesc<Class, Signature, 3> : public FuncDesc<Class>
{
    ...
    void declareSignature(
        const char* arg1Name, Variant arg1Default, const char* arg2Name, Variant arg2Default, const char* arg3Name, Variant arg3Default)
    {
        BOOST_STATIC_ASSERT((!boost::is_same<Arg1, shared_ptr<const Tuple>>::value));
        ...
        this->signature.addArgument(Aya::Name::declare(arg1Name), Type::singleton<Arg1>(), arg1Default);
        this->signature.addArgument(Aya::Name::declare(arg2Name), Type::singleton<Arg2>(), arg2Default);
        this->signature.addArgument(Aya::Name::declare(arg3Name), Type::singleton<Arg3>(), arg3Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        const char* arg3Name, Arg3 default3, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default3(new Arg3(default3))
        , default2(new Arg2(default2))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, Arg3 default3,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default3(new Arg3(default3))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default3()
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments) const
    {
        Call3Helper<Class, FunctionPtr, Arg1, Arg2, Arg3, result_type>::call(boost::polymorphic_downcast<Class*>(instance), function,
            arguments.returnValue, ArgHelper::getArg<Arg1, 1>(arguments, default1), ArgHelper::getArg<Arg2, 2>(arguments, default2),
...
class BoundFuncDesc<Class, Signature, 4> : public FuncDesc<Class>
{
    ...
    void declareSignature(const char* arg1Name, Variant arg1Default, const char* arg2Name, Variant arg2Default, const char* arg3Name,
        Variant arg3Default, const char* arg4Name, Variant arg4Default)
    {
        BOOST_STATIC_ASSERT((!boost::is_same<Arg1, shared_ptr<const Tuple>>::value));
        BOOST_STATIC_ASSERT((!boost::is_same<Arg2, shared_ptr<const Tuple>>::value));
        ...
        this->signature.addArgument(Aya::Name::declare(arg2Name), Type::singleton<Arg2>(), arg2Default);
        this->signature.addArgument(Aya::Name::declare(arg3Name), Type::singleton<Arg3>(), arg3Default);
        this->signature.addArgument(Aya::Name::declare(arg4Name), Type::singleton<Arg4>(), arg4Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        const char* arg3Name, Arg3 default3, const char* arg4Name, Arg4 default4, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, const char* arg4Name, Arg4 default4, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default4(new Arg4(default4))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, Arg3 default3,
        const char* arg4Name, Arg4 default4, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default4(new Arg4(default4))
        , default3(new Arg3(default3))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        Arg4 default4, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default4(new Arg4(default4))
        , default3()
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments) const
    {
        Call4Helper<Class, FunctionPtr, Arg1, Arg2, Arg3, Arg4, result_type>::call(boost::polymorphic_downcast<Class*>(instance), function,
            arguments.returnValue, ArgHelper::getArg<Arg1, 1>(arguments, default1), ArgHelper::getArg<Arg2, 2>(arguments, default2),
            ArgHelper::getArg<Arg3, 3>(arguments, default3), ArgHelper::getArg<Arg4, 4>(arguments, default4));
    }
};
...
class BoundFuncDesc<Class, Signature, 5> : public FuncDesc<Class>
{
    ...
    void declareSignature(const char* arg1Name, Variant arg1Default, const char* arg2Name, Variant arg2Default, const char* arg3Name,
        Variant arg3Default, const char* arg4Name, Variant arg4Default, const char* arg5Name, Variant arg5Default)
    {
        BOOST_STATIC_ASSERT((!boost::is_same<Arg1, shared_ptr<const Tuple>>::value));
        BOOST_STATIC_ASSERT((!boost::is_same<Arg2, shared_ptr<const Tuple>>::value));
        BOOST_STATIC_ASSERT((!boost::is_same<Arg3, shared_ptr<const Tuple>>::value));
        ...
        this->signature.addArgument(Aya::Name::declare(arg3Name), Type::singleton<Arg3>(), arg3Default);
        this->signature.addArgument(Aya::Name::declare(arg4Name), Type::singleton<Arg4>(), arg4Default);
        this->signature.addArgument(Aya::Name::declare(arg5Name), Type::singleton<Arg5>(), arg5Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        const char* arg3Name, Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, Arg3 default3,
        const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        Arg4 default4, const char* arg5Name, Arg5 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, Arg5 default5, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
        , default4()
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5()
        , default4()
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments) const
    {
        Call5Helper<Class, FunctionPtr, Arg1, Arg2, Arg3, Arg4, Arg5, result_type>::call(boost::polymorphic_downcast<Class*>(instance), function,
            arguments.returnValue, ArgHelper::getArg<Arg1, 1>(arguments, default1), ArgHelper::getArg<Arg2, 2>(arguments, default2),
            ArgHelper::getArg<Arg3, 3>(arguments, default3), ArgHelper::getArg<Arg4, 4>(arguments, default4),
...
class BoundFuncDesc<Class, Signature, 6> : public FuncDesc<Class>
{
    ...
    void declareSignature(const char* arg1Name, Variant arg1Default, const char* arg2Name, Variant arg2Default, const char* arg3Name,
        Variant arg3Default, const char* arg4Name, Variant arg4Default, const char* arg5Name, Variant arg5Default, const char* arg6Name,
        Variant arg6Default)
    {
        BOOST_STATIC_ASSERT((!boost::is_same<Arg1, shared_ptr<const Tuple>>::value));
        BOOST_STATIC_ASSERT((!boost::is_same<Arg2, shared_ptr<const Tuple>>::value));
        ...
        this->signature.addArgument(Aya::Name::declare(arg4Name), Type::singleton<Arg4>(), arg4Default);
        this->signature.addArgument(Aya::Name::declare(arg5Name), Type::singleton<Arg5>(), arg5Default);
        this->signature.addArgument(Aya::Name::declare(arg6Name), Type::singleton<Arg6>(), arg6Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        const char* arg3Name, Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name,
        Arg6 default6, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default6(new Arg6(default6))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, Arg3 default3,
        const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default6(new Arg6(default6))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default6(new Arg6(default6))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default6(new Arg6(default6))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, const char* arg6Name, Arg6 default6, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default6(new Arg6(default6))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, const char* arg6Name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default6()
        , default5()
    ...
    {
        declareSignature(
            arg1Name, Variant(), arg2Name, Variant(), arg3Name, Variant(), arg4Name, Variant(), arg5Name, Variant(), arg6Name, Variant());
    }

    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments) const
    {
        Call6Helper<Class, FunctionPtr, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, result_type>::call(boost::polymorphic_downcast<Class*>(instance),
            function, arguments.returnValue, ArgHelper::getArg<Arg1, 1>(arguments, default1), ArgHelper::getArg<Arg2, 2>(arguments, default2),
            ArgHelper::getArg<Arg3, 3>(arguments, default3), ArgHelper::getArg<Arg4, 4>(arguments, default4),
            ArgHelper::getArg<Arg5, 5>(arguments, default5), ArgHelper::getArg<Arg6, 6>(arguments, default6));
    }
};
...
class BoundFuncDesc<Class, Signature, 7> : public FuncDesc<Class>
{
    ...
    void declareSignature(const char* arg1Name, Variant arg1Default, const char* arg2Name, Variant arg2Default, const char* arg3Name,
        Variant arg3Default, const char* arg4Name, Variant arg4Default, const char* arg5Name, Variant arg5Default, const char* arg6Name,
        Variant arg6Default, const char* arg7Name, Variant arg7Default)
    {
        BOOST_STATIC_ASSERT((!boost::is_same<Arg1, shared_ptr<const Tuple>>::value));
        BOOST_STATIC_ASSERT((!boost::is_same<Arg2, shared_ptr<const Tuple>>::value));
        BOOST_STATIC_ASSERT((!boost::is_same<Arg3, shared_ptr<const Tuple>>::value));
        ...
        this->signature.addArgument(Aya::Name::declare(arg5Name), Type::singleton<Arg5>(), arg5Default);
        this->signature.addArgument(Aya::Name::declare(arg6Name), Type::singleton<Arg6>(), arg6Default);
        this->signature.addArgument(Aya::Name::declare(arg7Name), Type::singleton<Arg7>(), arg7Default);
    }

public:
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        const char* arg3Name, Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name,
        Arg6 default6, const char* arg7Name, Arg7 default7, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6,
        const char* arg7Name, Arg7 default7, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default7(new Arg7(default7))
        , default6(new Arg6(default6))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, Arg3 default3,
        const char* arg4Name, Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6, const char* arg7Name,
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        Arg4 default4, const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6, const char* arg7Name, Arg7 default7,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default7(new Arg7(default7))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, Arg5 default5, const char* arg6Name, Arg6 default6, const char* arg7Name, Arg7 default7, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default7(new Arg7(default7))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, const char* arg6Name, Arg6 default6, const char* arg7Name, Arg7 default7, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default7(new Arg7(default7))
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, const char* arg6Name, const char* arg7Name, Arg7 default7, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , default7(new Arg7(default7))
        , default6()
    ...
    BoundFuncDesc(FunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, const char* arg4Name,
        const char* arg5Name, const char* arg6Name, const char* arg7Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : FuncDesc<Class>(name, security, attributes)
        , function(function)
        , default7()
...
template<class Class, typename Signature, typename ReturnType = typename boost::function_traits<Signature>::result_type,
...
public:
    BoundYieldFuncDesc(
        YieldFunctionPtr function, const char* name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments,
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(boost::bind(&resume_adapter<ReturnType>, resumeFunction, _1), errorFunction);
    }
};
...
public:
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments,
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(boost::bind(resumeFunction, Variant()), errorFunction);
    }
};
...
public:
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default1(new Arg1(default1))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default1()
        ...
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(
            ArgHelper::getArg<Arg1, 1>(arguments, default1), boost::bind(&resume_adapter<ReturnType>, resumeFunction, _1), errorFunction);
    }
};
...
public:
    ...
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(
            ArgHelper::getArg<Arg1, 1>(arguments, default1), boost::bind(resumeFunction, Variant()), errorFunction);
    }
};
...
class BoundYieldFuncDesc<Class, Signature, ReturnType, 2> : public YieldFuncDesc<Class>
{
    typedef typename boost::function_traits<Signature>::arg1_type Arg1;
    typedef typename boost::function_traits<Signature>::arg2_type Arg2;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, boost::function<void(ReturnType)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default2(new Arg2(default2))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default2(new Arg2(default2))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default2()
    ...
    /*implement*/ void execute(Reflection::DescribedBase* instance, FunctionDescriptor::Arguments& arguments,
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), boost::bind(&resume_adapter<ReturnType>, resumeFunction, _1), errorFunction);
    }
};
...
public:
    ...
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), boost::bind(resumeFunction, Variant()), errorFunction);
    }
};
...
class BoundYieldFuncDesc<Class, Signature, ReturnType, 3> : public YieldFuncDesc<Class>
{
    ...
    typedef typename boost::function_traits<Signature>::arg3_type Arg3;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, Arg3, boost::function<void(ReturnType)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default3(new Arg3(default3))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name, Arg3 default3,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default3(new Arg3(default3))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default3()
    ...
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), ArgHelper::getArg<Arg3, 3>(arguments, default3),
...
class BoundYieldFuncDesc<Class, Signature, void, 3> : public YieldFuncDesc<Class>
{
    ...
    typedef typename boost::function_traits<Signature>::arg3_type Arg3;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, Arg3, boost::function<void(void)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
    ...
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), ArgHelper::getArg<Arg3, 3>(arguments, default3), boost::bind(resumeFunction, Variant()),
            errorFunction);
    }
};
...
class BoundYieldFuncDesc<Class, Signature, ReturnType, 4> : public YieldFuncDesc<Class>
{
    ...
    typedef typename boost::function_traits<Signature>::arg4_type Arg4;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, Arg3, Arg4, boost::function<void(ReturnType)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        const char* arg4Name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default4()
        , default3()
        ...
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), ArgHelper::getArg<Arg3, 3>(arguments, default3),
            ArgHelper::getArg<Arg4, 4>(arguments, default4), boost::bind(&resume_adapter<ReturnType>, resumeFunction, _1), errorFunction);
    }
};
...
class BoundYieldFuncDesc<Class, Signature, void, 4> : public YieldFuncDesc<Class>
{
    ...
    typedef typename boost::function_traits<Signature>::arg4_type Arg4;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, Arg3, Arg4, boost::function<void(void)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
        ...
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), ArgHelper::getArg<Arg3, 3>(arguments, default3),
            ArgHelper::getArg<Arg4, 4>(arguments, default4), boost::bind(resumeFunction, Variant()), errorFunction);
    }
};
...
class BoundYieldFuncDesc<Class, Signature, ReturnType, 5> : public YieldFuncDesc<Class>
{
    ...
    typedef typename boost::function_traits<Signature>::arg5_type Arg5;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, Arg3, Arg4, Arg5, boost::function<void(ReturnType)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, Arg1 default1, const char* arg2Name, Arg2 default2,
        const char* arg3Name, Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg4 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Arg2 default2, const char* arg3Name,
        Arg3 default3, const char* arg4Name, Arg4 default4, const char* arg5Name, Arg4 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        const char* arg4Name, Arg4 default4, const char* arg5Name, Arg4 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        const char* arg4Name, const char* arg5Name, Arg4 default5, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5(new Arg5(default5))
    ...
    BoundYieldFuncDesc(YieldFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        const char* arg4Name, const char* arg5Name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
        : YieldFuncDesc<Class>(name, security, attributes)
        , function(function)
        , default5()
        , default4()
        ...
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), ArgHelper::getArg<Arg3, 3>(arguments, default3),
            ArgHelper::getArg<Arg4, 4>(arguments, default4), ArgHelper::getArg<Arg5, 5>(arguments, default5),
            boost::bind(&resume_adapter<ReturnType>, resumeFunction, _1), errorFunction);
    }
};
...
class BoundYieldFuncDesc<Class, Signature, void, 5> : public YieldFuncDesc<Class>
{
    ...
    typedef typename boost::function_traits<Signature>::arg5_type Arg5;
    typedef void (Class::*YieldFunctionPtr)(
        Arg1, Arg2, Arg3, Arg4, Arg5, boost::function<void(void)> resumeFunction, boost::function<void(std::string)> errorFunction);
    YieldFunctionPtr function;
...
public:
        ...
        boost::function<void(Variant)> resumeFunction, boost::function<void(std::string)> errorFunction) const
    {
        (boost::polymorphic_downcast<Class*>(instance)->*function)(ArgHelper::getArg<Arg1, 1>(arguments, default1),
            ArgHelper::getArg<Arg2, 2>(arguments, default2), ArgHelper::getArg<Arg3, 3>(arguments, default3),
            ArgHelper::getArg<Arg4, 4>(arguments, default4), ArgHelper::getArg<Arg5, 5>(arguments, default5), boost::bind(resumeFunction, Variant()),
            errorFunction);
    }
};
...
public:
    CustomBoundFuncDesc(
        CustomFunctionPtr function, const char* name, Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
...
public:
    CustomBoundFuncDesc(CustomFunctionPtr function, const char* name, const char* arg1Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
...
public:
    CustomBoundFuncDesc(CustomFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, Security::Permissions security,
        Descriptor::Attributes attributes = Descriptor::Attributes())
...
public:
    CustomBoundFuncDesc(CustomFunctionPtr function, const char* name, const char* arg1Name, const char* arg2Name, const char* arg3Name,
        Security::Permissions security, Descriptor::Attributes attributes = Descriptor::Attributes())
