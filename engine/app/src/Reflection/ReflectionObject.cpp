...
unsigned int ClassDescriptor::checksum()
{
    ...
    if (checksumValue == 0)
    {
        StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "Calculating checksum...");
    ...
    StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "API checksum %d", checksumValue);
    ...
    , security(security)
{
...

    {
        ...
        AYAASSERT(iter == base.derivedClasses.end() || *iter != this);
