...
public:
    ...
    public:
        ...
        void setNull()
        {
            name = &Aya::Name::getNullName();
        }
        bool isNull() const
        {
            return *name == Aya::Name::getNullName();
        }
        void set(const std::string& s)
        {
            name = &Aya::Name::declare(s.c_str());
        }
        void set(const char* s)
        {
            name = &Aya::Name::declare(s);
        }

        const Aya::Name* getName() const
        {
            return name;
        }
...
public:
    ...
    std::string readableString(int scopeLength = 4) const
    {
        return data.readableString(scopeLength);
    }

    static const Aya::Guid::Scope& getLocalScope();

    static void generateRBXGUID(Aya::Guid::Scope& result);
...
public:
    ...
    class Registry : public Aya::quick_intrusive_ptr_target<Registry>
    {
    ...
    public:
        ...
        {
            AYAASSERT(item->registry.get() == this);
            Guid::Data data;
