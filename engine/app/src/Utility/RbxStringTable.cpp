...
static const char* stringsTable[] = {
    ...
    "Script",                                               // ScriptStr
    "rocky",                                                // Rocky
    "Game passes can only be queried by a Script running on a " AYA_PROJECT_NAME " game server", // HasGamePassLuaWarning
    "Teleporting while using " AYA_PROJECT_NAME " Studio is not permitted.",                     // NoTeleportInStudio
