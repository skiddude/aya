...
private:
    ...
    {
        return 0.0f;
    } // Negative friction Generates energy
    static float maxFri()
    {
        return 2.0f;
    }
    ...
    {
        return 0.0f;
    } // Negative Elasticity causes penetration
    static float maxEla()
    {
        return 1.0f;
    } // Elasticity > 1 causes energy gain
    static float minElW()
    {
        return 0.0f;
    }
...
public:
    ...
    {
        return ((customEnabled == other.customEnabled) && (density == other.density) && (friction == other.friction) &&
                (elasticity == other.elasticity) && (frictionWeight == other.frictionWeight) && (elasticityWeight == other.elasticityWeight));
    }
