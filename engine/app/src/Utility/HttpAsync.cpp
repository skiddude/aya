...
static void responseHandlerRetry(
    std::string* result, std::exception* error, shared_ptr<HttpPromise> promise, int retryCount, int retrySleep, bool externalRequest, Http http)
{
    AYAASSERT(result || error);
