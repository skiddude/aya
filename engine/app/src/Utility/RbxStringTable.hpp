...
#elif __APPLE__ || __ANDROID__ || __linux
...
enum StringIDs
{
    ...
    ScriptStr = 10,               // Script
    Rocky = 11,                   // rocky
    HasGamePassLuaWarning = 12,   // Game passes can only be queried by a Script running on a Aya game server
    NoTeleportInStudio = 13,      // Teleporting while using Aya Studio is not permitted
