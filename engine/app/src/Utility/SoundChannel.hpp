...
private:
    ...
    Aya::Timer<Aya::Time::Fast> lastTimePosReplication; // to regulate how often we replicate the time
    ...
    Aya::signals::scoped_connection serverUpdatedTimeConnection;
    Aya::signals::scoped_connection serverScriptUpdatedTimeConnection;
    Aya::signals::scoped_connection serverResumedSoundConnection;
...
public:
    Aya::signal<void(std::string soundId, int)> soundLoopedSignal;
    Aya::signal<void(std::string soundId)> soundPausedSignal;
    Aya::signal<void(std::string soundId)> soundStoppedSignal;
    Aya::signal<void(std::string soundId)> soundPlayedSignal;
    Aya::signal<void(std::string soundId)> soundEndedSignal;

    Aya::remote_signal<void(int)> timePositionUpdatedFromServerSignal;
    Aya::remote_signal<void(int)> timePositionUpdatedFromServerScriptSignal;

    Aya::remote_signal<void(int)> soundResumedFromServerSignal;
