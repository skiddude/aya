...
protected:
    ...
    IndexedMesh* getUpper()
    {
        return upper;
    }
    IndexedMesh* getLower()
    {
        return lower;
    }

    const IndexedMesh* getConstUpper() const
    {
        return upper;
    }
    const IndexedMesh* getConstLower() const
    {
        return lower;
    }
...
private:
    ...
    void lowersChanged()
    { // cycles up to the parent, calling onLowersChanged();
        onLowersChanged();
...
public:
    ...
    Type* getTypedLower()
    {
        return aya_static_cast<Type*>(getLower());
    }

    template<class Type>
    const Type* getConstTypedLower() const
    {
        return aya_static_cast<const Type*>(getConstLower());
    }

    template<class Type>
    Type* getTypedUpper()
    {
        return aya_static_cast<Type*>(getUpper());
    }

    template<class Type>
    const Type* getConstTypedUpper() const
    {
        return aya_static_cast<const Type*>(getConstUpper());
    }
