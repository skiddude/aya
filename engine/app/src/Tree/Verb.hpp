...
public:
    ...
    static inline void doItWithChecks(Verb* const verb, IDataState* dataState)
    {
        ...
        {
            Aya::Security::setHackFlagVs<LINE_RAND1>(Aya::Security::hackFlag9, HATE_VERB_SNATCH);
        }
        else
#endif
        {
...
public:
    BoundVerb(VerbContainer* container, const char* name, boost::function<void(VerbContainer*)> doItFunction,
        boost::function<bool(VerbContainer*)> isEnabledFunction = NULL, boost::function<bool(VerbContainer*)> isCheckedFunction = NULL,
