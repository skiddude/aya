...
template<>
std::string StringConverter<Aya::Random>::convertToString(const Aya::Random& value)
{
    return "Random";
}
...
template<>
std::string StringConverter<Aya::Vector2>::convertToString(const Aya::Vector2& value)
{
    std::string result = StringConverter<float>::convertToString(value[0]);
    result += ", ";
    result += StringConverter<float>::convertToString(value[1]);
...
template<>
std::string StringConverter<Aya::Rect2D>::convertToString(const Aya::Rect2D& value)
{
...
template<>
bool StringConverter<Aya::CoordinateFrame>::convertToValue(const std::string& text, Aya::CoordinateFrame& value)
{
    return false;
}
...
template<>
std::string StringConverter<Aya::Region3>::convertToString(const Aya::Region3& value)
{
    std::string result = StringConverter<Aya::CoordinateFrame>::convertToString(value.getCFrame());
    result += "; ";
    result += StringConverter<Aya::Vector3>::convertToString(value.getSize());
    return result;
}
template<>
bool StringConverter<Aya::Region3>::convertToValue(const std::string& text, Aya::Region3& value)
{
    return false;
}

template<>
std::string StringConverter<Aya::Region3int16>::convertToString(const Aya::Region3int16& value)
{
...
template<>
bool StringConverter<Aya::Region3int16>::convertToValue(const std::string& text, Aya::Region3int16& value)
{
    return false;
}
...
template<>
bool StringConverter<Aya::Vector2>::convertToValue(const std::string& text, Aya::Vector2& value)
{
    int pos = text.find_first_of(",;", 0);
    if (pos < 0)
        return false;
...
template<>
std::string Aya::StringConverter<Aya::RbxRay>::convertToString(const Aya::RbxRay& value)
{
    std::string result = "{" + Aya::StringConverter<Aya::Vector3>::convertToString(value.origin()) + "}";
    result += ", ";
    result += "{" + Aya::StringConverter<Aya::Vector3>::convertToString(value.direction()) + "}";
    return result;
}

template<>
bool Aya::StringConverter<Aya::RbxRay>::convertToValue(const std::string& text, Aya::RbxRay& value)
{
    ...
    if (closeBracket < 0)
        return false;
    if (!Aya::StringConverter<Aya::Vector3>::convertToValue(text.substr(openBracket + 1, closeBracket - openBracket - 1), value.origin()))
        return false;
    ...
    if (closeBracket < 0)
        return false;
    if (!Aya::StringConverter<Aya::Vector3>::convertToValue(text.substr(openBracket + 1, closeBracket - openBracket - 1), value.direction()))
        return false;
...
template<>
std::string StringConverter<Aya::BrickColor>::convertToString(const Aya::BrickColor& value)
{
    return value.name();
}
...
////////////////////////////////////////////////////////////////////////////////
//
// StringConverter<G3D::Color3uint8>
//
...
std::string StringConverter<G3D::Color3uint8>::convertToString(const G3D::Color3uint8& value)
{
    char szText[64];
#ifdef _WIN32
    _snprintf(szText, 64, "%d, %d, %d", value[0], value[1], value[2]);
#else
    snprintf(szText, 64, "%g, %g, %g", value[0], value[1], value[2]);
#endif
    return szText;
...
template<>
bool StringConverter<Aya::ContentId>::convertToValue(const std::string& text, Aya::ContentId& value)
{
...
template<>
bool StringConverter<Aya::BrickColor>::convertToValue(const std::string& text, Aya::BrickColor& value)
{
    // TODO: Is this the right thing to do?  Maybe we should just return false
    value = Aya::BrickColor::parse(text.c_str());
    return true;
}

template<>
std::string StringConverter<Aya::ContentId>::convertToString(const Aya::ContentId& value)
{
