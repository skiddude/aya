...
FASTFLAGVARIABLE(LuaDebugger, true)
...
static Reflection::BoundFuncDesc<DebuggerManager, shared_ptr<Instance>(shared_ptr<Instance>)> func_AddDebugger(
    &DebuggerManager::addDebugger_Reflection, "AddDebugger", "script", Security::None);
...
static Reflection::BoundFuncDesc<DebuggerManager, shared_ptr<const Instances>()> func_GetDebuggers(
    &DebuggerManager::getDebuggers_Reflection, "GetDebuggers", Security::None);
static Reflection::EventDesc<DebuggerManager, void(shared_ptr<Instance>)> event_DebuggerAdded(
    &DebuggerManager::debuggerAdded, "DebuggerAdded", "debugger");
static Reflection::EventDesc<DebuggerManager, void(shared_ptr<Instance>)> event_DebuggerRemoved(
    &DebuggerManager::debuggerRemoved, "DebuggerRemoved", "debugger");

static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<Instance>(int)> func_SetBreakpoint(
    &ScriptDebugger::setBreakpoint_Reflection, "SetBreakpoint", "line", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<const Instances>()> func_GetBreakpoints(
    &ScriptDebugger::getBreakpoints_Reflection, "GetBreakpoints", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<Instance>(std::string)> func_AddWatch(
    &ScriptDebugger::addWatch_Reflection, "AddWatch", "expression", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<const Instances>()> func_GetWatches(
    &ScriptDebugger::getWatches_Reflection, "GetWatches", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, Reflection::Variant(shared_ptr<Instance>)> func_GetValue(
    &ScriptDebugger::getWatchValue_Reflection, "GetWatchValue", "watch", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, void()> func_Resume_dep(
    &ScriptDebugger::resume, "Resume", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<ScriptDebugger, void()> func_StepOver_dep(
    &ScriptDebugger::stepOver, "StepOver", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<ScriptDebugger, void()> func_StepInto_dep(
    &ScriptDebugger::stepInto, "StepIn", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<ScriptDebugger, void()> func_StepOut_dep(
    &ScriptDebugger::stepOut, "StepOut", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<const Reflection::ValueArray>()> func_GetStack(
    &ScriptDebugger::getStack_Reflection, "GetStack", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<const Reflection::ValueMap>(int)> func_GetLocals(
    &ScriptDebugger::getLocals, "GetLocals", "stackFrame", 0, Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<const Reflection::ValueMap>(int)> func_GetUpvalues(
    &ScriptDebugger::getUpvalues, "GetUpvalues", "stackFrame", 0, Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, shared_ptr<const Reflection::ValueMap>()> func_GetGlobals(
    &ScriptDebugger::getGlobals, "GetGlobals", Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, void(std::string, Reflection::Variant, int)> func_SetLocal(
    &ScriptDebugger::setLocal, "SetLocal", "name", "value", "stackFrame", 0, Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, void(std::string, Reflection::Variant, int)> func_SetUpvalue(
    &ScriptDebugger::setUpvalue, "SetUpvalue", "name", "value", "stackFrame", 0, Security::None);
static Reflection::BoundFuncDesc<ScriptDebugger, void(std::string, Reflection::Variant)> func_SetGlobal(
    &ScriptDebugger::setGlobal, "SetGlobal", "name", "value", Security::None);
...
const Reflection::RefPropDescriptor<ScriptDebugger, Instance> prop_Script(
    "Script", category_Data, &ScriptDebugger::getScript, NULL, Reflection::PropertyDescriptor::UI);
const Reflection::PropDescriptor<ScriptDebugger, std::string> prop_ScriptPath(
    "ScriptPath", category_Data, &ScriptDebugger::getScriptPath, &ScriptDebugger::setScriptPath, Reflection::PropertyDescriptor::STREAMING);
static Reflection::PropDescriptor<ScriptDebugger, bool> prop_IsDebugging(
    "IsDebugging", category_Data, &ScriptDebugger::isDebugging, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<ScriptDebugger, bool> prop_IsPaused(
    "IsPaused", category_Data, &ScriptDebugger::isPaused, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<ScriptDebugger, int> prop_CurrentLine(
    "CurrentLine", category_Data, &ScriptDebugger::getCurrentLine, NULL, Reflection::PropertyDescriptor::UI);
...
static Reflection::EventDesc<ScriptDebugger, void(shared_ptr<Instance>)> event_BreakpointAdded(
    &ScriptDebugger::breakpointAdded, "BreakpointAdded", "breakpoint");
static Reflection::EventDesc<ScriptDebugger, void(shared_ptr<Instance>)> event_BreakpointRemoved(
    &ScriptDebugger::breakpointRemoved, "BreakpointRemoved", "breakpoint");
...
static Reflection::PropDescriptor<DebuggerBreakpoint, int> prop_Line(
    "Line", category_Data, &DebuggerBreakpoint::getLine, NULL, Reflection::PropertyDescriptor::UI);
Reflection::BoundProp<int> DebuggerBreakpoint::prop_Line_Data(
    "line", category_Data, &DebuggerBreakpoint::line, Reflection::PropertyDescriptor::STREAMING);
...
static Reflection::BoundFuncDesc<DebuggerWatch, void()> func_CheckExpressionSyntax(
    &DebuggerWatch::checkExpressionSyntax, "CheckSyntax", Security::None);
REFLECTION_END();
...
void DebuggerManager::setDataModel(Aya::DataModel* pDataModel)
{
    ...
    if (dataModel)
        descendantAddedSignalConnection =
            dataModel->getOrCreateDescendantAddedSignal()->connect(boost::bind(&DebuggerManager::addUnaddedDebuggerForAddedDescendant, this, _1));
}

Aya::DataModel* DebuggerManager::getDataModel()
{
    return dataModel;
}
...
{
    shared_ptr<Instances> result = Aya::make_shared<Instances>(debuggers.size());
    int i = 0;
...
void DebuggerManager::addDebugger(shared_ptr<ScriptDebugger> debugger)
{
    ...
    Aya::Instance* script = debugger->getScript();
...
void DebuggerManager::addUnaddedDebuggerForAddedDescendant(shared_ptr<Aya::Instance> instance)
{
    if (instance && (instance->isA<Aya::Script>() || instance->isA<Aya::ModuleScript>()))
    {
        ...
        {
            AYAASSERT(debuggers.find(instance.get()) == debuggers.end());
...
void DebuggerManager::addScriptDebugger(Instance* instance)
{
    if (ScriptDebugger* debugger = Instance::fastDynamicCast<ScriptDebugger>(instance))
    {
        ...
        {
            AYAASSERT(debuggers.find(debugger->getScript()) == debuggers.end());
...
void DebuggerManager::resume()
{
    ...
    while (!errorThreads.empty())
    {
        ...
        if (Aya::Lua::ThreadRef thread = weakref.lock())
        {
            ...
            if (Aya::Lua::ThreadRef thread = weakref.lock())
            {
                ...
                if (debugger)
                {
                    ...
                    else if (result == ScriptContext::Yield)
                    {
                        ...
                        // if root thread is yielded (using wait) and there's no special breakpoint, then how do we know it's resumed via
                        // yieldedthreads queue? knowing this we can resume other paused threads also, this will make sure we do not have incorrect
                        // stepping in child threads.
                    }
                    ...
                    if ((specialBreakpoint && specialBreakpoint->baseThread == thread.get()) || debugger->isRootThreadResumed())
                        specialBreakpoint.reset();
                    // now we need to force evaluation of line hook for current line in each debugger (just in case if we miss breakpoint set on
                    // current line)
...
void DebuggerManager::onHook(lua_State* L, lua_Debug* ar)
{
    ...
    if (paused)
    {
        ...
        // Aya::StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "paused debugger = %d", L);
    }
}
...
{
    setName(Aya::format("%sDebugger", script.getName().c_str()));
    setScript(&script);
}
...
{
    shared_ptr<Instances> result = Aya::make_shared<Instances>(breakpoints.size());
    int i = 0;
...
{
    shared_ptr<Instances> result = Aya::make_shared<Instances>(watches.size());
    int i = 0;
...
{
    Aya::StandardOut::singleton()->print(Aya::MESSAGE_INFO, "setIndexInfo");
    return 0;
}
...
Reflection::Variant DebuggerManager::readWatchValue(std::string expression, int stackDepth, lua_State* L)
{
    ...
    AYAASSERT_BALLANCED_LUA_STACK2(evalThread);
    ...
    {
        return std::string(Aya::format("*** %s ***", exp.what()));
    }
...
template<class R>
void ScriptDebugger::withPausedThreadHook(
    lua_State* L, lua_Debug* ar, boost::function<R(lua_State* L, lua_Debug* ar)> f, R& r, shared_ptr<std::string>& error)
{
    AYAASSERT(ar->event == LUA_HOOKLINE);
    AYAASSERT(currentLine == ar->currentline);
    ...
    {
        error = Aya::make_shared<std::string>(ex.what());
    }

    AYAASSERT(pausedThread.lock() == L);
    // pausedThread = L;
...
void ScriptDebugger::debuggerBreak(lua_State* L, lua_Debug* ar)
{
    ...
    AYAASSERT(currentLine > 0);

    // Aya::StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "Encountered breakpoint: %s line %d", ar->short_src, currentLine);
    ...
    if (pausedThread.empty())
    {
        ...
        // Aya::StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "Resuming: %s line %d", ar->short_src, ar->currentline);
        resuming();
        currentLine = 0;
    }
    else
...
shared_ptr<Reflection::ValueMap> ScriptDebugger::readLocals(int stackIndex, lua_State* L)
{
    ...
    shared_ptr<Reflection::ValueMap> locals = Aya::make_shared<Reflection::ValueMap>();
    AYAASSERT_BALLANCED_LUA_STACK(L);
    int n = 1;
...
shared_ptr<Reflection::ValueMap> ScriptDebugger::readGlobals(lua_State* L)
{
    ...
    lua_getfenv(L, t);
#endif
    shared_ptr<Reflection::ValueMap> result = Aya::make_shared<Reflection::ValueMap>();
    ...
    while (lua_next(L, t))
    {
        if (lua_isstring(L, -2))
        {
            ...
            AYAASSERT(result->find(name) == result->end());
...
shared_ptr<Reflection::ValueMap> ScriptDebugger::readUpvalues(int stackIndex, lua_State* L)
{
    ...
    shared_ptr<Reflection::ValueMap> arguments = Aya::make_shared<Reflection::ValueMap>();
    ...
    while (const char* name = lua_getupvalue(L, -1, n++))
    {
        if (name[0] > 0)
        {
            Reflection::Variant value;
            Lua::LuaArguments::get(L, -1, value, false);
            AYAASSERT(arguments->find(name) == arguments->end());
...
bool ScriptDebugger::onLineHook(lua_State* L, lua_Debug* ar)
{
    ...
    {
        lua_getinfo(L, "f", ar);
        Aya::Instance* scriptInstance = getScriptForLuaState(L);
        if (scriptInstance)
        {
...
bool ScriptDebugger::shouldBreak(DebuggerBreakpoint* bp, lua_State* L)
{
    ...
    {
        std::string err = Lua::safe_lua_tostring(evalThread, -1);
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Breakpoint %d condition syntax error: %s", bp->getLine(), err.c_str());
    ...
    {
        const char* message = lua_tostring(evalThread, -1);
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Breakpoint %d condition runtime error: %s", bp->getLine(), message);
...
void ScriptDebugger::onChildAdded(Instance* child)
{
    if (DebuggerBreakpoint* breakpoint = Instance::fastDynamicCast<DebuggerBreakpoint>(child))
    {
        AYAASSERT(breakpoint->getLine() > 0);
...
void ScriptDebugger::setScript(Script* value)
{
    ...
    AYAASSERT(!script); // Changing the script is not supported. DebuggerManager doesn't track changes like this
...
void ScriptDebugger::onScriptStarting(lua_State* L)
{
    ...
    DebuggerManager& debuggerManager = Aya::Scripting::DebuggerManager::singleton();
    if (!debuggerManager.getEnabled())
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_WARNING, "Can't debug script %s because debugging is disabled", script->getName().c_str());
        return;
    }
...
void ScriptDebugger::onScriptParentChanged(shared_ptr<Aya::Instance> newParent)
{
    if (!newParent)
    {
...
void ScriptDebugger::onScriptCloned(shared_ptr<Aya::Instance> clonedScript)
{
    boost::shared_ptr<ScriptDebugger> clonedDebugger = createClone(clonedScript);
    if (clonedDebugger)
        Aya::Scripting::DebuggerManager::singleton().addDebugger(clonedDebugger);
}
...
void ScriptDebugger::setLocal(std::string name, Reflection::Variant value, int stackFrame)
{
    if (!withPausedThread<bool>(boost::bind(&doSetLocal, name, boost::cref(value), stackFrame, _1)))
        throw std::runtime_error(Aya::format("Bad local %s", name.c_str()));
}
...
void ScriptDebugger::setUpvalue(std::string name, Reflection::Variant value, int stackFrame)
{
    if (!withPausedThread<bool>(boost::bind(&doSetUpvalue, name, boost::cref(value), stackFrame, _1)))
        throw std::runtime_error(Aya::format("Bad upvalue %s", name.c_str()));
}
...
void ScriptDebugger::setGlobal(std::string name, Reflection::Variant value)
{
    if (!withPausedThread<bool>(boost::bind(&doSetGlobal, name, boost::cref(value), _1)))
        throw std::runtime_error(Aya::format("Bad global %s", name.c_str()));
}
...
shared_ptr<const Reflection::ValueArray> ScriptDebugger::getStack_Reflection()
{
    ...
    {
        shared_ptr<Reflection::ValueMap> item = Aya::make_shared<Reflection::ValueMap>();
...
Aya::Instance* ScriptDebugger::getScriptForLuaState(lua_State* L)
{
    AYAASSERT(lua_isnil(L, -1) || lua_isfunction(L, -1));
    ...
    if (varResult.isType<boost::shared_ptr<Aya::Instance>>())
        return varResult.get<boost::shared_ptr<Aya::Instance>>().get();
...
static std::string getHashString(Aya::Instance* pInstance)
{
...
{
    Aya::Instance* pParent = Aya::DataModel::get(Aya::Scripting::DebuggerManager::singleton().getDataModel());
    Aya::Instance* pChild = NULL;
...
void ScriptDebugger::setLuaHook(ScriptDebugger* scriptDebugger, int hookMask, lua_State* L)
{
    if (L && (L->hookmask != hookMask))
    {
        ...
        if (pExtraSpace)
        {
            ...
            {
                shared_ptr<Aya::ModuleScript> pModuleScript = Aya::Instance::fastSharedDynamicCast<Aya::ModuleScript>(scriptDebugger->script);
                if (pModuleScript)
                    lua_sethook(L, DebuggerManager::hook, hookMask, ScriptContext::hookCount);
            }
        }
...
void ScriptDebugger::updateHook()
{
    ...
    if (pExtraSpace)
    {
        ...
        if (Aya::Scripting::DebuggerManager::singleton().getBreakOnErrorMode() == BreakOnErrorMode_AllExceptions)
...
void ScriptDebugger::handleError(lua_State* thread)
{
    ...
    std::string errorMessage = Aya::Lua::safe_lua_tostring(thread, -1);
...
boost::shared_ptr<ScriptDebugger> ScriptDebugger::createClone(boost::shared_ptr<Instance> clonedScript)
{
    ...
    for (Aya::Scripting::ScriptDebugger::Breakpoints::const_iterator iter = breakpoints.begin(); iter != breakpoints.end(); ++iter)
    {
        if (iter->second)
        {
            shared_ptr<Instance> breakpoint = iter->second->clone(Aya::EngineCreator);
            if (breakpoint)
    ...
    for (Aya::Scripting::ScriptDebugger::Watches::const_iterator iter = watches.begin(); iter != watches.end(); ++iter)
    {
        if (*iter)
        {
            shared_ptr<Instance> watch = (*iter)->clone(Aya::EngineCreator);
            if (watch)
...
{
    AYAASSERT(line > 0);
    setName(Aya::format("Breakpoint%d", line));
}
