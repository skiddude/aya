...
static int getApi(lua_State* L)
{
    std::list<std::string> api;
    {
        ...
        AYAASSERT(!lua_isnil(L, -1));             // A library was pushed without being created
        AYAASSERT(lua_istable(L, -1));            // A library was pushed without being created
