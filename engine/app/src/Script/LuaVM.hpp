...
#if ((defined(_WIN32) || (!defined(AYA_PLATFORM_IOS))) && !defined(AYA_STUDIO)) && !defined(__APPLE__) && !defined(_M_ARM64) && !defined(__aarch64__)
#define AYA_SECURE_DOUBLE
#endif

#ifdef _WIN32
#define AYA_ALIGN(s) _declspec(align(s))
#else
#define AYA_ALIGN(s) __attribute__((__aligned__(s)))
#endif

#include <boost/unordered_map.hpp>
#include <string>
#if defined(AYA_SECURE_DOUBLE) && !defined(_M_ARM64) && !defined(__aarch64__) && !defined(__aarch64__)
#include <emmintrin.h>
#endif
...
int load(lua_State* L, const Aya::ProtectedString& source, const char* chunkname, unsigned int modkey = 1);
...
public:
    static AYA_ALIGN(16) int luaXorMask[4];
