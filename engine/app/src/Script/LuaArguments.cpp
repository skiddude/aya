...
bool LuaArguments::getVector3int16(int index, Vector3int16& value) const
{
    ...
    return Bridge<Aya::Vector3int16>::getValue(L, index, value);
}
...
bool LuaArguments::getRegion3int16(int index, Region3int16& value) const
{
    ...
    return Bridge<Aya::Region3int16>::getValue(L, index, value);
}
...
bool LuaArguments::getVector3(int index, Vector3& value) const
{
    ...
    return Bridge<Aya::Vector3>::getValue(L, index, value);
}
...
bool LuaArguments::getRegion3(int index, Region3& value) const
{
    ...
    return Bridge<Aya::Region3>::getValue(L, index, value);
}
...
bool LuaArguments::getRect(int index, Rect2D& value) const
{
    ...
    return Bridge<Aya::Rect2D>::getValue(L, index, value);
}
...
bool LuaArguments::getRec(lua_State* L, int luaIndex, Reflection::Variant& value, bool treatNilAsMissing, TablesCollection* visitedTables)
{
    ...
    case LUA_TTABLE:
    {
        ...
        if (n > 0)
        {
            ...
            shared_ptr<Reflection::ValueArray> values(Aya::make_shared<Reflection::ValueArray>(n));
            ...
            value = shared_ptr<const Aya::Reflection::ValueArray>(values);
        }
        else
        {
            // Create a new collection so that we can populate it
            ...
            while (lua_next(L, tableIndex) != 0)
            {
                ...
                if (!values)
                    values = Aya::make_shared<Reflection::ValueTable>();
            ...
            if (values)
                value = shared_ptr<const Aya::Reflection::ValueTable>(values);
            else
                // Assume an empty Lua table is an empty ValueArray (they can auto-convert later)
                value = Aya::make_shared<const Reflection::ValueArray>();
...
public:
    ...
    int operator()(const Aya::ProtectedString& value)
    {
