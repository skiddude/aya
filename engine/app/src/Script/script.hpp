...
private:
    ...
    weak_ptr<Aya::Network::Player> localPlayer;
...
public:
    ...
    weak_ptr<Aya::Network::Player> getLocalPlayer()
    {
        return localPlayer;
    }
    void setLocalPlayer(const shared_ptr<Aya::Network::Player>& localPlayer)
    {
    ...
    Aya::signal<void(lua_State*)> starting;
    Aya::signal<void()> stopped;
...
class Script : public DescribedCreatable<Script, BaseScript, sScript>
{
private:
...
public:
    ...
    void assignConnection(const Aya::signals::connection& connection)
    {
