...
public:
    ...
    Aya::remote_signal<void()> requestLock;
    Aya::remote_signal<void(bool)> lockGrantedOrNot;
...
private:
    ...
    static void linkedSourceFetchingVisitor(shared_ptr<Instance> descendant, shared_ptr<ContentProvider> cp, AsyncHttpQueue::ResultJob jobType,
