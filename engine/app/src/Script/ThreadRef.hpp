...
{
class LiveThreadRef
    : public Aya::quick_intrusive_ptr_target<LiveThreadRef>
...
class ThreadRef : public Diagnostics::Countable<ThreadRef>
{
    boost::intrusive_ptr<detail::LiveThreadRef> liveThreadRef;
    friend class WeakThreadRef;
    ThreadRef(detail::LiveThreadRef* liveThreadRef)
...
class WeakThreadRef
    : public Aya::quick_intrusive_ptr_target<WeakThreadRef>
    , boost::noncopyable
    , public Diagnostics::Countable<WeakThreadRef>
{
    // TODO: boost::mutex would be safer
    typedef Aya::spin_mutex Mutex;
    static Mutex sync;

public:
    class Node
        : public Aya::quick_intrusive_ptr_target<Node>
        , boost::noncopyable
    {
        friend class WeakThreadRef;
        WeakThreadRef* first;
