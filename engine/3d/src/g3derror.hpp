 ...
 */
#define error(level, message, showPrompt) G3D::_internal::_utility_error(level, message, showPrompt, __FILE__, __LINE__)
...
namespace _internal
{
ErrorConstant _utility_error(const char* level, const char* message, bool showPrompt, const char* filename, int line);
