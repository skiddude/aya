/**
 ...
 @cite Random point method by  Greg Turk, Generating random points in triangles.  In A. S. Glassner, ed., Graphics Gems, pp. 24-28. Academic Press,
 1990
...
public:
    ...
    inline void getRandomSurfacePoint(Vector3& P, Vector3& N = Vector3::ignore()) const
    {
        P = randomPoint();
        N = normal();
    }
    ...
    {
        return _vertex[0].hashCode() + (_vertex[1].hashCode() >> 2) + (_vertex[2].hashCode() >> 3);
    }
