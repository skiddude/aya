...
std::string pathConcat(const std::string& dirname, const std::string& file)
{
    ...
    if ((dirname.size() != 0) && (dirname[dirname.size() - 1] != '/') && (dirname[dirname.size() - 1] != '\\') &&
...
void parseFilename(const std::string& filename, std::string& root, Array<std::string>& path, std::string& base, std::string& ext)
{
