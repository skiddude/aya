...
public:
    ...
    public:
        ...
        {
            return (key == peer.key && value == peer.value);
        }
        bool operator!=(const Entry& peer) const
        {
    ...
    */
    ...
    public:
        ...
        bool operator==(const Iterator& other) const
        {
            ...
            {
                return (table == other.table) && (node == other.node) && (index == other.index);
            }
        }
...
public:
    ...
    */
    Entry& getCreateEntry(const Key& key, bool& created)
    {
        ...
        if ((bucketLength > maxBucketLength) && !allSameCode && (m_numBuckets < m_size * 15))
        {
