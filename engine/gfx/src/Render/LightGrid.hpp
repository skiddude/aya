...
public:
    ...
    void occupancyUpdateChunkPrepare(
    ...
    Vector3int32 getChunkCount() const
    {
        return chunkCount;
    }
    ...
    const shared_ptr<Texture>& getLookupTexture() const
    {
...
private:
    ...
    void lightingUpdateDirectionalImpl(LightGridChunk& chunk, const Vector3int32& lightContrib);
    ...
    void lightingComputeShadowMask(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
    ...
    template<int Axis>
    void lightingTransferShadowSliceToShadowMask(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3int32& lightCell,
        int shadowMapSize, const LightShadowSlice& shadowSlice0, const LightShadowSlice& shadowSlice1);
    template<int Axis>
    void lightingTransferShadowMaskToShadowSlice(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, int shadowMapSize, LightShadowSlice& shadowSlice0, LightShadowSlice& shadowSlice1);

    void lightingComputeShadowMaskXYZ(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);
    template<bool NegX>
    void lightingComputeShadowMaskYZ(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);
    template<bool NegX, bool NegY>
    void lightingComputeShadowMaskZ(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);
    template<bool NegX, bool NegY, bool NegZ>
    void lightingComputeShadowMask(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);
    template<bool NegX, bool NegY, bool NegZ>
    void lightingComputeShadowMaskImplLUT(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);
    template<bool NegX, bool NegY, bool NegZ>
    void lightingComputeShadowMaskImplSmooth(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);
    template<bool NegX, bool NegY, bool NegZ>
    void lightingComputeShadowMaskImplSmoothSIMD(const LightGridChunk& chunk, const Vector3int32& extentsMin, const Vector3int32& extentsMax,
        const Vector3int32& lightCell, const Vector3& lightFraction);

    template<bool Shadows>
    void lightingUpdatePointLightScratch(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3& lightPosition,
        float lightRadius, const Color3uint8& lightColor, float lightIntensity);
    template<bool Shadows>
    void lightingUpdatePointLightScratchSIMD(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3& lightPosition,
        float lightRadius, const Color3uint8& lightColor, float lightIntensity);

    template<bool Shadows>
    void lightingUpdateSpotLightScratch(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3& lightPosition,
        float lightRadius, const Vector3& lightDirection, float lightConeAngle, const Color3uint8& lightColor, float lightIntensity);
    template<bool Shadows>
    void lightingUpdateSpotLightScratchSIMD(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3& lightPosition,
        float lightRadius, const Vector3& lightDirection, float lightConeAngle, const Color3uint8& lightColor, float lightIntensity);

    template<bool Shadows>
    void lightingUpdateSurfaceLightScratch(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3& lightPosition,
        float lightRadius, const Vector3& lightDirection, float lightConeAngle, const Vector4& axisU, const Vector4& axisV,
        const Color3uint8& lightColor, float lightIntensity);
    template<bool Shadows>
    void lightingUpdateSurfaceLightScratchSIMD(const Vector3int32& extentsMin, const Vector3int32& extentsMax, const Vector3& lightPosition,
        float lightRadius, const Vector3& lightDirection, float lightConeAngle, const Vector4& axisU, const Vector4& axisV,
        const Color3uint8& lightColor, float lightIntensity);


    template<bool AxisY>
    void lightingBlurAxisYZScratch();
    template<bool AxisY>
    void lightingBlurAxisYZScratchSIMD();
    ...
    // Each value here uses 10 bits per channel, with 8 bits for the value and 2 bits as carry bits (that are always zero except for intermediate
    // values)
