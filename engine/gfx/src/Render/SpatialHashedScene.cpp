...
class GfxSpatialHash : public Aya::SpatialHash<CullableSceneNode, Aya::Contact, Aya::ContactManager, GFXSPATIALHASHLEVELS>
{
public:
    GfxSpatialHash()
...
struct FrustumVisitor : public GfxSpatialHash::SpaceFilter
{
    ...
    FrustumVisitor(
        std::vector<CullableSceneNode*>& nodes, const RenderCamera& camera, const Vector3& pointOfInterest, FrameRateManager* frm, int frameNumber)
        : nodes(nodes)
        , camera(camera)
...
void SpatialHashedScene::queryFrustumOrdered(
    std::vector<CullableSceneNode*>& nodes, const RenderCamera& camera, const Vector3& pointOfInterest, FrameRateManager* frm)
{
    AYAPROFILER_SCOPE("Render", "queryFrustumOrdered");
...
{
    AYAPROFILER_SCOPE("Render", "querySphere");
...
{
    AYAPROFILER_SCOPE("Render", "queryExtents");
