...
private:
    ...
    typedef Voxel::AreaCopy<Voxel::kXZ_CHUNK_SIZE + 4, Voxel::kY_CHUNK_SIZE + 3, Voxel::kXZ_CHUNK_SIZE + 4> RenderArea;
    ...
    RenderEntity* createGeometry(RenderNode* node, const shared_ptr<VertexBuffer>& vbuf, const shared_ptr<IndexBuffer>& ibuf,
