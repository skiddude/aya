...
{
public:
    FastClusterEntity(FastCluster* cluster, const GeometryBatch& geometry, const shared_ptr<Material>& material,
...
class FastClusterBinding
    : public GfxBinding
    , public Aya::Allocator<FastClusterBinding>
{
public:
