...
public:
    ...
    // Numbers MUST match BlendState::Mode, see Core/states.h
    enum BlendMode
    {
        Blend_None,
        Blend_Additive,
    ...
    void setEmitterShape(int shape, Box bbox)
    {
        emitterShape = shape;
        emitterBox = bbox;
    }
    ...
    void setSpread(Vector2 v)
    {
        spread = v;
    }
    void setLocalForce(Vector3 v)
    {
        localForce = v;
    }
    void setGlobalForce(Vector3 v)
    {
        globalForce = v;
    }
    void setDampening(float v)
    {
        dampening = v;
    }
    ...
    void setSpin(Vector2 v)
    {
        spin = v;
    }
    void setSizeX(Vector2 v)
    {
        sizeX = v;
    }
    void setSizeY(Vector2 v)
    {
        sizeY = v;
    }
    void setGrowth(Vector2 v)
    {
        growth = v;
    }
    ...
    void setVelocityInheritance(float v)
    {
        velocityInheritance = v;
    }
    void setLockedToLocalSpace(bool v)
    {
        lockedToLocalSpace = v;
    }
    void setLegacyEmitter(bool v)
    {
        legacyEmitter = v;
    }
    void setAppearance(const Appearance& a, const std::string& context = "");
    void setModulateColor(const Vector4& v)
    {
        modulateColor = v;
    }
    ...
    void setInheritMotion(float v)
    {
        inheritMotion = v;
    }
    void setBrightenOnThrottle(float b)
    {
        brightenOnThrottle = b;
    }
    void setBlendRatio(float v)
    {
        blendRatio = v;
    }

    void setSphericalDirection(Vector2 v)
    {
        sphericalDirection = v;
    }
...
private:
    ...
    float brightenOnThrottle; // should the particles be brightened proportionally when throttled? (sometimes makes sense for some additives,
                              // default=false)
