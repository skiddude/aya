...
public:
    ...
    bool isClassicRendering() const
    {
        return classicRendering;
    }
    ...
    {
        return frameRateManager.get();
    }

    RenderCamera& getCameraMutable()
    {
        return camera;
    }

    const RenderCamera& getCamera()
    {
        return camera;
    }
    const RenderCamera& getCameraCull()
    {
        return cameraCull;
    }
    const RenderCamera& getCameraCullFrm()
    {
        return cameraCullFrm;
    }
    ...
    AdornRender* getAdorn()
    {
        return adorn.get();
    }
    VertexStreamer* getVertexStreamer()
    {
        return vertexStreamer.get();
    }
    TextureCompositor* getTextureCompositor()
    {
        return textureCompositor.get();
    }
    TextureManager* getTextureManager()
    {
        return textureManager.get();
    }
    EmitterShared* getEmitterSharedState()
    {
        return emitterShared.get();
    }
    ...
    {
        return lightGrid.get();
    }
    Water* getWater()
    {
        return water.get();
    }
    SceneUpdater* getSceneUpdater()
    {
        return sceneUpdater.get();
    }
    ...
    // be valid.
    const Frustum* getUpdateFrustum()
    {
    ...
    MeshContentProvider* getMeshContentProvider()
    {
        return meshContentProvider;
    }
    ...
    const RenderCaps* getRenderCaps()
    {
        return renderCaps.get();
    }

    MaterialGenerator* getMaterialGenerator()
    {
        return materialGenerator.get();
    }

    shared_ptr<VertexLayout>& getFastClusterLayout()
    {
        return fastClusterLayout;
    }
    shared_ptr<VertexLayout>& getFastClusterShadowLayout()
    {
        return fastClusterShadowLayout;
    }

    TextureAtlas* getGlyphAtlas() const
    {
...
private:
    ...
    Aya::CRenderSettings* settings;
    bool classicRendering;

    Aya::MeshContentProvider* meshContentProvider;
    Aya::ContentProvider* contentProvider;
    Aya::Lighting* lighting;

    scoped_ptr<RenderCaps> renderCaps;

    scoped_ptr<Aya::RenderStats> renderStats;
