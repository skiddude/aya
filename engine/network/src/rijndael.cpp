...
#include "Rijndael-Boxes.hpp"

static int ROUNDS;

static word8 shifts[3][4][2] = {{{0, 0}, {1, 3}, {2, 2}, {3, 1}},
...
void MixColumn(word8 a[4][4], word8 BC)
{
    ...
    for (j = 0; j < BC; j++)
        for (i = 0; i < 4; i++)
            b[j][i] = mul(2, a[j][i]) ^ mul(3, a[j][(i + 1) % 4]) ^ a[j][(i + 2) % 4] ^ a[j][(i + 3) % 4];
    for (i = 0; i < 4; i++)
        for (j = 0; j < BC; j++)
            a[j][i] = b[j][i];
}
...

{
    ...
    *((word32*)a[3]) = *((word32*)a[3]) ^ *((word32*)rk[0][3]);
    ...
    {
        *((word32*)temp[0]) = *((word32*)T1[a[0][0]]) ^ *((word32*)T2[a[1][1]]) ^ *((word32*)T3[a[2][2]]) ^ *((word32*)T4[a[3][3]]);
        *((word32*)temp[1]) = *((word32*)T1[a[1][0]]) ^ *((word32*)T2[a[2][1]]) ^ *((word32*)T3[a[3][2]]) ^ *((word32*)T4[a[0][3]]);
        *((word32*)temp[2]) = *((word32*)T1[a[2][0]]) ^ *((word32*)T2[a[3][1]]) ^ *((word32*)T3[a[0][2]]) ^ *((word32*)T4[a[1][3]]);
        *((word32*)temp[3]) = *((word32*)T1[a[3][0]]) ^ *((word32*)T2[a[0][1]]) ^ *((word32*)T3[a[1][2]]) ^ *((word32*)T4[a[2][3]]);
...
int rijndaelDecrypt(word8 a[16], word8 b[16], word8 rk[MAXROUNDS + 1][4][4])
{
    ...
    *((word32*)b) = *((word32*)T5[temp[0][0]]) ^ *((word32*)T6[temp[3][1]]) ^ *((word32*)T7[temp[2][2]]) ^ *((word32*)T8[temp[1][3]]);
    *((word32*)(b + 4)) = *((word32*)T5[temp[1][0]]) ^ *((word32*)T6[temp[0][1]]) ^ *((word32*)T7[temp[3][2]]) ^ *((word32*)T8[temp[2][3]]);
    *((word32*)(b + 8)) = *((word32*)T5[temp[2][0]]) ^ *((word32*)T6[temp[1][1]]) ^ *((word32*)T7[temp[0][2]]) ^ *((word32*)T8[temp[3][3]]);
    *((word32*)(b + 12)) = *((word32*)T5[temp[3][0]]) ^ *((word32*)T6[temp[2][1]]) ^ *((word32*)T7[temp[1][2]]) ^ *((word32*)T8[temp[0][3]]);
    ...
    case MODE_CBC:
        ...
        *((word32*)(outBuffer + 12)) = *((word32*)(block + 12)) ^ *((word32*)(cipher->IV + 12));
        ...
        for (i = numBlocks - 1; i > 0; i--)
        {
            ...
            *((word32*)(outBuffer + 16)) = *((word32*)block) ^ *((word32*)(input - 16));
            *((word32*)(outBuffer + 20)) = *((word32*)(block + 4)) ^ *((word32*)(input - 12));
            *((word32*)(outBuffer + 24)) = *((word32*)(block + 8)) ^ *((word32*)(input - 8));
            *((word32*)(outBuffer + 28)) = *((word32*)(block + 12)) ^ *((word32*)(input - 4));
