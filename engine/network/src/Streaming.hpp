...
public:
    DescriptorSender();
    std::map<const T*, IdContainer> DescToId() const
    {
        return descToId;
    }
...
protected:
    typedef SharedDictionary<Aya::Guid::Scope> SharedGuidDictionary;
    SharedGuidDictionary scopeNames; // Used for Aya::Guid
    Aya::Guid::Scope serverScope;
    ...
    typedef std::map<Aya::Guid::Data, std::vector<WaitItem>> WaitItemMap;
...
public:
    ...
    void serializeId(RakNet::BitStream& stream, const Aya::Guid::Data& id);
    void serializeIdWithoutDictionary(RakNet::BitStream& stream, const Instance* instance);
    void serializeIdWithoutDictionary(RakNet::BitStream& stream, const Aya::Guid::Data& id);
    bool trySerializeId(RakNet::BitStream& stream, const Instance* instance);
    bool canSerializeId(const Instance* instance);
    void deserializeId(RakNet::BitStream& stream, Aya::Guid::Data& id);
    void deserializeIdWithoutDictionary(RakNet::BitStream& stream, Aya::Guid::Data& id);
    void resolvePendingReferences(Instance* instance, Aya::Guid::Data id);

    void serializeInstanceRef(const Instance* instance, RakNet::BitStream& bitStream);

    bool deserializeInstanceRef(
        RakNet::BitStream& stream, shared_ptr<Instance>& instance, Aya::Guid::Data& id); // returns false if it couldn't find the Instance
    ...
    void addPendingRef(const Reflection::RefPropertyDescriptor* desc, boost::shared_ptr<Instance> instance, Aya::Guid::Data id);
...
template<>
void serialize<Aya::RbxRay>(const Reflection::ConstProperty& property, RakNet::BitStream& bitStream);
template<>
void deserialize<Aya::RbxRay>(Reflection::Property& property, RakNet::BitStream& bitStream);
