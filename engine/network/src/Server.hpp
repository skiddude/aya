...
public:
    ...
    bool getIsPlayerAuthenticationRequired() const
    {
        return Network::isPlayerAuthenticationEnabled() && isPlayerAuthenticationRequired;
    }
    void setIsPlayerAuthenticationRequired(bool value)
    {
        isPlayerAuthenticationRequired = value;
    }
    ...
    Aya::signal<void(shared_ptr<Instance> peer, FilterResult result, shared_ptr<Instance> item, std::string member)> dataBasicFilteredSignal;
    Aya::signal<void(shared_ptr<Instance> peer, FilterResult result, shared_ptr<Instance> item, std::string member)> dataCustomFilteredSignal;
    Aya::signal<void(std::string, shared_ptr<Instance>)> incommingConnectionSignal;
