...
#include "DataModel/SafeChat.hpp"
...
const char* const Aya::Network::sPlayers = "Players";
...
static Reflection::PropDescriptor<Players, int> propPlayerCount(
    "NumPlayers", category_Data, &Players::getNumPlayers, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Players, int> depPlayerCount("numPlayers", category_Data, &Players::getNumPlayers, NULL,
    Reflection::PropertyDescriptor::Attributes::deprecated(propPlayerCount, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING));
static Reflection::PropDescriptor<Players, int> propPlayerMaxCount(
    "MaxPlayers", category_Data, &Players::getMaxPlayers, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Players, int> propPlayerMaxCountInternal("MaxPlayersInternal", category_Data, &Players::getMaxPlayers,
    &Players::setMaxPlayers, Reflection::PropertyDescriptor::STANDARD, Security::LocalUser);
static Reflection::PropDescriptor<Players, int> propPlayerPreferredCount(
    "PreferredPlayers", category_Data, &Players::getPreferredPlayers, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Players, int> propPlayerPreferredCountInternal("PreferredPlayersInternal", category_Data,
    &Players::getPreferredPlayers, &Players::setPreferredPlayers, Reflection::PropertyDescriptor::STANDARD, Security::LocalUser);
Reflection::RefPropDescriptor<Players, Instance> Players::propLocalPlayer(
    "LocalPlayer", category_Data, &Players::getLocalPlayerDangerous, NULL, Reflection::PropertyDescriptor::UI);
Reflection::RefPropDescriptor<Players, Instance> dep_propLocalPlayer("localPlayer", category_Data, &Players::getLocalPlayerDangerous, NULL,
    Reflection::PropertyDescriptor::Attributes::deprecated(Players::propLocalPlayer, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING));
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(int)> func_GetPlayerByID(
    &Players::getPlayerInstanceByID, "GetPlayerById", "userId", Security::LocalUser);
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(int)> func_GetPlayerByIdDeprecated(&Players::getPlayerInstanceByID, "GetPlayerByID",
    "userID", Security::LocalUser, Reflection::PropertyDescriptor::Attributes::deprecated(func_GetPlayerByID));

Reflection::PropDescriptor<Players, bool> Players::propCharacterAutoSpawn("CharacterAutoLoads", category_Behavior,
    &Players::getCharacterAutoSpawnProperty, &Players::setCharacterAutoSpawnProperty, Reflection::PropertyDescriptor::STANDARD_NO_REPLICATE);
...
static Reflection::BoundFuncDesc<Players, void(std::string, shared_ptr<Instance>)> funcPlayerChat(
    &Players::whisperChat, "WhisperChat", "message", "player", Security::LocalUser);
static Reflection::EventDesc<Players, void(Players::PlayerChatType, shared_ptr<Instance>, std::string, shared_ptr<Instance>)> event_Chatted(
    &Players::playerChattedSignal, "PlayerChatted", "chatType", "player", "message", "targetPlayer", Security::LocalUser);
static Reflection::EventDesc<Players, void(std::string)> event_GameAnnounce(
    &Players::gameAnnounceSignal, "GameAnnounce", "message", Security::RobloxScript);

static Reflection::BoundFuncDesc<Players, void(shared_ptr<Instance>, std::string, std::string)> funcReportAbuse(
    &Players::reportAbuseLua, "ReportAbuse", "player", "reason", "optionalMessage", Security::LocalUser);
...
static Reflection::BoundFuncDesc<Players, shared_ptr<const Instances>()> dep_players(
    &Players::getPlayers, "players", Security::None, Reflection::Descriptor::Attributes::deprecated(func_GetPlayers));
static Reflection::BoundFuncDesc<Players, shared_ptr<const Instances>()> dep_getPlayers(
    &Players::getPlayers, "getPlayers", Security::None, Reflection::Descriptor::Attributes::deprecated(func_GetPlayers));
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(int, bool)> func_createLocalPlayer(
    &Players::createLocalPlayer, "CreateLocalPlayer", "userId", "isTeleport", false, Security::Plugin);
static Reflection::BoundFuncDesc<Players, void(std::string)> func_setAbuseReportUrl(
    &Players::setAbuseReportUrl, "SetAbuseReportUrl", "url", Security::Roblox);
static Reflection::BoundFuncDesc<Players, void(std::string)> func_setChatFilterUrl(
    &Players::setChatFilterUrl, "SetChatFilterUrl", "url", Security::Roblox);

static Reflection::BoundFuncDesc<Players, void(std::string)> func_setBuildUserPermissionsUrl(
    &Players::setBuildUserPermissionsUrl, "SetBuildUserPermissionsUrl", "url", Security::Roblox);
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(shared_ptr<Instance>)> func_playerFromCharacter(
    &Players::playerFromCharacter, "GetPlayerFromCharacter", "character", Security::None);
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(shared_ptr<Instance>)> func_playerFromCharacterOld(&Players::playerFromCharacter,
    "playerFromCharacter", "character", Security::None, Reflection::Descriptor::Attributes::deprecated(func_playerFromCharacter));
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(shared_ptr<Instance>)> dep_playerFromCharacter(&Players::playerFromCharacter,
    "getPlayerFromCharacter", "character", Security::None, Reflection::Descriptor::Attributes::deprecated(func_playerFromCharacter));

static Reflection::EventDesc<Players, void(shared_ptr<Instance>, shared_ptr<Instance>, FriendService::FriendEventType)> event_FriendRequestEvent(
    &Players::friendRequestEvent, "FriendRequestEvent", "player", "player", "friendRequestEvent", Security::RobloxScript);
static Reflection::EventDesc<Players, void(shared_ptr<Instance>)> event_PlayerAddedEarly(
    &Players::playerAddedEarlySignal, "PlayerAddedEarly", "player", Security::LocalUser);
...
static Reflection::EventDesc<Players, void(shared_ptr<Instance>)> event_PlayerRemovingLate(
    &Players::playerRemovingLateSignal, "PlayerRemovingLate", "player", Security::LocalUser);

static Reflection::BoundFuncDesc<Players, void(std::string)> func_setSysStatsUrl(
    &Players::setSysStatsUrl, "SetSysStatsUrl", "url", Security::LocalUser);

static Reflection::BoundFuncDesc<Players, void(std::string)> func_setLoadDataUrl(
    &Players::setLoadDataUrl, "SetLoadDataUrl", "url", Security::LocalUser);
static Reflection::BoundFuncDesc<Players, void(std::string)> func_setSaveDataUrl(
    &Players::setSaveDataUrl, "SetSaveDataUrl", "url", Security::LocalUser);
static Reflection::BoundFuncDesc<Players, void(std::string)> func_setSaveLeaderboardDataUrl(
    &Players::setSaveLeaderboardDataUrl, "SetSaveLeaderboardDataUrl", "url", Security::LocalUser);
static Reflection::BoundFuncDesc<Players, void(std::string)> func_addLeaderboardKey(
    &Players::addLeaderboardKey, "AddLeaderboardKey", "key", Security::LocalUser);

static Reflection::BoundFuncDesc<Players, void(Players::ChatOption)> func_setChatOption(
    &Players::setChatOption, "SetChatStyle", "style", Players::CLASSIC_CHAT, Security::Plugin);
Reflection::PropDescriptor<Players, bool> propClassicChat(
    "ClassicChat", category_Data, &Players::getClassicChat, NULL, Reflection::PropertyDescriptor::UI);
Reflection::PropDescriptor<Players, bool> propBubbleChat(
    "BubbleChat", category_Data, &Players::getBubbleChat, NULL, Reflection::PropertyDescriptor::UI);

static Reflection::BoundFuncDesc<Players, bool()> func_coreScriptHealthBar(
    &Players::getUseCoreScriptHealthBar, "GetUseCoreScriptHealthBar", Security::RobloxScript);

// Chat Ignore Support
static Reflection::RemoteEventDesc<Players, void(int, int, std::string)> event_serverFinishedBlockUser(&Players::blockUserFinishedFromServerSignal,
    "BlockedRequestFinishedSignal", "blockerUserId", "blockeeUserId", "didDoRequest", Security::Roblox, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::BROADCAST);
static Reflection::RemoteEventDesc<Players, void(int, int, bool)> event_blockUserFromClient(&Players::blockUserRequestFromClientSignal,
    "BlockUserSignal", "blockerUserId", "blockeeUserId", "blocking", Security::Roblox, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::BoundYieldFuncDesc<Players, std::string(int, int)> func_blockUser(
    &Players::blockUser, "BlockUser", "blockerUserId", "blockeeUserId", Security::RobloxScript);
static Reflection::BoundYieldFuncDesc<Players, std::string(int, int)> func_unblockUser(
    &Players::unblockUser, "UnblockUser", "exblockerUserId", "exblockeeUserId", Security::RobloxScript);

// UserName to userId, userId to UserName
static Reflection::BoundYieldFuncDesc<Players, int(std::string)> func_getUserIdFromName(
    &Players::getUserIdFromName, "GetUserIdFromNameAsync", "userName", Security::None);
static Reflection::BoundYieldFuncDesc<Players, std::string(int)> func_getNameFromUserId(
    &Players::getNameFromUserId, "GetNameFromUserIdAsync", "userId", Security::None);
static Reflection::BoundYieldFuncDesc<Players, shared_ptr<Instance>(int)> func_getFriends(
    &Players::getFriends, "GetFriendsAsync", "userId", Security::None);
static Reflection::BoundYieldFuncDesc<Players, shared_ptr<Instance>(int)> func_getCharacterAppearance(
    &Players::getCharacterAppearance, "GetCharacterAppearanceAsync", "userId", Security::None);
static Reflection::BoundFuncDesc<Players, shared_ptr<Instance>(int)> func_getPlayerByUserId(
    &Players::getPlayerInstanceByID, "GetPlayerByUserId", "userId", Security::None);


namespace
{
shared_ptr<RakNet::BitStream> buildBasicChatBitStream(const Instance* sender, const Instance* receiver, unsigned char chatType)
{
...
{
    return Instance::fastDynamicCast<Aya::Network::Client>(instance) != NULL;
}
...
template<class T>
bool valueTableGet(shared_ptr<const Reflection::ValueTable> valueTable, const std::string& key, T* outValue)
{
...
void Players::getUserIdFromName(std::string userName, boost::function<void(int)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    {
        apiService->getAsync(format(FString::GetUserIdUrl.c_str(), userName.c_str()), true, Aya::PRIORITY_DEFAULT,
...
void Players::onReceivedRawGetUserIdSuccess(weak_ptr<DataModel> weakDataModel, std::string response, boost::function<void(int)> resumeFunction,
...
void Players::getNameFromUserId(int userId, boost::function<void(std::string)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        apiService->getAsync(format(FString::GetUserNameUrl.c_str(), userId), true, Aya::PRIORITY_DEFAULT,
...
void Players::setAppearanceParent(shared_ptr<Instance> model, weak_ptr<Instance> instance)
{
    ...
    if (Instance::fastDynamicCast<Aya::DataModelMesh>(i.get()) || Instance::fastDynamicCast<Aya::Decal>(i.get()) ||
        Instance::fastDynamicCast<Aya::CharacterAppearance>(i.get()))
    {
...
void Players::doLoadAppearance(AsyncHttpQueue::RequestResult result, shared_ptr<Instances> instances, std::string contentDescription,
    ...
    boost::function<void(std::string)> errorFunction)
{
    if (amountToLoad.get())
    {
        ...
        catch (Aya::base_exception& e)
        {
            amountToLoad.reset();
            errorFunction(
                format("Players:GetCharacterAppearanceAsync() Error loading character appearance %s: %s", contentDescription.c_str(), e.what()));
        }
    }
}
    ...
    *amountToLoad.get() = (int)strings.size();
    ...
    if (d)
    {
        ...
        for (size_t i = 0; i < strings.size(); i++)
        {
            ...
            ServiceProvider::create<ContentProvider>(d.get())->loadContent(ContentId(contentIdString), ContentProvider::PRIORITY_DEFAULT,
    ...
    boost::function<void(shared_ptr<Instance>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (d)
    {
        ...
        {
            d->submitTask(
                boost::bind(&Players::doMakeAccoutrementRequests, *response, dataModel, model, resumeFunction, errorFunction), DataModelJob::Write);
        }
...
void Players::getCharacterAppearance(
    int userId, boost::function<void(shared_ptr<Instance>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    std::string characterAppearance =
        format("%sAsset/CharacterFetch.ashx?userId=%d", ServiceProvider::create<ContentProvider>(this)->getBaseUrl().c_str(), userId);
    ...
    Aya::Http(characterAppearance)
        .get(boost::bind(&makeAccoutrementRequests, _1, _2, boost::weak_ptr<DataModel>(dm), model, resumeFunction, errorFunction));
}

void Players::onReceivedRawGetUserNameSuccess(weak_ptr<DataModel> weakDataModel, std::string response,
...
bool Players::clientIsPresent(const Aya::Instance* context, bool testInDatamodel)
{
    return Client::clientIsPresent(context, testInDatamodel);
}

bool Players::serverIsPresent(const Aya::Instance* context, bool testInDatamodel)
{
...
bool Players::frontendProcessing(const Aya::Instance* context, bool testInDatamodel)
{
...
bool Players::backendProcessing(const Aya::Instance* context, bool testInDatamodel)
{
    const ServiceProvider* serviceProvider = ServiceProvider::findServiceProvider(context);
    AYAASSERT(!testInDatamodel || serviceProvider != NULL);
...
int Players::getPlayerCount(const Aya::Instance* context)
{
    const ServiceProvider* serviceProvider = ServiceProvider::findServiceProvider(context);
...
Aya::SystemAddress Players::findLocalSimulatorAddress(const Aya::Instance* context)
{
...
void Players::setMaxPlayers(int value)
{
    ...
    if (value != maxPlayers)
    {
        ...
        integration.setPartySize(getNumPlayers(), maxPlayers);
#endif
    }
}
...
shared_ptr<Instance> Players::createLocalPlayer(int userId, bool teleportedIn)
{
    ...
    Aya::AyaDbgInfo::s_instance.PlayerID = userId;
    ...
    {
        if (backendProcessing(this) && frontendProcessing(this))
        { // play solo mode
    ...
    if (DFFlag::LoadGuisWithoutChar && Network::Players::frontendProcessing(this) && Network::Players::backendProcessing(this))
        Aya::DataModel::get(this)->setIsGameLoaded(true);
...
{
    XmlElement* element = messages->addChild(Aya::Name::declare("message"));
    element->setValue(msg.text);
    element->addAttribute(Aya::Name::declare("userID"), msg.userID);
    element->addAttribute(Aya::Name::declare("guid"), msg.guid);
}
...
bool ChatMessage::isVisibleToPlayer(
    shared_ptr<Player> const player, shared_ptr<Player> const source, shared_ptr<Player> const destination, const ChatMessage::ChatType chatType)
{
    switch (chatType)
    {
    case CHAT_TYPE_ALL:
...
AbuseReporter::AbuseReporter(std::string abuseUrl)
    : _data(new data())
{
    requestProcessor.reset(new worker_thread(boost::bind(&AbuseReporter::processRequests, _data, abuseUrl), "aya_abusereporter"));
}
...
void AbuseReporter::add(AbuseReport& r, shared_ptr<Player> reportingPlayer, const std::list<ChatMessage>& chatHistory)
{
    ...
    std::for_each(chatHistory.begin(), chatHistory.end(), boost::bind(&AbuseReport::addMessage, boost::ref(r), reportingPlayer, _1));
...
worker_thread::work_result AbuseReporter::processRequests(shared_ptr<data> _data, std::string abuseUrl)
{
    try
    {
        ...
        std::stringstream body;
        {
            ...
            XmlElement root(Aya::Name::declare("report"));
            root.addAttribute(Aya::Name::declare("userID"), r.submitterID);
            root.addAttribute(Aya::Name::declare("placeID"), r.placeID);
            root.addAttribute(Aya::Name::declare("gameJobID"), r.gameJobID);

            root.addChild(new XmlElement(Aya::Name::declare("comment"), r.comment));
            XmlElement* messages = root.addChild(new XmlElement(Aya::Name::declare("messages")));
...
void Players::reportAbuseLua(shared_ptr<Instance> instance, std::string reason, std::string comment)
{
    ...
    if (instance)
    {
        ...
        if (!player)
            throw Aya::runtime_error("player must be a Player object or null");
    }

    if (!localPlayer)
        throw Aya::runtime_error("You can only report-abuse from a client machine");
...
void Players::checkChat(const std::string& message)
{
    ...
    {
        throw std::runtime_error("Chat message too long");
    }

    if (std::all_of(message.begin(), message.end(), isspace))
    {
        throw std::runtime_error("Chat message is all whitespace");
    }
}

static Aya::Guid::Data readPlayerIdentifier(RakNet::BitStream& inBitStream)
{
    Aya::Guid::Data id;
...
static void writePlayerIdentifier(
    RakNet::BitStream& bitStream, const boost::intrusive_ptr<GuidItem<Instance>::Registry>& guidRegistery, shared_ptr<Player> player)
{
    // Write the sender
...
void Players::SendOpusData()
{
    if (!rakPeer)
        return;

    if (!MicrophoneInput::isInitialized())
        return;

    if (getLocalPlayer())
    {
        std::tuple<unsigned char*, int> data = MicrophoneInput::getData();
        if (std::get<0>(data) == nullptr)
            return; // no data for this opus packet

        shared_ptr<RakNet::BitStream> bitStream(new RakNet::BitStream());
        *bitStream << (unsigned char)ID_OPUS_DATA;

        Aya::Guid::Data guid;
        getLocalPlayer()->getGuid().extract(guid);
        *bitStream << guid.scope;
        *bitStream << guid.index;

        bitStream->Write(std::get<1>(data));
        bitStream->WriteAlignedBytes(std::get<0>(data), std::get<1>(data));

        Aya::StandardOut::singleton()->printf(MESSAGE_SENSITIVE, "Sending %d bytes of opus data", sizeof(data));

        rakPeer->Send(bitStream, VOICE_CHAT_PRIORITY, VOICE_CHAT_RELIABILITY, VOICE_CHAT_CHANNEL, UNASSIGNED_SYSTEM_ADDRESS, true);
        delete std::get<0>(data);
    }
}

Players::ReceiveResult Players::OnReceiveOpusData(Player* source, RakNet::RakPeerInterface* peer, RakNet::Packet* packet, unsigned char chatType)
{
    RakNet::BitStream inBitstream(packet->data, packet->length, false);
    inBitstream.IgnoreBits(8);

    Aya::Guid::Data sourceGuid;
    ...
    if (source)
    {
        if (sourceInstance.get() != source)
        {
            StandardOut::singleton()->printf(
                MESSAGE_SENSITIVE, "Source instance not from the same player from %s", RakNetAddressToString(packet->systemAddress).c_str());
            return Players::PLAYERS_STOP_PROCESSING_AND_DEALLOCATE;
        }
    }

    int data_size;
    inBitstream >> data_size;

    if (!sourceInstance)
    {
        StandardOut::singleton()->printf(
            MESSAGE_SENSITIVE, "Opus packet from unknown Player %s", RakNetAddressToString(packet->systemAddress).c_str());
    }
    else if (sourceInstance->getParent() == this) // confirm the player hasn't been bumped
    {
        ...
        printf("OnReceiveOpusData %i DS: %i\n", kIsBackendProcessing, data_size);
        if (kIsBackendProcessing)
        {
            ...
            peer->Send((const char*)packet->data, packet->length, CHAT_PRIORITY, UNRELIABLE_SEQUENCED, CHAT_CHANNEL, UNASSIGNED_SYSTEM_ADDRESS, true);

            Aya::ModelInstance* character = sourcePlayer->getCharacter();
            if (character)
            {
                Aya::Instance* head = character->findFirstChildByName("Head");
                if (head)
                {
                    if (!head->findFirstChildByName("VoiceChatOutput"))
                    {
                        Aya::Security::Impersonator impersonate(Aya::Security::Replicator_);
                        shared_ptr<VoiceChatOutput> vco = Creatable<Instance>::create<VoiceChatOutput>();
                        vco->setParent(head);
                    }
                }

                printf("created VoiceChatOutput for player %s\n", sourcePlayer->getName().c_str());
            }
        ...
        else
        {
            ...
            inBitstream.ReadAlignedBytes(data, data_size);

            Soundscape::SoundService* service = ServiceProvider::create<Soundscape::SoundService>(this);
            Aya::StandardOut::singleton()->printf(MESSAGE_SENSITIVE, "Received %d bytes of opus data", data_size);
            ...
            if (character)
            {
                ...
                if (head)
                {
                    VoiceChatOutput* vco = sourcePlayer->findFirstChildOfType<VoiceChatOutput>();
                    if (vco)
                    {
                        if (!vco->isInitialized())
                            vco->load(this);

                        vco->addData(VoiceChatOpusData(data_size, data));
                    }
                }
            }
...
Players::ReceiveResult Players::OnReceiveChat(
    Player* sourceValidation, RakNet::RakPeerInterface* peer, RakNet::Packet* packet, unsigned char chatType)
{
    RakNet::BitStream inBitstream(packet->data, packet->length, false);
    ...
    if (!sourceInstance)
    {
        ...
        {
            StandardOut::singleton()->printf(
                MESSAGE_SENSITIVE, "Chat message from unknown Player %s %s", RakNetAddressToString(packet->systemAddress).c_str(), message.c_str());
        }
    }
    else if (sourceInstance->getParent() == this) // confirm the player hasn't been bumped
    {
        ...
        if (kIsBackendProcessing)
        {
            ...
            ChatFilter::FilteredChatMessageCallback callback = boost::bind(&Players::sendFilteredChatMessageSignalHelper, shared_from(this),
                packet->systemAddress, buildBasicChatBitStream(sourceInstance.get(), destinationInstance.get(), chatType), sourceInstance,
                shared_ptr<ChatMessage>(), _1);
...
void Players::sendFilteredChatMessageSignalHelper(const RakNet::SystemAddress& systemAddress, const shared_ptr<RakNet::BitStream>& baseData,
    const shared_ptr<Instance> sourceInstance, shared_ptr<ChatMessage> chatEvent, const ChatFilter::Result& result)
{
    DataModel::LegacyLock l(DataModel::get(this), DataModelJob::Write);

    sendFilteredChatMessageSignal(systemAddress, baseData, sourceInstance, result.whitelistFilteredMessage, result.blacklistFilteredMessage);
}
...
std::string Players::getLoadDataUrl(int userId) const
{
    ...
    return Aya::format(loadDataUrl.c_str(), userId);
}
...
std::string Players::getSaveDataUrl(int userId) const
{
    ...
    return Aya::format(saveDataUrl.c_str(), userId);
}
...
std::string Players::getSaveLeaderboardDataUrl(int userId) const
{
    ...
    return Aya::format(saveLeaderboardDataUrl.c_str(), userId);
}
...
void Players::friendServiceRequest(bool makeFriends, weak_ptr<Player> sourcePlayer, int otherUserId)
{
    ...
    if (Aya::FriendService* fs = ServiceProvider::find<FriendService>(this))
    {
        if (!makeFriends)
        {
...
void Players::gotBlockUserSuccess(std::string response, bool blockUser, int blockerUserId, int blockeeUserId,
    boost::function<void(std::string)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (!response.empty())
    {
        ...
        else
        {
            ...
            {
                event_serverFinishedBlockUser.fireAndReplicateEvent(
                    this, blockerUserId, blockeeUserId, methodName + " response indicating block request failed");
            }
        }
    }
    else
...
void Players::gotBlockUserError(
    std::string error, bool blockUser, int blockerUserId, int blockeeUserId, boost::function<void(std::string)> errorFunction)
{
...
void Players::serverMakeBlockUserRequest(bool blockUser, int blockerUserId, int blockeeUserId, boost::function<void(std::string)> resumeFunction,
    boost::function<void(std::string)> errorFunction)
{
    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        std::stringstream params;
        params << "user_id=" << blockerUserId << "&to_block_id=" << blockeeUserId;

        std::string apiPath = blockUser ? "server/block-user" : "server/unblock-user";

        apiService->postAsync(apiPath, params.str(), true, Aya::PRIORITY_DEFAULT, Aya::HttpService::APPLICATION_URLENCODED,
...
void Players::internalBlockUser(int blockerUserId, int blockeeUserId, bool isBlocking, boost::function<void(std::string)> resumeFunction,
    boost::function<void(std::string)> errorFunction)
{
    ...
    if (clientIsPresent(this))
    {
        ...
        {
            errorFunction(Aya::format("Currently processing block request for userIds %i and %i, please wait until these requests return a value "
                                      "before submitting a new request.",
                blockerUserId, blockeeUserId));
            return;
        }

        clientBlockUserMap[blockerPair] =
            std::pair<boost::function<void(std::string)>, boost::function<void(std::string)>>(resumeFunction, errorFunction);
...
void Players::blockUser(
    int blockerUserId, int blockeeUserId, boost::function<void(std::string)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    internalBlockUser(blockerUserId, blockeeUserId, true, resumeFunction, errorFunction);
}

void Players::unblockUser(
    int blockerUserId, int blockeeUserId, boost::function<void(std::string)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
...
void Players::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider)
{
    ...
    if (newProvider)
    {
        ...
        {
            blockUserClientSignalConnection = blockUserRequestFromClientSignal.connect(boost::bind(
                &Players::serverMakeBlockUserRequest, this, _3, _1, _2, boost::function<void(std::string)>(), boost::function<void(std::string)>()));
        }

        if (frontendProcessing(newProvider))
        {
            blockUserFinishedFromServerConnection =
                blockUserFinishedFromServerSignal.connect(boost::bind(&Players::clientReceiveBlockUserFinished, this, _1, _2, _3));
            if (DFFlag::LoadGuisWithoutChar)
            {
                if (ServiceProvider::create<ReplicatedFirst>(newProvider))
                    loadLocalPlayerGuisConnection =
                        Aya::DataModel::get(newProvider)->gameLoadedSignal.connect(boost::bind(&Players::loadLocalPlayerGuis, this));
            }
        }
    }
}
...
ModelInstance* Players::findLocalCharacter(Aya::Instance* context)
{
...
const ModelInstance* Players::findConstLocalCharacter(const Aya::Instance* context)
{
...
shared_ptr<Player> Players::findAncestorPlayer(const Aya::Instance* descendent)
{
...
shared_ptr<Player> Players::findPlayerWithAddress(const Aya::SystemAddress& playerAddress, const Aya::Instance* context)
{
    if (Players* players = ServiceProvider::find<Players>(context))
    {
        // First check is the descendent is from one of our Players
...
Player* Players::getPlayerFromCharacter(Aya::Instance* character)
{
...
void Players::onChildRemoving(Instance* child)
{
    if (Player* player = Instance::fastDynamicCast<Player>(child))
    {
        ...
        if (Teams* teamService = ServiceProvider::find<Teams>(this))
        {
            if (Team* team = teamService->getTeamFromPlayer(player))
            {
                team->playerRemovedSignal(shared_from(player));
            }
        }
...
void Players::processRemoteEvent(
...
void Players::killPlayer(int userId)
{
    ...
    if (player)
    {
        if (Humanoid* humanoid = player->getCharacter()->findFirstChildOfType<Humanoid>())
            humanoid->setHealth(0.0f);
    }
}
...
// used to report hackers, the legacy Roblox anticheat, that is now GUTTED... mwa ha ha.
void Players::onRemoteSysStats(int userId, const std::string& stat, const std::string& message, bool desireKick)
{
    // should not care about DebugLocalRccServerConnection
    if (IsInsecureMode() || FFlag::DebugLocalRccServerConnection)
        return;
    ...
    if (Player* player = Instance::fastDynamicCast<Player>(child))
    {
        ...
        if (Players::backendProcessing(this)) // Server does it in client/server - bail on client mode.  will still execute in solo mode
        {
            if (userId == 0 && player->getName() == "Player")
            {
                ...
                Aya::Security::Impersonator impersonate(Aya::Security::Replicator_);
                player->setName(Aya::format("Player%d", ++testPlayerNameId));
                player->setUserId(--testPlayerUserId);
            }

            Workspace* workspace = ServiceProvider::find<Workspace>(this);
            if (!DFFlag::LoadGuisWithoutChar || !workspace->getNetworkFilteringEnabled() ||
                (Network::Players::frontendProcessing(this) && Network::Players::backendProcessing(this)))
            {
            ...
            if (!player->calculatesSpawnLocationEarly())
            {
                // Team Service
    ...
    void operator()(shared_ptr<Instance> instance)
    {
        if (Player* p = Instance::fastDynamicCast<Player>(instance.get()))
        {
            if (p != ownerPlayer)
            {
                ...
                {
                    region.appendOther(Region2::WeightedPoint(pos.translation.xz(), p->getSimulationRadius()));
                }
            }
        }
    }
...
void Players::buildClientRegion(Region2& clientRegion)
{
    ...
    {
        clientRegion.setOwner(Region2::WeightedPoint(pos.translation.xz(), localPlayer->getSimulationRadius()));
