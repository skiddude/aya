...
#include "Utility/AsyncHttpQueue.hpp"
...
// for future differences between PlayerMouse and Mouse objects
...
const char* const Aya::Network::sPlayer = "Player";
static const char* const kPlaceIdUrlParamFormat = "&serverplaceid=%d";

static const char* const kValidCharacterAppearancePaths[] = {"asset/characterfetch.ashx", "asset/avataraccoutrements.ashx"};
...
static Reflection::PropDescriptor<Player, bool> prop_groupBuildTools("HasBuildTools", category_Data, &Player::getHasGroupBuildTools,
    &Player::setHasGroupBuildTools, Reflection::PropertyDescriptor::SCRIPTING, Security::RobloxScript);
static Reflection::PropDescriptor<Player, int> prop_personalServerRank("PersonalServerRank", category_Data, &Player::getPersonalServerRank,
    &Player::setPersonalServerRank, Reflection::PropertyDescriptor::SCRIPTING, Security::RobloxScript);
static Reflection::BoundYieldFuncDesc<Player, std::string()> func_getWebPersonalServerRank(
    &Player::getWebPersonalServerRank, "GetWebPersonalServerRank", Security::LocalUser);
static Reflection::BoundYieldFuncDesc<Player, bool(int)> func_setPersonalServerRank(
    &Player::setWebPersonalServerRank, "SetWebPersonalServerRank", "rank", Security::WritePlayer);


static Reflection::PropDescriptor<Player, int> prop_dataComplexity(
    "DataComplexity", category_Data, &Player::getDataComplexity, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Player, int> prop_dataComplexityLimit("DataComplexityLimit", category_Data, &Player::getDataComplexityLimit,
    &Player::setDataComplexityLimit, Reflection::PropertyDescriptor::UI, Security::LocalUser);

static Reflection::PropDescriptor<Player, bool> prop_dataReady(
    "DataReady", category_Data, &Player::getDataReady, NULL, Reflection::PropertyDescriptor::UI);
...
static Reflection::BoundYieldFuncDesc<Player, bool()> func_dep_waitForDataReady(
    &Player::waitForDataReady, "waitForDataReady", Security::None, Reflection::Descriptor::Attributes::deprecated(func_waitForDataReady));

static Reflection::BoundFuncDesc<Player, void(shared_ptr<Instance>)> func_requestFriendship(
    &Player::requestFriendship, "RequestFriendship", "player", Security::RobloxScript);
static Reflection::BoundFuncDesc<Player, void(shared_ptr<Instance>)> func_revokeFriendship(
    &Player::revokeFriendship, "RevokeFriendship", "player", Security::RobloxScript);
static Reflection::RemoteEventDesc<Player, void(bool, int)> desc_remoteFriendServiceSignal(&Player::remoteFriendServiceSignal,
    "RemoteFriendServiceSignal", "makeFriends", "userId", Security::RobloxScript, Reflection::RemoteEventCommon::REPLICATE_ONLY,
...
static Reflection::BoundFuncDesc<Player, void(std::string, std::string)> func_saveString(
    &Player::saveString, "SaveString", "key", "value", Security::None);
static Reflection::BoundFuncDesc<Player, bool(std::string)> func_loadBoolean(&Player::loadBoolean, "LoadBoolean", "key", Security::None);
static Reflection::BoundFuncDesc<Player, void(std::string, bool)> func_saveBoolean(
    &Player::saveBoolean, "SaveBoolean", "key", "value", Security::None);
static Reflection::BoundFuncDesc<Player, double(std::string)> func_loadNumber(&Player::loadNumber, "LoadNumber", "key", Security::None);
static Reflection::BoundFuncDesc<Player, void(std::string, double)> func_saveNumber(
    &Player::saveNumber, "SaveNumber", "key", "value", Security::None);
static Reflection::BoundFuncDesc<Player, shared_ptr<Instance>(std::string)> func_loadInstance(
    &Player::loadInstance, "LoadInstance", "key", Security::None);
static Reflection::BoundFuncDesc<Player, void(std::string, shared_ptr<Instance>)> func_saveInstance(
    &Player::saveInstance, "SaveInstance", "key", "value", Security::None);

static Reflection::BoundFuncDesc<Player, std::string(std::string)> dep_loadString(
    &Player::loadString, "loadString", "key", Security::None, Reflection::Descriptor::Attributes::deprecated(func_loadString));
static Reflection::BoundFuncDesc<Player, void(std::string, std::string)> dep_saveString(
    &Player::saveString, "saveString", "key", "value", Security::None, Reflection::Descriptor::Attributes::deprecated(func_saveString));
static Reflection::BoundFuncDesc<Player, bool(std::string)> dep_loadBoolean(
    &Player::loadBoolean, "loadBoolean", "key", Security::None, Reflection::Descriptor::Attributes::deprecated(func_loadBoolean));
static Reflection::BoundFuncDesc<Player, void(std::string, bool)> dep_saveBoolean(
    &Player::saveBoolean, "saveBoolean", "key", "value", Security::None, Reflection::Descriptor::Attributes::deprecated(func_saveBoolean));
static Reflection::BoundFuncDesc<Player, double(std::string)> dep_loadNumber(
    &Player::loadNumber, "loadNumber", "key", Security::None, Reflection::Descriptor::Attributes::deprecated(func_loadNumber));
static Reflection::BoundFuncDesc<Player, void(std::string, double)> dep_saveNumber(
    &Player::saveNumber, "saveNumber", "key", "value", Security::None, Reflection::Descriptor::Attributes::deprecated(func_saveNumber));
static Reflection::BoundFuncDesc<Player, shared_ptr<Instance>(std::string)> dep_loadInstance(
    &Player::loadInstance, "loadInstance", "key", Security::None, Reflection::Descriptor::Attributes::deprecated(func_loadInstance));
static Reflection::BoundFuncDesc<Player, void(std::string, shared_ptr<Instance>)> dep_saveInstance(
    &Player::saveInstance, "saveInstance", "key", "value", Security::None, Reflection::Descriptor::Attributes::deprecated(func_saveInstance));

#ifdef _ADVANCED_PERSISTENCE_TYPES_
static Reflection::BoundFuncDesc<Player, shared_ptr<const Reflection::ValueArray>(std::string)> func_loadList(
    &Player::loadList, "LoadList", "key", Security::None);
static Reflection::BoundFuncDesc<Player, void(std::string, shared_ptr<const Reflection::ValueArray>)> func_saveList(
    &Player::saveList, "SaveList", "key", "value", Security::None);
static Reflection::BoundFuncDesc<Player, shared_ptr<const Aya::Reflection::ValueMap>(std::string)> func_loadTable(
    &Player::loadTable, "LoadTable", "key", Security::None);
static Reflection::BoundFuncDesc<Player, void(std::string, shared_ptr<const Aya::Reflection::ValueMap>)> func_saveTable(
    &Player::saveTable, "SaveTable", "key", "value", Security::None);
#endif

static Reflection::BoundFuncDesc<Player, void(Vector3, bool)> moveCharacterFunction(
    &Player::move, "Move", "walkDirection", "relativeToCamera", false, Security::None);

// MoveCharacter + JumpCharacter only used by lua control core scripts
static Reflection::BoundFuncDesc<Player, void(Vector2, float)> moveLocalCharacterFunction(
    &Player::luaMoveCharacter, "MoveCharacter", "walkDirection", "maxWalkDelta", Security::RobloxScript);
...
static Reflection::BoundFuncDesc<Player, void(bool)> loadCharacterFunction(
    &Player::luaLoadCharacter, "LoadCharacter", "inGame", true, Security::None);
...
static Reflection::BoundFuncDesc<Player, void(Player::MembershipType)> func_SetMembershipType(
    &Player::setMembershipType, "SetMembershipType", "membershipType", Security::RobloxScript);
...
static Reflection::RemoteEventDesc<Player, void(std::string)> event_setShutdownMessage(&Player::setShutdownMessageSignal, "SetShutdownMessage",
    "message", Security::Roblox, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

// This property is used by the replication framework to propagate user positions within a multi-player game
static Reflection::RefPropDescriptor<Player, ModelInstance> prop_Character(
    "Character", category_Data, &Player::getDangerousCharacter, &Player::setCharacter);
static Reflection::PropDescriptor<Player, std::string> prop_characterAppearance(
    "CharacterAppearance", category_Data, &Player::getCharacterAppearance, &Player::setCharacterAppearance);
static Reflection::PropDescriptor<Player, bool> prop_canLoadCharacterAppearance("CanLoadCharacterAppearance", category_Behavior,
    &Player::getCanLoadCharacterAppearance, &Player::setCanLoadCharacterAppearance, Reflection::PropertyDescriptor::SCRIPTING, Security::None);
static Reflection::BoundFuncDesc<Player, void()> func_RemoveCharacterAppearance(
    &Player::removeCharacterAppearanceScript, "ClearCharacterAppearance", Security::None);
static Reflection::BoundFuncDesc<Player, void(shared_ptr<Instance>)> func_LoadCharacterAppearanceScript(
    &Player::loadCharacterAppearanceScript, "LoadCharacterAppearance", "assetInstance", Security::None);

static Reflection::RefPropDescriptor<Player, SpawnLocation> prop_RespawnLocation(
    "RespawnLocation", category_Data, &Player::getDangerousRespawnLocation, &Player::setRespawnLocation);
Reflection::PropDescriptor<Player, std::string> Player::prop_displayName(
    "DisplayName", category_Data, &Player::getDisplayName, &Player::setDisplayName, Reflection::PropertyDescriptor::SCRIPTING);
Reflection::PropDescriptor<Player, int> Player::prop_userId(
    "UserId", category_Data, &Player::getUserID, &Player::setUserId, Reflection::PropertyDescriptor::SCRIPTING);
Reflection::PropDescriptor<Player, int> Player::prop_userIdDeprecated("userId", category_Data, &Player::getUserID, &Player::setUserId,
    Reflection::PropertyDescriptor::Attributes::deprecated(Player::prop_userId, Reflection::PropertyDescriptor::SCRIPTING));
static Reflection::BoundFuncDesc<Player, float(Vector3)> func_CharacterDistance(
    &Player::distanceFromCharacter, "DistanceFromCharacter", "point", Security::None);

static Reflection::BoundFuncDesc<Player, FriendService::FriendStatus(shared_ptr<Instance>)> func_GetFriendStatus(
    &Player::getFriendStatus, "GetFriendStatus", "player", Security::RobloxScript);
...
static Reflection::BoundYieldFuncDesc<Player, bool(int)> dep_IsFriendsWith(
    &Player::isFriendsWith, "isFriendsWith", "userId", Security::None, Reflection::Descriptor::Attributes::deprecated(func_IsFriendsWith));
static Reflection::BoundYieldFuncDesc<Player, bool(int)> func_IsBestFriendsWith(
    &Player::isBestFriendsWith, "IsBestFriendsWith", "userId", Security::None, Reflection::Descriptor::Attributes::deprecated());
static Reflection::BoundYieldFuncDesc<Player, bool(int)> func_IsInGroup(&Player::isInGroup, "IsInGroup", "groupId", Security::None);
static Reflection::BoundYieldFuncDesc<Player, shared_ptr<const Reflection::ValueArray>(int)> func_getFriendsOnline(
    &Player::getFriendsOnline, "GetFriendsOnline", "maxFriends", 200, Security::None);
...
static Reflection::BoundYieldFuncDesc<Player, std::string(int)> func_getRoleInGroup(
    &Player::getRoleInGroup, "GetRoleInGroup", "groupId", Security::None);

// TODO: Security - put Aya::Security::WritePlayer checks on these properties (like userId has)
Reflection::PropDescriptor<Player, bool> Player::prop_SuperSafeChat("SuperSafeChatReplicate", category_Data, &Player::getSuperSafeChat,
    &Player::setSuperSafeChat, Reflection::PropertyDescriptor::REPLICATE_ONLY, Security::LocalUser);

Reflection::BoundProp<std::string> Player::prop_OsPlatform(
    "OsPlatform", category_Data, &Player::osPlatform, Reflection::PropertyDescriptor::REPLICATE_ONLY, Security::RobloxScript);

static Reflection::RemoteEventDesc<Player, void(float)> event_simulationRadiusChanged(&Player::simulationRadiusChangedSignal,
    "SimulationRadiusChanged", "radius", Security::LocalUser, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
Reflection::PropDescriptor<Player, float> Player::prop_DeprecatedMaxSimulationRadius("MaxSimulationRadius" /*keep this name*/, category_Data,
    &Player::getDeprecatedMaxSimulationRadius, &Player::setDeprecatedMaxSimulationRadius, Reflection::PropertyDescriptor::REPLICATE_ONLY,
    Security::LocalUser);
Reflection::BoundProp<float> Player::prop_MaxSimulationRadius(
    "MaximumSimulationRadius", category_Data, &Player::maxSimulationRadius, Reflection::PropertyDescriptor::UI, Security::TestLocalUser);
Reflection::BoundProp<float> Player::prop_SimulationRadius(
    "SimulationRadius", category_Data, &Player::simulationRadius, Reflection::PropertyDescriptor::SCRIPTING, Security::TestLocalUser);

Reflection::EnumPropDescriptor<Player, Player::ChatMode> prop_ChatMode(
    "ChatMode", category_Data, &Player::getChatMode, NULL, Reflection::PropertyDescriptor::UI, Security::RobloxScript);
...
static Reflection::RefPropDescriptor<Player, Team> prop_team("Team", category_Team, &Player::getTeam2, &Player::setTeam);
static Reflection::PropDescriptor<Player, bool /**/> prop_neutral("Neutral", category_Team, &Player::getNeutral, &Player::setNeutral);

static Reflection::PropDescriptor<Player, bool> prop_autoJumpEnabled(
    "AutoJumpEnabled", category_Data, &Player::getAutoJumpEnabled, &Player::setAutoJumpEnabled);

static Reflection::PropDescriptor<Player, bool> prop_Guest(
    "Guest", category_Data, &Player::isGuest, NULL, Reflection::PropertyDescriptor::UI, Security::RobloxScript);
static Reflection::EnumPropDescriptor<Player, Player::MembershipType> prop_membershipType(
    "MembershipType", category_Data, &Player::getMembershipType, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::EnumPropDescriptor<Player, Player::MembershipType /**/> prop_membershipTypeReplicate(
    "MembershipTypeReplicate", category_Data, &Player::getMembershipType, &Player::setMembershipType, Reflection::PropertyDescriptor::REPLICATE_ONLY);

static Reflection::PropDescriptor<Player, int> prop_accountAge(
    "AccountAge", category_Data, &Player::getAccountAge, NULL, Reflection::PropertyDescriptor::UI);
static Reflection::PropDescriptor<Player, int /**/> prop_accountAgeReplicate(
    "AccountAgeReplicate", category_Data, &Player::getAccountAge, &Player::setAccountAge, Reflection::PropertyDescriptor::REPLICATE_ONLY);

static Reflection::EventDesc<Player, void(std::string, shared_ptr<Instance>)> event_Chatted(
    &Player::chattedSignal, "Chatted", "message", "recipient");
...
static Reflection::RemoteEventDesc<Player, void(shared_ptr<Instance>)> event_CharacterLoaded(&Player::CharacterAppearanceLoadedSignal,
    "CharacterAppearanceLoaded", "character", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::EventDesc<Player, void(shared_ptr<Instance>)> event_CharacterRemoving(
    &Player::characterRemovingSignal, "CharacterRemoving", "character");
static Reflection::EventDesc<Player, void(double)> event_Idled(&Player::idledSignal, "Idled", "time");
static Reflection::EventDesc<Player, void(shared_ptr<Instance>, FriendService::FriendStatus)> event_FriendStatusChanged(
    &Player::friendStatusChangedSignal, "FriendStatusChanged", "player", "friendStatus", Security::RobloxScript);

static Reflection::RemoteEventDesc<Player, void()> desc_kill(&Player::killPlayerSignal, "Kill", Security::LocalUser,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::RemoteEventDesc<Player, void(std::string, std::string, std::string)> desc_scriptSecurityError(&Player::scriptSecurityErrorSignal,
    "ScriptSecurityError", "hash", "error", "stack", Security::LocalUser, Reflection::RemoteEventCommon::REPLICATE_ONLY,
    Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<Player, void(std::string, Vector3)> desc_remoteInsert(&Player::remoteInsertSignal, "RemoteInsert", "url",
    "position", Security::LocalUser, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::RemoteEventDesc<Player, void(std::string)> desc_statsSignal(&Player::statsSignal, "StatsAvailable", "info", Security::LocalUser,
    Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::PropDescriptor<Player, bool> prop_appearanceDidLoad("AppearanceDidLoad", category_Data, &Player::getAppearanceDidLoad, NULL,
    Reflection::PropertyDescriptor::Attributes::deprecated(Reflection::PropertyDescriptor::UI), Security::RobloxScript);
...
static Reflection::EnumPropDescriptor<Player, Camera::CameraMode> prop_cameraMode(
    "CameraMode", "Camera", &Player::getCameraMode, &Player::setCameraMode);
static Reflection::PropDescriptor<Player, float> prop_cameraMaxZoomDistance(
    "CameraMaxZoomDistance", "Camera", &Player::getCameraMaxZoomDistance, &Player::setCameraMaxZoomDistance);
static Reflection::PropDescriptor<Player, float> prop_cameraMinZoomDistance(
    "CameraMinZoomDistance", "Camera", &Player::getCameraMinZoomDistance, &Player::setCameraMinZoomDistance);

static Reflection::EnumPropDescriptor<Player, StarterPlayerService::DeveloperTouchCameraMovementMode> prop_devTouchCameraMode(
    "DevTouchCameraMode", "Camera", &Player::getDevTouchCameraMode, &Player::setDevTouchCameraMode);
static Reflection::EnumPropDescriptor<Player, StarterPlayerService::DeveloperComputerCameraMovementMode> prop_devComputerCameraMode(
    "DevComputerCameraMode", "Camera", &Player::getDevComputerCameraMode, &Player::setDevComputerCameraMode);
static Reflection::PropDescriptor<Player, bool> prop_devEnableMouseLockOption(
    "DevEnableMouseLock", "Camera", &Player::getDevEnableMouseLockOption, &Player::setDevEnableMouseLockOption);
static Reflection::EnumPropDescriptor<Player, StarterPlayerService::DeveloperCameraOcclusionMode> prop_devCameraOcclusionMode(
    "DevCameraOcclusionMode", "Camera", &Player::getDevCameraOcclusionMode, &Player::setDevCameraOcclusionMode);

static Reflection::EnumPropDescriptor<Player, StarterPlayerService::DeveloperTouchMovementMode> prop_devTouchMovementMode(
    "DevTouchMovementMode", category_Control, &Player::getDevTouchMovementMode, &Player::setDevTouchMovementMode);
static Reflection::EnumPropDescriptor<Player, StarterPlayerService::DeveloperComputerMovementMode> prop_devComputerMovementMode(
    "DevComputerMovementMode", category_Control, &Player::getDevComputerMovementMode, &Player::setDevComputerMovementMode);

static Reflection::PropDescriptor<Player, float> prop_nameDisplayDistance(
    "NameDisplayDistance", "Camera", &Player::getNameDisplayDistance, &Player::setNameDisplayDistance);
static Reflection::PropDescriptor<Player, float> prop_healthDisplayDistance(
    "HealthDisplayDistance", "Camera", &Player::getHealthDisplayDistance, &Player::setHealthDisplayDistance);

static Reflection::RemoteEventDesc<Player, void()> event_connectDiedSignal(&Player::connectDiedSignalBackend, "ConnectDiedSignalBackend",
    Security::Roblox, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);

static Reflection::PropDescriptor<Player, int> prop_getFollowUserIdReplicated("FollowUserIdReplicated", category_Data, &Player::getFollowUserId,
    &Player::setFollowUserId, Reflection::PropertyDescriptor::REPLICATE_ONLY, Security::None);
static Reflection::PropDescriptor<Player, int> prop_getFollowUserId("FollowUserId", category_Data, &Player::getFollowUserId, NULL);

// Teleport related
static Reflection::RemoteEventDesc<Player, void(TeleportService::TeleportState, int, std::string)> event_OnTeleport(&Player::onTeleportSignal,
    "OnTeleport", "teleportState", "placeId", "spawnName", Security::None, Reflection::RemoteEventCommon::SCRIPTING,
    Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::RemoteEventDesc<Player, void(TeleportService::TeleportState, shared_ptr<const Reflection::ValueTable>, shared_ptr<Instance>)>
    event_OnTeleportInternal(&Player::onTeleportInternalSignal, "OnTeleportInternal", "teleportState", "teleportInfo", "customLoadingScreen",
        Security::Roblox, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
static Reflection::PropDescriptor<Player, bool> prop_teleported(
    "Teleported", category_Data, &Player::getTeleported, NULL, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING, Security::RobloxScript);
static Reflection::PropDescriptor<Player, bool> prop_teleportedIn("TeleportedIn", category_Data, &Player::getTeleportedIn, &Player::setTeleportedIn,
    ...
    , myTeam(NULL)
{
    ...
    Aya::Security::Context::current().requirePermission(Aya::Security::WritePlayer, "create a Player");
#endif
    setName(sPlayer);
}
...
bool Player::physicsOutBandwidthExceeded(const Aya::Instance* context)
{
    return Client::physicsOutBandwidthExceeded(context);
}

double Player::getNetworkBufferHealth(const Aya::Instance* context)
{
...
void Player::saveNumber(std::string key, double value)
{
    ...
    if (!persistentData->setNumber(key, value))
    {
        ...
        throw Aya::runtime_error("Exceeded DataComplexity limit for Number key %s", key.c_str());
    }
    raisePropertyChanged(prop_dataComplexity);
}
...
void Player::saveBoolean(std::string key, bool value)
{
    ...
    {
        raisePropertyChanged(prop_dataComplexity);
        throw Aya::runtime_error("Exceeded DataComplexity limit for Boolean key %s", key.c_str());
    }
    raisePropertyChanged(prop_dataComplexity);
}
...
void Player::saveString(std::string key, std::string value)
{
    ...
    {
        raisePropertyChanged(prop_dataComplexity);
        throw Aya::runtime_error("Exceeded DataComplexity limit for String key %s", key.c_str());
    }
    raisePropertyChanged(prop_dataComplexity);
}
...
void Player::saveList(std::string key, shared_ptr<const Reflection::ValueArray> value)
{
    ...
    {
        raisePropertyChanged(prop_dataComplexity);
        throw Aya::runtime_error("Exceeded DataComplexity limit for List key %s", key.c_str());
    }
    raisePropertyChanged(prop_dataComplexity);
}

shared_ptr<const Aya::Reflection::ValueMap> Player::loadTable(std::string key)
{
    if (!Players::backendProcessing(this, false))
...
void Player::saveTable(std::string key, shared_ptr<const Aya::Reflection::ValueMap> value)
{
    if (!Players::backendProcessing(this, false))
    ...
    {
        raisePropertyChanged(prop_dataComplexity);
        throw Aya::runtime_error("Exceeded DataComplexity limit for Table key %s", key.c_str());
    }
    raisePropertyChanged(prop_dataComplexity);
}
...
void Player::saveInstance(std::string key, shared_ptr<Instance> value)
{
    ...
    {
        raisePropertyChanged(prop_dataComplexity);
        throw Aya::runtime_error("Exceeded DataComplexity limit for Instance key %s", key.c_str());
    }
    raisePropertyChanged(prop_dataComplexity);
}
...
{
    Aya::Network::Client* client = ServiceProvider::find<Aya::Network::Client>(this);
    if (client)
    {
        if (Aya::Network::ClientReplicator* cRep = client->findFirstChildOfType<Aya::Network::ClientReplicator>())
        {
...
void Player::renderDPhysicsRegion(Adorn* adorn)
{
    ...
    if (this->hasCharacterHead(coord))
    {
        if (const Primitive* prim = getConstCharacterRoot())
        {
            ...
            Color3 color = Aya::Color::colorFromInt(prim->getNetworkOwner().getAddress());
...
void Player::setSimulationRadius(float value)
{
    if (simulationRadius > value)
    {
        ...
        Aya::Network::Server* server = ServiceProvider::find<Aya::Network::Server>(this);
...
{
    if (value && (value->getClassName() != ModelInstance::className()) && (value->getClassName() != PartInstance::className()))
    {
    ...
    if (value != this->character.get())
    {
        if (character)
        {
            ...
            if (!Aya::GameBasicSettings::singleton().inMouseLockMode())
                if (shared_ptr<Aya::CoreGuiService> coreGuiService =
                        shared_from(ServiceProvider::find<Aya::CoreGuiService>(this->fastDynamicCast<Instance>())))
                    if (Aya::GuiTextButton* button =
                            Instance::fastDynamicCast<Aya::GuiTextButton>(coreGuiService->findFirstChildByName2("MouseLockLabel", true).get()))
        ...
        if (value)
        {
            ...
            if (Players::backendProcessing(this, false))
            { // Server does it in client/server - bail on client mode.  will still execute in solo mode
                AYAASSERT(workspace);
...
{
    AYAASSERT(Players::backendProcessing(this));
...
void Player::setTeamColor(BrickColor value)
{
    ...
    if (value != teamColor)
    {
        if (Team* oldTeam = getTeam())
            oldTeam->playerRemovedSignal(shared_from(this));
        ...
        if (Team* newTeam = getTeam())
            newTeam->playerAddedSignal(shared_from(this));
    }
}
...
Team* Player::getTeam()
{
    ...
    if (teams != NULL)
    {
        if (neutral == false)
        {
            Team* t = teams->getTeamFromPlayer(this);
            if (t != NULL)
            {
                return t;
            }
...
void Player::onLocalPlayerNotIdle(Aya::ServiceProvider* serviceProvider)
{
...
{
    AYAASSERT(Players::frontendProcessing(this));
...
void Player::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider)
{
    ...
    if (newProvider)
    {
        ...
        {
            onCharacterChangedFrontend();
            Aya::Network::Player* localPlayer = Network::Players::findLocalPlayer(newProvider);
...
static void doLoadGear(weak_ptr<Player> player, shared_ptr<Instances> instances, std::string contentDescription, bool equipped)
{
    ...
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Error loading character gear %s: %s", contentDescription.c_str(), e.what());
    }
}
...
void static doMakeStarterGearRequests(std::string response, weak_ptr<Player> player, weak_ptr<DataModel> dataModel)
{
    ...
    if (d)
    {
        ...
        for (size_t i = 0; i < strings.size(); i++)
        {
            ...
            ServiceProvider::create<ContentProvider>(d.get())->loadContent(ContentId(contentIdString), ContentProvider::PRIORITY_CHARACTER,
                boost::bind(
                    &doLoadGear, player, _2, contentIdString, (contentIdString.find("equipped=1") != std::string::npos)), // equipped sentinel check
...
void static makeStarterGearRequests(std::string* response, std::exception* err, weak_ptr<Player> player, weak_ptr<DataModel> dataModel)
{
    if (!response)
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Make Starter Gear Request exception: %s", err->what());
        return;
    }
...
void Player::loadStarterGear()
{
    if (!loadedStarterGear && !characterAppearance.empty())
    {
        ...
        Aya::Http(characterAppearance).get(boost::bind(&makeStarterGearRequests, _1, _2, weak_from(this), boost::weak_ptr<DataModel>(dm)));
    }
}
...
void Player::setAppearanceParent(weak_ptr<Player> player, weak_ptr<Instance> instance, bool equipped)
{
    ...
    // This is a hack that works as follows:  if they receive an asset with type DataModelMesh, then it must be for a head.  This is b/c we currently
    // dont allow a mesh to be used on any other part except for in accoutrements, so this shouldnt be an issue.  In the future, we may want to pass
    // another value which indicates where the mesh is being applied to.

    ModelInstance* character = p->getCharacter();

    if (character)
    {
        if (Aya::DataModelMesh* headMesh = i->fastDynamicCast<Aya::DataModelMesh>())
        {
            if (Humanoid* humanoid = character->findFirstChildOfType<Humanoid>())
                humanoid->setHeadMesh(headMesh);
        }
        else if (Aya::Decal* decal = i->fastDynamicCast<Aya::Decal>())
        {
            if (Humanoid* humanoid = character->findFirstChildOfType<Humanoid>())
        ...
        else if (dynamic_cast<IEquipable*>(i.get()))
        {
            ...
            else
            {
                if (Humanoid* humanoid = character->findFirstChildOfType<Humanoid>())
                {
                    ...
                    // Quick edit to allow hats for R15. Ideally we should properly implement hat attachments in the near future
                    // @mdolli
                    if (!i->fastDynamicCast<Tool>())
                    {
                        i->setParent(character);
    ...
    std::string contentDescription, bool equipped, double requestTime)
{
    ...
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Error loading character appearance %s: %s", contentDescription.c_str(), e.what());
    }
}
...
void static doMakeAccoutrementRequests(std::string response, weak_ptr<Player> player, weak_ptr<DataModel> dataModel)
{
    ...
    if (d)
    {
        ...
        for (size_t i = 0; i < strings.size(); i++)
        {
            ...
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "doMakeAccoutrementRequests: %s", contentIdString.c_str());

            ServiceProvider::create<ContentProvider>(d.get())->loadContent(ContentId(contentIdString), ContentProvider::PRIORITY_CHARACTER,
                boost::bind(&doLoadAppearance, player, _1, _2, contentIdString, (contentIdString.find("equipped=1") != std::string::npos),
                    Time::nowFastSec()), // equipped sentinel check
                AsyncHttpQueue::AsyncWrite);
        }
    }
}
...
void static makeAccoutrementRequests(std::string* response, std::exception* err, weak_ptr<Player> player, weak_ptr<DataModel> dataModel)
{
    if (!response)
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Make Accoutrement Request exception: %s", err->what());
        return;
    }
...
void Player::loadCharacterAppearance(bool blockingCall)
{
    ...
    if (!characterAppearance.empty())
    {
        ...
        if (blockingCall)
        {
            Aya::Http(sanitizedCharacterAppearance).get(response);
            std::vector<std::string> strings;
            boost::split(strings, response, boost::is_any_of(";"));
            ...
            for (size_t i = 0; i < strings.size(); i++)
            {
                try
                {
                    ...
                    {
                        ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(
                            ContentId(contentIdString), characterAppearanceInstancesEquipped);
                    }
                    else
                    {
                        ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(
                            ContentId(contentIdString), characterAppearanceInstances);
                    }
                }
            ...
            std::for_each(characterAppearanceInstancesEquipped.begin(), characterAppearanceInstancesEquipped.end(),
                boost::bind(&setAppearanceParent, weak_from(this), _1, true));
            std::for_each(characterAppearanceInstances.begin(), characterAppearanceInstances.end(),
                boost::bind(&setAppearanceParent, weak_from(this), _1, false));
        }
        else
        {
            // start debug timer
            ...
            weak_ptr<DataModel> dm(shared_from(Instance::fastDynamicCast<DataModel>(this->getRootAncestor())));
            Aya::Http(sanitizedCharacterAppearance)
                .get(boost::bind(&makeAccoutrementRequests, _1, _2, weak_from(this), boost::weak_ptr<DataModel>(dm)));
        }
    }
    else
    {
...
void Player::doFirstSpawnLocationCalculation(const ServiceProvider* serviceProvider, const std::string& preferedSpawnName)
{

    AYAASSERT(nextSpawnLocation == NULL);
    AYAASSERT(!hasSpawnedAtLeastOnce);
...
void Player::move(Vector3 walkVector, bool relativeToCamera)
{
    if (ModelInstance* character = getCharacter())
    {
        ...
        {
            Aya::StandardOut::singleton()->print(MESSAGE_WARNING, "Player:Move called, but player currently has no humanoid.");
        }
    }
    else
    {
        Aya::StandardOut::singleton()->print(MESSAGE_WARNING, "Player:Move called, but player currently has no character.");
    }
}
...
void Player::calculateNextSpawnLocation(const ServiceProvider* serviceProvider)
{
    ...
    if (SpawnerService* ss = serviceProvider->find<SpawnerService>())
    {
        if (SpawnLocation* sl = ss->GetSpawnLocation(this, hasSpawnedAtLeastOnce ? "" : teleportSpawnName))
        {
            ...
            spawnLocationChangedConnection =
                sl->propertyChangedSignal.connect(boost::bind(&Player::calculateNextSpawnLocationHelper, weak_from(this), serviceProvider));
            locationFound = true;
        }
    }
    ...
    Aya::StandardOut::singleton()->printf(Aya::MESSAGE_INFO, "next spawn location = (%f,%f,%f)", location.x, location.y, location.z);
...
void Player::loadCharacter(bool inGame, std::string preferedSpawnName)
{
    ...
    if (starterPlayerService != NULL)
    {
        ...
        if (pStarterCharacter && Aya::Instance::fastDynamicCast<ModelInstance>(pStarterCharacter) != NULL)
        {
            if (shared_ptr<Instance> copy = pStarterCharacter->clone(EngineCreator))
            {
                model = Aya::Instance::fastSharedDynamicCast<ModelInstance>(copy);
                pModel = model.get();
            }
        }
    ...
    if (model == NULL)
    {
        ...
        if (useR15)
        {
            ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(ContentId::fromAssets("avatar/characterR15.rbxm"), instances);
        }
        else
        {
            ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(ContentId::fromAssets("avatar/character.rbxmx"), instances);
        }
    ...
    if (humanoid)
        // set Humanoid display name
        humanoid->setDisplayName(displayName);
    ...
    if (starterPlayerService != NULL)
    {
        Aya::StarterPlayerScripts* pStarterCharacterScripts = starterPlayerService->findFirstChildOfType<Aya::StarterCharacterScripts>();
        if (pStarterCharacterScripts)
        {
            ...
            if (pAnimateScript)
            {
                // We're not overriding if using legacy versions
        ...
        if (!overrideSoundScript)
        {
            ...
            // For 2013 and below, we load the legacy Sound script
            // Is this secure?
            // @mdolli
            // rj: NO
            Instances extraSound;
            ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(
                ContentId::fromAssets("avatar/scripts/humanoidSound.rbxmx"), extraSound);
            std::for_each(extraSound.begin(), extraSound.end(), boost::bind(&addChild, model, _1));
        }

        if (inGame && !overrideHealthScript)
        {
            // new rbxm (storing in humanoidHealthRegenScript.rbxm to make turning flag on easy) only contains server script that does humanoid
            // health regen (gui script is now core script)
            ServiceProvider::create<ContentProvider>(this)->loadContent(ContentId::fromAssets("avatar/scripts/humanoidHealthRegenScript.rbxm"),
                ContentProvider::PRIORITY_SCRIPT, boost::bind(&CharacterLoadHelper, model, _1, _2), AsyncHttpQueue::AsyncWrite);
        }
        ...
        if (!overrideAnimateScript)
        {
            ...
            {
                ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(
                    ContentId::fromAssets("avatar/scripts/humanoidAnimateR15.rbxm"), extraAnimate);
            }
            else
            {
                ServiceProvider::create<ContentProvider>(this)->blockingLoadInstances(
                    ContentId::fromAssets("avatar/scripts/humanoidAnimate.rbxmx"), extraAnimate);
            }
...
{
    if (Humanoid* humanoid = Aya::Instance::fastDynamicCast<Humanoid>(child.get()))
    {
...
{
    Aya::PlayerGui* currPlayerGui = findFirstChildOfType<Aya::PlayerGui>();
    if (!currPlayerGui)
    {
        shared_ptr<Aya::PlayerGui> playerGui = Creatable<Instance>::create<Aya::PlayerGui>();
...
void Player::rebuildGui()
{
    ...
    if (currPlayerGui)
    {
        ...
        {
            if (starterGui->getResetPlayerGui())
                currPlayerGui->removeAllChildren();
            else
            {
                // Remove only ScreenGuis that have ResetOnSpawn = true
                if (currPlayerGui->getChildren())
                {
                    boost::shared_ptr<const Instances> children(currPlayerGui->getChildren().read());
                    std::vector<shared_ptr<Instance>> toRemove;

                    for (Instances::const_iterator iter = children->begin(); iter != children->end(); ++iter)
                    {
                        if (Aya::ScreenGui* screenGui = Instance::fastDynamicCast<Aya::ScreenGui>(iter->get()))
                        {
                            if (screenGui->getResetOnSpawn())
                            {
...
void Player::rebuildPlayerScripts()
{
    ...
    Aya::PlayerScripts* currPlayerScripts = findFirstChildOfType<Aya::PlayerScripts>();
    if (!currPlayerScripts)
    {
        shared_ptr<Aya::PlayerScripts> playerScripts = Creatable<Instance>::create<Aya::PlayerScripts>();
...
{
#ifndef REMOVE_PLAYER_PROTECTIONS
    Aya::Security::Context::current().requirePermission(Aya::Security::WritePlayer, "set a Player's name");
#endif
    Super::setName(value);
}

void Player::setDisplayName(std::string value)
{
#ifndef REMOVE_PLAYER_PROTECTIONS
    Aya::Security::Context::current().requirePermission(Aya::Security::WritePlayer, "set a Player's DisplayName");
#endif
...
#endif
#ifndef REMOVE_PLAYER_PROTECTIONS
        Aya::Security::Context::current().requirePermission(Aya::Security::WritePlayer, "set a Player's ID");
#endif
        userId = value;
...
void Player::setCameraMode(Aya::Camera::CameraMode value)
{
    if (cameraMode != value)
    {
        cameraMode = value;
...
void Player::setDevEnableMouseLockOption(bool setting)
{
    if (!Players::backendProcessing(this, false) && Players::frontendProcessing(this, false))
    {
        try
        {
            Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setDevEnableMouseLockOption");
        }
        catch (Aya::base_exception& e)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficent permissions to set DevEnableMouseLockOption");
            throw e;
        }
    }
...
void Player::setDevTouchCameraMode(StarterPlayerService::DeveloperTouchCameraMovementMode setting)
{
    if (!Players::backendProcessing(this, false) && Players::frontendProcessing(this, false))
    {
        try
        {
            Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setDevTouchCameraMode");
        }
        catch (Aya::base_exception& e)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficent permissions to set DevTouchCameraMode");
            throw e;
        }
    }
...
void Player::setDevComputerCameraMode(StarterPlayerService::DeveloperComputerCameraMovementMode setting)
{
    if (!Players::backendProcessing(this, false) && Players::frontendProcessing(this, false))
    {
        try
        {
            Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setDevComputerCameraMode");
        }
        catch (Aya::base_exception& e)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficent permissions to set DevComputerCameraMode");
            throw e;
        }
    }
...
void Player::setDevCameraOcclusionMode(StarterPlayerService::DeveloperCameraOcclusionMode setting)
{
    if (!Players::backendProcessing(this, false) && Players::frontendProcessing(this, false))
    {
        try
        {
            Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setDevCameraOcclusionMode");
        }
        catch (Aya::base_exception& e)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficent permissions to set DevCameraOcclusionMode");
            throw e;
        }
    }
...
void Player::setDevTouchMovementMode(StarterPlayerService::DeveloperTouchMovementMode setting)
{
    if (!Players::backendProcessing(this, false) && Players::frontendProcessing(this, false))
    {
        try
        {
            Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setDevTouchMovementMode");
        }
        catch (Aya::base_exception& e)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficent permissions to set DevTouchMovementMode");
            throw e;
        }
    }
...
void Player::setDevComputerMovementMode(StarterPlayerService::DeveloperComputerMovementMode setting)
{
    if (!Players::backendProcessing(this, false) && Players::frontendProcessing(this, false))
    {
        try
        {
            Aya::Security::Context::current().requirePermission(Aya::Security::RobloxScript, "setDevComputerMovementMode");
        }
        catch (Aya::base_exception& e)
        {
            Aya::StandardOut::singleton()->printf(Aya::MESSAGE_ERROR, "Insufficent permissions to set DevComputerMovementMode");
            throw e;
        }
    }
...
{
    const Aya::Backpack* backpack = findConstFirstChildOfType<Aya::Backpack>();
    return backpack;
}
...
void Player::verifySetParent(const Instance* instance) const
{
    ...
    {
        throw Aya::runtime_error("Parent of Player can not be changed");
    }
...
void Player::requestFriendship(shared_ptr<Instance> instance)
{
    ...
    {
        throw Aya::runtime_error("RequestFriendship should be passed a Player");
    }
    ...
    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        ...
        apiService->postAsync("user/request-friendship?" + postData, postData, true, Aya::PRIORITY_DEFAULT, HttpService::TEXT_PLAIN,
            boost::bind(&dontCareResponse), boost::bind(&dontCareResponse));
    }
...
void Player::revokeFriendship(shared_ptr<Instance> instance)
{
    ...
    if (!(player = Instance::fastSharedDynamicCast<Player>(instance)))
    {
        throw Aya::runtime_error("RevokeFriendship should be passed a Player");
    }

    if (Aya::HttpRbxApiService* apiService = Aya::ServiceProvider::find<Aya::HttpRbxApiService>(this))
    {
        const std::string postData = "requesterUserId=" + boost::lexical_cast<std::string>(player->getUserID());
        apiService->postAsync("user/decline-friend-request?" + postData, postData, true, Aya::PRIORITY_DEFAULT, HttpService::TEXT_PLAIN,
            boost::bind(&dontCareResponse), boost::bind(&dontCareResponse));
    }
...
void Player::isFriendsWith(int otherUserId, boost::function<void(bool)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    ...
    if (Aya::SocialService* socialService = ServiceProvider::create<Aya::SocialService>(this))
...
void Player::getFriendsOnline(
    int maxFriends, boost::function<void(shared_ptr<const Reflection::ValueArray>)> resumeFunction, boost::function<void(std::string)> errorFunction)
{
    if (maxFriends > 200)
    {
        Aya::StandardOut::singleton()->printf(Aya::MESSAGE_WARNING, "GetFriendsOnline only returns a maximum of 200 friends");
    }
    if (Players* players = ServiceProvider::find<Players>(this))
    {
    ...
    if (Aya::FriendService* friendService = ServiceProvider::create<Aya::FriendService>(this))
    {
...
void Player::kick(std::string msg)
{
    ...
    if (msg != "")
    {
        ...
        {
            const Aya::SystemAddress& target = getRemoteAddressAsRbxAddress();
    ...
    if (Network::Players* players = ServiceProvider::find<Players>(this))
    {
        ...
        {
            TimerService* ts = Aya::ServiceProvider::find<TimerService>(this);
            if (ts && delay)
            {
...
void Player::handleTeleportInternalSignal(
...
void Player::handleTeleportSignalBackend(TeleportService::TeleportState teleportState)
{
    ...
    if (teleportState == TeleportService::TeleportState_InProgress || teleportState == TeleportService::TeleportState_Started ||
...
void Player::onTeleportInternal(
    TeleportService::TeleportState teleportState, shared_ptr<const Reflection::ValueTable> teleportInfo, shared_ptr<Instance> customLoadingGUI)
{
    event_OnTeleport.fireAndReplicateEvent(
        this, teleportState, teleportInfo->at("placeId").get<int>(), teleportInfo->at("spawnName").get<std::string>());
...
void Player::loadChatInfo()
{
    ...
    boost::function0<void> g = boost::bind(&StandardOut::print_exception, f, Aya::MESSAGE_ERROR, false);
    boost::thread(thread_wrapper(g, "aya_getPlayerMetaData"));
}
...
void Player::loadChatInfoInternal(weak_ptr<Player> weakPlayer)
{
    ...
    player->chatFilterType = Player::CHAT_FILTER_WHITELIST;
