...
const char* ReplicatorStats::kPacketTypeNames[PACKET_TYPE_MAX] = {"InstanceNew", "InstanceDelete", "Ping", category_Data, category_Behavior,
    category_State, category_Appearance, category_Team, category_Video, category_Control, "Events"};
